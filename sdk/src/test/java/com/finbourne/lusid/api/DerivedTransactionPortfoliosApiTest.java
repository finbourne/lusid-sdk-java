...
public class DerivedTransactionPortfoliosApiTest {
    ...
    public void createDerivedPortfolioTest() throws ApiException {
        String scope = null;
        CreateDerivedTransactionPortfolioRequest createDerivedTransactionPortfolioRequest = null;
        Portfolio response = api.createDerivedPortfolio(scope, createDerivedTransactionPortfolioRequest);
