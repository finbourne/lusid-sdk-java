...
public class SearchApiTest {
    ...
    public void instrumentsSearchTest() throws ApiException {
        ...
        OffsetDateTime masteredEffectiveAt = null;
    ...
    public void portfolioGroupsSearchTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfPortfolioGroup response = api.portfolioGroupsSearch(request, sortBy, start, limit, filter);
    ...
    public void portfoliosSearchTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfPortfolioSearchResult response = api.portfoliosSearch(request, sortBy, start, limit, filter);
    ...
    public void propertiesSearchTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfPropertyDefinition response = api.propertiesSearch(request, sortBy, start, limit, filter);
