...
public class AggregationApiTest {
    ...
    public void getAggregationByGroupTest() throws ApiException {
        ...
        Integer start = null;
        Integer limit = null;
        ListAggregationResponse response = api.getAggregationByGroup(scope, code, request, sortBy, start, limit);
    ...
    public void getAggregationByPortfolioTest() throws ApiException {
        ...
        Integer start = null;
        Integer limit = null;
        ListAggregationResponse response = api.getAggregationByPortfolio(scope, code, request, sortBy, start, limit);
    ...
    public void getAggregationByResultSetTest() throws ApiException {
        ...
        Integer start = null;
        Integer limit = null;
        ListAggregationResponse response = api.getAggregationByResultSet(scope, resultsKey, request, sortBy, start, limit);
