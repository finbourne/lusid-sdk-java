...
public class PortfoliosApiTest {
    ...
    public void listPortfoliosTest() throws ApiException {
        ...
        String query = null;
        List<String> portfolioPropertyKeys = null;
        ResourceListOfPortfolio response = api.listPortfolios(effectiveAt, asAt, page, sortBy, start, limit, filter, query, portfolioPropertyKeys);
    ...
    public void listPortfoliosForScopeTest() throws ApiException {
        ...
        String filter = null;
        List<String> portfolioPropertyKeys = null;
        ResourceListOfPortfolio response = api.listPortfoliosForScope(scope, effectiveAt, asAt, sortBy, start, limit, filter, portfolioPropertyKeys);
    ...
    public void updatePortfolioTest() throws ApiException {
        ...
        Portfolio response = api.updatePortfolio(scope, code, effectiveAt, request);
    ...
    public void upsertPortfolioPropertiesTest() throws ApiException {
        String scope = null;
        String code = null;
        Map<String, PropertyValue> portfolioProperties = null;
