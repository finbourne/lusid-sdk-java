...
public class PortfoliosApiTest {
    ...
    public void listPortfoliosTest() throws ApiException {
        ...
        String filter = null;
        String query = null;
        ResourceListOfPortfolio response = api.listPortfolios(effectiveAt, asAt, page, sortBy, start, limit, filter, query);
    ...
    public void listPortfoliosForScopeTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfPortfolio response = api.listPortfoliosForScope(scope, effectiveAt, asAt, sortBy, start, limit, filter);
