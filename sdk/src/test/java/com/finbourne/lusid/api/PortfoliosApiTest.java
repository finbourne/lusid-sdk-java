...
public class PortfoliosApiTest {
    ...
    public void listPortfoliosTest() throws ApiException {
        ...
        String query = null;
        List<String> portfolioPropertyKeys = null;
        ResourceListOfPortfolio response = api.listPortfolios(effectiveAt, asAt, page, start, limit, filter, query, portfolioPropertyKeys);
    ...
    public void listPortfoliosForScopeTest() throws ApiException {
        ...
        String filter = null;
        List<String> portfolioPropertyKeys = null;
        ResourceListOfPortfolio response = api.listPortfoliosForScope(scope, effectiveAt, asAt, filter, portfolioPropertyKeys);
