...
public class CorporateActionSourcesApiTest {
    ...
    public void batchUpsertCorporateActionsTest() throws ApiException {
        String scope = null;
        String code = null;
        List<CreateCorporateAction> actions = null;
    ...
    public void deleteCorporateActionSourceTest() throws ApiException {
        ...
        DeletedEntityResponse response = api.deleteCorporateActionSource(scope, code, effectiveAt);
    ...
    public void getCorporateActionsTest() throws ApiException {
        String scope = null;
        String code = null;
        OffsetDateTime fromEffectiveAt = null;
        OffsetDateTime toEffectiveAt = null;
    ...
    public void listCorporateActionSourcesTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfCorporateActionSource response = api.listCorporateActionSources(effectiveAt, asAt, sortBy, start, limit, filter);
