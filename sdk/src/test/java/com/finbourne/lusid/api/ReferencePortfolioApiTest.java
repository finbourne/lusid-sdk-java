...
public class ReferencePortfolioApiTest {
    ...
    public void getReferencePortfolioConstituentsTest() throws ApiException {
        ...
        GetReferencePortfolioConstituentsResponse response = api.getReferencePortfolioConstituents(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys);
