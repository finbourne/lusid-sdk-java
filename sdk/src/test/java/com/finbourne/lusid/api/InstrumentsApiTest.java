...
public class InstrumentsApiTest {
    ...
    public void getInstrumentTest() throws ApiException {
        ...
        OffsetDateTime asAt = null;
        List<String> instrumentPropertyKeys = null;
        Instrument response = api.getInstrument(identifierType, identifier, effectiveAt, asAt, instrumentPropertyKeys);
    ...
    public void getInstrumentIdentifiersTest() throws ApiException {
        ResourceListOfString response = api.getInstrumentIdentifiers();
    ...
    public void getInstrumentsTest() throws ApiException {
        ...
        OffsetDateTime asAt = null;
        List<String> instrumentPropertyKeys = null;
        GetInstrumentsResponse response = api.getInstruments(identifierType, identifiers, effectiveAt, asAt, instrumentPropertyKeys);
    ...
    public void listInstrumentsTest() throws ApiException {
        ...
        String filter = null;
        List<String> instrumentPropertyKeys = null;
        ResourceListOfInstrument response = api.listInstruments(asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys);
    ...
    public void matchInstrumentsTest() throws ApiException {
        String identifierType = null;
        List<String> identifiers = null;
        MatchInstrumentsResponse response = api.matchInstruments(identifierType, identifiers);
