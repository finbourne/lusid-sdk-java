...
public class TransactionPortfoliosApiTest {
     ...
     */
    @Test
    public void addTransactionPropertyTest() throws ApiException {
        String scope = null;
        String code = null;
        String transactionId = null;
        Object transactionProperties = null;
        AddTransactionPropertyResponse response = api.addTransactionProperty(scope, code, transactionId, transactionProperties);
    ...
    public void adjustHoldingsTest() throws ApiException {
        ...
        AdjustHolding response = api.adjustHoldings(scope, code, effectiveAt, holdingAdjustments);
    ...
    public void buildTransactionsTest() throws ApiException {
        ...
        String filter = null;
        TransactionQueryParameters parameters = null;
        VersionedResourceListOfOutputTransaction response = api.buildTransactions(scope, code, asAt, sortBy, start, limit, instrumentPropertyKeys, filter, parameters);
    ...
    public void createPortfolioTest() throws ApiException {
        String scope = null;
        CreateTransactionPortfolioRequest createRequest = null;
        Portfolio response = api.createPortfolio(scope, createRequest);
     ...
     */
    @Test
    public void deleteExecutionsTest() throws ApiException {
        String scope = null;
        String code = null;
        List<String> executionIds = null;
        DeletedEntityResponse response = api.deleteExecutions(scope, code, executionIds);
     ...
     */
    @Test
    public void deletePropertyFromTransactionTest() throws ApiException {
        String scope = null;
        String code = null;
        String transactionId = null;
        String transactionPropertyKey = null;
        DeletedEntityResponse response = api.deletePropertyFromTransaction(scope, code, transactionId, transactionPropertyKey);
     ...
     */
    @Test
    public void deleteTransactionsTest() throws ApiException {
        String scope = null;
        String code = null;
        List<String> transactionIds = null;
        DeletedEntityResponse response = api.deleteTransactions(scope, code, transactionIds);
    ...
    public void getHoldingsTest() throws ApiException {
        ...
        String filter = null;
        List<String> instrumentPropertyKeys = null;
        VersionedResourceListOfPortfolioHolding response = api.getHoldings(scope, code, byTaxlots, effectiveAt, asAt, sortBy, start, limit, filter, instrumentPropertyKeys);
    ...
    public void getTransactionsTest() throws ApiException {
        String scope = null;
        String code = null;
        OffsetDateTime fromTransactionDate = null;
        OffsetDateTime toTransactionDate = null;
        OffsetDateTime asAt = null;
        List<String> sortBy = null;
        Integer start = null;
        Integer limit = null;
        List<String> instrumentPropertyKeys = null;
        String filter = null;
        VersionedResourceListOfTransaction response = api.getTransactions(scope, code, fromTransactionDate, toTransactionDate, asAt, sortBy, start, limit, instrumentPropertyKeys, filter);
    ...
    public void setHoldingsTest() throws ApiException {
        ...
        OffsetDateTime effectiveAt = null;
        List<AdjustHoldingRequest> holdingAdjustments = null;
        AdjustHolding response = api.setHoldings(scope, code, effectiveAt, holdingAdjustments);
    ...
    public void upsertPortfolioDetailsTest() throws ApiException {
        String scope = null;
        String code = null;
        CreatePortfolioDetails details = null;
        OffsetDateTime effectiveAt = null;
        PortfolioDetails response = api.upsertPortfolioDetails(scope, code, details, effectiveAt);
