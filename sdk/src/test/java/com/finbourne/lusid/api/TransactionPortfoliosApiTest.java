...
public class TransactionPortfoliosApiTest {
    ...
    public void buildTransactionsTest() throws ApiException {
        ...
        VersionedResourceListOfOutputTransaction response = api.buildTransactions(scope, code, transactionQueryParameters, asAt, filter, propertyKeys);
    ...
    public void upsertExecutionsTest() throws ApiException {
        String scope = null;
        String code = null;
        List<ExecutionRequest> executionRequest = null;
        UpsertPortfolioExecutionsResponse response = api.upsertExecutions(scope, code, executionRequest);
