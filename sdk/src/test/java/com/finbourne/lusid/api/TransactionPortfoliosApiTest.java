...
public class TransactionPortfoliosApiTest {
    ...
    public void buildTransactionsTest() throws ApiException {
        ...
        VersionedResourceListOfOutputTransaction response = api.buildTransactions(scope, code, asAt, sortBy, start, limit, propertyKeys, filter, parameters);
    ...
    public void getHoldingsTest() throws ApiException {
        ...
        String filter = null;
        List<String> propertyKeys = null;
        VersionedResourceListOfPortfolioHolding response = api.getHoldings(scope, code, byTaxlots, effectiveAt, asAt, sortBy, start, limit, filter, propertyKeys);
    ...
    public void getTransactionsTest() throws ApiException {
        ...
        List<String> propertyKeys = null;
        String filter = null;
        VersionedResourceListOfTransaction response = api.getTransactions(scope, code, fromTransactionDate, toTransactionDate, asAt, sortBy, start, limit, propertyKeys, filter);
