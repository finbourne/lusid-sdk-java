...
public class TransactionPortfoliosApiTest {
    ...
    public void buildTransactionsTest() throws ApiException {
        ...
        String filter = null;
        VersionedResourceListOfOutputTransaction response = api.buildTransactions(scope, code, parameters, asAt, propertyKeys, filter);
    ...
    public void getHoldingsTest() throws ApiException {
        ...
        String filter = null;
        List<String> propertyKeys = null;
        VersionedResourceListOfPortfolioHolding response = api.getHoldings(scope, code, byTaxlots, effectiveAt, asAt, filter, propertyKeys);
    ...
    public void getTransactionsTest() throws ApiException {
        ...
        List<String> propertyKeys = null;
        String filter = null;
        VersionedResourceListOfTransaction response = api.getTransactions(scope, code, fromTransactionDate, toTransactionDate, asAt, propertyKeys, filter);
