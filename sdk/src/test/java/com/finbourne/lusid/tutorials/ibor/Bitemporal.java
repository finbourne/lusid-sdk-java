...
public class Bitemporal {
    ...
    public void apply_bitemporal_portfolio_change() throws Exception
    {
        ...
        //  list transactions
        VersionedResourceListOfTransaction transactions = transactionPortfoliosApi.getTransactions(TutorialScope, portfolioId, null, null, asAtBatch1, null, 0, Integer.MAX_VALUE, null, null);
        ...
        transactions = transactionPortfoliosApi.getTransactions(TutorialScope, portfolioId, null, null, asAtBatch2, null, 0, Integer.MAX_VALUE, null, null);

        assertEquals(String.format("asAt %s", asAtBatch2),4, transactions.getValues().size());
        System.out.println("transactions at " + asAtBatch2);
        printTransactions.accept(transactions.getValues());

        transactions = transactionPortfoliosApi.getTransactions(TutorialScope, portfolioId, null, null, asAtBatch3, null, 0, Integer.MAX_VALUE, null, null);
        ...
        //  latest transactions
        transactions = transactionPortfoliosApi.getTransactions(TutorialScope, portfolioId, null, null, null, null, 0, Integer.MAX_VALUE, null, null);
