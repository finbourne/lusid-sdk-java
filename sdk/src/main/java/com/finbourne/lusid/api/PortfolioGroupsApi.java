...
public class PortfolioGroupsApi {
    ...
    public okhttp3.Call addPortfolioToGroupCall(String scope, String code, ResourceId portfolioId, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "0.10.672");
     ...
     */
    public okhttp3.Call listPortfolioGroupsCall(String scope, OffsetDateTime asAt, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listPortfolioGroupsValidateBeforeCall(String scope, OffsetDateTime asAt, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listPortfolioGroupsCall(scope, asAt, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPortfolioGroup listPortfolioGroups(String scope, OffsetDateTime asAt, String filter) throws ApiException {
        ApiResponse<ResourceListOfPortfolioGroup> localVarResp = listPortfolioGroupsWithHttpInfo(scope, asAt, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPortfolioGroup> listPortfolioGroupsWithHttpInfo(String scope, OffsetDateTime asAt, String filter) throws ApiException {
        okhttp3.Call localVarCall = listPortfolioGroupsValidateBeforeCall(scope, asAt, filter, null);
     ...
     */
    public okhttp3.Call listPortfolioGroupsAsync(String scope, OffsetDateTime asAt, String filter, final ApiCallback<ResourceListOfPortfolioGroup> _callback) throws ApiException {

        okhttp3.Call localVarCall = listPortfolioGroupsValidateBeforeCall(scope, asAt, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioGroup>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
