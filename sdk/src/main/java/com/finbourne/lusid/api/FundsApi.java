...
import com.finbourne.lusid.model.CreateValuationPointRequest;
...
import com.finbourne.lusid.model.PagedResourceListOfFundCalendarEntries;
import com.finbourne.lusid.model.PagedResourceListOfFundCalendarEntry;
import com.finbourne.lusid.model.PagedResourceListOfValuationPointInstrument;
...
import com.finbourne.lusid.model.ValuationPointResourceListOfUnsettledTransaction;
...
public class FundsApi {
    ...
    private okhttp3.Call addSeriesCall(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return addSeriesCall(scope, code, seriesDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call addSeriesCall(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = seriesDefinitionRequest;

        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/series"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call addSeriesValidateBeforeCall(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling addSeries(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling addSeries(Async)");
        }

        // verify the required parameter 'seriesDefinitionRequest' is set
        if (seriesDefinitionRequest == null) {
            throw new ApiException("Missing the required parameter 'seriesDefinitionRequest' when calling addSeries(Async)");
        }

        return addSeriesCall(scope, code, seriesDefinitionRequest, _callback, opts);

    }


    private ApiResponse<Fund> addSeriesWithHttpInfo(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest) throws ApiException {
        okhttp3.Call localVarCall = addSeriesValidateBeforeCall(scope, code, seriesDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<Fund>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<Fund> addSeriesWithHttpInfo(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = addSeriesValidateBeforeCall(scope, code, seriesDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeToken<Fund>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call addSeriesAsync(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest, final ApiCallback<Fund> _callback) throws ApiException {

        okhttp3.Call localVarCall = addSeriesValidateBeforeCall(scope, code, seriesDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<Fund>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call addSeriesAsync(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest, final ApiCallback<Fund> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = addSeriesValidateBeforeCall(scope, code, seriesDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeToken<Fund>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIaddSeriesRequest {
        private final String scope;
        private final String code;
        private final List<SeriesDefinitionRequest> seriesDefinitionRequest;

        private APIaddSeriesRequest(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest) {
            this.scope = scope;
            this.code = code;
            this.seriesDefinitionRequest = seriesDefinitionRequest;
        }

        /**
         * Build call for addSeries
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The updated Fund with the added Series. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return addSeriesCall(scope, code, seriesDefinitionRequest, _callback);
        }

        /**
         * Execute addSeries request
         * @return Fund
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public Fund execute() throws ApiException {
            ApiResponse<Fund> localVarResp = addSeriesWithHttpInfo(scope, code, seriesDefinitionRequest);
            return localVarResp.getData();
        }

        /**
         * Execute addSeries request. Use any specified configuration options to override any other configuration for this request only.
         * @return Fund
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public Fund execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<Fund> localVarResp = addSeriesWithHttpInfo(scope, code, seriesDefinitionRequest, opts);
            return localVarResp.getData();
        }

        /**
         * Execute addSeries request with HTTP info returned
         * @return ApiResponse&lt;Fund&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Fund> executeWithHttpInfo() throws ApiException {
            return addSeriesWithHttpInfo(scope, code, seriesDefinitionRequest);
        }

        /**
         * Execute addSeries request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;Fund&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Fund> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return addSeriesWithHttpInfo(scope, code, seriesDefinitionRequest, opts);
        }

        /**
         * Execute addSeries request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Fund> _callback) throws ApiException {
            return addSeriesAsync(scope, code, seriesDefinitionRequest, _callback);
        }

        /**
         * Execute addSeries request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Fund> _callback, ConfigurationOptions opts) throws ApiException {
            return addSeriesAsync(scope, code, seriesDefinitionRequest, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund. (required)
     * @param seriesDefinitionRequest The definitions of the Series to add. (required)
     ...
     */
    public APIaddSeriesRequest addSeries(String scope, String code, List<SeriesDefinitionRequest> seriesDefinitionRequest) {
        return new APIaddSeriesRequest(scope, code, seriesDefinitionRequest);
    }
    ...
    private okhttp3.Call createValuationPointCall(String scope, String code, CreateValuationPointRequest createValuationPointRequest, String navTypeCode, final ApiCallback _callback) throws ApiException {
        return createValuationPointCall(scope, code, createValuationPointRequest, navTypeCode,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call createValuationPointCall(String scope, String code, CreateValuationPointRequest createValuationPointRequest, String navTypeCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = createValuationPointRequest;

        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/valuationpoints/$create"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createValuationPointValidateBeforeCall(String scope, String code, CreateValuationPointRequest createValuationPointRequest, String navTypeCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling createValuationPoint(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling createValuationPoint(Async)");
        }

        // verify the required parameter 'createValuationPointRequest' is set
        if (createValuationPointRequest == null) {
            throw new ApiException("Missing the required parameter 'createValuationPointRequest' when calling createValuationPoint(Async)");
        }

        return createValuationPointCall(scope, code, createValuationPointRequest, navTypeCode, _callback, opts);

    }


    private ApiResponse<ValuationPoint> createValuationPointWithHttpInfo(String scope, String code, CreateValuationPointRequest createValuationPointRequest, String navTypeCode) throws ApiException {
        okhttp3.Call localVarCall = createValuationPointValidateBeforeCall(scope, code, createValuationPointRequest, navTypeCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPoint>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<ValuationPoint> createValuationPointWithHttpInfo(String scope, String code, CreateValuationPointRequest createValuationPointRequest, String navTypeCode, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = createValuationPointValidateBeforeCall(scope, code, createValuationPointRequest, navTypeCode, null, opts);
        Type localVarReturnType = new TypeToken<ValuationPoint>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createValuationPointAsync(String scope, String code, CreateValuationPointRequest createValuationPointRequest, String navTypeCode, final ApiCallback<ValuationPoint> _callback) throws ApiException {

        okhttp3.Call localVarCall = createValuationPointValidateBeforeCall(scope, code, createValuationPointRequest, navTypeCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPoint>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call createValuationPointAsync(String scope, String code, CreateValuationPointRequest createValuationPointRequest, String navTypeCode, final ApiCallback<ValuationPoint> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = createValuationPointValidateBeforeCall(scope, code, createValuationPointRequest, navTypeCode, _callback, opts);
        Type localVarReturnType = new TypeToken<ValuationPoint>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIcreateValuationPointRequest {
        private final String scope;
        private final String code;
        private final CreateValuationPointRequest createValuationPointRequest;
        private String navTypeCode;

        private APIcreateValuationPointRequest(String scope, String code, CreateValuationPointRequest createValuationPointRequest) {
            this.scope = scope;
            this.code = code;
            this.createValuationPointRequest = createValuationPointRequest;
        }

        /**
         * Set navTypeCode
         * @param navTypeCode When provided, creates the Valuation Point against the specified NAV Type, otherwise the Primary NAV Type will be used. (optional)
         * @return APIcreateValuationPointRequest
         */
        public APIcreateValuationPointRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }

        /**
         * Build call for createValuationPoint
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The created estimated Valuation Point </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return createValuationPointCall(scope, code, createValuationPointRequest, navTypeCode, _callback);
        }

        /**
         * Execute createValuationPoint request
         ...
         */
        public ValuationPoint execute() throws ApiException {
            ApiResponse<ValuationPoint> localVarResp = createValuationPointWithHttpInfo(scope, code, createValuationPointRequest, navTypeCode);
            return localVarResp.getData();
        }

        /**
         * Execute createValuationPoint request. Use any specified configuration options to override any other configuration for this request only.
         * @return ValuationPoint
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ValuationPoint execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ValuationPoint> localVarResp = createValuationPointWithHttpInfo(scope, code, createValuationPointRequest, navTypeCode, opts);
            return localVarResp.getData();
        }

        /**
         * Execute createValuationPoint request with HTTP info returned
         * @return ApiResponse&lt;ValuationPoint&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ValuationPoint> executeWithHttpInfo() throws ApiException {
            return createValuationPointWithHttpInfo(scope, code, createValuationPointRequest, navTypeCode);
        }

        /**
         * Execute createValuationPoint request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ValuationPoint&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ValuationPoint> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return createValuationPointWithHttpInfo(scope, code, createValuationPointRequest, navTypeCode, opts);
        }

        /**
         * Execute createValuationPoint request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPoint> _callback) throws ApiException {
            return createValuationPointAsync(scope, code, createValuationPointRequest, navTypeCode, _callback);
        }

        /**
         * Execute createValuationPoint request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPoint> _callback, ConfigurationOptions opts) throws ApiException {
            return createValuationPointAsync(scope, code, createValuationPointRequest, navTypeCode, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund. (required)
     * @param createValuationPointRequest The Valuation Point Estimate definition to create. (required)
     * @return APIcreateValuationPointRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIcreateValuationPointRequest createValuationPoint(String scope, String code, CreateValuationPointRequest createValuationPointRequest) {
        return new APIcreateValuationPointRequest(scope, code, createValuationPointRequest);
    }
    private okhttp3.Call deactivateNavTypesCall(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback _callback) throws ApiException {
        return deactivateNavTypesCall(scope, code, requestBody, deleteMode,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call deactivateNavTypesCall(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/deactivateNavTypes"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deactivateNavTypesValidateBeforeCall(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling deactivateNavTypes(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling deactivateNavTypes(Async)");
        }

        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling deactivateNavTypes(Async)");
        }

        return deactivateNavTypesCall(scope, code, requestBody, deleteMode, _callback, opts);

    }


    private ApiResponse<Fund> deactivateNavTypesWithHttpInfo(String scope, String code, List<String> requestBody, String deleteMode) throws ApiException {
        okhttp3.Call localVarCall = deactivateNavTypesValidateBeforeCall(scope, code, requestBody, deleteMode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<Fund>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<Fund> deactivateNavTypesWithHttpInfo(String scope, String code, List<String> requestBody, String deleteMode, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = deactivateNavTypesValidateBeforeCall(scope, code, requestBody, deleteMode, null, opts);
        Type localVarReturnType = new TypeToken<Fund>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call deactivateNavTypesAsync(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback<Fund> _callback) throws ApiException {

        okhttp3.Call localVarCall = deactivateNavTypesValidateBeforeCall(scope, code, requestBody, deleteMode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<Fund>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call deactivateNavTypesAsync(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback<Fund> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = deactivateNavTypesValidateBeforeCall(scope, code, requestBody, deleteMode, _callback, opts);
        Type localVarReturnType = new TypeToken<Fund>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIdeactivateNavTypesRequest {
        private final String scope;
        private final String code;
        private final List<String> requestBody;
        private String deleteMode;

        private APIdeactivateNavTypesRequest(String scope, String code, List<String> requestBody) {
            this.scope = scope;
            this.code = code;
         ...
         * @return APIdeactivateNavTypesRequest
         */
        public APIdeactivateNavTypesRequest deleteMode(String deleteMode) {
            this.deleteMode = deleteMode;
            return this;
        }

        /**
         * Build call for deactivateNavTypes
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The updated Fund with the specified NAV types deactivated. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return deactivateNavTypesCall(scope, code, requestBody, deleteMode, _callback);
        }

        /**
         * Execute deactivateNavTypes request
         * @return Fund
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public Fund execute() throws ApiException {
            ApiResponse<Fund> localVarResp = deactivateNavTypesWithHttpInfo(scope, code, requestBody, deleteMode);
            return localVarResp.getData();
        }

        /**
         * Execute deactivateNavTypes request. Use any specified configuration options to override any other configuration for this request only.
         * @return Fund
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public Fund execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<Fund> localVarResp = deactivateNavTypesWithHttpInfo(scope, code, requestBody, deleteMode, opts);
            return localVarResp.getData();
        }

        /**
         * Execute deactivateNavTypes request with HTTP info returned
         * @return ApiResponse&lt;Fund&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Fund> executeWithHttpInfo() throws ApiException {
            return deactivateNavTypesWithHttpInfo(scope, code, requestBody, deleteMode);
        }

        /**
         * Execute deactivateNavTypes request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;Fund&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Fund> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return deactivateNavTypesWithHttpInfo(scope, code, requestBody, deleteMode, opts);
        }

        /**
         * Execute deactivateNavTypes request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Fund> _callback) throws ApiException {
            return deactivateNavTypesAsync(scope, code, requestBody, deleteMode, _callback);
        }

        /**
         * Execute deactivateNavTypes request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Fund> _callback, ConfigurationOptions opts) throws ApiException {
            return deactivateNavTypesAsync(scope, code, requestBody, deleteMode, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund. (required)
     * @param requestBody The codes of the nav types to be deactivated. (required)
     * @return APIdeactivateNavTypesRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIdeactivateNavTypesRequest deactivateNavTypes(String scope, String code, List<String> requestBody) {
        return new APIdeactivateNavTypesRequest(scope, code, requestBody);
    }
    ...
    private okhttp3.Call deleteNavActivityAdjustmentsCall(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse, String navTypeCode, String valuationPointCodeVariant, final ApiCallback _callback) throws ApiException {
        return deleteNavActivityAdjustmentsCall(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call deleteNavActivityAdjustmentsCall(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse, String navTypeCode, String valuationPointCodeVariant, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = navActivityAdjustmentResponse;

        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/navAdjustment/$delete"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
        ...
        if (valuationPointCode != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("valuationPointCode", valuationPointCode));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteNavActivityAdjustmentsValidateBeforeCall(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse, String navTypeCode, String valuationPointCodeVariant, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
        ...
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling deleteNavActivityAdjustments(Async)");
        }

        // verify the required parameter 'valuationPointCode' is set
        if (valuationPointCode == null) {
            throw new ApiException("Missing the required parameter 'valuationPointCode' when calling deleteNavActivityAdjustments(Async)");
        }

        // verify the required parameter 'navActivityAdjustmentResponse' is set
        if (navActivityAdjustmentResponse == null) {
            throw new ApiException("Missing the required parameter 'navActivityAdjustmentResponse' when calling deleteNavActivityAdjustments(Async)");
        }

        return deleteNavActivityAdjustmentsCall(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, _callback, opts);

    }


    private ApiResponse<DeletedEntityResponse> deleteNavActivityAdjustmentsWithHttpInfo(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse, String navTypeCode, String valuationPointCodeVariant) throws ApiException {
        okhttp3.Call localVarCall = deleteNavActivityAdjustmentsValidateBeforeCall(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<DeletedEntityResponse> deleteNavActivityAdjustmentsWithHttpInfo(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse, String navTypeCode, String valuationPointCodeVariant, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = deleteNavActivityAdjustmentsValidateBeforeCall(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, null, opts);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call deleteNavActivityAdjustmentsAsync(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse, String navTypeCode, String valuationPointCodeVariant, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteNavActivityAdjustmentsValidateBeforeCall(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call deleteNavActivityAdjustmentsAsync(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse, String navTypeCode, String valuationPointCodeVariant, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = deleteNavActivityAdjustmentsValidateBeforeCall(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, _callback, opts);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIdeleteNavActivityAdjustmentsRequest {
        private final String scope;
        private final String code;
        private final String valuationPointCode;
        private final List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse;
        private String navTypeCode;
        private String valuationPointCodeVariant;

        private APIdeleteNavActivityAdjustmentsRequest(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse) {
            this.scope = scope;
            this.code = code;
            this.valuationPointCode = valuationPointCode;
            this.navActivityAdjustmentResponse = navActivityAdjustmentResponse;
        }
         ...
         */
        public APIdeleteNavActivityAdjustmentsRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }
        ...
        /**
         * Build call for deleteNavActivityAdjustments
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The datetime that the Nav activity adjustments were deleted </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return deleteNavActivityAdjustmentsCall(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, _callback);
        }

        /**
         * Execute deleteNavActivityAdjustments request
         * @return DeletedEntityResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public DeletedEntityResponse execute() throws ApiException {
            ApiResponse<DeletedEntityResponse> localVarResp = deleteNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant);
            return localVarResp.getData();
        }

        /**
         * Execute deleteNavActivityAdjustments request. Use any specified configuration options to override any other configuration for this request only.
         * @return DeletedEntityResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public DeletedEntityResponse execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<DeletedEntityResponse> localVarResp = deleteNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, opts);
            return localVarResp.getData();
        }

        /**
         * Execute deleteNavActivityAdjustments request with HTTP info returned
         * @return ApiResponse&lt;DeletedEntityResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<DeletedEntityResponse> executeWithHttpInfo() throws ApiException {
            return deleteNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant);
        }

        /**
         * Execute deleteNavActivityAdjustments request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;DeletedEntityResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<DeletedEntityResponse> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return deleteNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, opts);
        }

        /**
         * Execute deleteNavActivityAdjustments request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            return deleteNavActivityAdjustmentsAsync(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, _callback);
        }

        /**
         * Execute deleteNavActivityAdjustments request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            return deleteNavActivityAdjustmentsAsync(scope, code, valuationPointCode, navActivityAdjustmentResponse, navTypeCode, valuationPointCodeVariant, _callback, opts);
        }
    }
     ...
     * @param valuationPointCode The valuation point Code to delete the adjustment from (required)
     * @param navActivityAdjustmentResponse The request describing the Nav activity adjustments to delete from a specific valuation point and nav type (required)
     * @return APIdeleteNavActivityAdjustmentsRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIdeleteNavActivityAdjustmentsRequest deleteNavActivityAdjustments(String scope, String code, String valuationPointCode, List<NavActivityAdjustmentResponse> navActivityAdjustmentResponse) {
        return new APIdeleteNavActivityAdjustmentsRequest(scope, code, valuationPointCode, navActivityAdjustmentResponse);
    }
    ...
    private okhttp3.Call getHoldingContributorsForFundCall(String scope, String code, Long holdingId, ValuationPointDataQueryParameters valuationPointDataQueryParameters, String navTypeCode, Boolean includeHistoric, String taxLotId, Boolean includeUnsettledMovements, Integer limit, OffsetDateTime asAt, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        if (includeUnsettledMovements != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("includeUnsettledMovements", includeUnsettledMovements));
        }
    ...
    private okhttp3.Call getHoldingContributorsForFundValidateBeforeCall(String scope, String code, Long holdingId, ValuationPointDataQueryParameters valuationPointDataQueryParameters, String navTypeCode, Boolean includeHistoric, String taxLotId, Boolean includeUnsettledMovements, Integer limit, OffsetDateTime asAt, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getHoldingContributorsForFund(Async)");
        }
    ...
    public class APIgetHoldingContributorsForFundRequest {
        private final String scope;
        private final String code;
         ...
         * @return APIgetHoldingContributorsForFundRequest
         */
        public APIgetHoldingContributorsForFundRequest includeHistoric(Boolean includeHistoric) {
         ...
         * @return APIgetHoldingContributorsForFundRequest
         */
        public APIgetHoldingContributorsForFundRequest taxLotId(String taxLotId) {
            this.taxLotId = taxLotId;
            return this;
        }

        /**
         * Set includeUnsettledMovements
         * @param includeUnsettledMovements If true, contributing transaction which have not settled yet will also be returned. False by default (optional, default to false)
         * @return APIgetHoldingContributorsForFundRequest
         */
        public APIgetHoldingContributorsForFundRequest includeUnsettledMovements(Boolean includeUnsettledMovements) {
            this.includeUnsettledMovements = includeUnsettledMovements;
            return this;
        }
         ...
         * @return APIgetHoldingContributorsForFundRequest
         */
        public APIgetHoldingContributorsForFundRequest limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return APIgetHoldingContributorsForFundRequest
         */
        public APIgetHoldingContributorsForFundRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
         ...
         * @return APIgetHoldingContributorsForFundRequest
         */
        public APIgetHoldingContributorsForFundRequest page(String page) {
            this.page = page;
            return this;
        }

        /**
         * Build call for getHoldingContributorsForFund
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The requested holding contributors from the specified Fund and NavType. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        ...
        /**
         * Execute getHoldingContributorsForFund request
        ...
        /**
         * Execute getHoldingContributorsForFund request. Use any specified configuration options to override any other configuration for this request only.
         * @return VersionedResourceListOfHoldingContributor
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        /**
         * Execute getHoldingContributorsForFund request with HTTP info returned
        ...
        /**
         * Execute getHoldingContributorsForFund request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;VersionedResourceListOfHoldingContributor&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        /**
         * Execute getHoldingContributorsForFund request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        /**
         * Execute getHoldingContributorsForFund request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
    ...
    public class APIgetHoldingsForFundRequest {
        ...
        /**
         * Set propertyKeys
         * @param propertyKeys A list of property keys from the \&quot;Instrument\&quot;, \&quot;Holding\&quot; or \&quot;Portfolio\&quot;,\&quot;CustodianAccount\&quot; or \&quot;LegalEntity\&quot; domain to decorate onto domain to decorate onto   the holdings. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or \&quot;Holding/system/Cost\&quot;. (optional)
         * @return APIgetHoldingsForFundRequest
         */
    ...
    private okhttp3.Call getValuationPointQuotesCall(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, Integer limit, String page, String navTypeCode, final ApiCallback _callback) throws ApiException {
        return getValuationPointQuotesCall(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call getValuationPointQuotesCall(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, Integer limit, String page, String navTypeCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/valuationpoints/quotes/$query"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValuationPointQuotesValidateBeforeCall(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, Integer limit, String page, String navTypeCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getValuationPointQuotes(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getValuationPointQuotes(Async)");
        }

        // verify the required parameter 'valuationPointDataQueryParameters' is set
        if (valuationPointDataQueryParameters == null) {
            throw new ApiException("Missing the required parameter 'valuationPointDataQueryParameters' when calling getValuationPointQuotes(Async)");
        }

        return getValuationPointQuotesCall(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, _callback, opts);

    }


    private ApiResponse<ValuationPointResourceListOfAccountedQuote> getValuationPointQuotesWithHttpInfo(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, Integer limit, String page, String navTypeCode) throws ApiException {
        okhttp3.Call localVarCall = getValuationPointQuotesValidateBeforeCall(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfAccountedQuote>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<ValuationPointResourceListOfAccountedQuote> getValuationPointQuotesWithHttpInfo(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, Integer limit, String page, String navTypeCode, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = getValuationPointQuotesValidateBeforeCall(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, null, opts);
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfAccountedQuote>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getValuationPointQuotesAsync(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, Integer limit, String page, String navTypeCode, final ApiCallback<ValuationPointResourceListOfAccountedQuote> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValuationPointQuotesValidateBeforeCall(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfAccountedQuote>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call getValuationPointQuotesAsync(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, Integer limit, String page, String navTypeCode, final ApiCallback<ValuationPointResourceListOfAccountedQuote> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = getValuationPointQuotesValidateBeforeCall(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, _callback, opts);
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfAccountedQuote>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetValuationPointQuotesRequest {
        private final String scope;
        private final String code;
        private final ValuationPointDataQueryParameters valuationPointDataQueryParameters;
        private OffsetDateTime asAt;
        ...
        private APIgetValuationPointQuotesRequest(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters) {
            this.scope = scope;
            this.code = code;
            this.valuationPointDataQueryParameters = valuationPointDataQueryParameters;
        }
        ...
        /**
         * Set asAt
         * @param asAt The asAt datetime at which to retrieve quotes. Defaults to returning the latest version   of each quote if not specified. (optional)
         * @return APIgetValuationPointQuotesRequest
         */
        public APIgetValuationPointQuotesRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
         ...
         * @return APIgetValuationPointQuotesRequest
         */
        public APIgetValuationPointQuotesRequest limit(Integer limit) {
            this.limit = limit;
            return this;
        }
        ...
        /**
         * Set page
         * @param page The pagination token to use to continue listing quotes from a previous call to GetValuationPointQuotes. (optional)
         * @return APIgetValuationPointQuotesRequest
         */
        public APIgetValuationPointQuotesRequest page(String page) {
            this.page = page;
            return this;
        }
         ...
         * @return APIgetValuationPointQuotesRequest
         */
        public APIgetValuationPointQuotesRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }

        /**
         * Build call for getValuationPointQuotes
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The requested quotes for the specified Valuation Point for a Fund. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return getValuationPointQuotesCall(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, _callback);
        }

        /**
         * Execute getValuationPointQuotes request
         * @return ValuationPointResourceListOfAccountedQuote
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ValuationPointResourceListOfAccountedQuote execute() throws ApiException {
            ApiResponse<ValuationPointResourceListOfAccountedQuote> localVarResp = getValuationPointQuotesWithHttpInfo(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode);
            return localVarResp.getData();
        }

        /**
         * Execute getValuationPointQuotes request. Use any specified configuration options to override any other configuration for this request only.
         * @return ValuationPointResourceListOfAccountedQuote
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ValuationPointResourceListOfAccountedQuote execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ValuationPointResourceListOfAccountedQuote> localVarResp = getValuationPointQuotesWithHttpInfo(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, opts);
            return localVarResp.getData();
        }

        /**
         * Execute getValuationPointQuotes request with HTTP info returned
         * @return ApiResponse&lt;ValuationPointResourceListOfAccountedQuote&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ValuationPointResourceListOfAccountedQuote> executeWithHttpInfo() throws ApiException {
            return getValuationPointQuotesWithHttpInfo(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode);
        }

        /**
         * Execute getValuationPointQuotes request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ValuationPointResourceListOfAccountedQuote&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ValuationPointResourceListOfAccountedQuote> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return getValuationPointQuotesWithHttpInfo(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, opts);
        }

        /**
         * Execute getValuationPointQuotes request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPointResourceListOfAccountedQuote> _callback) throws ApiException {
            return getValuationPointQuotesAsync(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, _callback);
        }

        /**
         * Execute getValuationPointQuotes request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPointResourceListOfAccountedQuote> _callback, ConfigurationOptions opts) throws ApiException {
            return getValuationPointQuotesAsync(scope, code, valuationPointDataQueryParameters, asAt, limit, page, navTypeCode, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund. (required)
     * @param valuationPointDataQueryParameters The arguments to use for querying the quotes. (required)
     * @return APIgetValuationPointQuotesRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIgetValuationPointQuotesRequest getValuationPointQuotes(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters) {
        return new APIgetValuationPointQuotesRequest(scope, code, valuationPointDataQueryParameters);
    }
    private okhttp3.Call getValuationPointTransactionsCall(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, String dataModelScope, String dataModelCode, Boolean showCancelledTransactions, String membershipType, Boolean returnExcludedTransactions, final ApiCallback _callback) throws ApiException {
        return getValuationPointTransactionsCall(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call getValuationPointTransactionsCall(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, String dataModelScope, String dataModelCode, Boolean showCancelledTransactions, String membershipType, Boolean returnExcludedTransactions, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private okhttp3.Call getValuationPointTransactionsValidateBeforeCall(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, String dataModelScope, String dataModelCode, Boolean showCancelledTransactions, String membershipType, Boolean returnExcludedTransactions, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        return getValuationPointTransactionsCall(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, _callback, opts);

    }


    private ApiResponse<ValuationPointResourceListOfAccountedTransaction> getValuationPointTransactionsWithHttpInfo(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, String dataModelScope, String dataModelCode, Boolean showCancelledTransactions, String membershipType, Boolean returnExcludedTransactions) throws ApiException {
        okhttp3.Call localVarCall = getValuationPointTransactionsValidateBeforeCall(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfAccountedTransaction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<ValuationPointResourceListOfAccountedTransaction> getValuationPointTransactionsWithHttpInfo(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, String dataModelScope, String dataModelCode, Boolean showCancelledTransactions, String membershipType, Boolean returnExcludedTransactions, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = getValuationPointTransactionsValidateBeforeCall(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, null, opts);
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfAccountedTransaction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getValuationPointTransactionsAsync(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, String dataModelScope, String dataModelCode, Boolean showCancelledTransactions, String membershipType, Boolean returnExcludedTransactions, final ApiCallback<ValuationPointResourceListOfAccountedTransaction> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValuationPointTransactionsValidateBeforeCall(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfAccountedTransaction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getValuationPointTransactionsAsync(String scope, String code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, String dataModelScope, String dataModelCode, Boolean showCancelledTransactions, String membershipType, Boolean returnExcludedTransactions, final ApiCallback<ValuationPointResourceListOfAccountedTransaction> _callback, ConfigurationOptions opts) throws ApiException {
        ...
        okhttp3.Call localVarCall = getValuationPointTransactionsValidateBeforeCall(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, _callback, opts);
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfAccountedTransaction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIgetValuationPointTransactionsRequest {
         ...
         * @return APIgetValuationPointTransactionsRequest
         */
        public APIgetValuationPointTransactionsRequest showCancelledTransactions(Boolean showCancelledTransactions) {
         ...
         * @param returnExcludedTransactions Option to specify whether or not to include transactions excluded by the   NavType&#39;s TransactionExclusionFilter. Defaults to False if not specified. (optional)
         * @return APIgetValuationPointTransactionsRequest
         */
        public APIgetValuationPointTransactionsRequest returnExcludedTransactions(Boolean returnExcludedTransactions) {
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return getValuationPointTransactionsCall(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, _callback);
        }
        ...
        public ApiResponse<ValuationPointResourceListOfAccountedTransaction> executeWithHttpInfo() throws ApiException {
            return getValuationPointTransactionsWithHttpInfo(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions);
        }
        ...
        public ApiResponse<ValuationPointResourceListOfAccountedTransaction> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return getValuationPointTransactionsWithHttpInfo(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, opts);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPointResourceListOfAccountedTransaction> _callback) throws ApiException {
            return getValuationPointTransactionsAsync(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, _callback);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPointResourceListOfAccountedTransaction> _callback, ConfigurationOptions opts) throws ApiException {
            return getValuationPointTransactionsAsync(scope, code, valuationPointDataQueryParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, dataModelScope, dataModelCode, showCancelledTransactions, membershipType, returnExcludedTransactions, _callback, opts);
        }
    }
    ...
    public class APIgetValuationPointUnsettledTransactionsRequest {
         ...
         */
        public APIgetValuationPointUnsettledTransactionsRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
         ...
         * @return APIgetValuationPointUnsettledTransactionsRequest
         */
        public APIgetValuationPointUnsettledTransactionsRequest limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return APIgetValuationPointUnsettledTransactionsRequest
         */
        public APIgetValuationPointUnsettledTransactionsRequest page(String page) {
            this.page = page;
            return this;
        }
         ...
         * @return APIgetValuationPointUnsettledTransactionsRequest
         */
        public APIgetValuationPointUnsettledTransactionsRequest propertyKeys(List<String> propertyKeys) {
            this.propertyKeys = propertyKeys;
            return this;
        }
         ...
         * @return APIgetValuationPointUnsettledTransactionsRequest
         */
        public APIgetValuationPointUnsettledTransactionsRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The unsettled transactions for the specified Valuation Point for a Fund. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        ...
        /**
         * Execute getValuationPointUnsettledTransactions request
         * @return ValuationPointResourceListOfUnsettledTransaction
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        /**
         * Execute getValuationPointUnsettledTransactions request. Use any specified configuration options to override any other configuration for this request only.
         * @return ValuationPointResourceListOfUnsettledTransaction
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        /**
         * Execute getValuationPointUnsettledTransactions request with HTTP info returned
        ...
        /**
         * Execute getValuationPointUnsettledTransactions request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ValuationPointResourceListOfUnsettledTransaction&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        /**
         * Execute getValuationPointUnsettledTransactions request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        /**
         * Execute getValuationPointUnsettledTransactions request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund. (required)
     * @param singleValuationPointQueryParameters The arguments to use for querying the unsettled transactions. (required)
     * @return APIgetValuationPointUnsettledTransactionsRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIgetValuationPointUnsettledTransactionsRequest getValuationPointUnsettledTransactions(String scope, String code, SingleValuationPointQueryParameters singleValuationPointQueryParameters) {
        return new APIgetValuationPointUnsettledTransactionsRequest(scope, code, singleValuationPointQueryParameters);
    }
    ...
    private okhttp3.Call listFundCalendarEntriesCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return listFundCalendarEntriesCall(scope, code, asAt, page, limit, filter, sortBy, propertyKeys,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call listFundCalendarEntriesCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/calendars"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listFundCalendarEntriesValidateBeforeCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling listFundCalendarEntries(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling listFundCalendarEntries(Async)");
        }

        return listFundCalendarEntriesCall(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);

    }


    private ApiResponse<PagedResourceListOfFundCalendarEntries> listFundCalendarEntriesWithHttpInfo(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = listFundCalendarEntriesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<PagedResourceListOfFundCalendarEntries>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<PagedResourceListOfFundCalendarEntries> listFundCalendarEntriesWithHttpInfo(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = listFundCalendarEntriesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, null, opts);
        Type localVarReturnType = new TypeToken<PagedResourceListOfFundCalendarEntries>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listFundCalendarEntriesAsync(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<PagedResourceListOfFundCalendarEntries> _callback) throws ApiException {

        okhttp3.Call localVarCall = listFundCalendarEntriesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<PagedResourceListOfFundCalendarEntries>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call listFundCalendarEntriesAsync(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<PagedResourceListOfFundCalendarEntries> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = listFundCalendarEntriesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeToken<PagedResourceListOfFundCalendarEntries>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIlistFundCalendarEntriesRequest {
        private final String scope;
        private final String code;
        private OffsetDateTime asAt;
        private String page;
        ...
        private APIlistFundCalendarEntriesRequest(String scope, String code) {
            this.scope = scope;
            this.code = code;
        }
         ...
         */
        public APIlistFundCalendarEntriesRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
         ...
         * @return APIlistFundCalendarEntriesRequest
         */
        public APIlistFundCalendarEntriesRequest page(String page) {
            this.page = page;
            return this;
        }
         ...
         * @return APIlistFundCalendarEntriesRequest
         */
        public APIlistFundCalendarEntriesRequest limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return APIlistFundCalendarEntriesRequest
         */
        public APIlistFundCalendarEntriesRequest sortBy(List<String> sortBy) {
            this.sortBy = sortBy;
            return this;
        }
         ...
         * @return APIlistFundCalendarEntriesRequest
         */
        public APIlistFundCalendarEntriesRequest propertyKeys(List<String> propertyKeys) {
            this.propertyKeys = propertyKeys;
            return this;
        }

        /**
         * Build call for listFundCalendarEntries
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return listFundCalendarEntriesCall(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, _callback);
        }

        /**
         * Execute listFundCalendarEntries request
         * @return PagedResourceListOfFundCalendarEntries
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public PagedResourceListOfFundCalendarEntries execute() throws ApiException {
            ApiResponse<PagedResourceListOfFundCalendarEntries> localVarResp = listFundCalendarEntriesWithHttpInfo(scope, code, asAt, page, limit, filter, sortBy, propertyKeys);
            return localVarResp.getData();
        }

        /**
         * Execute listFundCalendarEntries request. Use any specified configuration options to override any other configuration for this request only.
         * @return PagedResourceListOfFundCalendarEntries
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public PagedResourceListOfFundCalendarEntries execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<PagedResourceListOfFundCalendarEntries> localVarResp = listFundCalendarEntriesWithHttpInfo(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, opts);
            return localVarResp.getData();
        }

        /**
         * Execute listFundCalendarEntries request with HTTP info returned
         ...
         */
        public ApiResponse<PagedResourceListOfFundCalendarEntries> executeWithHttpInfo() throws ApiException {
            return listFundCalendarEntriesWithHttpInfo(scope, code, asAt, page, limit, filter, sortBy, propertyKeys);
        }

        /**
         * Execute listFundCalendarEntries request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;PagedResourceListOfFundCalendarEntries&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<PagedResourceListOfFundCalendarEntries> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return listFundCalendarEntriesWithHttpInfo(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, opts);
        }

        /**
         * Execute listFundCalendarEntries request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PagedResourceListOfFundCalendarEntries> _callback) throws ApiException {
            return listFundCalendarEntriesAsync(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, _callback);
        }

        /**
         * Execute listFundCalendarEntries request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PagedResourceListOfFundCalendarEntries> _callback, ConfigurationOptions opts) throws ApiException {
            return listFundCalendarEntriesAsync(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    public APIlistFundCalendarEntriesRequest listFundCalendarEntries(String scope, String code) {
        return new APIlistFundCalendarEntriesRequest(scope, code);
    }
    ...
    private okhttp3.Call listNavActivityAdjustmentsCall(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, String valuationPointCodeVariant, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/navAdjustment"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    private okhttp3.Call listNavActivityAdjustmentsValidateBeforeCall(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, String valuationPointCodeVariant, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling listNavActivityAdjustments(Async)");
        }

        // verify the required parameter 'valuationPointCode' is set
        if (valuationPointCode == null) {
            throw new ApiException("Missing the required parameter 'valuationPointCode' when calling listNavActivityAdjustments(Async)");
        }
    ...
    private ApiResponse<ResourceListOfNavActivityAdjustmentResponse> listNavActivityAdjustmentsWithHttpInfo(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, String valuationPointCodeVariant) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ResourceListOfNavActivityAdjustmentResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<ResourceListOfNavActivityAdjustmentResponse> listNavActivityAdjustmentsWithHttpInfo(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, String valuationPointCodeVariant, ConfigurationOptions opts) throws ApiException {
    ...
    private okhttp3.Call listNavActivityAdjustmentsAsync(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, String valuationPointCodeVariant, final ApiCallback<ResourceListOfNavActivityAdjustmentResponse> _callback) throws ApiException {
    ...
    private okhttp3.Call listNavActivityAdjustmentsAsync(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, String valuationPointCodeVariant, final ApiCallback<ResourceListOfNavActivityAdjustmentResponse> _callback, ConfigurationOptions opts) throws ApiException {
    ...
    public class APIlistNavActivityAdjustmentsRequest {
        private final String scope;
        private final String code;
        private final String valuationPointCode;
        private String navTypeCode;
        ...
        private APIlistNavActivityAdjustmentsRequest(String scope, String code, String valuationPointCode) {
            this.scope = scope;
            this.code = code;
            this.valuationPointCode = valuationPointCode;
        }
         ...
         */
        public APIlistNavActivityAdjustmentsRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }
        ...
        /**
         * Set asAt
         * @param asAt The asAt datetime at which to list the Nav activity adjustments. Defaults to returning the latest version of each adjustment if not specified. (optional)
         * @return APIlistNavActivityAdjustmentsRequest
         */
        public APIlistNavActivityAdjustmentsRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
        ...
        /**
         * Set page
         * @param page The pagination token to use to continue listing Nav activity adjustments; this   value is returned from the previous call. If a pagination token is provided, the filter,   and asAt fields must not have changed since the original request. (optional)
         * @return APIlistNavActivityAdjustmentsRequest
         */
        public APIlistNavActivityAdjustmentsRequest page(String page) {
            this.page = page;
            return this;
        }
         ...
         * @return APIlistNavActivityAdjustmentsRequest
         */
        public APIlistNavActivityAdjustmentsRequest limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The requested NAV activity adjustments for the specific valuation point and Nav type for the Fund. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        ...
        /**
         * Execute listNavActivityAdjustments request
         * @return ResourceListOfNavActivityAdjustmentResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ResourceListOfNavActivityAdjustmentResponse execute() throws ApiException {
            ApiResponse<ResourceListOfNavActivityAdjustmentResponse> localVarResp = listNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, valuationPointCodeVariant);
            return localVarResp.getData();
        }

        /**
         * Execute listNavActivityAdjustments request. Use any specified configuration options to override any other configuration for this request only.
         * @return ResourceListOfNavActivityAdjustmentResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ResourceListOfNavActivityAdjustmentResponse execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ResourceListOfNavActivityAdjustmentResponse> localVarResp = listNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, valuationPointCodeVariant, opts);
            return localVarResp.getData();
        }

        /**
         * Execute listNavActivityAdjustments request with HTTP info returned
         * @return ApiResponse&lt;ResourceListOfNavActivityAdjustmentResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ResourceListOfNavActivityAdjustmentResponse> executeWithHttpInfo() throws ApiException {
        ...
        /**
         * Execute listNavActivityAdjustments request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ResourceListOfNavActivityAdjustmentResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ResourceListOfNavActivityAdjustmentResponse> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
        ...
        /**
         * Execute listNavActivityAdjustments request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ResourceListOfNavActivityAdjustmentResponse> _callback) throws ApiException {
        ...
        /**
         * Execute listNavActivityAdjustments request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ResourceListOfNavActivityAdjustmentResponse> _callback, ConfigurationOptions opts) throws ApiException {
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope is the unique identifier for the given Fund. (required)
     * @param valuationPointCode Fetch all NAV adjustment activities for this valuation point. (required)
     * @return APIlistNavActivityAdjustmentsRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    private okhttp3.Call listValuationPointInstrumentsCall(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> instrumentPropertyKeys, String valuationPointCodeVariant, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/valuationpoints/instruments/$query"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValuationPointInstrumentsValidateBeforeCall(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> instrumentPropertyKeys, String valuationPointCodeVariant, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling listValuationPointInstruments(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling listValuationPointInstruments(Async)");
        }

        // verify the required parameter 'valuationPointCode' is set
        if (valuationPointCode == null) {
            throw new ApiException("Missing the required parameter 'valuationPointCode' when calling listValuationPointInstruments(Async)");
        }

        return listValuationPointInstrumentsCall(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, _callback, opts);

    }


    private ApiResponse<PagedResourceListOfValuationPointInstrument> listValuationPointInstrumentsWithHttpInfo(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> instrumentPropertyKeys, String valuationPointCodeVariant) throws ApiException {
        okhttp3.Call localVarCall = listValuationPointInstrumentsValidateBeforeCall(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<PagedResourceListOfValuationPointInstrument>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<PagedResourceListOfValuationPointInstrument> listValuationPointInstrumentsWithHttpInfo(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> instrumentPropertyKeys, String valuationPointCodeVariant, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = listValuationPointInstrumentsValidateBeforeCall(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, null, opts);
        Type localVarReturnType = new TypeToken<PagedResourceListOfValuationPointInstrument>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listValuationPointInstrumentsAsync(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> instrumentPropertyKeys, String valuationPointCodeVariant, final ApiCallback<PagedResourceListOfValuationPointInstrument> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValuationPointInstrumentsValidateBeforeCall(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<PagedResourceListOfValuationPointInstrument>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call listValuationPointInstrumentsAsync(String scope, String code, String valuationPointCode, String navTypeCode, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> instrumentPropertyKeys, String valuationPointCodeVariant, final ApiCallback<PagedResourceListOfValuationPointInstrument> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = listValuationPointInstrumentsValidateBeforeCall(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, _callback, opts);
        Type localVarReturnType = new TypeToken<PagedResourceListOfValuationPointInstrument>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIlistValuationPointInstrumentsRequest {
        private final String scope;
        private final String code;
        private final String valuationPointCode;
        private String navTypeCode;
        ...
        private APIlistValuationPointInstrumentsRequest(String scope, String code, String valuationPointCode) {
            this.scope = scope;
            this.code = code;
            this.valuationPointCode = valuationPointCode;
        }
         ...
         * Set navTypeCode
         * @param navTypeCode When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used. (optional)
         * @return APIlistValuationPointInstrumentsRequest
         */
        public APIlistValuationPointInstrumentsRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }
        ...
        /**
         * Set asAt
         * @param asAt The asAt datetime at which to list the instruments. Defaults to returning the latest version of each instrument if not specified. (optional)
         * @return APIlistValuationPointInstrumentsRequest
         */
        public APIlistValuationPointInstrumentsRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
        ...
        /**
         * Set page
         * @param page The pagination token to use to continue listing instruments; this   value is returned from the previous call. If a pagination token is provided, the filter,   and asAt fields must not have changed since the original request. (optional)
         * @return APIlistValuationPointInstrumentsRequest
         */
        public APIlistValuationPointInstrumentsRequest page(String page) {
            this.page = page;
            return this;
        }
         ...
         * @return APIlistValuationPointInstrumentsRequest
         */
        public APIlistValuationPointInstrumentsRequest limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return APIlistValuationPointInstrumentsRequest
         */
        public APIlistValuationPointInstrumentsRequest filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return APIlistValuationPointInstrumentsRequest
         */
        public APIlistValuationPointInstrumentsRequest sortBy(List<String> sortBy) {
            this.sortBy = sortBy;
            return this;
        }
         ...
         * @return APIlistValuationPointInstrumentsRequest
         */
        public APIlistValuationPointInstrumentsRequest instrumentPropertyKeys(List<String> instrumentPropertyKeys) {
         ...
         * @return APIlistValuationPointInstrumentsRequest
         */
        public APIlistValuationPointInstrumentsRequest valuationPointCodeVariant(String valuationPointCodeVariant) {
            this.valuationPointCodeVariant = valuationPointCodeVariant;
            return this;
        }

        /**
         * Build call for listValuationPointInstruments
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The instruments held at the specified valuation point for the Fund. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return listValuationPointInstrumentsCall(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, _callback);
        }

        /**
         * Execute listValuationPointInstruments request
         * @return PagedResourceListOfValuationPointInstrument
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public PagedResourceListOfValuationPointInstrument execute() throws ApiException {
            ApiResponse<PagedResourceListOfValuationPointInstrument> localVarResp = listValuationPointInstrumentsWithHttpInfo(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant);
            return localVarResp.getData();
        }

        /**
         * Execute listValuationPointInstruments request. Use any specified configuration options to override any other configuration for this request only.
         * @return PagedResourceListOfValuationPointInstrument
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public PagedResourceListOfValuationPointInstrument execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<PagedResourceListOfValuationPointInstrument> localVarResp = listValuationPointInstrumentsWithHttpInfo(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, opts);
            return localVarResp.getData();
        }

        /**
         * Execute listValuationPointInstruments request with HTTP info returned
         * @return ApiResponse&lt;PagedResourceListOfValuationPointInstrument&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<PagedResourceListOfValuationPointInstrument> executeWithHttpInfo() throws ApiException {
            return listValuationPointInstrumentsWithHttpInfo(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant);
        }

        /**
         * Execute listValuationPointInstruments request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;PagedResourceListOfValuationPointInstrument&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<PagedResourceListOfValuationPointInstrument> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return listValuationPointInstrumentsWithHttpInfo(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, opts);
        }

        /**
         * Execute listValuationPointInstruments request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PagedResourceListOfValuationPointInstrument> _callback) throws ApiException {
            return listValuationPointInstrumentsAsync(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, _callback);
        }

        /**
         * Execute listValuationPointInstruments request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PagedResourceListOfValuationPointInstrument> _callback, ConfigurationOptions opts) throws ApiException {
            return listValuationPointInstrumentsAsync(scope, code, valuationPointCode, navTypeCode, asAt, page, limit, filter, sortBy, instrumentPropertyKeys, valuationPointCodeVariant, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope is the unique identifier for the given Fund. (required)
     * @param valuationPointCode Fetch all instruments for this valuation point. (required)
     * @return APIlistValuationPointInstrumentsRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIlistValuationPointInstrumentsRequest listValuationPointInstruments(String scope, String code, String valuationPointCode) {
        return new APIlistValuationPointInstrumentsRequest(scope, code, valuationPointCode);
    }
    ...
    private okhttp3.Call queryCashStatementCall(String scope, String code, QueryFundCashStatementParameters queryFundCashStatementParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, final ApiCallback _callback) throws ApiException {
        return queryCashStatementCall(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call queryCashStatementCall(String scope, String code, QueryFundCashStatementParameters queryFundCashStatementParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/funds/{scope}/{code}/valuationpoints/cashstatement/$query"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryCashStatementValidateBeforeCall(String scope, String code, QueryFundCashStatementParameters queryFundCashStatementParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling queryCashStatement(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling queryCashStatement(Async)");
        }

        // verify the required parameter 'queryFundCashStatementParameters' is set
        if (queryFundCashStatementParameters == null) {
            throw new ApiException("Missing the required parameter 'queryFundCashStatementParameters' when calling queryCashStatement(Async)");
        }

        return queryCashStatementCall(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, _callback, opts);

    }


    private ApiResponse<ValuationPointResourceListOfFundCashStatementRow> queryCashStatementWithHttpInfo(String scope, String code, QueryFundCashStatementParameters queryFundCashStatementParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode) throws ApiException {
        okhttp3.Call localVarCall = queryCashStatementValidateBeforeCall(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfFundCashStatementRow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ValuationPointResourceListOfFundCashStatementRow> queryCashStatementWithHttpInfo(String scope, String code, QueryFundCashStatementParameters queryFundCashStatementParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = queryCashStatementValidateBeforeCall(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, null, opts);
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfFundCashStatementRow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call queryCashStatementAsync(String scope, String code, QueryFundCashStatementParameters queryFundCashStatementParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, final ApiCallback<ValuationPointResourceListOfFundCashStatementRow> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryCashStatementValidateBeforeCall(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfFundCashStatementRow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call queryCashStatementAsync(String scope, String code, QueryFundCashStatementParameters queryFundCashStatementParameters, OffsetDateTime asAt, String filter, Integer limit, String page, List<String> propertyKeys, String navTypeCode, final ApiCallback<ValuationPointResourceListOfFundCashStatementRow> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = queryCashStatementValidateBeforeCall(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, _callback, opts);
        Type localVarReturnType = new TypeToken<ValuationPointResourceListOfFundCashStatementRow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIqueryCashStatementRequest {
        private final String scope;
        private final String code;
        ...
        private APIqueryCashStatementRequest(String scope, String code, QueryFundCashStatementParameters queryFundCashStatementParameters) {
            this.scope = scope;
            this.code = code;
         ...
         * @return APIqueryCashStatementRequest
         */
        public APIqueryCashStatementRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
         ...
         * @return APIqueryCashStatementRequest
         */
        public APIqueryCashStatementRequest filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return APIqueryCashStatementRequest
         */
        public APIqueryCashStatementRequest limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return APIqueryCashStatementRequest
         */
        public APIqueryCashStatementRequest page(String page) {
            this.page = page;
            return this;
        }
         ...
         * @return APIqueryCashStatementRequest
         */
        public APIqueryCashStatementRequest propertyKeys(List<String> propertyKeys) {
            this.propertyKeys = propertyKeys;
            return this;
        }
         ...
         * @return APIqueryCashStatementRequest
         */
        public APIqueryCashStatementRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }

        /**
         * Build call for queryCashStatement
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The cash statement for the specified Fund valuation point. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return queryCashStatementCall(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, _callback);
        }

        /**
         * Execute queryCashStatement request
         * @return ValuationPointResourceListOfFundCashStatementRow
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ValuationPointResourceListOfFundCashStatementRow execute() throws ApiException {
            ApiResponse<ValuationPointResourceListOfFundCashStatementRow> localVarResp = queryCashStatementWithHttpInfo(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode);
            return localVarResp.getData();
        }

        /**
         * Execute queryCashStatement request. Use any specified configuration options to override any other configuration for this request only.
         * @return ValuationPointResourceListOfFundCashStatementRow
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ValuationPointResourceListOfFundCashStatementRow execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ValuationPointResourceListOfFundCashStatementRow> localVarResp = queryCashStatementWithHttpInfo(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, opts);
            return localVarResp.getData();
        }

        /**
         * Execute queryCashStatement request with HTTP info returned
         * @return ApiResponse&lt;ValuationPointResourceListOfFundCashStatementRow&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ValuationPointResourceListOfFundCashStatementRow> executeWithHttpInfo() throws ApiException {
            return queryCashStatementWithHttpInfo(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode);
        }

        /**
         * Execute queryCashStatement request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ValuationPointResourceListOfFundCashStatementRow&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ValuationPointResourceListOfFundCashStatementRow> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return queryCashStatementWithHttpInfo(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, opts);
        }

        /**
         * Execute queryCashStatement request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPointResourceListOfFundCashStatementRow> _callback) throws ApiException {
            return queryCashStatementAsync(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, _callback);
        }

        /**
         * Execute queryCashStatement request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPointResourceListOfFundCashStatementRow> _callback, ConfigurationOptions opts) throws ApiException {
            return queryCashStatementAsync(scope, code, queryFundCashStatementParameters, asAt, filter, limit, page, propertyKeys, navTypeCode, _callback, opts);
        }
    }
    ...
    private okhttp3.Call updateValuationPointCall(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest, String navTypeCode, final ApiCallback _callback) throws ApiException {
        return updateValuationPointCall(scope, code, updateValuationPointRequest, navTypeCode,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call updateValuationPointCall(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest, String navTypeCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = updateValuationPointRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateValuationPointValidateBeforeCall(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest, String navTypeCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling updateValuationPoint(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling updateValuationPoint(Async)");
        }

        // verify the required parameter 'updateValuationPointRequest' is set
        if (updateValuationPointRequest == null) {
            throw new ApiException("Missing the required parameter 'updateValuationPointRequest' when calling updateValuationPoint(Async)");
        }

        return updateValuationPointCall(scope, code, updateValuationPointRequest, navTypeCode, _callback, opts);

    }


    private ApiResponse<ValuationPoint> updateValuationPointWithHttpInfo(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest, String navTypeCode) throws ApiException {
        okhttp3.Call localVarCall = updateValuationPointValidateBeforeCall(scope, code, updateValuationPointRequest, navTypeCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPoint>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<ValuationPoint> updateValuationPointWithHttpInfo(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest, String navTypeCode, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = updateValuationPointValidateBeforeCall(scope, code, updateValuationPointRequest, navTypeCode, null, opts);
        Type localVarReturnType = new TypeToken<ValuationPoint>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateValuationPointAsync(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest, String navTypeCode, final ApiCallback<ValuationPoint> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateValuationPointValidateBeforeCall(scope, code, updateValuationPointRequest, navTypeCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ValuationPoint>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call updateValuationPointAsync(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest, String navTypeCode, final ApiCallback<ValuationPoint> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = updateValuationPointValidateBeforeCall(scope, code, updateValuationPointRequest, navTypeCode, _callback, opts);
        Type localVarReturnType = new TypeToken<ValuationPoint>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIupdateValuationPointRequest {
        private final String scope;
        private final String code;
        private final UpdateValuationPointRequest updateValuationPointRequest;
        private String navTypeCode;

        private APIupdateValuationPointRequest(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest) {
            this.scope = scope;
            this.code = code;
            this.updateValuationPointRequest = updateValuationPointRequest;
        }
         ...
         * @return APIupdateValuationPointRequest
         */
        public APIupdateValuationPointRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }

        /**
         * Build call for updateValuationPoint
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The updated estimated Valuation Point </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 404 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return updateValuationPointCall(scope, code, updateValuationPointRequest, navTypeCode, _callback);
        }

        /**
         * Execute updateValuationPoint request
         * @return ValuationPoint
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ValuationPoint execute() throws ApiException {
            ApiResponse<ValuationPoint> localVarResp = updateValuationPointWithHttpInfo(scope, code, updateValuationPointRequest, navTypeCode);
            return localVarResp.getData();
        }

        /**
         * Execute updateValuationPoint request. Use any specified configuration options to override any other configuration for this request only.
         * @return ValuationPoint
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ValuationPoint execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ValuationPoint> localVarResp = updateValuationPointWithHttpInfo(scope, code, updateValuationPointRequest, navTypeCode, opts);
            return localVarResp.getData();
        }

        /**
         * Execute updateValuationPoint request with HTTP info returned
         * @return ApiResponse&lt;ValuationPoint&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ValuationPoint> executeWithHttpInfo() throws ApiException {
            return updateValuationPointWithHttpInfo(scope, code, updateValuationPointRequest, navTypeCode);
        }

        /**
         * Execute updateValuationPoint request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ValuationPoint&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ValuationPoint> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return updateValuationPointWithHttpInfo(scope, code, updateValuationPointRequest, navTypeCode, opts);
        }

        /**
         * Execute updateValuationPoint request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPoint> _callback) throws ApiException {
            return updateValuationPointAsync(scope, code, updateValuationPointRequest, navTypeCode, _callback);
        }

        /**
         * Execute updateValuationPoint request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ValuationPoint> _callback, ConfigurationOptions opts) throws ApiException {
            return updateValuationPointAsync(scope, code, updateValuationPointRequest, navTypeCode, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund. (required)
     * @param updateValuationPointRequest The Valuation Point Estimate definition to upsert. (required)
     * @return APIupdateValuationPointRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIupdateValuationPointRequest updateValuationPoint(String scope, String code, UpdateValuationPointRequest updateValuationPointRequest) {
        return new APIupdateValuationPointRequest(scope, code, updateValuationPointRequest);
    }
    ...
    private okhttp3.Call upsertNavActivityAdjustmentsCall(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, String navTypeCode, String valuationPointCodeVariant, final ApiCallback _callback) throws ApiException {
        return upsertNavActivityAdjustmentsCall(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call upsertNavActivityAdjustmentsCall(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, String navTypeCode, String valuationPointCodeVariant, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = navActivityAdjustment;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertNavActivityAdjustmentsValidateBeforeCall(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, String navTypeCode, String valuationPointCodeVariant, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
        ...
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling upsertNavActivityAdjustments(Async)");
        }

        // verify the required parameter 'valuationPointCode' is set
        if (valuationPointCode == null) {
            throw new ApiException("Missing the required parameter 'valuationPointCode' when calling upsertNavActivityAdjustments(Async)");
        }
        ...
        return upsertNavActivityAdjustmentsCall(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, _callback, opts);

    }


    private ApiResponse<OffsetDateTime> upsertNavActivityAdjustmentsWithHttpInfo(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, String navTypeCode, String valuationPointCodeVariant) throws ApiException {
        okhttp3.Call localVarCall = upsertNavActivityAdjustmentsValidateBeforeCall(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<OffsetDateTime>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<OffsetDateTime> upsertNavActivityAdjustmentsWithHttpInfo(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, String navTypeCode, String valuationPointCodeVariant, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = upsertNavActivityAdjustmentsValidateBeforeCall(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, null, opts);
        Type localVarReturnType = new TypeToken<OffsetDateTime>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call upsertNavActivityAdjustmentsAsync(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, String navTypeCode, String valuationPointCodeVariant, final ApiCallback<OffsetDateTime> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertNavActivityAdjustmentsValidateBeforeCall(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<OffsetDateTime>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call upsertNavActivityAdjustmentsAsync(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, String navTypeCode, String valuationPointCodeVariant, final ApiCallback<OffsetDateTime> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = upsertNavActivityAdjustmentsValidateBeforeCall(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, _callback, opts);
        Type localVarReturnType = new TypeToken<OffsetDateTime>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIupsertNavActivityAdjustmentsRequest {
        private final String scope;
        private final String code;
        private final String valuationPointCode;
        ...
        private APIupsertNavActivityAdjustmentsRequest(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment) {
            this.scope = scope;
            this.code = code;
            this.valuationPointCode = valuationPointCode;
         ...
         */
        public APIupsertNavActivityAdjustmentsRequest navTypeCode(String navTypeCode) {
            this.navTypeCode = navTypeCode;
            return this;
        }
        ...
        /**
         * Build call for upsertNavActivityAdjustments
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The date and time of the successfully applied Nav Activity Adjustments. </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return upsertNavActivityAdjustmentsCall(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, _callback);
        }

        /**
         * Execute upsertNavActivityAdjustments request
        ...
        public OffsetDateTime execute() throws ApiException {
            ApiResponse<OffsetDateTime> localVarResp = upsertNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant);
            return localVarResp.getData();
        }

        /**
         * Execute upsertNavActivityAdjustments request. Use any specified configuration options to override any other configuration for this request only.
         * @return OffsetDateTime
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public OffsetDateTime execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<OffsetDateTime> localVarResp = upsertNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, opts);
            return localVarResp.getData();
        }

        /**
         * Execute upsertNavActivityAdjustments request with HTTP info returned
        ...
        public ApiResponse<OffsetDateTime> executeWithHttpInfo() throws ApiException {
            return upsertNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant);
        }

        /**
         * Execute upsertNavActivityAdjustments request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;OffsetDateTime&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<OffsetDateTime> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return upsertNavActivityAdjustmentsWithHttpInfo(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, opts);
        }

        /**
         * Execute upsertNavActivityAdjustments request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<OffsetDateTime> _callback) throws ApiException {
            return upsertNavActivityAdjustmentsAsync(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, _callback);
        }

        /**
         * Execute upsertNavActivityAdjustments request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<OffsetDateTime> _callback, ConfigurationOptions opts) throws ApiException {
            return upsertNavActivityAdjustmentsAsync(scope, code, valuationPointCode, navActivityAdjustment, navTypeCode, valuationPointCodeVariant, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the Fund. (required)
     * @param code The code of the Fund. Together with the scope is the unique identifier for the given Fund. (required)
     * @param valuationPointCode The valuation point Code to apply the adjustment to (required)
     * @param navActivityAdjustment The request describing the Nav activity adjustments to apply to a specific valuation point and nav type (required)
     * @return APIupsertNavActivityAdjustmentsRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIupsertNavActivityAdjustmentsRequest upsertNavActivityAdjustments(String scope, String code, String valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment) {
        return new APIupsertNavActivityAdjustmentsRequest(scope, code, valuationPointCode, navActivityAdjustment);
    }
}
