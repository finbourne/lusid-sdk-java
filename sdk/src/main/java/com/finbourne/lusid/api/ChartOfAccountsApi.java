...
public class ChartOfAccountsApi {
    ...
    private okhttp3.Call getAccountPropertiesCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getAccountPropertiesCall(scope, code, accountCode, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call getAccountPropertiesCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/chartofaccounts/{scope}/{code}/accounts/{accountCode}/properties"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
            .replace("{" + "accountCode" + "}", localVarApiClient.escapeString(accountCode.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAccountPropertiesValidateBeforeCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AccountProperties> getAccountPropertiesWithHttpInfo(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getAccountPropertiesValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, null, new ConfigurationOptions());
    ...
    private ApiResponse<AccountProperties> getAccountPropertiesWithHttpInfo(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = getAccountPropertiesValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeToken<AccountProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAccountPropertiesAsync(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback<AccountProperties> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountPropertiesValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<AccountProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call getAccountPropertiesAsync(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback<AccountProperties> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = getAccountPropertiesValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeToken<AccountProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIgetAccountPropertiesRequest {
        ...
        public okhttp3.Call executeAsync(final ApiCallback<AccountProperties> _callback) throws ApiException {
            return getAccountPropertiesAsync(scope, code, accountCode, effectiveAt, asAt, _callback);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<AccountProperties> _callback, ConfigurationOptions opts) throws ApiException {
            return getAccountPropertiesAsync(scope, code, accountCode, effectiveAt, asAt, _callback, opts);
        }
    }
    ...
    private okhttp3.Call getChartOfAccountsPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getChartOfAccountsPropertiesCall(scope, code, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call getChartOfAccountsPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/chartofaccounts/{scope}/{code}/properties"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getChartOfAccountsPropertiesValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ChartOfAccountsProperties> getChartOfAccountsPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getChartOfAccountsPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, null, new ConfigurationOptions());
    ...
    private ApiResponse<ChartOfAccountsProperties> getChartOfAccountsPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = getChartOfAccountsPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeToken<ChartOfAccountsProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getChartOfAccountsPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<ChartOfAccountsProperties> _callback) throws ApiException {

        okhttp3.Call localVarCall = getChartOfAccountsPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ChartOfAccountsProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call getChartOfAccountsPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<ChartOfAccountsProperties> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = getChartOfAccountsPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeToken<ChartOfAccountsProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIgetChartOfAccountsPropertiesRequest {
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ChartOfAccountsProperties> _callback) throws ApiException {
            return getChartOfAccountsPropertiesAsync(scope, code, effectiveAt, asAt, _callback);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ChartOfAccountsProperties> _callback, ConfigurationOptions opts) throws ApiException {
            return getChartOfAccountsPropertiesAsync(scope, code, effectiveAt, asAt, _callback, opts);
        }
    }
    ...
    private okhttp3.Call patchChartOfAccountsCall(String scope, String code, List<Operation> operation, final ApiCallback _callback) throws ApiException {
        return patchChartOfAccountsCall(scope, code, operation,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call patchChartOfAccountsCall(String scope, String code, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchChartOfAccountsValidateBeforeCall(String scope, String code, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ChartOfAccounts> patchChartOfAccountsWithHttpInfo(String scope, String code, List<Operation> operation) throws ApiException {
        okhttp3.Call localVarCall = patchChartOfAccountsValidateBeforeCall(scope, code, operation, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ChartOfAccounts> patchChartOfAccountsWithHttpInfo(String scope, String code, List<Operation> operation, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = patchChartOfAccountsValidateBeforeCall(scope, code, operation, null, opts);
        Type localVarReturnType = new TypeToken<ChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call patchChartOfAccountsAsync(String scope, String code, List<Operation> operation, final ApiCallback<ChartOfAccounts> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchChartOfAccountsValidateBeforeCall(scope, code, operation, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call patchChartOfAccountsAsync(String scope, String code, List<Operation> operation, final ApiCallback<ChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = patchChartOfAccountsValidateBeforeCall(scope, code, operation, _callback, opts);
        Type localVarReturnType = new TypeToken<ChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIpatchChartOfAccountsRequest {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ChartOfAccounts> _callback) throws ApiException {
            return patchChartOfAccountsAsync(scope, code, operation, _callback);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {
            return patchChartOfAccountsAsync(scope, code, operation, _callback, opts);
        }
    }
