...
public class CustomEntityDefinitionsApi {
    ...
    /**
     * Build call for getCustomEntityDefinition
     ...
     */
    public okhttp3.Call getCustomEntityDefinitionCall(String entityType, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCustomEntityDefinitionValidateBeforeCall(String entityType, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
            throw new ApiException("Missing the required parameter 'entityType' when calling getCustomEntityDefinition(Async)");
        }
        

        okhttp3.Call localVarCall = getCustomEntityDefinitionCall(entityType, asAt, _callback);
        return localVarCall;
     ...
     */
    public CustomEntityDefinition getCustomEntityDefinition(String entityType, OffsetDateTime asAt) throws ApiException {
        ApiResponse<CustomEntityDefinition> localVarResp = getCustomEntityDefinitionWithHttpInfo(entityType, asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomEntityDefinition> getCustomEntityDefinitionWithHttpInfo(String entityType, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getCustomEntityDefinitionValidateBeforeCall(entityType, asAt, null);
        Type localVarReturnType = new TypeToken<CustomEntityDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetCustomEntityDefinition: Get a Custom Entity type definition. (asynchronously)
     * Retrieve a CustomEntityDefinition by a specific entityType at a point in AsAt time
     * @param entityType The identifier for the Custom Entity type, derived from the \&quot;entityTypeName\&quot; provided on creation. (required)
     * @param asAt The AsAt datetime at which to retrieve the definition. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getCustomEntityDefinitionAsync(String entityType, OffsetDateTime asAt, final ApiCallback<CustomEntityDefinition> _callback) throws ApiException {
        okhttp3.Call localVarCall = getCustomEntityDefinitionValidateBeforeCall(entityType, asAt, _callback);
        Type localVarReturnType = new TypeToken<CustomEntityDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call getDefinitionCall(String entityType, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/customentities/entitytypes/{entityType}/$deprecated"
            .replaceAll("\\{" + "entityType" + "\\}", localVarApiClient.escapeString(entityType.toString()));
    ...
    /**
     * [DEPRECATED] GetDefinition: Get a Custom Entity type definition. (asynchronously)
     * Retrieve a CustomEntityDefinition by a specific entityType at a point in AsAt time
     * @param entityType The identifier for the Custom Entity type, derived from the \&quot;entityTypeName\&quot; provided on creation. (required)
     * @param asAt The AsAt datetime at which to retrieve the definition. (optional)
     * @param _callback The callback to be executed when the API call finishes
    ...
    private okhttp3.Call listCustomEntityDefinitionsValidateBeforeCall(OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listCustomEntityDefinitionsCall(asAt, limit, filter, page, _callback);
        return localVarCall;
    ...
    private okhttp3.Call updateCustomEntityDefinitionValidateBeforeCall(String entityType, UpdateCustomEntityDefinitionRequest updateCustomEntityDefinitionRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateCustomEntityDefinitionCall(entityType, updateCustomEntityDefinitionRequest, _callback);
        return localVarCall;
