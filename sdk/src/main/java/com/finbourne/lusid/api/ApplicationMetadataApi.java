...
public class ApplicationMetadataApi {
    ...
    /**
     * Build call for getExcelDownloadUrl
     * @param version The requested version of the Excel plugin (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getExcelDownloadUrlCall(String version, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/metadata/downloads/excel";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getExcelDownloadUrlValidateBeforeCall(String version, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getExcelDownloadUrlCall(version, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String getExcelDownloadUrl(String version) throws ApiException {
        ApiResponse<String> resp = getExcelDownloadUrlWithHttpInfo(version);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> getExcelDownloadUrlWithHttpInfo(String version) throws ApiException {
        com.squareup.okhttp.Call call = getExcelDownloadUrlValidateBeforeCall(version, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Excel download url (asynchronously)
     * Request an authorised url for an Excel client version
     * @param version The requested version of the Excel plugin (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getExcelDownloadUrlAsync(String version, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getExcelDownloadUrlValidateBeforeCall(version, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for listAccessControlledActions
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listAccessControlledActionsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/metadata/access/actions";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listAccessControlledActionsValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listAccessControlledActionsCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<AccessControlledAction> listAccessControlledActions() throws ApiException {
        ApiResponse<List<AccessControlledAction>> resp = listAccessControlledActionsWithHttpInfo();
        return resp.getData();
    }
     ...
     * Get resources available for access control
     * Get the comprehensive set of resources that are available for access control
     * @return ApiResponse&lt;List&lt;AccessControlledAction&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<AccessControlledAction>> listAccessControlledActionsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = listAccessControlledActionsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<AccessControlledAction>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listAccessControlledActionsAsync(final ApiCallback<List<AccessControlledAction>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listAccessControlledActionsValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<AccessControlledAction>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
