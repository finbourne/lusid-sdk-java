...
import com.finbourne.lusid.model.VersionSummary;
...
public class ApplicationMetadataApi {
     ...
     */
    public String getExcelAddin(String version) throws ApiException {
        ApiResponse<String> resp = getExcelAddinWithHttpInfo(version);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> getExcelAddinWithHttpInfo(String version) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getExcelAddinAsync(String version, final ApiCallback<String> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public VersionSummary getLusidVersions() throws ApiException {
        ApiResponse<VersionSummary> resp = getLusidVersionsWithHttpInfo();
        return resp.getData();
    }
     ...
     * Get LUSID versions
     * Get the semantic versions associated with LUSID and its ecosystem
     * @return ApiResponse&lt;VersionSummary&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VersionSummary> getLusidVersionsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getLusidVersionsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<VersionSummary>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getLusidVersionsAsync(final ApiCallback<VersionSummary> callback) throws ApiException {
