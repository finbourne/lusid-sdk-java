...
import com.finbourne.lusid.model.ResourceListOfReferencePortfolioConstituent;
...
public class ReferencePortfolioApi {
     ...
     * @param code The scope of the portfolio (required)
     * @param effectiveAt Optional. The effective date of the data (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getReferencePortfolioConstituentsCall(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/referenceportfolios/{scope}/{code}/{effectiveAt}/constituents"
            .replaceAll("\\{" + "scope" + "\\}", apiClient.escapeString(scope.toString()))
    ...
    private com.squareup.okhttp.Call getReferencePortfolioConstituentsValidateBeforeCall(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (effectiveAt == null) {
            throw new ApiException("Missing the required parameter 'effectiveAt' when calling getReferencePortfolioConstituents(Async)");
        }
        

        com.squareup.okhttp.Call call = getReferencePortfolioConstituentsCall(scope, code, effectiveAt, asAt, sortBy, start, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many (optional)
     * @return ResourceListOfReferencePortfolioConstituent
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfReferencePortfolioConstituent getReferencePortfolioConstituents(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit) throws ApiException {
        ApiResponse<ResourceListOfReferencePortfolioConstituent> resp = getReferencePortfolioConstituentsWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit);
        return resp.getData();
    }
     ...
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many (optional)
     * @return ApiResponse&lt;ResourceListOfReferencePortfolioConstituent&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfReferencePortfolioConstituent> getReferencePortfolioConstituentsWithHttpInfo(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getReferencePortfolioConstituentsValidateBeforeCall(scope, code, effectiveAt, asAt, sortBy, start, limit, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfReferencePortfolioConstituent>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getReferencePortfolioConstituentsAsync(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ApiCallback<ResourceListOfReferencePortfolioConstituent> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getReferencePortfolioConstituentsValidateBeforeCall(scope, code, effectiveAt, asAt, sortBy, start, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfReferencePortfolioConstituent>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertReferencePortfolioConstituentsCall(String scope, String code, OffsetDateTime effectiveAt, List<ReferencePortfolioConstituentRequest> constituents, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call upsertReferencePortfolioConstituentsValidateBeforeCall(String scope, String code, OffsetDateTime effectiveAt, List<ReferencePortfolioConstituentRequest> constituents, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'effectiveAt' is set
        if (effectiveAt == null) {
            throw new ApiException("Missing the required parameter 'effectiveAt' when calling upsertReferencePortfolioConstituents(Async)");
        }
        

        com.squareup.okhttp.Call call = upsertReferencePortfolioConstituentsCall(scope, code, effectiveAt, constituents, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UpsertReferencePortfolioConstituentsResponse upsertReferencePortfolioConstituents(String scope, String code, OffsetDateTime effectiveAt, List<ReferencePortfolioConstituentRequest> constituents) throws ApiException {
        ApiResponse<UpsertReferencePortfolioConstituentsResponse> resp = upsertReferencePortfolioConstituentsWithHttpInfo(scope, code, effectiveAt, constituents);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UpsertReferencePortfolioConstituentsResponse> upsertReferencePortfolioConstituentsWithHttpInfo(String scope, String code, OffsetDateTime effectiveAt, List<ReferencePortfolioConstituentRequest> constituents) throws ApiException {
        com.squareup.okhttp.Call call = upsertReferencePortfolioConstituentsValidateBeforeCall(scope, code, effectiveAt, constituents, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertReferencePortfolioConstituentsAsync(String scope, String code, OffsetDateTime effectiveAt, List<ReferencePortfolioConstituentRequest> constituents, final ApiCallback<UpsertReferencePortfolioConstituentsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertReferencePortfolioConstituentsValidateBeforeCall(scope, code, effectiveAt, constituents, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpsertReferencePortfolioConstituentsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
