...
public class ReferencePortfolioApi {
     ...
     * @param effectiveAt The effective date of the constituents to retrieve (required)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetReferencePortfolioConstituentsResponse getReferencePortfolioConstituents(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit) throws ApiException {
        ApiResponse<GetReferencePortfolioConstituentsResponse> resp = getReferencePortfolioConstituentsWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetReferencePortfolioConstituentsResponse> getReferencePortfolioConstituentsWithHttpInfo(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getReferencePortfolioConstituentsAsync(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ApiCallback<GetReferencePortfolioConstituentsResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listConstituentsAdjustmentsCall(String scope, String code, OffsetDateTime fromEffectiveAt, OffsetDateTime toEffectiveAt, OffsetDateTime asAtTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listConstituentsAdjustmentsValidateBeforeCall(String scope, String code, OffsetDateTime fromEffectiveAt, OffsetDateTime toEffectiveAt, OffsetDateTime asAtTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfConstituentsAdjustmentHeader listConstituentsAdjustments(String scope, String code, OffsetDateTime fromEffectiveAt, OffsetDateTime toEffectiveAt, OffsetDateTime asAtTime) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfConstituentsAdjustmentHeader> listConstituentsAdjustmentsWithHttpInfo(String scope, String code, OffsetDateTime fromEffectiveAt, OffsetDateTime toEffectiveAt, OffsetDateTime asAtTime) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listConstituentsAdjustmentsAsync(String scope, String code, OffsetDateTime fromEffectiveAt, OffsetDateTime toEffectiveAt, OffsetDateTime asAtTime, final ApiCallback<ResourceListOfConstituentsAdjustmentHeader> callback) throws ApiException {
