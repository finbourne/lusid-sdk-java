...
public class ComplianceGenericApi {
    private ApiClient localVarApiClient;
    public ComplianceGenericApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ComplianceGenericApi(ApiClient apiClient) {
    ...
    /**
     * Build call for deleteComplianceRule2
     ...
     */
    public okhttp3.Call deleteComplianceRule2Call(String scope, String code, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/compliance/generic/rules/{scope}/{code}"
    ...
    private okhttp3.Call deleteComplianceRule2ValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling deleteComplianceRule2(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling deleteComplianceRule2(Async)");
        }
        

        okhttp3.Call localVarCall = deleteComplianceRule2Call(scope, code, _callback);
        return localVarCall;
     ...
     */
    public DeletedEntityResponse deleteComplianceRule2(String scope, String code) throws ApiException {
        ApiResponse<DeletedEntityResponse> localVarResp = deleteComplianceRule2WithHttpInfo(scope, code);
     ...
     */
    public ApiResponse<DeletedEntityResponse> deleteComplianceRule2WithHttpInfo(String scope, String code) throws ApiException {
        okhttp3.Call localVarCall = deleteComplianceRule2ValidateBeforeCall(scope, code, null);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] DeleteComplianceRule2: Delete compliance rule. (asynchronously)
     * Use this endpoint to delete a compliance rule. The rule will be recoverable for asat times earlier than the  delete time, but will otherwise appear to have never existed.
     * @param scope The compliance rule&#39;s scope. (required)
     * @param code The compliance rule&#39;s code. (required)
     ...
     */
    public okhttp3.Call deleteComplianceRule2Async(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = deleteComplianceRule2ValidateBeforeCall(scope, code, _callback);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getComplianceRule2
     * @param scope The compliance rule&#39;s scope. (required)
     * @param code The compliance rule&#39;s code. (required)
     ...
     */
    public okhttp3.Call getComplianceRule2Call(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getComplianceRule2ValidateBeforeCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getComplianceRule2(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getComplianceRule2(Async)");
        }
        

        okhttp3.Call localVarCall = getComplianceRule2Call(scope, code, asAt, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public ComplianceRuleResponse getComplianceRule2(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        ApiResponse<ComplianceRuleResponse> localVarResp = getComplianceRule2WithHttpInfo(scope, code, asAt, propertyKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ComplianceRuleResponse> getComplianceRule2WithHttpInfo(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRule2ValidateBeforeCall(scope, code, asAt, propertyKeys, null);
        Type localVarReturnType = new TypeToken<ComplianceRuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetComplianceRule2: Get compliance rule. (asynchronously)
     * Use this endpoint to retrieve a single compliance rule.
     * @param scope The compliance rule&#39;s scope. (required)
     * @param code The compliance rule&#39;s code. (required)
     * @param asAt Optional. Asat time for query. (optional)
     ...
     */
    public okhttp3.Call getComplianceRule2Async(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<ComplianceRuleResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRule2ValidateBeforeCall(scope, code, asAt, propertyKeys, _callback);
        Type localVarReturnType = new TypeToken<ComplianceRuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call getComplianceRunSummaryCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/compliance/generic/runs/summary/{scope}/{code}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()));
    ...
    /**
     * [EARLY ACCESS] GetComplianceRunSummary: Get compliance summary results. (asynchronously)
     * Specify a run scope and code from a previously run compliance check to get summarised results.
     * @param scope Required: Run Scope. (required)
     * @param code Required: Run Code. (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Build call for listComplianceRules2
     ...
     */
    public okhttp3.Call listComplianceRules2Call(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/compliance/generic/rules";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listComplianceRules2ValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listComplianceRules2Call(asAt, page, limit, filter, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfComplianceRuleResponse listComplianceRules2(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        ApiResponse<PagedResourceListOfComplianceRuleResponse> localVarResp = listComplianceRules2WithHttpInfo(asAt, page, limit, filter, propertyKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedResourceListOfComplianceRuleResponse> listComplianceRules2WithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRules2ValidateBeforeCall(asAt, page, limit, filter, propertyKeys, null);
        Type localVarReturnType = new TypeToken<PagedResourceListOfComplianceRuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListComplianceRules2: List compliance rules. (asynchronously)
     * Use this endpoint to retrieve all compliance rules, or a collection defined by an optional filter.
     * @param asAt Optional. Asat time. (optional)
     * @param page Optional. Pagination token. (optional)
     * @param limit Optional. Entries per page. (optional)
     ...
     */
    public okhttp3.Call listComplianceRules2Async(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfComplianceRuleResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRules2ValidateBeforeCall(asAt, page, limit, filter, propertyKeys, _callback);
        Type localVarReturnType = new TypeToken<PagedResourceListOfComplianceRuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call listComplianceRunsCall(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/compliance/generic/runs";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listComplianceRunsValidateBeforeCall(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listComplianceRunsCall(asAt, page, start, limit, filter, sortBy, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfComplianceRunInfoV2 listComplianceRuns(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, List<String> sortBy) throws ApiException {
        ApiResponse<PagedResourceListOfComplianceRunInfoV2> localVarResp = listComplianceRunsWithHttpInfo(asAt, page, start, limit, filter, sortBy);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedResourceListOfComplianceRunInfoV2> listComplianceRunsWithHttpInfo(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, List<String> sortBy) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRunsValidateBeforeCall(asAt, page, start, limit, filter, sortBy, null);
        Type localVarReturnType = new TypeToken<PagedResourceListOfComplianceRunInfoV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListComplianceRuns: List historical Compliance RunIds (asynchronously)
     * Lists out all RunIds of prior compliance runs.
     * @param asAt Optional. The time at which to get results from. Default : latest (optional)
     * @param page Optional. The pagination token to use to continue listing compliance runs from a previous call to list compliance runs.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param start Optional. When paginating, skip this number of results. (optional)
     ...
     */
    public okhttp3.Call listComplianceRunsAsync(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfComplianceRunInfoV2> _callback) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRunsValidateBeforeCall(asAt, page, start, limit, filter, sortBy, _callback);
        Type localVarReturnType = new TypeToken<PagedResourceListOfComplianceRunInfoV2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * [EARLY ACCESS] ListComplianceTemplates: Get a specific compliance template (asynchronously)
     * Use this endpoint to fetch a list of all available compliance template ids.
     * @param asAt Optional. The time at which to get results from. Default : latest (optional)
     * @param page Optional. The pagination token to use to continue listing compliance runs from a previous call to list compliance runs.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param start Optional. When paginating, skip this number of results. (optional)
    ...
    /**
     * Build call for runGenericCompliance
     ...
     */
    public okhttp3.Call runGenericComplianceCall(String runScope, String ruleScope, Boolean isPreTrade, String recipeIdScope, String recipeIdCode, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call runGenericComplianceValidateBeforeCall(String runScope, String ruleScope, Boolean isPreTrade, String recipeIdScope, String recipeIdCode, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'runScope' is set
        if (runScope == null) {
            throw new ApiException("Missing the required parameter 'runScope' when calling runGenericCompliance(Async)");
        }
        
        // verify the required parameter 'ruleScope' is set
        if (ruleScope == null) {
            throw new ApiException("Missing the required parameter 'ruleScope' when calling runGenericCompliance(Async)");
        }
        
        // verify the required parameter 'isPreTrade' is set
        if (isPreTrade == null) {
            throw new ApiException("Missing the required parameter 'isPreTrade' when calling runGenericCompliance(Async)");
        }
        
        // verify the required parameter 'recipeIdScope' is set
        if (recipeIdScope == null) {
            throw new ApiException("Missing the required parameter 'recipeIdScope' when calling runGenericCompliance(Async)");
        }
        
        // verify the required parameter 'recipeIdCode' is set
        if (recipeIdCode == null) {
            throw new ApiException("Missing the required parameter 'recipeIdCode' when calling runGenericCompliance(Async)");
        }
        

        okhttp3.Call localVarCall = runGenericComplianceCall(runScope, ruleScope, isPreTrade, recipeIdScope, recipeIdCode, _callback);
        return localVarCall;
     ...
     */
    public ComplianceRunInfoV2 runGenericCompliance(String runScope, String ruleScope, Boolean isPreTrade, String recipeIdScope, String recipeIdCode) throws ApiException {
        ApiResponse<ComplianceRunInfoV2> localVarResp = runGenericComplianceWithHttpInfo(runScope, ruleScope, isPreTrade, recipeIdScope, recipeIdCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ComplianceRunInfoV2> runGenericComplianceWithHttpInfo(String runScope, String ruleScope, Boolean isPreTrade, String recipeIdScope, String recipeIdCode) throws ApiException {
        okhttp3.Call localVarCall = runGenericComplianceValidateBeforeCall(runScope, ruleScope, isPreTrade, recipeIdScope, recipeIdCode, null);
        Type localVarReturnType = new TypeToken<ComplianceRunInfoV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] RunGenericCompliance: Kick off the compliance check process (asynchronously)
     * Use this endpoint to fetch the start a compliance run, based on a pre-set mapping file.
     * @param runScope Required: Scope to save the run results in. (required)
     * @param ruleScope Required: Scope from which to select rules to be run. (required)
     * @param isPreTrade Required: Boolean flag indicating if a run should be PreTrade (Including orders). For post-trade only, set to false (required)
     ...
     */
    public okhttp3.Call runGenericComplianceAsync(String runScope, String ruleScope, Boolean isPreTrade, String recipeIdScope, String recipeIdCode, final ApiCallback<ComplianceRunInfoV2> _callback) throws ApiException {
        okhttp3.Call localVarCall = runGenericComplianceValidateBeforeCall(runScope, ruleScope, isPreTrade, recipeIdScope, recipeIdCode, _callback);
        Type localVarReturnType = new TypeToken<ComplianceRunInfoV2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
