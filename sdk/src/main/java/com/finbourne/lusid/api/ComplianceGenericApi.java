...
public class ComplianceGenericApi {
    ...
    /**
     * [EARLY ACCESS] DeleteComplianceRule2: Get compliance rule. (asynchronously)
     * PLEASE NOTE: loopback EarlyAccess endpoint for discussion only.
     * @param scope The compliance rule&#39;s scope. (required)
     * @param code The compliance rule&#39;s code. (required)
     ...
     */
    public okhttp3.Call getComplianceRule2Call(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getComplianceRule2ValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getComplianceRule2Call(scope, code, asAt, _callback);
        return localVarCall;
     ...
     */
    public ComplianceRuleResponse getComplianceRule2(String scope, String code, OffsetDateTime asAt) throws ApiException {
        ApiResponse<ComplianceRuleResponse> localVarResp = getComplianceRule2WithHttpInfo(scope, code, asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ComplianceRuleResponse> getComplianceRule2WithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRule2ValidateBeforeCall(scope, code, asAt, null);
     ...
     */
    public okhttp3.Call getComplianceRule2Async(String scope, String code, OffsetDateTime asAt, final ApiCallback<ComplianceRuleResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRule2ValidateBeforeCall(scope, code, asAt, _callback);
        Type localVarReturnType = new TypeToken<ComplianceRuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param start Optional. Entry at which to start. (optional)
     ...
     */
    public okhttp3.Call listComplianceRules2Call(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listComplianceRules2ValidateBeforeCall(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listComplianceRules2Call(asAt, page, start, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfComplianceRuleResponse listComplianceRules2(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<PagedResourceListOfComplianceRuleResponse> localVarResp = listComplianceRules2WithHttpInfo(asAt, page, start, limit, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedResourceListOfComplianceRuleResponse> listComplianceRules2WithHttpInfo(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRules2ValidateBeforeCall(asAt, page, start, limit, filter, null);
     ...
     */
    public okhttp3.Call listComplianceRules2Async(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, final ApiCallback<PagedResourceListOfComplianceRuleResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRules2ValidateBeforeCall(asAt, page, start, limit, filter, _callback);
        Type localVarReturnType = new TypeToken<PagedResourceListOfComplianceRuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
