...
public class ReconciliationsApi {
     ...
     */
    public com.squareup.okhttp.Call reconcileHoldingsCall(PortfoliosReconciliationRequest request, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call reconcileHoldingsValidateBeforeCall(PortfoliosReconciliationRequest request, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = reconcileHoldingsCall(request, sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     */
    public ResourceListOfReconciliationBreak reconcileHoldings(PortfoliosReconciliationRequest request, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfReconciliationBreak> resp = reconcileHoldingsWithHttpInfo(request, sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfReconciliationBreak> reconcileHoldingsWithHttpInfo(PortfoliosReconciliationRequest request, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = reconcileHoldingsValidateBeforeCall(request, sortBy, start, limit, filter, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Reconcile portfolio holdings (asynchronously)
     * Reconcile the holdings of two portfolios.
     * @param request The specifications of the inputs to the reconciliation (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     ...
     */
    public com.squareup.okhttp.Call reconcileHoldingsAsync(PortfoliosReconciliationRequest request, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfReconciliationBreak> callback) throws ApiException {
