...
public class CorporateActionsApi {
    ...
    public com.squareup.okhttp.Call batchUpsertCorporateActionsCall(String scope, String code, List<CreateCorporateAction> actions, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/api/corporateactions/{scope}/{code}"
    ...
    private com.squareup.okhttp.Call getCorporateActionsValidateBeforeCall(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCorporateActionsCall(scope, code, effectiveAt, asAt, sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfCorporateAction getCorporateActions(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfCorporateAction> resp = getCorporateActionsWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfCorporateAction> getCorporateActionsWithHttpInfo(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = getCorporateActionsValidateBeforeCall(scope, code, effectiveAt, asAt, sortBy, start, limit, filter, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCorporateActionsAsync(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfCorporateAction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCorporateActionsValidateBeforeCall(scope, code, effectiveAt, asAt, sortBy, start, limit, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfCorporateAction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
