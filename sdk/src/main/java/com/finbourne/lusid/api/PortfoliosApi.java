...
public class PortfoliosApi {
    ...
    private okhttp3.Call deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(String scope, String code, String metadataKey, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteKeyFromPortfolioAccessMetadataCall(scope, code, metadataKey, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public DeletedEntityResponse deleteKeyFromPortfolioAccessMetadata(String scope, String code, String metadataKey, String effectiveAt) throws ApiException {
        ApiResponse<DeletedEntityResponse> localVarResp = deleteKeyFromPortfolioAccessMetadataWithHttpInfo(scope, code, metadataKey, effectiveAt);
     ...
     */
    public ApiResponse<DeletedEntityResponse> deleteKeyFromPortfolioAccessMetadataWithHttpInfo(String scope, String code, String metadataKey, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, effectiveAt, null);
     ...
     */
    public okhttp3.Call getPortfolioAggregatedReturnsCall(String scope, String code, String returnScope, String returnCode, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPortfolioAggregatedReturnsValidateBeforeCall(String scope, String code, String returnScope, String returnCode, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'returnScope' is set
        if (returnScope == null) {
            throw new ApiException("Missing the required parameter 'returnScope' when calling getPortfolioAggregatedReturns(Async)");
        }
        
        // verify the required parameter 'returnCode' is set
        if (returnCode == null) {
            throw new ApiException("Missing the required parameter 'returnCode' when calling getPortfolioAggregatedReturns(Async)");
        }
        ...
        okhttp3.Call localVarCall = getPortfolioAggregatedReturnsCall(scope, code, returnScope, returnCode, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfAggregatedReturn getPortfolioAggregatedReturns(String scope, String code, String returnScope, String returnCode, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt) throws ApiException {
        ApiResponse<ResourceListOfAggregatedReturn> localVarResp = getPortfolioAggregatedReturnsWithHttpInfo(scope, code, returnScope, returnCode, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfAggregatedReturn> getPortfolioAggregatedReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getPortfolioAggregatedReturnsValidateBeforeCall(scope, code, returnScope, returnCode, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, null);
     ...
     */
    public okhttp3.Call getPortfolioAggregatedReturnsAsync(String scope, String code, String returnScope, String returnCode, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback<ResourceListOfAggregatedReturn> _callback) throws ApiException {
        okhttp3.Call localVarCall = getPortfolioAggregatedReturnsValidateBeforeCall(scope, code, returnScope, returnCode, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfAggregatedReturn>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * [EARLY ACCESS] GetPortfolioCommands: Get portfolio commands (asynchronously)
     * Get all the commands that modified a particular portfolio, including any input transactions.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param fromAsAt The lower bound asAt datetime (inclusive) from which to retrieve commands. There is no lower bound if this is not specified. (optional)
     ...
     */
    public okhttp3.Call upsertPortfolioAccessMetadataCall(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertPortfolioAccessMetadataValidateBeforeCall(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertPortfolioAccessMetadataCall(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfAccessMetadataValueOf upsertPortfolioAccessMetadata(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt) throws ApiException {
        ApiResponse<ResourceListOfAccessMetadataValueOf> localVarResp = upsertPortfolioAccessMetadataWithHttpInfo(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfAccessMetadataValueOf> upsertPortfolioAccessMetadataWithHttpInfo(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = upsertPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt, null);
