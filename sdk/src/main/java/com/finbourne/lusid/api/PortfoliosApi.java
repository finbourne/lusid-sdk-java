...
public class PortfoliosApi {
     ...
     */
    public com.squareup.okhttp.Call deletePortfolioCall(String scope, String code, String effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call deletePortfolioValidateBeforeCall(String scope, String code, String effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call deletePortfolioAsync(String scope, String code, String effectiveAt, final ApiCallback<DeletedEntityResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deletePortfolioPropertiesCall(String scope, String code, String effectiveAt, List<String> portfolioPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deletePortfolioPropertiesValidateBeforeCall(String scope, String code, String effectiveAt, List<String> portfolioPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deletePortfolioPropertiesAsync(String scope, String code, String effectiveAt, List<String> portfolioPropertyKeys, final ApiCallback<DeletedEntityResponse> callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioPropertiesValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ApiCallback<PortfolioProperties> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listPortfoliosCall(String effectiveAt, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, String query, List<String> portfolioPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call listPortfoliosValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, String query, List<String> portfolioPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPortfoliosCall(effectiveAt, asAt, page, sortBy, start, limit, filter, query, portfolioPropertyKeys, progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfPortfolio listPortfolios(String effectiveAt, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, String query, List<String> portfolioPropertyKeys) throws ApiException {
        ApiResponse<ResourceListOfPortfolio> resp = listPortfoliosWithHttpInfo(effectiveAt, asAt, page, sortBy, start, limit, filter, query, portfolioPropertyKeys);
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfPortfolio> listPortfoliosWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, String query, List<String> portfolioPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = listPortfoliosValidateBeforeCall(effectiveAt, asAt, page, sortBy, start, limit, filter, query, portfolioPropertyKeys, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listPortfoliosAsync(String effectiveAt, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, String query, List<String> portfolioPropertyKeys, final ApiCallback<ResourceListOfPortfolio> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPortfoliosValidateBeforeCall(effectiveAt, asAt, page, sortBy, start, limit, filter, query, portfolioPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolio>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listPortfoliosForScopeCall(String scope, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> portfolioPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listPortfoliosForScopeValidateBeforeCall(String scope, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> portfolioPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPortfoliosForScopeCall(scope, effectiveAt, asAt, sortBy, start, limit, filter, portfolioPropertyKeys, progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfPortfolio listPortfoliosForScope(String scope, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> portfolioPropertyKeys) throws ApiException {
        ApiResponse<ResourceListOfPortfolio> resp = listPortfoliosForScopeWithHttpInfo(scope, effectiveAt, asAt, sortBy, start, limit, filter, portfolioPropertyKeys);
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfPortfolio> listPortfoliosForScopeWithHttpInfo(String scope, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> portfolioPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = listPortfoliosForScopeValidateBeforeCall(scope, effectiveAt, asAt, sortBy, start, limit, filter, portfolioPropertyKeys, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolio>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listPortfoliosForScopeAsync(String scope, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> portfolioPropertyKeys, final ApiCallback<ResourceListOfPortfolio> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPortfoliosForScopeValidateBeforeCall(scope, effectiveAt, asAt, sortBy, start, limit, filter, portfolioPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolio>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updatePortfolioCall(String scope, String code, UpdatePortfolioRequest request, String effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updatePortfolioValidateBeforeCall(String scope, String code, UpdatePortfolioRequest request, String effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Portfolio updatePortfolio(String scope, String code, UpdatePortfolioRequest request, String effectiveAt) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Portfolio> updatePortfolioWithHttpInfo(String scope, String code, UpdatePortfolioRequest request, String effectiveAt) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePortfolioAsync(String scope, String code, UpdatePortfolioRequest request, String effectiveAt, final ApiCallback<Portfolio> callback) throws ApiException {
