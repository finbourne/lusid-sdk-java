...
public class PortfoliosApi {
    ...
    private com.squareup.okhttp.Call listPortfoliosValidateBeforeCall(OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPortfoliosCall(effectiveAt, asAt, sortBy, start, limit, filter, query, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfPortfolio listPortfolios(OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query) throws ApiException {
        ApiResponse<ResourceListOfPortfolio> resp = listPortfoliosWithHttpInfo(effectiveAt, asAt, sortBy, start, limit, filter, query);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfPortfolio> listPortfoliosWithHttpInfo(OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query) throws ApiException {
        com.squareup.okhttp.Call call = listPortfoliosValidateBeforeCall(effectiveAt, asAt, sortBy, start, limit, filter, query, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listPortfoliosAsync(OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query, final ApiCallback<ResourceListOfPortfolio> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPortfoliosValidateBeforeCall(effectiveAt, asAt, sortBy, start, limit, filter, query, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolio>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
