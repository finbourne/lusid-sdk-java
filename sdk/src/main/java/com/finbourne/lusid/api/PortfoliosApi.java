...
public class PortfoliosApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioCall(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioValidateBeforeCall(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Portfolio getPortfolio(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Portfolio> getPortfolioWithHttpInfo(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioAsync(String scope, String code, OffsetDateTime effectiveAt, OffsetDateTime asAt, final ApiCallback<Portfolio> callback) throws ApiException {
    ...
    /**
     * Build call for listPortfolioScopes
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param filter Filter to be applied to the list of scopes (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listPortfolioScopesCall(List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listPortfolioScopesValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listPortfolioScopesCall(sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param filter Filter to be applied to the list of scopes (optional)
     * @return ResourceListOfScope
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfScope listPortfolioScopes(List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfScope> resp = listPortfolioScopesWithHttpInfo(sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param filter Filter to be applied to the list of scopes (optional)
     * @return ApiResponse&lt;ResourceListOfScope&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfScope> listPortfolioScopesWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = listPortfolioScopesValidateBeforeCall(sortBy, start, limit, filter, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfScope>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List portfolio scopes (asynchronously)
     * Lists all scopes that are either currently or have previously had portfolios in them
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listPortfolioScopesAsync(List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfScope> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPortfolioScopesValidateBeforeCall(sortBy, start, limit, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfScope>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listPortfoliosValidateBeforeCall(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling listPortfolios(Async)");
        }
        

        com.squareup.okhttp.Call call = listPortfoliosCall(scope, effectiveAt, asAt, sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfPortfolio listPortfolios(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfPortfolio> resp = listPortfoliosWithHttpInfo(scope, effectiveAt, asAt, sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfPortfolio> listPortfoliosWithHttpInfo(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = listPortfoliosValidateBeforeCall(scope, effectiveAt, asAt, sortBy, start, limit, filter, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listPortfoliosAsync(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfPortfolio> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPortfoliosValidateBeforeCall(scope, effectiveAt, asAt, sortBy, start, limit, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolio>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param scope The scope of the portfolio (required)
     * @param code The code of the portfolio (required)
     * @param portfolioProperties The property values to be upserted to the portfolio (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertPortfolioPropertiesCall(String scope, String code, Object portfolioProperties, OffsetDateTime effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call upsertPortfolioPropertiesValidateBeforeCall(String scope, String code, Object portfolioProperties, OffsetDateTime effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertPortfolioPropertiesCall(scope, code, portfolioProperties, effectiveAt, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortfolioProperties upsertPortfolioProperties(String scope, String code, Object portfolioProperties, OffsetDateTime effectiveAt) throws ApiException {
        ApiResponse<PortfolioProperties> resp = upsertPortfolioPropertiesWithHttpInfo(scope, code, portfolioProperties, effectiveAt);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortfolioProperties> upsertPortfolioPropertiesWithHttpInfo(String scope, String code, Object portfolioProperties, OffsetDateTime effectiveAt) throws ApiException {
        com.squareup.okhttp.Call call = upsertPortfolioPropertiesValidateBeforeCall(scope, code, portfolioProperties, effectiveAt, null, null);
        Type localVarReturnType = new TypeToken<PortfolioProperties>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Upsert properties (asynchronously)
     * Upsert one or more property values to a portfolio for the specified effectiveAt. All properties must be of the domain Portfolio.
     * @param scope The scope of the portfolio (required)
     * @param code The code of the portfolio (required)
     * @param portfolioProperties The property values to be upserted to the portfolio (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertPortfolioPropertiesAsync(String scope, String code, Object portfolioProperties, OffsetDateTime effectiveAt, final ApiCallback<PortfolioProperties> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertPortfolioPropertiesValidateBeforeCall(scope, code, portfolioProperties, effectiveAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PortfolioProperties>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
