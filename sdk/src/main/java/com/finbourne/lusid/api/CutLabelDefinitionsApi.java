...
public class CutLabelDefinitionsApi {
     ...
     */
    public com.squareup.okhttp.Call createCutLabelDefinitionCall(CreateCutLabelDefinitionRequest createRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-Sdk-Version", "0.10.192");
    ...
    private com.squareup.okhttp.Call createCutLabelDefinitionValidateBeforeCall(CreateCutLabelDefinitionRequest createRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = createCutLabelDefinitionCall(createRequest, progressListener, progressRequestListener);
        return call;
    ...
    public CutLabelDefinition createCutLabelDefinition(CreateCutLabelDefinitionRequest createRequest) throws ApiException {
        ApiResponse<CutLabelDefinition> resp = createCutLabelDefinitionWithHttpInfo(createRequest);
        return resp.getData();
    }
    ...
    public ApiResponse<CutLabelDefinition> createCutLabelDefinitionWithHttpInfo(CreateCutLabelDefinitionRequest createRequest) throws ApiException {
        com.squareup.okhttp.Call call = createCutLabelDefinitionValidateBeforeCall(createRequest, null, null);
        Type localVarReturnType = new TypeToken<CutLabelDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create a Cut Label (asynchronously)
     * Create a Cut Label valid in all scopes
     * @param createRequest The cut label definition (optional)
     ...
     */
    public com.squareup.okhttp.Call createCutLabelDefinitionAsync(CreateCutLabelDefinitionRequest createRequest, final ApiCallback<CutLabelDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createCutLabelDefinitionValidateBeforeCall(createRequest, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CutLabelDefinition>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteCutLabelDefinitionCall(String code, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteCutLabelDefinitionValidateBeforeCall(String code, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteCutLabelDefinitionCall(code, progressListener, progressRequestListener);
        return call;
    ...
    public OffsetDateTime deleteCutLabelDefinition(String code) throws ApiException {
        ApiResponse<OffsetDateTime> resp = deleteCutLabelDefinitionWithHttpInfo(code);
        return resp.getData();
    }
    ...
    public ApiResponse<OffsetDateTime> deleteCutLabelDefinitionWithHttpInfo(String code) throws ApiException {
        com.squareup.okhttp.Call call = deleteCutLabelDefinitionValidateBeforeCall(code, null, null);
        Type localVarReturnType = new TypeToken<OffsetDateTime>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Delete a Cut Label (asynchronously)
     * Delete a specified cut label
     * @param code The Code of the Cut Label that is being Deleted (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteCutLabelDefinitionAsync(String code, final ApiCallback<OffsetDateTime> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteCutLabelDefinitionValidateBeforeCall(code, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<OffsetDateTime>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getCutLabelDefinitionCall(String code, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCutLabelDefinitionValidateBeforeCall(String code, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCutLabelDefinitionCall(code, asAt, progressListener, progressRequestListener);
        return call;
    ...
    public CutLabelDefinition getCutLabelDefinition(String code, OffsetDateTime asAt) throws ApiException {
        ApiResponse<CutLabelDefinition> resp = getCutLabelDefinitionWithHttpInfo(code, asAt);
        return resp.getData();
    }
    ...
    public ApiResponse<CutLabelDefinition> getCutLabelDefinitionWithHttpInfo(String code, OffsetDateTime asAt) throws ApiException {
        com.squareup.okhttp.Call call = getCutLabelDefinitionValidateBeforeCall(code, asAt, null, null);
        Type localVarReturnType = new TypeToken<CutLabelDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get a Cut Label (asynchronously)
     * Get a specified cut label at a given time
     * @param code The Code of the Cut Label that is being queried (required)
     * @param asAt The time at which to get the Cut Label (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCutLabelDefinitionAsync(String code, OffsetDateTime asAt, final ApiCallback<CutLabelDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCutLabelDefinitionValidateBeforeCall(code, asAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CutLabelDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listCutLabelDefinitionsCall(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listCutLabelDefinitionsValidateBeforeCall(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listCutLabelDefinitionsCall(asAt, sortBy, start, limit, filter, query, progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfCutLabelDefinition listCutLabelDefinitions(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query) throws ApiException {
        ApiResponse<ResourceListOfCutLabelDefinition> resp = listCutLabelDefinitionsWithHttpInfo(asAt, sortBy, start, limit, filter, query);
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfCutLabelDefinition> listCutLabelDefinitionsWithHttpInfo(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query) throws ApiException {
        com.squareup.okhttp.Call call = listCutLabelDefinitionsValidateBeforeCall(asAt, sortBy, start, limit, filter, query, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfCutLabelDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List Existing Cut Labels (asynchronously)
     * List all the Cut Label Definitions that are valid at the given AsAt time
     * @param asAt Optional. The As At time at which listed Cut Labels are valid (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listCutLabelDefinitionsAsync(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, String query, final ApiCallback<ResourceListOfCutLabelDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listCutLabelDefinitionsValidateBeforeCall(asAt, sortBy, start, limit, filter, query, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfCutLabelDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateCutLabelDefinitionCall(String code, UpdateCutLabelDefinitionRequest updateRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateCutLabelDefinitionValidateBeforeCall(String code, UpdateCutLabelDefinitionRequest updateRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateCutLabelDefinitionCall(code, updateRequest, progressListener, progressRequestListener);
        return call;
    ...
    public CutLabelDefinition updateCutLabelDefinition(String code, UpdateCutLabelDefinitionRequest updateRequest) throws ApiException {
        ApiResponse<CutLabelDefinition> resp = updateCutLabelDefinitionWithHttpInfo(code, updateRequest);
        return resp.getData();
    }
    ...
    public ApiResponse<CutLabelDefinition> updateCutLabelDefinitionWithHttpInfo(String code, UpdateCutLabelDefinitionRequest updateRequest) throws ApiException {
        com.squareup.okhttp.Call call = updateCutLabelDefinitionValidateBeforeCall(code, updateRequest, null, null);
        Type localVarReturnType = new TypeToken<CutLabelDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update a Cut Label (asynchronously)
     * Update a specified cut label
     * @param code The Code of the Cut Label that is being updated (required)
     * @param updateRequest The cut label update definition (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateCutLabelDefinitionAsync(String code, UpdateCutLabelDefinitionRequest updateRequest, final ApiCallback<CutLabelDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateCutLabelDefinitionValidateBeforeCall(code, updateRequest, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CutLabelDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
