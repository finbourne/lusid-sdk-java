...
public class ResultsApi {
     ...
     * @param scope The scope of the data (required)
     * @param key The key that identifies the data (required)
     * @param date The date for which the data was loaded (required)
     ...
     */
    public com.squareup.okhttp.Call getResultsCall(String scope, String key, OffsetDateTime date, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/results/{scope}/{key}/{date}"
    ...
    private com.squareup.okhttp.Call getResultsValidateBeforeCall(String scope, String key, OffsetDateTime date, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getResults(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling getResults(Async)");
        }
        
        // verify the required parameter 'date' is set
        if (date == null) {
            throw new ApiException("Missing the required parameter 'date' when calling getResults(Async)");
        }
        

        com.squareup.okhttp.Call call = getResultsCall(scope, key, date, asAt, sortBy, start, limit, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Results getResults(String scope, String key, OffsetDateTime date, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit) throws ApiException {
        ApiResponse<Results> resp = getResultsWithHttpInfo(scope, key, date, asAt, sortBy, start, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Results> getResultsWithHttpInfo(String scope, String key, OffsetDateTime date, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getResultsValidateBeforeCall(scope, key, date, asAt, sortBy, start, limit, null, null);
     ...
     */
    public com.squareup.okhttp.Call getResultsAsync(String scope, String key, OffsetDateTime date, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, final ApiCallback<Results> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getResultsValidateBeforeCall(scope, key, date, asAt, sortBy, start, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
     ...
     * @param scope The scope of the data (required)
     * @param key The key that identifies the data (required)
     * @param date The date for which the data is relevant (required)
     * @param request The results to upload (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertResultsCall(String scope, String key, OffsetDateTime date, CreateResults request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call upsertResultsValidateBeforeCall(String scope, String key, OffsetDateTime date, CreateResults request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling upsertResults(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling upsertResults(Async)");
        }
        
        // verify the required parameter 'date' is set
        if (date == null) {
            throw new ApiException("Missing the required parameter 'date' when calling upsertResults(Async)");
        }
        

        com.squareup.okhttp.Call call = upsertResultsCall(scope, key, date, request, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Results upsertResults(String scope, String key, OffsetDateTime date, CreateResults request) throws ApiException {
        ApiResponse<Results> resp = upsertResultsWithHttpInfo(scope, key, date, request);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Results> upsertResultsWithHttpInfo(String scope, String key, OffsetDateTime date, CreateResults request) throws ApiException {
        com.squareup.okhttp.Call call = upsertResultsValidateBeforeCall(scope, key, date, request, null, null);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertResultsAsync(String scope, String key, OffsetDateTime date, CreateResults request, final ApiCallback<Results> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertResultsValidateBeforeCall(scope, key, date, request, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
