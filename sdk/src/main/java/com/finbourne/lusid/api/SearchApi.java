...
public class SearchApi {
     ...
     */
    public com.squareup.okhttp.Call instrumentsSearchCall(List<InstrumentSearchProperty> symbols, String masteredEffectiveAt, Boolean masteredOnly, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call instrumentsSearchValidateBeforeCall(List<InstrumentSearchProperty> symbols, String masteredEffectiveAt, Boolean masteredOnly, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call instrumentsSearchAsync(List<InstrumentSearchProperty> symbols, String masteredEffectiveAt, Boolean masteredOnly, final ApiCallback<List<InstrumentMatch>> callback) throws ApiException {
