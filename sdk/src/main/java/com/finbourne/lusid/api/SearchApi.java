...
public class SearchApi {
     ...
     * @param symbols A collection of instrument symbols to search for (optional)
     * @param masteredEffectiveAt Optional. The effective date for searching mastered instruments. If this is not set, then the current date is taken.  This parameter has no effect on instruments that have not been mastered within LUSID. (optional)
     * @param masteredOnly Optional. If set to true, only search over instruments that have been mastered within LUSID. Default to false (optional, default to false)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call instrumentsSearchCall(List<InstrumentSearchProperty> symbols, OffsetDateTime masteredEffectiveAt, Boolean masteredOnly, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("masteredEffectiveAt", masteredEffectiveAt));
        if (masteredOnly != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("masteredOnly", masteredOnly));
    ...
    private com.squareup.okhttp.Call instrumentsSearchValidateBeforeCall(List<InstrumentSearchProperty> symbols, OffsetDateTime masteredEffectiveAt, Boolean masteredOnly, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = instrumentsSearchCall(symbols, masteredEffectiveAt, masteredOnly, progressListener, progressRequestListener);
        return call;
     ...
     */
    public List<InstrumentMatch> instrumentsSearch(List<InstrumentSearchProperty> symbols, OffsetDateTime masteredEffectiveAt, Boolean masteredOnly) throws ApiException {
        ApiResponse<List<InstrumentMatch>> resp = instrumentsSearchWithHttpInfo(symbols, masteredEffectiveAt, masteredOnly);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<InstrumentMatch>> instrumentsSearchWithHttpInfo(List<InstrumentSearchProperty> symbols, OffsetDateTime masteredEffectiveAt, Boolean masteredOnly) throws ApiException {
        com.squareup.okhttp.Call call = instrumentsSearchValidateBeforeCall(symbols, masteredEffectiveAt, masteredOnly, null, null);
     ...
     */
    public com.squareup.okhttp.Call instrumentsSearchAsync(List<InstrumentSearchProperty> symbols, OffsetDateTime masteredEffectiveAt, Boolean masteredOnly, final ApiCallback<List<InstrumentMatch>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = instrumentsSearchValidateBeforeCall(symbols, masteredEffectiveAt, masteredOnly, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<InstrumentMatch>>(){}.getType();
     ...
     * @param request A valid Elasticsearch 5.x request (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call portfolioGroupsSearchCall(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call portfolioGroupsSearchValidateBeforeCall(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = portfolioGroupsSearchCall(request, sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfPortfolioGroup portfolioGroupsSearch(Object request, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfPortfolioGroup> resp = portfolioGroupsSearchWithHttpInfo(request, sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfPortfolioGroup> portfolioGroupsSearchWithHttpInfo(Object request, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = portfolioGroupsSearchValidateBeforeCall(request, sortBy, start, limit, filter, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioGroup>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Search portfolio groups (asynchronously)
     * Search through all portfolio groups
     * @param request A valid Elasticsearch 5.x request (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call portfolioGroupsSearchAsync(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfPortfolioGroup> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = portfolioGroupsSearchValidateBeforeCall(request, sortBy, start, limit, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioGroup>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call portfoliosSearchCall(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call portfoliosSearchValidateBeforeCall(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = portfoliosSearchCall(request, sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfPortfolioSearchResult portfoliosSearch(Object request, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfPortfolioSearchResult> resp = portfoliosSearchWithHttpInfo(request, sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfPortfolioSearchResult> portfoliosSearchWithHttpInfo(Object request, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = portfoliosSearchValidateBeforeCall(request, sortBy, start, limit, filter, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Search portfolios (asynchronously)
     * Search through all portfolios
     * @param request A valid Elasticsearch 5.x request (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call portfoliosSearchAsync(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfPortfolioSearchResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = portfoliosSearchValidateBeforeCall(request, sortBy, start, limit, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call propertiesSearchCall(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call propertiesSearchValidateBeforeCall(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = propertiesSearchCall(request, sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfPropertyDefinition propertiesSearch(Object request, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfPropertyDefinition> resp = propertiesSearchWithHttpInfo(request, sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfPropertyDefinition> propertiesSearchWithHttpInfo(Object request, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = propertiesSearchValidateBeforeCall(request, sortBy, start, limit, filter, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPropertyDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Search property definitions (asynchronously)
     * Search through all property definitions
     * @param request A valid Elasticsearch 5.x request (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call propertiesSearchAsync(Object request, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfPropertyDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = propertiesSearchValidateBeforeCall(request, sortBy, start, limit, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPropertyDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
