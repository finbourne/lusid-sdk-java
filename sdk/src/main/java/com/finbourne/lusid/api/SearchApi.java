...
public class SearchApi {
     ...
     * @param body The search query to use. Read more about search queries in LUSID here https://support.lusid.com/constructing-a-search-request. (required)
     ...
     */
    public okhttp3.Call portfolioGroupsSearchCall(Object body, String filter, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call portfolioGroupsSearchValidateBeforeCall(Object body, String filter, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling portfolioGroupsSearch(Async)");
        }
        

        okhttp3.Call localVarCall = portfolioGroupsSearchCall(body, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPortfolioGroup portfolioGroupsSearch(Object body, String filter) throws ApiException {
        ApiResponse<ResourceListOfPortfolioGroup> localVarResp = portfolioGroupsSearchWithHttpInfo(body, filter);
     ...
     */
    public ApiResponse<ResourceListOfPortfolioGroup> portfolioGroupsSearchWithHttpInfo(Object body, String filter) throws ApiException {
        okhttp3.Call localVarCall = portfolioGroupsSearchValidateBeforeCall(body, filter, null);
     ...
     */
    public okhttp3.Call portfolioGroupsSearchAsync(Object body, String filter, final ApiCallback<ResourceListOfPortfolioGroup> _callback) throws ApiException {

        okhttp3.Call localVarCall = portfolioGroupsSearchValidateBeforeCall(body, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioGroup>(){}.getType();
     ...
     */
    public okhttp3.Call portfoliosSearchCall(Object body, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call portfoliosSearchValidateBeforeCall(Object body, String filter, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling portfoliosSearch(Async)");
        }
        

        okhttp3.Call localVarCall = portfoliosSearchCall(body, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPortfolioSearchResult portfoliosSearch(Object body, String filter) throws ApiException {
        ApiResponse<ResourceListOfPortfolioSearchResult> localVarResp = portfoliosSearchWithHttpInfo(body, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPortfolioSearchResult> portfoliosSearchWithHttpInfo(Object body, String filter) throws ApiException {
        okhttp3.Call localVarCall = portfoliosSearchValidateBeforeCall(body, filter, null);
     ...
     */
    public okhttp3.Call portfoliosSearchAsync(Object body, String filter, final ApiCallback<ResourceListOfPortfolioSearchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = portfoliosSearchValidateBeforeCall(body, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call propertiesSearchCall(Object body, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call propertiesSearchValidateBeforeCall(Object body, String filter, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling propertiesSearch(Async)");
        }
        

        okhttp3.Call localVarCall = propertiesSearchCall(body, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPropertyDefinition propertiesSearch(Object body, String filter) throws ApiException {
        ApiResponse<ResourceListOfPropertyDefinition> localVarResp = propertiesSearchWithHttpInfo(body, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPropertyDefinition> propertiesSearchWithHttpInfo(Object body, String filter) throws ApiException {
        okhttp3.Call localVarCall = propertiesSearchValidateBeforeCall(body, filter, null);
     ...
     */
    public okhttp3.Call propertiesSearchAsync(Object body, String filter, final ApiCallback<ResourceListOfPropertyDefinition> _callback) throws ApiException {

        okhttp3.Call localVarCall = propertiesSearchValidateBeforeCall(body, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
