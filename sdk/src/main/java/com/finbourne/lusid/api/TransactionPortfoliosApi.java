...
public class TransactionPortfoliosApi {
     ...
     * @param scope The scope of the portfolio to retrieve the CashStatement for. (required)
     * @param code The code of the portfolio to retrieve the CashStatement for. Together with the scope this              uniquely identifies the portfolio. (required)
    ...
    /**
     * [EARLY ACCESS] Get CashStatement for the given portfolio. (asynchronously)
     * Get CashStatement for the given portfolio.
     * @param scope The scope of the portfolio to retrieve the CashStatement for. (required)
     * @param code The code of the portfolio to retrieve the CashStatement for. Together with the scope this              uniquely identifies the portfolio. (required)
     * @param fromEffectiveAt The lower bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no lower bound if this is not specified. (required)
