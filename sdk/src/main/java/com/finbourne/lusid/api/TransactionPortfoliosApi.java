...
public class TransactionPortfoliosApi {
    ...
    private okhttp3.Call batchUpsertTransactionsCall(String scope, String code, String successMode, Map<String, TransactionRequest> requestBody, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call batchUpsertTransactionsCall(String scope, String code, String successMode, Map<String, TransactionRequest> requestBody, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call batchUpsertTransactionsValidateBeforeCall(String scope, String code, String successMode, Map<String, TransactionRequest> requestBody, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<BatchUpsertPortfolioTransactionsResponse> batchUpsertTransactionsWithHttpInfo(String scope, String code, String successMode, Map<String, TransactionRequest> requestBody, Boolean preserveProperties, String dataModelScope, String dataModelCode) throws ApiException {
        okhttp3.Call localVarCall = batchUpsertTransactionsValidateBeforeCall(scope, code, successMode, requestBody, preserveProperties, dataModelScope, dataModelCode, null, new ConfigurationOptions());
    ...
    private ApiResponse<BatchUpsertPortfolioTransactionsResponse> batchUpsertTransactionsWithHttpInfo(String scope, String code, String successMode, Map<String, TransactionRequest> requestBody, Boolean preserveProperties, String dataModelScope, String dataModelCode, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = batchUpsertTransactionsValidateBeforeCall(scope, code, successMode, requestBody, preserveProperties, dataModelScope, dataModelCode, null, opts);
        Type localVarReturnType = new TypeToken<BatchUpsertPortfolioTransactionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call batchUpsertTransactionsAsync(String scope, String code, String successMode, Map<String, TransactionRequest> requestBody, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback<BatchUpsertPortfolioTransactionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = batchUpsertTransactionsValidateBeforeCall(scope, code, successMode, requestBody, preserveProperties, dataModelScope, dataModelCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<BatchUpsertPortfolioTransactionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call batchUpsertTransactionsAsync(String scope, String code, String successMode, Map<String, TransactionRequest> requestBody, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback<BatchUpsertPortfolioTransactionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = batchUpsertTransactionsValidateBeforeCall(scope, code, successMode, requestBody, preserveProperties, dataModelScope, dataModelCode, _callback, opts);
        Type localVarReturnType = new TypeToken<BatchUpsertPortfolioTransactionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIbatchUpsertTransactionsRequest {
        ...
        public okhttp3.Call executeAsync(final ApiCallback<BatchUpsertPortfolioTransactionsResponse> _callback) throws ApiException {
            return batchUpsertTransactionsAsync(scope, code, successMode, requestBody, preserveProperties, dataModelScope, dataModelCode, _callback);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<BatchUpsertPortfolioTransactionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            return batchUpsertTransactionsAsync(scope, code, successMode, requestBody, preserveProperties, dataModelScope, dataModelCode, _callback, opts);
        }
    }
    ...
    private okhttp3.Call buildSettlementInstructionsCall(String scope, String code, SettlementInstructionQuery settlementInstructionQuery, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        Object localVarPostBody = settlementInstructionQuery;

        // create path and map variables
        String localVarPath = "/api/transactionportfolios/{scope}/{code}/settlementinstructions/$build"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    private okhttp3.Call buildSettlementInstructionsValidateBeforeCall(String scope, String code, SettlementInstructionQuery settlementInstructionQuery, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling buildSettlementInstructions(Async)");
        }
    ...
    public class APIbuildSettlementInstructionsRequest {
        private final String scope;
        private final String code;
        ...
        /**
         * Build call for buildSettlementInstructions
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The requested settlement instructions from the specified transaction portfolio </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        ...
        /**
         * Execute buildSettlementInstructions request
         * @return VersionedResourceListWithPostBodiesOfSettlementInstructionWithTransactionToSettlementInstructionQuery
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        /**
         * Execute buildSettlementInstructions request. Use any specified configuration options to override any other configuration for this request only.
         * @return VersionedResourceListWithPostBodiesOfSettlementInstructionWithTransactionToSettlementInstructionQuery
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        /**
         * Execute buildSettlementInstructions request with HTTP info returned
         * @return ApiResponse&lt;VersionedResourceListWithPostBodiesOfSettlementInstructionWithTransactionToSettlementInstructionQuery&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        /**
         * Execute buildSettlementInstructions request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;VersionedResourceListWithPostBodiesOfSettlementInstructionWithTransactionToSettlementInstructionQuery&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        /**
         * Execute buildSettlementInstructions request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        /**
         * Execute buildSettlementInstructions request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
     ...
     * @param scope The scope of the transaction portfolio. (required)
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies   the transaction portfolio. (required)
     * @param settlementInstructionQuery The queryParameters which control how the settlement instructions are built and returned. (required)
    ...
    public class APIbuildTransactionsRequest {
         ...
         * @return APIbuildTransactionsRequest
         */
        public APIbuildTransactionsRequest dataModelScope(String dataModelScope) {
            this.dataModelScope = dataModelScope;
            return this;
        }
         ...
         * @return APIbuildTransactionsRequest
         */
        public APIbuildTransactionsRequest dataModelCode(String dataModelCode) {
            this.dataModelCode = dataModelCode;
            return this;
        }
    ...
    private okhttp3.Call deleteVirtualTransactionOverrideCall(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, final ApiCallback _callback) throws ApiException {
        return deleteVirtualTransactionOverrideCall(scope, code, instrumentEventId, portfolioEffectiveAt,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call deleteVirtualTransactionOverrideCall(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteVirtualTransactionOverrideValidateBeforeCall(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling deleteVirtualTransactionOverride(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling deleteVirtualTransactionOverride(Async)");
        }

        // verify the required parameter 'instrumentEventId' is set
        if (instrumentEventId == null) {
            throw new ApiException("Missing the required parameter 'instrumentEventId' when calling deleteVirtualTransactionOverride(Async)");
        }

        return deleteVirtualTransactionOverrideCall(scope, code, instrumentEventId, portfolioEffectiveAt, _callback, opts);

    }


    private ApiResponse<DeletedEntityResponse> deleteVirtualTransactionOverrideWithHttpInfo(String scope, String code, String instrumentEventId, String portfolioEffectiveAt) throws ApiException {
        okhttp3.Call localVarCall = deleteVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, portfolioEffectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<DeletedEntityResponse> deleteVirtualTransactionOverrideWithHttpInfo(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = deleteVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, portfolioEffectiveAt, null, opts);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call deleteVirtualTransactionOverrideAsync(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, portfolioEffectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call deleteVirtualTransactionOverrideAsync(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = deleteVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, portfolioEffectiveAt, _callback, opts);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIdeleteVirtualTransactionOverrideRequest {
        private final String scope;
        private final String code;
        private final String instrumentEventId;
        private String portfolioEffectiveAt;

        private APIdeleteVirtualTransactionOverrideRequest(String scope, String code, String instrumentEventId) {
            this.scope = scope;
            this.code = code;
         ...
         * @return APIdeleteVirtualTransactionOverrideRequest
         */
        public APIdeleteVirtualTransactionOverrideRequest portfolioEffectiveAt(String portfolioEffectiveAt) {
            this.portfolioEffectiveAt = portfolioEffectiveAt;
            return this;
        }

        /**
         * Build call for deleteVirtualTransactionOverride
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The datetime that the override was deleted </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return deleteVirtualTransactionOverrideCall(scope, code, instrumentEventId, portfolioEffectiveAt, _callback);
        }

        /**
         * Execute deleteVirtualTransactionOverride request
         * @return DeletedEntityResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public DeletedEntityResponse execute() throws ApiException {
            ApiResponse<DeletedEntityResponse> localVarResp = deleteVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, portfolioEffectiveAt);
            return localVarResp.getData();
        }

        /**
         * Execute deleteVirtualTransactionOverride request. Use any specified configuration options to override any other configuration for this request only.
         * @return DeletedEntityResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public DeletedEntityResponse execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<DeletedEntityResponse> localVarResp = deleteVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, portfolioEffectiveAt, opts);
            return localVarResp.getData();
        }

        /**
         * Execute deleteVirtualTransactionOverride request with HTTP info returned
         * @return ApiResponse&lt;DeletedEntityResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<DeletedEntityResponse> executeWithHttpInfo() throws ApiException {
            return deleteVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, portfolioEffectiveAt);
        }

        /**
         * Execute deleteVirtualTransactionOverride request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;DeletedEntityResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<DeletedEntityResponse> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return deleteVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, portfolioEffectiveAt, opts);
        }

        /**
         * Execute deleteVirtualTransactionOverride request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            return deleteVirtualTransactionOverrideAsync(scope, code, instrumentEventId, portfolioEffectiveAt, _callback);
        }

        /**
         * Execute deleteVirtualTransactionOverride request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            return deleteVirtualTransactionOverrideAsync(scope, code, instrumentEventId, portfolioEffectiveAt, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the transaction portfolio. (required)
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies the transaction portfolio. (required)
     * @param instrumentEventId The ID of the instrument event whose override should be reverted. (required)
     * @return APIdeleteVirtualTransactionOverrideRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIdeleteVirtualTransactionOverrideRequest deleteVirtualTransactionOverride(String scope, String code, String instrumentEventId) {
        return new APIdeleteVirtualTransactionOverrideRequest(scope, code, instrumentEventId);
    }
    ...
    public class APIgetHoldingContributorsRequest {
         ...
         * @return APIgetHoldingContributorsRequest
         */
        public APIgetHoldingContributorsRequest includeUnsettledMovements(Boolean includeUnsettledMovements) {
    ...
    public class APIgetHoldingsRequest {
         ...
         * @return APIgetHoldingsRequest
         */
        public APIgetHoldingsRequest includeSettlementEventsAfterDays(Integer includeSettlementEventsAfterDays) {
         ...
         * @return APIgetHoldingsRequest
         */
        public APIgetHoldingsRequest timelineScope(String timelineScope) {
            this.timelineScope = timelineScope;
            return this;
        }
         ...
         * @return APIgetHoldingsRequest
         */
        public APIgetHoldingsRequest closedPeriodId(String closedPeriodId) {
            this.closedPeriodId = closedPeriodId;
            return this;
        }
    ...
    private ApiResponse<VersionedResourceListWithWarningsOfPortfolioHolding> getHoldingsWithOrdersWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> propertyKeys, Boolean byTaxlots, String recipeIdScope, String recipeIdCode, Integer includeSettlementEventsAfterDays, Boolean aggregateCashCommitments) throws ApiException {
        okhttp3.Call localVarCall = getHoldingsWithOrdersValidateBeforeCall(scope, code, effectiveAt, asAt, filter, propertyKeys, byTaxlots, recipeIdScope, recipeIdCode, includeSettlementEventsAfterDays, aggregateCashCommitments, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<VersionedResourceListWithWarningsOfPortfolioHolding>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<VersionedResourceListWithWarningsOfPortfolioHolding> getHoldingsWithOrdersWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> propertyKeys, Boolean byTaxlots, String recipeIdScope, String recipeIdCode, Integer includeSettlementEventsAfterDays, Boolean aggregateCashCommitments, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = getHoldingsWithOrdersValidateBeforeCall(scope, code, effectiveAt, asAt, filter, propertyKeys, byTaxlots, recipeIdScope, recipeIdCode, includeSettlementEventsAfterDays, aggregateCashCommitments, null, opts);
        Type localVarReturnType = new TypeToken<VersionedResourceListWithWarningsOfPortfolioHolding>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private okhttp3.Call getHoldingsWithOrdersAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> propertyKeys, Boolean byTaxlots, String recipeIdScope, String recipeIdCode, Integer includeSettlementEventsAfterDays, Boolean aggregateCashCommitments, final ApiCallback<VersionedResourceListWithWarningsOfPortfolioHolding> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getHoldingsWithOrdersValidateBeforeCall(scope, code, effectiveAt, asAt, filter, propertyKeys, byTaxlots, recipeIdScope, recipeIdCode, includeSettlementEventsAfterDays, aggregateCashCommitments, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<VersionedResourceListWithWarningsOfPortfolioHolding>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getHoldingsWithOrdersAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> propertyKeys, Boolean byTaxlots, String recipeIdScope, String recipeIdCode, Integer includeSettlementEventsAfterDays, Boolean aggregateCashCommitments, final ApiCallback<VersionedResourceListWithWarningsOfPortfolioHolding> _callback, ConfigurationOptions opts) throws ApiException {
        ...
        okhttp3.Call localVarCall = getHoldingsWithOrdersValidateBeforeCall(scope, code, effectiveAt, asAt, filter, propertyKeys, byTaxlots, recipeIdScope, recipeIdCode, includeSettlementEventsAfterDays, aggregateCashCommitments, _callback, opts);
        Type localVarReturnType = new TypeToken<VersionedResourceListWithWarningsOfPortfolioHolding>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIgetHoldingsWithOrdersRequest {
         ...
         * @return APIgetHoldingsWithOrdersRequest
         */
        public APIgetHoldingsWithOrdersRequest includeSettlementEventsAfterDays(Integer includeSettlementEventsAfterDays) {
            this.includeSettlementEventsAfterDays = includeSettlementEventsAfterDays;
            return this;
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<VersionedResourceListWithWarningsOfPortfolioHolding> _callback) throws ApiException {
            return getHoldingsWithOrdersAsync(scope, code, effectiveAt, asAt, filter, propertyKeys, byTaxlots, recipeIdScope, recipeIdCode, includeSettlementEventsAfterDays, aggregateCashCommitments, _callback);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<VersionedResourceListWithWarningsOfPortfolioHolding> _callback, ConfigurationOptions opts) throws ApiException {
            return getHoldingsWithOrdersAsync(scope, code, effectiveAt, asAt, filter, propertyKeys, byTaxlots, recipeIdScope, recipeIdCode, includeSettlementEventsAfterDays, aggregateCashCommitments, _callback, opts);
        }
    }
    ...
    public class APIgetMultipleHoldingContributorsRequest {
         ...
         * @return APIgetMultipleHoldingContributorsRequest
         */
        public APIgetMultipleHoldingContributorsRequest includeUnsettledMovements(Boolean includeUnsettledMovements) {
            this.includeUnsettledMovements = includeUnsettledMovements;
            return this;
        }
    ...
    public class APIgetTransactionsRequest {
         ...
         * @return APIgetTransactionsRequest
         */
        public APIgetTransactionsRequest dataModelScope(String dataModelScope) {
            this.dataModelScope = dataModelScope;
            return this;
        }
         ...
         * @return APIgetTransactionsRequest
         */
        public APIgetTransactionsRequest dataModelCode(String dataModelCode) {
            this.dataModelCode = dataModelCode;
            return this;
        }
    ...
    private okhttp3.Call getVirtualTransactionOverrideCall(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getVirtualTransactionOverrideCall(scope, code, instrumentEventId, portfolioEffectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call getVirtualTransactionOverrideCall(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVirtualTransactionOverrideValidateBeforeCall(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getVirtualTransactionOverride(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getVirtualTransactionOverride(Async)");
        }

        // verify the required parameter 'instrumentEventId' is set
        if (instrumentEventId == null) {
            throw new ApiException("Missing the required parameter 'instrumentEventId' when calling getVirtualTransactionOverride(Async)");
        }

        return getVirtualTransactionOverrideCall(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, _callback, opts);

    }


    private ApiResponse<VirtualTransactionOverridesResponse> getVirtualTransactionOverrideWithHttpInfo(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<VirtualTransactionOverridesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<VirtualTransactionOverridesResponse> getVirtualTransactionOverrideWithHttpInfo(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = getVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeToken<VirtualTransactionOverridesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getVirtualTransactionOverrideAsync(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, OffsetDateTime asAt, final ApiCallback<VirtualTransactionOverridesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<VirtualTransactionOverridesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call getVirtualTransactionOverrideAsync(String scope, String code, String instrumentEventId, String portfolioEffectiveAt, OffsetDateTime asAt, final ApiCallback<VirtualTransactionOverridesResponse> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = getVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeToken<VirtualTransactionOverridesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetVirtualTransactionOverrideRequest {
        private final String scope;
        private final String code;
        private final String instrumentEventId;
        private String portfolioEffectiveAt;
        ...
        private APIgetVirtualTransactionOverrideRequest(String scope, String code, String instrumentEventId) {
            this.scope = scope;
            this.code = code;
            this.instrumentEventId = instrumentEventId;
        }
         ...
         * Set portfolioEffectiveAt
         * @param portfolioEffectiveAt The effective datetime used to resolve the portfolio. Defaults to the current LUSID system datetime if not specified. (optional)
         * @return APIgetVirtualTransactionOverrideRequest
         */
        public APIgetVirtualTransactionOverrideRequest portfolioEffectiveAt(String portfolioEffectiveAt) {
            this.portfolioEffectiveAt = portfolioEffectiveAt;
            return this;
        }
        ...
        /**
         * Set asAt
         * @param asAt The asAt datetime at which to retrieve the overrides and suppressions. Defaults to returning the latest version if not specified. (optional)
         * @return APIgetVirtualTransactionOverrideRequest
         */
        public APIgetVirtualTransactionOverrideRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }

        /**
         * Build call for getVirtualTransactionOverride
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The overrides and suppressions affecting this portfolio for the requested instrument event </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return getVirtualTransactionOverrideCall(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, _callback);
        }

        /**
         * Execute getVirtualTransactionOverride request
         * @return VirtualTransactionOverridesResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public VirtualTransactionOverridesResponse execute() throws ApiException {
            ApiResponse<VirtualTransactionOverridesResponse> localVarResp = getVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, portfolioEffectiveAt, asAt);
            return localVarResp.getData();
        }

        /**
         * Execute getVirtualTransactionOverride request. Use any specified configuration options to override any other configuration for this request only.
         * @return VirtualTransactionOverridesResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public VirtualTransactionOverridesResponse execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<VirtualTransactionOverridesResponse> localVarResp = getVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, opts);
            return localVarResp.getData();
        }

        /**
         * Execute getVirtualTransactionOverride request with HTTP info returned
         * @return ApiResponse&lt;VirtualTransactionOverridesResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<VirtualTransactionOverridesResponse> executeWithHttpInfo() throws ApiException {
            return getVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, portfolioEffectiveAt, asAt);
        }

        /**
         * Execute getVirtualTransactionOverride request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;VirtualTransactionOverridesResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<VirtualTransactionOverridesResponse> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return getVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, opts);
        }

        /**
         * Execute getVirtualTransactionOverride request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<VirtualTransactionOverridesResponse> _callback) throws ApiException {
            return getVirtualTransactionOverrideAsync(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, _callback);
        }

        /**
         * Execute getVirtualTransactionOverride request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<VirtualTransactionOverridesResponse> _callback, ConfigurationOptions opts) throws ApiException {
            return getVirtualTransactionOverrideAsync(scope, code, instrumentEventId, portfolioEffectiveAt, asAt, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the transaction portfolio. (required)
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies the transaction portfolio. (required)
     * @param instrumentEventId The ID of the instrument event whose overrides and suppressions should be returned. (required)
     * @return APIgetVirtualTransactionOverrideRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIgetVirtualTransactionOverrideRequest getVirtualTransactionOverride(String scope, String code, String instrumentEventId) {
        return new APIgetVirtualTransactionOverrideRequest(scope, code, instrumentEventId);
    }
    ...
    private okhttp3.Call listSettlementInstructionsCall(String scope, String code, String fromDate, String toDate, String page, Integer limit, String filter, OffsetDateTime asAt, List<String> propertyKeys, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback) throws ApiException {
        return listSettlementInstructionsCall(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId,  _callback, new ConfigurationOptions());
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listSettlementInstructionsValidateBeforeCall(String scope, String code, String fromDate, String toDate, String page, Integer limit, String filter, OffsetDateTime asAt, List<String> propertyKeys, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
        ...
        return listSettlementInstructionsCall(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, _callback, opts);

    }


    private ApiResponse<VersionedResourceListOfTransactionSettlementInstruction> listSettlementInstructionsWithHttpInfo(String scope, String code, String fromDate, String toDate, String page, Integer limit, String filter, OffsetDateTime asAt, List<String> propertyKeys, String timelineScope, String timelineCode, String closedPeriodId) throws ApiException {
        okhttp3.Call localVarCall = listSettlementInstructionsValidateBeforeCall(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<VersionedResourceListOfTransactionSettlementInstruction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<VersionedResourceListOfTransactionSettlementInstruction> listSettlementInstructionsWithHttpInfo(String scope, String code, String fromDate, String toDate, String page, Integer limit, String filter, OffsetDateTime asAt, List<String> propertyKeys, String timelineScope, String timelineCode, String closedPeriodId, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = listSettlementInstructionsValidateBeforeCall(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, null, opts);
        Type localVarReturnType = new TypeToken<VersionedResourceListOfTransactionSettlementInstruction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listSettlementInstructionsAsync(String scope, String code, String fromDate, String toDate, String page, Integer limit, String filter, OffsetDateTime asAt, List<String> propertyKeys, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<VersionedResourceListOfTransactionSettlementInstruction> _callback) throws ApiException {

        okhttp3.Call localVarCall = listSettlementInstructionsValidateBeforeCall(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<VersionedResourceListOfTransactionSettlementInstruction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call listSettlementInstructionsAsync(String scope, String code, String fromDate, String toDate, String page, Integer limit, String filter, OffsetDateTime asAt, List<String> propertyKeys, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<VersionedResourceListOfTransactionSettlementInstruction> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = listSettlementInstructionsValidateBeforeCall(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        Type localVarReturnType = new TypeToken<VersionedResourceListOfTransactionSettlementInstruction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIlistSettlementInstructionsRequest {
         ...
         * @return APIlistSettlementInstructionsRequest
         */
        public APIlistSettlementInstructionsRequest timelineScope(String timelineScope) {
            this.timelineScope = timelineScope;
            return this;
        }
         ...
         * @return APIlistSettlementInstructionsRequest
         */
        public APIlistSettlementInstructionsRequest timelineCode(String timelineCode) {
            this.timelineCode = timelineCode;
            return this;
        }
         ...
         * @return APIlistSettlementInstructionsRequest
         */
        public APIlistSettlementInstructionsRequest closedPeriodId(String closedPeriodId) {
            this.closedPeriodId = closedPeriodId;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return listSettlementInstructionsCall(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, _callback);
        }
        ...
        public VersionedResourceListOfTransactionSettlementInstruction execute() throws ApiException {
            ApiResponse<VersionedResourceListOfTransactionSettlementInstruction> localVarResp = listSettlementInstructionsWithHttpInfo(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId);
            return localVarResp.getData();
        }
        ...
        public VersionedResourceListOfTransactionSettlementInstruction execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<VersionedResourceListOfTransactionSettlementInstruction> localVarResp = listSettlementInstructionsWithHttpInfo(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, opts);
            return localVarResp.getData();
        }
        ...
        public ApiResponse<VersionedResourceListOfTransactionSettlementInstruction> executeWithHttpInfo() throws ApiException {
            return listSettlementInstructionsWithHttpInfo(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId);
        }
        ...
        public ApiResponse<VersionedResourceListOfTransactionSettlementInstruction> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return listSettlementInstructionsWithHttpInfo(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, opts);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<VersionedResourceListOfTransactionSettlementInstruction> _callback) throws ApiException {
            return listSettlementInstructionsAsync(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, _callback);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<VersionedResourceListOfTransactionSettlementInstruction> _callback, ConfigurationOptions opts) throws ApiException {
            return listSettlementInstructionsAsync(scope, code, fromDate, toDate, page, limit, filter, asAt, propertyKeys, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        }
    }
    ...
    private okhttp3.Call listVirtualTransactionOverridesCall(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, List<String> overrideMatchStatus, List<String> overrideApplicationStatus, final ApiCallback _callback) throws ApiException {
        return listVirtualTransactionOverridesCall(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call listVirtualTransactionOverridesCall(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, List<String> overrideMatchStatus, List<String> overrideApplicationStatus, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/transactionportfolios/{scope}/{code}/overridevirtualtransactions/$list"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
        ...
        if (overrideMatchStatus != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "overrideMatchStatus", overrideMatchStatus));
        }

        if (overrideApplicationStatus != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "overrideApplicationStatus", overrideApplicationStatus));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listVirtualTransactionOverridesValidateBeforeCall(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, List<String> overrideMatchStatus, List<String> overrideApplicationStatus, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling listVirtualTransactionOverrides(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling listVirtualTransactionOverrides(Async)");
        }

        return listVirtualTransactionOverridesCall(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, _callback, opts);

    }


    private ApiResponse<ResourceListOfVirtualTransactionOverrideRecord> listVirtualTransactionOverridesWithHttpInfo(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, List<String> overrideMatchStatus, List<String> overrideApplicationStatus) throws ApiException {
        okhttp3.Call localVarCall = listVirtualTransactionOverridesValidateBeforeCall(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ResourceListOfVirtualTransactionOverrideRecord>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<ResourceListOfVirtualTransactionOverrideRecord> listVirtualTransactionOverridesWithHttpInfo(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, List<String> overrideMatchStatus, List<String> overrideApplicationStatus, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = listVirtualTransactionOverridesValidateBeforeCall(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, null, opts);
        Type localVarReturnType = new TypeToken<ResourceListOfVirtualTransactionOverrideRecord>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listVirtualTransactionOverridesAsync(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, List<String> overrideMatchStatus, List<String> overrideApplicationStatus, final ApiCallback<ResourceListOfVirtualTransactionOverrideRecord> _callback) throws ApiException {

        okhttp3.Call localVarCall = listVirtualTransactionOverridesValidateBeforeCall(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ResourceListOfVirtualTransactionOverrideRecord>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call listVirtualTransactionOverridesAsync(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, List<String> overrideMatchStatus, List<String> overrideApplicationStatus, final ApiCallback<ResourceListOfVirtualTransactionOverrideRecord> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = listVirtualTransactionOverridesValidateBeforeCall(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, _callback, opts);
        Type localVarReturnType = new TypeToken<ResourceListOfVirtualTransactionOverrideRecord>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIlistVirtualTransactionOverridesRequest {
        private final String scope;
        private final String code;
        private String portfolioEffectiveAt;
        private OffsetDateTime asAt;
        private List<String> overrideMatchStatus;
        private List<String> overrideApplicationStatus;

        private APIlistVirtualTransactionOverridesRequest(String scope, String code) {
            this.scope = scope;
            this.code = code;
        }
         ...
         * Set portfolioEffectiveAt
         * @param portfolioEffectiveAt The effective datetime used to resolve the portfolio. Defaults to the current LUSID system datetime if not specified. (optional)
         * @return APIlistVirtualTransactionOverridesRequest
         */
        public APIlistVirtualTransactionOverridesRequest portfolioEffectiveAt(String portfolioEffectiveAt) {
            this.portfolioEffectiveAt = portfolioEffectiveAt;
            return this;
        }
         ...
         * @return APIlistVirtualTransactionOverridesRequest
         */
        public APIlistVirtualTransactionOverridesRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }

        /**
         * Set overrideMatchStatus
         * @param overrideMatchStatus Restrict the records returned to those with one of these match statuses. May be specified more than once. Available values: Matched, Orphaned. (optional)
         * @return APIlistVirtualTransactionOverridesRequest
         */
        public APIlistVirtualTransactionOverridesRequest overrideMatchStatus(List<String> overrideMatchStatus) {
            this.overrideMatchStatus = overrideMatchStatus;
            return this;
        }

        /**
         * Set overrideApplicationStatus
         * @param overrideApplicationStatus Restrict the records returned to those with one of these application statuses. May be specified more than once. Available values: Full, Partial, Orphaned. (optional)
         * @return APIlistVirtualTransactionOverridesRequest
         */
        public APIlistVirtualTransactionOverridesRequest overrideApplicationStatus(List<String> overrideApplicationStatus) {
            this.overrideApplicationStatus = overrideApplicationStatus;
            return this;
        }

        /**
         * Build call for listVirtualTransactionOverrides
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The override and suppression records affecting this portfolio </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return listVirtualTransactionOverridesCall(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, _callback);
        }

        /**
         * Execute listVirtualTransactionOverrides request
         * @return ResourceListOfVirtualTransactionOverrideRecord
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ResourceListOfVirtualTransactionOverrideRecord execute() throws ApiException {
            ApiResponse<ResourceListOfVirtualTransactionOverrideRecord> localVarResp = listVirtualTransactionOverridesWithHttpInfo(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus);
            return localVarResp.getData();
        }

        /**
         * Execute listVirtualTransactionOverrides request. Use any specified configuration options to override any other configuration for this request only.
         * @return ResourceListOfVirtualTransactionOverrideRecord
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ResourceListOfVirtualTransactionOverrideRecord execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ResourceListOfVirtualTransactionOverrideRecord> localVarResp = listVirtualTransactionOverridesWithHttpInfo(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, opts);
            return localVarResp.getData();
        }

        /**
         * Execute listVirtualTransactionOverrides request with HTTP info returned
         * @return ApiResponse&lt;ResourceListOfVirtualTransactionOverrideRecord&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ResourceListOfVirtualTransactionOverrideRecord> executeWithHttpInfo() throws ApiException {
            return listVirtualTransactionOverridesWithHttpInfo(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus);
        }

        /**
         * Execute listVirtualTransactionOverrides request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ResourceListOfVirtualTransactionOverrideRecord&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ResourceListOfVirtualTransactionOverrideRecord> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return listVirtualTransactionOverridesWithHttpInfo(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, opts);
        }

        /**
         * Execute listVirtualTransactionOverrides request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ResourceListOfVirtualTransactionOverrideRecord> _callback) throws ApiException {
            return listVirtualTransactionOverridesAsync(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, _callback);
        }

        /**
         * Execute listVirtualTransactionOverrides request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ResourceListOfVirtualTransactionOverrideRecord> _callback, ConfigurationOptions opts) throws ApiException {
            return listVirtualTransactionOverridesAsync(scope, code, portfolioEffectiveAt, asAt, overrideMatchStatus, overrideApplicationStatus, _callback, opts);
        }
    }
     ...
     */
    public APIlistVirtualTransactionOverridesRequest listVirtualTransactionOverrides(String scope, String code) {
        return new APIlistVirtualTransactionOverridesRequest(scope, code);
    }
    ...
    private okhttp3.Call previewTransactionCall(String scope, String code, TransactionRequest transactionRequest, List<String> propertyKeys, Boolean showCancelledTransactions, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback) throws ApiException {
        return previewTransactionCall(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call previewTransactionCall(String scope, String code, TransactionRequest transactionRequest, List<String> propertyKeys, Boolean showCancelledTransactions, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call previewTransactionValidateBeforeCall(String scope, String code, TransactionRequest transactionRequest, List<String> propertyKeys, Boolean showCancelledTransactions, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
        ...
        return previewTransactionCall(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, _callback, opts);

    }


    private ApiResponse<ResourceListOfOutputTransaction> previewTransactionWithHttpInfo(String scope, String code, TransactionRequest transactionRequest, List<String> propertyKeys, Boolean showCancelledTransactions, Boolean preserveProperties, String dataModelScope, String dataModelCode) throws ApiException {
        okhttp3.Call localVarCall = previewTransactionValidateBeforeCall(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ResourceListOfOutputTransaction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<ResourceListOfOutputTransaction> previewTransactionWithHttpInfo(String scope, String code, TransactionRequest transactionRequest, List<String> propertyKeys, Boolean showCancelledTransactions, Boolean preserveProperties, String dataModelScope, String dataModelCode, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = previewTransactionValidateBeforeCall(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, null, opts);
        Type localVarReturnType = new TypeToken<ResourceListOfOutputTransaction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call previewTransactionAsync(String scope, String code, TransactionRequest transactionRequest, List<String> propertyKeys, Boolean showCancelledTransactions, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback<ResourceListOfOutputTransaction> _callback) throws ApiException {

        okhttp3.Call localVarCall = previewTransactionValidateBeforeCall(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<ResourceListOfOutputTransaction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call previewTransactionAsync(String scope, String code, TransactionRequest transactionRequest, List<String> propertyKeys, Boolean showCancelledTransactions, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback<ResourceListOfOutputTransaction> _callback, ConfigurationOptions opts) throws ApiException {
        ...
        okhttp3.Call localVarCall = previewTransactionValidateBeforeCall(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, _callback, opts);
        Type localVarReturnType = new TypeToken<ResourceListOfOutputTransaction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIpreviewTransactionRequest {
         ...
         * @return APIpreviewTransactionRequest
         */
        public APIpreviewTransactionRequest dataModelScope(String dataModelScope) {
            this.dataModelScope = dataModelScope;
            return this;
        }
         ...
         * @return APIpreviewTransactionRequest
         */
        public APIpreviewTransactionRequest dataModelCode(String dataModelCode) {
            this.dataModelCode = dataModelCode;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return previewTransactionCall(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, _callback);
        }
        ...
        public ResourceListOfOutputTransaction execute() throws ApiException {
            ApiResponse<ResourceListOfOutputTransaction> localVarResp = previewTransactionWithHttpInfo(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode);
            return localVarResp.getData();
        }
        ...
        public ResourceListOfOutputTransaction execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ResourceListOfOutputTransaction> localVarResp = previewTransactionWithHttpInfo(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, opts);
            return localVarResp.getData();
        }
        ...
        public ApiResponse<ResourceListOfOutputTransaction> executeWithHttpInfo() throws ApiException {
            return previewTransactionWithHttpInfo(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode);
        }
        ...
        public ApiResponse<ResourceListOfOutputTransaction> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return previewTransactionWithHttpInfo(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, opts);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ResourceListOfOutputTransaction> _callback) throws ApiException {
            return previewTransactionAsync(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, _callback);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ResourceListOfOutputTransaction> _callback, ConfigurationOptions opts) throws ApiException {
            return previewTransactionAsync(scope, code, transactionRequest, propertyKeys, showCancelledTransactions, preserveProperties, dataModelScope, dataModelCode, _callback, opts);
        }
    }
    ...
    private okhttp3.Call upsertTransactionsCall(String scope, String code, List<TransactionRequest> transactionRequest, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback) throws ApiException {
        return upsertTransactionsCall(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call upsertTransactionsCall(String scope, String code, List<TransactionRequest> transactionRequest, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertTransactionsValidateBeforeCall(String scope, String code, List<TransactionRequest> transactionRequest, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
        ...
        return upsertTransactionsCall(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, _callback, opts);

    }


    private ApiResponse<UpsertPortfolioTransactionsResponse> upsertTransactionsWithHttpInfo(String scope, String code, List<TransactionRequest> transactionRequest, Boolean preserveProperties, String dataModelScope, String dataModelCode) throws ApiException {
        okhttp3.Call localVarCall = upsertTransactionsValidateBeforeCall(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<UpsertPortfolioTransactionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<UpsertPortfolioTransactionsResponse> upsertTransactionsWithHttpInfo(String scope, String code, List<TransactionRequest> transactionRequest, Boolean preserveProperties, String dataModelScope, String dataModelCode, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = upsertTransactionsValidateBeforeCall(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, null, opts);
        Type localVarReturnType = new TypeToken<UpsertPortfolioTransactionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call upsertTransactionsAsync(String scope, String code, List<TransactionRequest> transactionRequest, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback<UpsertPortfolioTransactionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertTransactionsValidateBeforeCall(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<UpsertPortfolioTransactionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call upsertTransactionsAsync(String scope, String code, List<TransactionRequest> transactionRequest, Boolean preserveProperties, String dataModelScope, String dataModelCode, final ApiCallback<UpsertPortfolioTransactionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = upsertTransactionsValidateBeforeCall(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, _callback, opts);
        Type localVarReturnType = new TypeToken<UpsertPortfolioTransactionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIupsertTransactionsRequest {
         ...
         * @return APIupsertTransactionsRequest
         */
        public APIupsertTransactionsRequest dataModelScope(String dataModelScope) {
            this.dataModelScope = dataModelScope;
            return this;
        }
         ...
         * @return APIupsertTransactionsRequest
         */
        public APIupsertTransactionsRequest dataModelCode(String dataModelCode) {
            this.dataModelCode = dataModelCode;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return upsertTransactionsCall(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, _callback);
        }
         ...
         */
        public UpsertPortfolioTransactionsResponse execute() throws ApiException {
            ApiResponse<UpsertPortfolioTransactionsResponse> localVarResp = upsertTransactionsWithHttpInfo(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode);
            return localVarResp.getData();
        }
         ...
         */
        public UpsertPortfolioTransactionsResponse execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<UpsertPortfolioTransactionsResponse> localVarResp = upsertTransactionsWithHttpInfo(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, opts);
            return localVarResp.getData();
        }
         ...
         */
        public ApiResponse<UpsertPortfolioTransactionsResponse> executeWithHttpInfo() throws ApiException {
            return upsertTransactionsWithHttpInfo(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode);
        }
         ...
         */
        public ApiResponse<UpsertPortfolioTransactionsResponse> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return upsertTransactionsWithHttpInfo(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, opts);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<UpsertPortfolioTransactionsResponse> _callback) throws ApiException {
            return upsertTransactionsAsync(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, _callback);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<UpsertPortfolioTransactionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            return upsertTransactionsAsync(scope, code, transactionRequest, preserveProperties, dataModelScope, dataModelCode, _callback, opts);
        }
    }
    ...
    private okhttp3.Call upsertVirtualTransactionOverrideCall(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest, String portfolioEffectiveAt, Boolean preserveProperties, final ApiCallback _callback) throws ApiException {
        return upsertVirtualTransactionOverrideCall(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties,  _callback, new ConfigurationOptions());
    }

    private okhttp3.Call upsertVirtualTransactionOverrideCall(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest, String portfolioEffectiveAt, Boolean preserveProperties, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = overrideVirtualTransactionsRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertVirtualTransactionOverrideValidateBeforeCall(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest, String portfolioEffectiveAt, Boolean preserveProperties, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling upsertVirtualTransactionOverride(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling upsertVirtualTransactionOverride(Async)");
        }

        // verify the required parameter 'instrumentEventId' is set
        if (instrumentEventId == null) {
            throw new ApiException("Missing the required parameter 'instrumentEventId' when calling upsertVirtualTransactionOverride(Async)");
        }

        // verify the required parameter 'overrideVirtualTransactionsRequest' is set
        if (overrideVirtualTransactionsRequest == null) {
            throw new ApiException("Missing the required parameter 'overrideVirtualTransactionsRequest' when calling upsertVirtualTransactionOverride(Async)");
        }

        return upsertVirtualTransactionOverrideCall(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, _callback, opts);

    }


    private ApiResponse<UpsertVirtualTransactionOverrideResponse> upsertVirtualTransactionOverrideWithHttpInfo(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest, String portfolioEffectiveAt, Boolean preserveProperties) throws ApiException {
        okhttp3.Call localVarCall = upsertVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<UpsertVirtualTransactionOverrideResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private ApiResponse<UpsertVirtualTransactionOverrideResponse> upsertVirtualTransactionOverrideWithHttpInfo(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest, String portfolioEffectiveAt, Boolean preserveProperties, ConfigurationOptions opts) throws ApiException {
        okhttp3.Call localVarCall = upsertVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, null, opts);
        Type localVarReturnType = new TypeToken<UpsertVirtualTransactionOverrideResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call upsertVirtualTransactionOverrideAsync(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest, String portfolioEffectiveAt, Boolean preserveProperties, final ApiCallback<UpsertVirtualTransactionOverrideResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeToken<UpsertVirtualTransactionOverrideResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    private okhttp3.Call upsertVirtualTransactionOverrideAsync(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest, String portfolioEffectiveAt, Boolean preserveProperties, final ApiCallback<UpsertVirtualTransactionOverrideResponse> _callback, ConfigurationOptions opts) throws ApiException {

        okhttp3.Call localVarCall = upsertVirtualTransactionOverrideValidateBeforeCall(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, _callback, opts);
        Type localVarReturnType = new TypeToken<UpsertVirtualTransactionOverrideResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIupsertVirtualTransactionOverrideRequest {
        private final String scope;
        private final String code;
        private final String instrumentEventId;
        private final OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest;
        private String portfolioEffectiveAt;
        private Boolean preserveProperties;

        private APIupsertVirtualTransactionOverrideRequest(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest) {
            this.scope = scope;
            this.code = code;
            this.instrumentEventId = instrumentEventId;
            this.overrideVirtualTransactionsRequest = overrideVirtualTransactionsRequest;
        }

        /**
         * Set portfolioEffectiveAt
         * @param portfolioEffectiveAt The effective datetime used to resolve the portfolio. Defaults to the current LUSID system datetime if not specified. (optional)
         * @return APIupsertVirtualTransactionOverrideRequest
         */
        public APIupsertVirtualTransactionOverrideRequest portfolioEffectiveAt(String portfolioEffectiveAt) {
            this.portfolioEffectiveAt = portfolioEffectiveAt;
            return this;
        }
        ...
        /**
         * Set preserveProperties
         * @param preserveProperties If set to false, the entire property set of an updated override entry will be overwritten by the provided properties. If not specified or set to true, only the properties provided will be updated. (optional, default to true)
         * @return APIupsertVirtualTransactionOverrideRequest
         */
        public APIupsertVirtualTransactionOverrideRequest preserveProperties(Boolean preserveProperties) {
            this.preserveProperties = preserveProperties;
            return this;
        }

        /**
         * Build call for upsertVirtualTransactionOverride
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The result of the upsert including the persisted overrides, suppressions, and instrument event details </td><td>  -  </td></tr>
            <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
            <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return upsertVirtualTransactionOverrideCall(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, _callback);
        }

        /**
         * Execute upsertVirtualTransactionOverride request
         * @return UpsertVirtualTransactionOverrideResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public UpsertVirtualTransactionOverrideResponse execute() throws ApiException {
            ApiResponse<UpsertVirtualTransactionOverrideResponse> localVarResp = upsertVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties);
            return localVarResp.getData();
        }

        /**
         * Execute upsertVirtualTransactionOverride request. Use any specified configuration options to override any other configuration for this request only.
         * @return UpsertVirtualTransactionOverrideResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public UpsertVirtualTransactionOverrideResponse execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<UpsertVirtualTransactionOverrideResponse> localVarResp = upsertVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, opts);
            return localVarResp.getData();
        }

        /**
         * Execute upsertVirtualTransactionOverride request with HTTP info returned
         * @return ApiResponse&lt;UpsertVirtualTransactionOverrideResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<UpsertVirtualTransactionOverrideResponse> executeWithHttpInfo() throws ApiException {
            return upsertVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties);
        }

        /**
         * Execute upsertVirtualTransactionOverride request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;UpsertVirtualTransactionOverrideResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<UpsertVirtualTransactionOverrideResponse> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return upsertVirtualTransactionOverrideWithHttpInfo(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, opts);
        }

        /**
         * Execute upsertVirtualTransactionOverride request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<UpsertVirtualTransactionOverrideResponse> _callback) throws ApiException {
            return upsertVirtualTransactionOverrideAsync(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, _callback);
        }

        /**
         * Execute upsertVirtualTransactionOverride request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<UpsertVirtualTransactionOverrideResponse> _callback, ConfigurationOptions opts) throws ApiException {
            return upsertVirtualTransactionOverrideAsync(scope, code, instrumentEventId, overrideVirtualTransactionsRequest, portfolioEffectiveAt, preserveProperties, _callback, opts);
        }
    }
     ...
     * @param scope The scope of the transaction portfolio. (required)
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies   the transaction portfolio. (required)
     * @param instrumentEventId The ID of the instrument event whose virtual transactions should be overridden or suppressed. (required)
     * @param overrideVirtualTransactionsRequest The overrides and suppressions to upsert, keyed by the virtual transaction id being overridden or suppressed. (required)
     * @return APIupsertVirtualTransactionOverrideRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIupsertVirtualTransactionOverrideRequest upsertVirtualTransactionOverride(String scope, String code, String instrumentEventId, OverrideVirtualTransactionsRequest overrideVirtualTransactionsRequest) {
        return new APIupsertVirtualTransactionOverrideRequest(scope, code, instrumentEventId, overrideVirtualTransactionsRequest);
    }
}
