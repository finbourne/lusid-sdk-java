...
public class LoginApi {
     ...
     */
    public LusidProblemDetails getSamlIdentityProviderId(String domain) throws ApiException {
        ApiResponse<LusidProblemDetails> resp = getSamlIdentityProviderIdWithHttpInfo(domain);
        return resp.getData();
    }
     ...
     * Get the unique identifier for the SAML 2.0 Identity Provider to be used for domain.
     * @param domain The domain that the user will be logging in to (required)
     * @return ApiResponse&lt;LusidProblemDetails&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LusidProblemDetails> getSamlIdentityProviderIdWithHttpInfo(String domain) throws ApiException {
        com.squareup.okhttp.Call call = getSamlIdentityProviderIdValidateBeforeCall(domain, null, null);
        Type localVarReturnType = new TypeToken<LusidProblemDetails>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getSamlIdentityProviderIdAsync(String domain, final ApiCallback<LusidProblemDetails> callback) throws ApiException {
