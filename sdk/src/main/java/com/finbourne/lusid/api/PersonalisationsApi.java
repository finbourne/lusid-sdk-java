...
public class PersonalisationsApi {
    private ApiClient apiClient;

    public PersonalisationsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PersonalisationsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for deletePersonalisation
     * @param key The key of the setting to be deleted (optional)
     * @param scope The scope to delete at (use ALL to purge the setting entirely) (optional)
     * @param group Optional. If deleting a setting at group level, specify the group here (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deletePersonalisationCall(String key, String scope, String group, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/personalisations";
    ...
    private com.squareup.okhttp.Call deletePersonalisationValidateBeforeCall(String key, String scope, String group, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = deletePersonalisationCall(key, scope, group, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DeletedEntityResponse deletePersonalisation(String key, String scope, String group) throws ApiException {
        ApiResponse<DeletedEntityResponse> resp = deletePersonalisationWithHttpInfo(key, scope, group);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeletedEntityResponse> deletePersonalisationWithHttpInfo(String key, String scope, String group) throws ApiException {
        com.squareup.okhttp.Call call = deletePersonalisationValidateBeforeCall(key, scope, group, null, null);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Delete a personalisation (asynchronously)
     * Delete a personalisation at a specific scope (or use scope ALL to purge the setting entirely)
     * @param key The key of the setting to be deleted (optional)
     * @param scope The scope to delete at (use ALL to purge the setting entirely) (optional)
     * @param group Optional. If deleting a setting at group level, specify the group here (optional)
     ...
     */
    public com.squareup.okhttp.Call deletePersonalisationAsync(String key, String scope, String group, final ApiCallback<DeletedEntityResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deletePersonalisationValidateBeforeCall(key, scope, group, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getPersonalisations
     * @param pattern The search pattern or specific key (optional)
     * @param scope Optional. The scope level to request for (optional)
     * @param recursive Optional. Whether to recurse into dereference recursive settings (optional, default to false)
     * @param wildcards Optional. Whether to apply wildcards to the provided pattern and pull back any matching (optional, default to false)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPersonalisationsCall(String pattern, String scope, Boolean recursive, Boolean wildcards, List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (wildcards != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("wildcards", wildcards));
        if (sortBy != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPersonalisationsValidateBeforeCall(String pattern, String scope, Boolean recursive, Boolean wildcards, List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getPersonalisationsCall(pattern, scope, recursive, wildcards, sortBy, start, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @return ResourceListOfPersonalisation
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfPersonalisation getPersonalisations(String pattern, String scope, Boolean recursive, Boolean wildcards, List<String> sortBy, Integer start, Integer limit) throws ApiException {
        ApiResponse<ResourceListOfPersonalisation> resp = getPersonalisationsWithHttpInfo(pattern, scope, recursive, wildcards, sortBy, start, limit);
        return resp.getData();
    }
     ...
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @return ApiResponse&lt;ResourceListOfPersonalisation&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfPersonalisation> getPersonalisationsWithHttpInfo(String pattern, String scope, Boolean recursive, Boolean wildcards, List<String> sortBy, Integer start, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getPersonalisationsValidateBeforeCall(pattern, scope, recursive, wildcards, sortBy, start, limit, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPersonalisation>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get personalisation (asynchronously)
     * Get a personalisation, recursing to get any referenced if required.
     * @param pattern The search pattern or specific key (optional)
     * @param scope Optional. The scope level to request for (optional)
     * @param recursive Optional. Whether to recurse into dereference recursive settings (optional, default to false)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPersonalisationsAsync(String pattern, String scope, Boolean recursive, Boolean wildcards, List<String> sortBy, Integer start, Integer limit, final ApiCallback<ResourceListOfPersonalisation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPersonalisationsValidateBeforeCall(pattern, scope, recursive, wildcards, sortBy, start, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPersonalisation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for upsertPersonalisations
     * @param personalisations The set of personalisations to persist (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertPersonalisationsCall(List<Personalisation> personalisations, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = personalisations;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call upsertPersonalisationsValidateBeforeCall(List<Personalisation> personalisations, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = upsertPersonalisationsCall(personalisations, progressListener, progressRequestListener);
        return call;
     ...
     * @param personalisations The set of personalisations to persist (optional)
     * @return UpsertPersonalisationResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UpsertPersonalisationResponse upsertPersonalisations(List<Personalisation> personalisations) throws ApiException {
        ApiResponse<UpsertPersonalisationResponse> resp = upsertPersonalisationsWithHttpInfo(personalisations);
        return resp.getData();
    }
     ...
     * Upsert one or more personalisations
     * @param personalisations The set of personalisations to persist (optional)
     * @return ApiResponse&lt;UpsertPersonalisationResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UpsertPersonalisationResponse> upsertPersonalisationsWithHttpInfo(List<Personalisation> personalisations) throws ApiException {
        com.squareup.okhttp.Call call = upsertPersonalisationsValidateBeforeCall(personalisations, null, null);
        Type localVarReturnType = new TypeToken<UpsertPersonalisationResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Upsert personalisations (asynchronously)
     * Upsert one or more personalisations
     * @param personalisations The set of personalisations to persist (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertPersonalisationsAsync(List<Personalisation> personalisations, final ApiCallback<UpsertPersonalisationResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertPersonalisationsValidateBeforeCall(personalisations, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpsertPersonalisationResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
