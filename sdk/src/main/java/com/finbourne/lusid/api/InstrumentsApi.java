...
public class InstrumentsApi {
     ...
     * @param identifierType The identifier type of the instrument, e.g., \&quot;Figi\&quot; (required)
     * @param identifier The value of the identifier for the requested instrument. (required)
     * @param propertyKey The property key of the property that will have its history shown. These must be in the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;.              Each property must be from the \&quot;Instrument\&quot; domain. (optional)
     * @param identifierEffectiveAt The effective datetime used to resolve the instrument from the provided identifier. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the instrument&#39;s property history. Defaults to return the current datetime if not supplied. (optional)
    ...
    /**
     * [EARLY ACCESS] Get the time series of an instrument property (asynchronously)
     * List the complete time series of an instrument property.
     * @param identifierType The identifier type of the instrument, e.g., \&quot;Figi\&quot; (required)
     * @param identifier The value of the identifier for the requested instrument. (required)
     * @param propertyKey The property key of the property that will have its history shown. These must be in the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;.              Each property must be from the \&quot;Instrument\&quot; domain. (optional)
     ...
     * @param identifierType The identifier being supplied e.g. \&quot;Figi\&quot;. (required)
     * @param requestBody The values of the identifier for the requested instruments. (required)
     ...
     * @param updateInstrumentIdentifierRequest The identifier to update or remove. This may or may not be the same identifier used              to resolve the instrument. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param requestBody The definitions of the instruments to update or insert. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param upsertInstrumentPropertyRequest A collection of instruments and associated instrument properties to update or insert. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
