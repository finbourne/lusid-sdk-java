...
public class InstrumentsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listInstrumentsCall(OffsetDateTime asAt, OffsetDateTime effectiveAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call listInstrumentsValidateBeforeCall(OffsetDateTime asAt, OffsetDateTime effectiveAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listInstrumentsCall(asAt, effectiveAt, sortBy, start, limit, filter, instrumentPropertyKeys, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfInstrument listInstruments(OffsetDateTime asAt, OffsetDateTime effectiveAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<ResourceListOfInstrument> resp = listInstrumentsWithHttpInfo(asAt, effectiveAt, sortBy, start, limit, filter, instrumentPropertyKeys);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfInstrument> listInstrumentsWithHttpInfo(OffsetDateTime asAt, OffsetDateTime effectiveAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = listInstrumentsValidateBeforeCall(asAt, effectiveAt, sortBy, start, limit, filter, instrumentPropertyKeys, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfInstrument>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listInstrumentsAsync(OffsetDateTime asAt, OffsetDateTime effectiveAt, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ApiCallback<ResourceListOfInstrument> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listInstrumentsValidateBeforeCall(asAt, effectiveAt, sortBy, start, limit, filter, instrumentPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfInstrument>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
