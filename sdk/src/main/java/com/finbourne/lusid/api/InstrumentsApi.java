...
import com.finbourne.lusid.model.FindInstrumentsResponse;
...
import com.finbourne.lusid.model.ResourceListOfCodeType;
...
public class InstrumentsApi {
     ...
     * @param type The type of identifier being supplied (required)
     * @param id The instrument identifier (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteInstrumentCall(String type, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/instruments/{type}/{id}"
    ...
    private com.squareup.okhttp.Call deleteInstrumentValidateBeforeCall(String type, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling deleteInstrument(Async)");
        }
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteInstrument(Async)");
        }
        

        com.squareup.okhttp.Call call = deleteInstrumentCall(type, id, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DeleteInstrumentResponse deleteInstrument(String type, String id) throws ApiException {
        ApiResponse<DeleteInstrumentResponse> resp = deleteInstrumentWithHttpInfo(type, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeleteInstrumentResponse> deleteInstrumentWithHttpInfo(String type, String id) throws ApiException {
        com.squareup.okhttp.Call call = deleteInstrumentValidateBeforeCall(type, id, null, null);
     ...
     */
    public com.squareup.okhttp.Call deleteInstrumentAsync(String type, String id, final ApiCallback<DeleteInstrumentResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteInstrumentValidateBeforeCall(type, id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteInstrumentResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for findExternalInstruments
     * @param codeType The type of codes to search for (optional)
     * @param codes The collection of instruments to search for (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call findExternalInstrumentsCall(String codeType, List<String> codes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = codes;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call findExternalInstrumentsValidateBeforeCall(String codeType, List<String> codes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = findExternalInstrumentsCall(codeType, codes, progressListener, progressRequestListener);
        return call;
     ...
     * @param codeType The type of codes to search for (optional)
     * @param codes The collection of instruments to search for (optional)
     * @return FindInstrumentsResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FindInstrumentsResponse findExternalInstruments(String codeType, List<String> codes) throws ApiException {
        ApiResponse<FindInstrumentsResponse> resp = findExternalInstrumentsWithHttpInfo(codeType, codes);
        return resp.getData();
    }
     ...
     * @param codeType The type of codes to search for (optional)
     * @param codes The collection of instruments to search for (optional)
     * @return ApiResponse&lt;FindInstrumentsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FindInstrumentsResponse> findExternalInstrumentsWithHttpInfo(String codeType, List<String> codes) throws ApiException {
        com.squareup.okhttp.Call call = findExternalInstrumentsValidateBeforeCall(codeType, codes, null, null);
        Type localVarReturnType = new TypeToken<FindInstrumentsResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findExternalInstrumentsAsync(String codeType, List<String> codes, final ApiCallback<FindInstrumentsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = findExternalInstrumentsValidateBeforeCall(codeType, codes, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FindInstrumentsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call findInstrumentsCall(List<Property> aliases, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/instruments/$query";
     ...
     * @param type The type of identifier being supplied (required)
     * @param id The identifier of the requested instrument (required)
     * @param effectiveAt Optional. The effective date of the query (optional)
     * @param asAt Optional. The AsAt date of the query (optional)
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument (optional)
     * @param progressListener Progress listener
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getInstrumentValidateBeforeCall(String type, String id, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getInstrument(Async)");
        }
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getInstrument(Async)");
        }
        

        com.squareup.okhttp.Call call = getInstrumentCall(type, id, effectiveAt, asAt, instrumentPropertyKeys, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Instrument getInstrument(String type, String id, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<Instrument> resp = getInstrumentWithHttpInfo(type, id, effectiveAt, asAt, instrumentPropertyKeys);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Instrument> getInstrumentWithHttpInfo(String type, String id, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = getInstrumentValidateBeforeCall(type, id, effectiveAt, asAt, instrumentPropertyKeys, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInstrumentAsync(String type, String id, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback<Instrument> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInstrumentValidateBeforeCall(type, id, effectiveAt, asAt, instrumentPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Instrument>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @return ResourceListOfCodeType
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfCodeType getInstrumentIdentifiers() throws ApiException {
        ApiResponse<ResourceListOfCodeType> resp = getInstrumentIdentifiersWithHttpInfo();
        return resp.getData();
    }
     ...
     * Get allowable instrument identifiers
     * Gets the set of identifiers that have been configured as unique identifiers for instruments.     Only CodeTypes returned from this end point can be used as identifiers for instruments.
     * @return ApiResponse&lt;ResourceListOfCodeType&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfCodeType> getInstrumentIdentifiersWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getInstrumentIdentifiersValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfCodeType>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInstrumentIdentifiersAsync(final ApiCallback<ResourceListOfCodeType> callback) throws ApiException {
     ...
     * @param codeType the type of codes being specified (optional)
     * @param codes The identifiers of the instruments to get (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getInstrumentsCall(String codeType, List<String> codes, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = codes;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getInstrumentsValidateBeforeCall(String codeType, List<String> codes, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getInstrumentsCall(codeType, codes, effectiveAt, asAt, instrumentPropertyKeys, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetInstrumentsResponse getInstruments(String codeType, List<String> codes, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<GetInstrumentsResponse> resp = getInstrumentsWithHttpInfo(codeType, codes, effectiveAt, asAt, instrumentPropertyKeys);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetInstrumentsResponse> getInstrumentsWithHttpInfo(String codeType, List<String> codes, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = getInstrumentsValidateBeforeCall(codeType, codes, effectiveAt, asAt, instrumentPropertyKeys, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInstrumentsAsync(String codeType, List<String> codes, OffsetDateTime effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback<GetInstrumentsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInstrumentsValidateBeforeCall(codeType, codes, effectiveAt, asAt, instrumentPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetInstrumentsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param asAt The AsAt time (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateInstrumentIdentifierCall(String type, String id, UpdateInstrumentIdentifierRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateInstrumentIdentifierValidateBeforeCall(String type, String id, UpdateInstrumentIdentifierRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling updateInstrumentIdentifier(Async)");
        }
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateInstrumentIdentifier(Async)");
        }
        

        com.squareup.okhttp.Call call = updateInstrumentIdentifierCall(type, id, request, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Instrument updateInstrumentIdentifier(String type, String id, UpdateInstrumentIdentifierRequest request) throws ApiException {
        ApiResponse<Instrument> resp = updateInstrumentIdentifierWithHttpInfo(type, id, request);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Instrument> updateInstrumentIdentifierWithHttpInfo(String type, String id, UpdateInstrumentIdentifierRequest request) throws ApiException {
        com.squareup.okhttp.Call call = updateInstrumentIdentifierValidateBeforeCall(type, id, request, null, null);
        Type localVarReturnType = new TypeToken<Instrument>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateInstrumentIdentifierAsync(String type, String id, UpdateInstrumentIdentifierRequest request, final ApiCallback<Instrument> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateInstrumentIdentifierValidateBeforeCall(type, id, request, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Instrument>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertInstrumentsPropertiesCall(List<InstrumentProperty> instrumentProperties, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call upsertInstrumentsPropertiesValidateBeforeCall(List<InstrumentProperty> instrumentProperties, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UpsertInstrumentPropertiesResponse upsertInstrumentsProperties(List<InstrumentProperty> instrumentProperties) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UpsertInstrumentPropertiesResponse> upsertInstrumentsPropertiesWithHttpInfo(List<InstrumentProperty> instrumentProperties) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertInstrumentsPropertiesAsync(List<InstrumentProperty> instrumentProperties, final ApiCallback<UpsertInstrumentPropertiesResponse> callback) throws ApiException {
