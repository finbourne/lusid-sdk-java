...
public class InstrumentsApi {
     ...
     */
    public okhttp3.Call getInstrumentCall(String identifierType, String identifier, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInstrumentValidateBeforeCall(String identifierType, String identifier, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInstrumentCall(identifierType, identifier, effectiveAt, asAt, instrumentPropertyKeys, _callback);
        return localVarCall;
     ...
     */
    public Instrument getInstrument(String identifierType, String identifier, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<Instrument> localVarResp = getInstrumentWithHttpInfo(identifierType, identifier, effectiveAt, asAt, instrumentPropertyKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Instrument> getInstrumentWithHttpInfo(String identifierType, String identifier, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        okhttp3.Call localVarCall = getInstrumentValidateBeforeCall(identifierType, identifier, effectiveAt, asAt, instrumentPropertyKeys, null);
        Type localVarReturnType = new TypeToken<Instrument>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] Get instrument definition (asynchronously)
     * Get an individual instrument by the one of its unique instrument identifiers. Optionally, it is possible to decorate each instrument with specified property data.
     * @param identifierType The type of identifier being supplied (required)
     * @param identifier The identifier of the requested instrument (required)
     * @param effectiveAt Optional. The effective date of the query (optional)
     ...
     */
    public okhttp3.Call getInstrumentAsync(String identifierType, String identifier, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback<Instrument> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInstrumentValidateBeforeCall(identifierType, identifier, effectiveAt, asAt, instrumentPropertyKeys, _callback);
        Type localVarReturnType = new TypeToken<Instrument>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getInstrumentIdentifiersCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInstrumentIdentifiersValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getInstrumentIdentifiersCall(_callback);
        return localVarCall;
     ...
     */
    public ResourceListOfInstrumentIdTypeDescriptor getInstrumentIdentifiers() throws ApiException {
        ApiResponse<ResourceListOfInstrumentIdTypeDescriptor> localVarResp = getInstrumentIdentifiersWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfInstrumentIdTypeDescriptor> getInstrumentIdentifiersWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getInstrumentIdentifiersValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<ResourceListOfInstrumentIdTypeDescriptor>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] Get allowable instrument identifiers (asynchronously)
     * Returns a collection of instrument identifier type descriptors. Each descriptor specifies the properties  of a particular instrument identifier - its name, its cardinality (whether or not multiple instruments can  share the same identifier value), and its corresponding PropertyKey.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getInstrumentIdentifiersAsync(final ApiCallback<ResourceListOfInstrumentIdTypeDescriptor> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInstrumentIdentifiersValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<ResourceListOfInstrumentIdTypeDescriptor>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param identifierType The type of identifiers being supplied (required)
     * @param identifiers The identifiers of the instruments to get (required)
     ...
     */
    public okhttp3.Call getInstrumentsCall(String identifierType, List<String> identifiers, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInstrumentsValidateBeforeCall(String identifierType, List<String> identifiers, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInstrumentsCall(identifierType, identifiers, effectiveAt, asAt, instrumentPropertyKeys, _callback);
        return localVarCall;
     ...
     */
    public GetInstrumentsResponse getInstruments(String identifierType, List<String> identifiers, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<GetInstrumentsResponse> localVarResp = getInstrumentsWithHttpInfo(identifierType, identifiers, effectiveAt, asAt, instrumentPropertyKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetInstrumentsResponse> getInstrumentsWithHttpInfo(String identifierType, List<String> identifiers, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        okhttp3.Call localVarCall = getInstrumentsValidateBeforeCall(identifierType, identifiers, effectiveAt, asAt, instrumentPropertyKeys, null);
     ...
     */
    public okhttp3.Call getInstrumentsAsync(String identifierType, List<String> identifiers, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback<GetInstrumentsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInstrumentsValidateBeforeCall(identifierType, identifiers, effectiveAt, asAt, instrumentPropertyKeys, _callback);
        Type localVarReturnType = new TypeToken<GetInstrumentsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param effectiveAt Optional. The effective date of the query (optional)
     * @param page Optional. The pagination token to continue listing instruments. This value is returned from a previous call to ListInstruments.  If this is set, then the sortBy, filter, effectiveAt, and asAt fields must not have changed. Also, if set, a start value cannot be set. (optional)
     ...
     */
    public okhttp3.Call listInstrumentsCall(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listInstrumentsValidateBeforeCall(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ResourceListOfInstrument listInstruments(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<ResourceListOfInstrument> localVarResp = listInstrumentsWithHttpInfo(asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfInstrument> listInstrumentsWithHttpInfo(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys) throws ApiException {
    ...
    /**
     * [EARLY ACCESS] Get all of the currently mastered instruments in LUSID (asynchronously)
     * Lists all instruments that have been mastered within LUSID.
     * @param asAt Optional. The AsAt time (optional)
     * @param effectiveAt Optional. The effective date of the query (optional)
     * @param page Optional. The pagination token to continue listing instruments. This value is returned from a previous call to ListInstruments.  If this is set, then the sortBy, filter, effectiveAt, and asAt fields must not have changed. Also, if set, a start value cannot be set. (optional)
     ...
     */
    public okhttp3.Call listInstrumentsAsync(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ApiCallback<ResourceListOfInstrument> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call upsertInstrumentsCall(Map<String, InstrumentDefinition> requests, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertInstrumentsValidateBeforeCall(Map<String, InstrumentDefinition> requests, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = upsertInstrumentsCall(requests, _callback);
        return localVarCall;
     ...
     */
    public UpsertInstrumentsResponse upsertInstruments(Map<String, InstrumentDefinition> requests) throws ApiException {
        ApiResponse<UpsertInstrumentsResponse> localVarResp = upsertInstrumentsWithHttpInfo(requests);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertInstrumentsResponse> upsertInstrumentsWithHttpInfo(Map<String, InstrumentDefinition> requests) throws ApiException {
        okhttp3.Call localVarCall = upsertInstrumentsValidateBeforeCall(requests, null);
        Type localVarReturnType = new TypeToken<UpsertInstrumentsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] Upsert instruments (asynchronously)
     * Attempt to master one or more instruments in LUSID&#39;s instrument master. Each instrument is keyed by some unique key. This key is unimportant, and serves only as a method to identify created instruments in the response.    The response will return both the collection of successfully created instruments, as well as those that were rejected and why their creation failed. They will be keyed against the key supplied in the  request.                It is important to always check the &#39;Failed&#39; set for any unsuccessful results.
     * @param requests The instrument definitions (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call upsertInstrumentsAsync(Map<String, InstrumentDefinition> requests, final ApiCallback<UpsertInstrumentsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertInstrumentsValidateBeforeCall(requests, _callback);
        Type localVarReturnType = new TypeToken<UpsertInstrumentsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * [EARLY ACCESS] Upsert instrument properties (asynchronously)
     * Attempt to upsert property data for one or more instruments, properties, and effective dates.    The response will include the details of any failures that occurred during data storage.                It is important to always check the &#39;Failed&#39; collection for any unsuccessful results.
     * @param instrumentProperties The instrument property data (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
