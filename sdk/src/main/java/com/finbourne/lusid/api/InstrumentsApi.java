...
public class InstrumentsApi {
     ...
     * @param effectiveAt The effective datetime at which to retrieve the instrument definition.              Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     * @param instrumentPropertyKeys A list of property keys from the \&quot;Instrument\&quot; domain to decorate onto the instrument.              These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * [EARLY ACCESS] Get instrument (asynchronously)
     * Get the definition of a single instrument identified by a unique instrument identifier.
     * @param identifierType The identifier being supplied e.g. \&quot;Figi\&quot;. (required)
     * @param identifier The value of the identifier for the requested instrument. (required)
     * @param effectiveAt The effective datetime at which to retrieve the instrument definition.              Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    /**
     * [EARLY ACCESS] Get instrument identifiers (asynchronously)
     * Get the allowable instrument identifiers and their descriptions.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     * @param effectiveAt The effective datetime at which to retrieve the instrument definitions.              Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    /**
     * [EARLY ACCESS] Get instruments (asynchronously)
     * Get the definition of one or more instruments identified by a collection of unique instrument identifiers.
     * @param identifierType The identifier being supplied e.g. \&quot;Figi\&quot;. (required)
     * @param identifiers The values of the identifier for the requested instruments. (required)
     * @param effectiveAt The effective datetime at which to retrieve the instrument definitions.              Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     * @param effectiveAt The effective datetime at which to list the instruments.              Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    public ResourceListOfInstrument listInstruments(OffsetDateTime asAt, String effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys) throws ApiException {
     ...
     */
    public ApiResponse<ResourceListOfInstrument> listInstrumentsWithHttpInfo(OffsetDateTime asAt, String effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys) throws ApiException {
     ...
     */
    public okhttp3.Call listInstrumentsAsync(OffsetDateTime asAt, String effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ApiCallback<ResourceListOfInstrument> _callback) throws ApiException {
     ...
     * @param requests The definitions of the instruments to update or insert. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * [EARLY ACCESS] Upsert instruments properties (asynchronously)
     * Update or insert one or more instrument properties for one or more instruments. Each instrument property will be updated  if it already exists and inserted if it does not. If any properties fail to be updated or inserted, none will be updated or inserted and  the reason for the failure will be returned.
     * @param instrumentProperties A collection of instruments and associated instrument properties to update or insert. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
