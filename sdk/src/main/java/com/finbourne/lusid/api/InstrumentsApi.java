...
public class InstrumentsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call matchInstrumentsCall(String codeType, List<String> codes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = codes;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call matchInstrumentsValidateBeforeCall(String codeType, List<String> codes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = matchInstrumentsCall(codeType, codes, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MatchInstrumentsResponse matchInstruments(String codeType, List<String> codes) throws ApiException {
        ApiResponse<MatchInstrumentsResponse> resp = matchInstrumentsWithHttpInfo(codeType, codes);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MatchInstrumentsResponse> matchInstrumentsWithHttpInfo(String codeType, List<String> codes) throws ApiException {
        com.squareup.okhttp.Call call = matchInstrumentsValidateBeforeCall(codeType, codes, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call matchInstrumentsAsync(String codeType, List<String> codes, final ApiCallback<MatchInstrumentsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = matchInstrumentsValidateBeforeCall(codeType, codes, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MatchInstrumentsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
