...
import com.finbourne.lusid.model.DeleteClientInstrumentsResponse;
...
import com.finbourne.lusid.model.LookupInstrumentsFromCodesResponse;
import java.time.OffsetDateTime;
import com.finbourne.lusid.model.TryAddClientInstruments;
...
public class InstrumentsApi {
    ...
    /**
     * Build call for batchAddClientInstruments
     * @param definitions The client instrument definitions (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call batchAddClientInstrumentsCall(Object definitions, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = definitions;
    ...
    private com.squareup.okhttp.Call batchAddClientInstrumentsValidateBeforeCall(Object definitions, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = batchAddClientInstrumentsCall(definitions, progressListener, progressRequestListener);
        return call;
     ...
     * @param definitions The client instrument definitions (optional)
     * @return TryAddClientInstruments
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TryAddClientInstruments batchAddClientInstruments(Object definitions) throws ApiException {
        ApiResponse<TryAddClientInstruments> resp = batchAddClientInstrumentsWithHttpInfo(definitions);
        return resp.getData();
    }
     ...
     * Attempt to create one or more \&quot;client\&quot; instruments. Each instrument is keyed by some unique key. This key is unimportant, and serves only as a method to identify created instruments in the response.    The response will return both the collection of successfully created instruments, as well as those that were rejected and why their creation failed. They will be keyed against the key supplied in the  request.                It is important to always check the &#39;Failed&#39; set for any unsuccessful results.
     * @param definitions The client instrument definitions (optional)
     * @return ApiResponse&lt;TryAddClientInstruments&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TryAddClientInstruments> batchAddClientInstrumentsWithHttpInfo(Object definitions) throws ApiException {
        com.squareup.okhttp.Call call = batchAddClientInstrumentsValidateBeforeCall(definitions, null, null);
        Type localVarReturnType = new TypeToken<TryAddClientInstruments>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create instrument (asynchronously)
     * Attempt to create one or more \&quot;client\&quot; instruments. Each instrument is keyed by some unique key. This key is unimportant, and serves only as a method to identify created instruments in the response.    The response will return both the collection of successfully created instruments, as well as those that were rejected and why their creation failed. They will be keyed against the key supplied in the  request.                It is important to always check the &#39;Failed&#39; set for any unsuccessful results.
     * @param definitions The client instrument definitions (optional)
     ...
     */
    public com.squareup.okhttp.Call batchAddClientInstrumentsAsync(Object definitions, final ApiCallback<TryAddClientInstruments> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = batchAddClientInstrumentsValidateBeforeCall(definitions, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TryAddClientInstruments>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for batchDeleteClientInstruments
     * @param uids The unique identifiers of the instruments to delete (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call batchDeleteClientInstrumentsCall(List<String> uids, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (uids != null)
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("multi", "uids", uids));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call batchDeleteClientInstrumentsValidateBeforeCall(List<String> uids, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = batchDeleteClientInstrumentsCall(uids, progressListener, progressRequestListener);
        return call;
     ...
     * @param uids The unique identifiers of the instruments to delete (optional)
     * @return DeleteClientInstrumentsResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public DeleteClientInstrumentsResponse batchDeleteClientInstruments(List<String> uids) throws ApiException {
        ApiResponse<DeleteClientInstrumentsResponse> resp = batchDeleteClientInstrumentsWithHttpInfo(uids);
        return resp.getData();
    }
     ...
     * Attempt to delete one or more \&quot;client\&quot; instruments.    The response will include those instruments that could not be deleted (as well as any available details).                It is important to always check the &#39;Failed&#39; set for any unsuccessful results.
     * @param uids The unique identifiers of the instruments to delete (optional)
     * @return ApiResponse&lt;DeleteClientInstrumentsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeleteClientInstrumentsResponse> batchDeleteClientInstrumentsWithHttpInfo(List<String> uids) throws ApiException {
        com.squareup.okhttp.Call call = batchDeleteClientInstrumentsValidateBeforeCall(uids, null, null);
        Type localVarReturnType = new TypeToken<DeleteClientInstrumentsResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call batchDeleteClientInstrumentsAsync(List<String> uids, final ApiCallback<DeleteClientInstrumentsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = batchDeleteClientInstrumentsValidateBeforeCall(uids, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteClientInstrumentsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call batchUpsertInstrumentPropertiesCall(List<InstrumentProperty> instrumentProperties, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call batchUpsertInstrumentPropertiesValidateBeforeCall(List<InstrumentProperty> instrumentProperties, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = batchUpsertInstrumentPropertiesCall(instrumentProperties, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UpsertInstrumentPropertiesResponse batchUpsertInstrumentProperties(List<InstrumentProperty> instrumentProperties) throws ApiException {
        ApiResponse<UpsertInstrumentPropertiesResponse> resp = batchUpsertInstrumentPropertiesWithHttpInfo(instrumentProperties);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UpsertInstrumentPropertiesResponse> batchUpsertInstrumentPropertiesWithHttpInfo(List<InstrumentProperty> instrumentProperties) throws ApiException {
        com.squareup.okhttp.Call call = batchUpsertInstrumentPropertiesValidateBeforeCall(instrumentProperties, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call batchUpsertInstrumentPropertiesAsync(List<InstrumentProperty> instrumentProperties, final ApiCallback<UpsertInstrumentPropertiesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = batchUpsertInstrumentPropertiesValidateBeforeCall(instrumentProperties, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpsertInstrumentPropertiesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param uid The uid of the requested instrument (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getInstrumentCall(String uid, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/instruments/{uid}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getInstrumentValidateBeforeCall(String uid, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'uid' is set
        if (uid == null) {
            throw new ApiException("Missing the required parameter 'uid' when calling getInstrument(Async)");
        }
        

        com.squareup.okhttp.Call call = getInstrumentCall(uid, asAt, instrumentPropertyKeys, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Instrument getInstrument(String uid, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<Instrument> resp = getInstrumentWithHttpInfo(uid, asAt, instrumentPropertyKeys);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Instrument> getInstrumentWithHttpInfo(String uid, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = getInstrumentValidateBeforeCall(uid, asAt, instrumentPropertyKeys, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInstrumentAsync(String uid, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback<Instrument> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInstrumentValidateBeforeCall(uid, asAt, instrumentPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Instrument>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for lookupInstrumentsFromCodes
     * @param codeType The type of identifiers (optional)
     * @param codes One or more identifiers of the type specified in the codeType (optional)
     * @param asAt Optional. The AsAt date of the data (optional)
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call lookupInstrumentsFromCodesValidateBeforeCall(String codeType, List<String> codes, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = lookupInstrumentsFromCodesCall(codeType, codes, asAt, instrumentPropertyKeys, progressListener, progressRequestListener);
        return call;
     ...
     * @param asAt Optional. The AsAt date of the data (optional)
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument (optional)
     * @return LookupInstrumentsFromCodesResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public LookupInstrumentsFromCodesResponse lookupInstrumentsFromCodes(String codeType, List<String> codes, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<LookupInstrumentsFromCodesResponse> resp = lookupInstrumentsFromCodesWithHttpInfo(codeType, codes, asAt, instrumentPropertyKeys);
        return resp.getData();
    }
     ...
     * @param asAt Optional. The AsAt date of the data (optional)
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument (optional)
     * @return ApiResponse&lt;LookupInstrumentsFromCodesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LookupInstrumentsFromCodesResponse> lookupInstrumentsFromCodesWithHttpInfo(String codeType, List<String> codes, OffsetDateTime asAt, List<String> instrumentPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = lookupInstrumentsFromCodesValidateBeforeCall(codeType, codes, asAt, instrumentPropertyKeys, null, null);
        Type localVarReturnType = new TypeToken<LookupInstrumentsFromCodesResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Lookup instrument definition (asynchronously)
     * Lookup one or more instrument definitions by specifying non-LUSID identifiers. Optionally, it is possible to decorate each instrument with specified property data.    The response will return both the collection of found instruments for each identifier, as well as a collection of all identifiers for which no instruments could be found (as well as any available details).                It is important to always check the &#39;Failed&#39; set for any unsuccessful results.
     * @param codeType The type of identifiers (optional)
     * @param codes One or more identifiers of the type specified in the codeType (optional)
     * @param asAt Optional. The AsAt date of the data (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call lookupInstrumentsFromCodesAsync(String codeType, List<String> codes, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback<LookupInstrumentsFromCodesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = lookupInstrumentsFromCodesValidateBeforeCall(codeType, codes, asAt, instrumentPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LookupInstrumentsFromCodesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
