...
public class InstrumentsApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getInstrumentValidateBeforeCall(String identifierType, String identifier, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInstrumentAsync(String identifierType, String identifier, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback<Instrument> callback) throws ApiException {
    ...
    public ResourceListOfInstrumentIdTypeDescriptor getInstrumentIdentifiers() throws ApiException {
        ApiResponse<ResourceListOfInstrumentIdTypeDescriptor> resp = getInstrumentIdentifiersWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInstrumentIdentifiersAsync(final ApiCallback<ResourceListOfInstrumentIdTypeDescriptor> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getInstrumentsCall(String identifierType, List<String> identifiers, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getInstrumentsValidateBeforeCall(String identifierType, List<String> identifiers, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInstrumentsAsync(String identifierType, List<String> identifiers, String effectiveAt, OffsetDateTime asAt, List<String> instrumentPropertyKeys, final ApiCallback<GetInstrumentsResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listInstrumentsCall(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call listInstrumentsValidateBeforeCall(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listInstrumentsCall(asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys, progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfInstrument listInstruments(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<ResourceListOfInstrument> resp = listInstrumentsWithHttpInfo(asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys);
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfInstrument> listInstrumentsWithHttpInfo(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = listInstrumentsValidateBeforeCall(asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listInstrumentsAsync(OffsetDateTime asAt, OffsetDateTime effectiveAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> instrumentPropertyKeys, final ApiCallback<ResourceListOfInstrument> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listInstrumentsValidateBeforeCall(asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfInstrument>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
