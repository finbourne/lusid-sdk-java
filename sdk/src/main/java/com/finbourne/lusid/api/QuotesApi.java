...
public class QuotesApi {
     ...
     * @param id The quote id (optional)
     * @param effectiveFrom The date/time from which the quote is effective (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteQuoteCall(String scope, String id, OffsetDateTime effectiveFrom, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("effectiveFrom", effectiveFrom));
    ...
    private com.squareup.okhttp.Call deleteQuoteValidateBeforeCall(String scope, String id, OffsetDateTime effectiveFrom, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteQuoteCall(scope, id, effectiveFrom, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DeleteQuotesResponse deleteQuote(String scope, String id, OffsetDateTime effectiveFrom) throws ApiException {
        ApiResponse<DeleteQuotesResponse> resp = deleteQuoteWithHttpInfo(scope, id, effectiveFrom);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeleteQuotesResponse> deleteQuoteWithHttpInfo(String scope, String id, OffsetDateTime effectiveFrom) throws ApiException {
        com.squareup.okhttp.Call call = deleteQuoteValidateBeforeCall(scope, id, effectiveFrom, null, null);
     ...
     */
    public com.squareup.okhttp.Call deleteQuoteAsync(String scope, String id, OffsetDateTime effectiveFrom, final ApiCallback<DeleteQuotesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteQuoteValidateBeforeCall(scope, id, effectiveFrom, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteQuotesResponse>(){}.getType();
    ...
    public com.squareup.okhttp.Call getQuotesCall(String scope, List<String> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (quoteIds != null)
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("multi", "quoteIds", quoteIds));
        if (effectiveAt != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getQuotesValidateBeforeCall(String scope, List<String> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfQuote getQuotes(String scope, List<String> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit) throws ApiException {
        ApiResponse<ResourceListOfQuote> resp = getQuotesWithHttpInfo(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfQuote> getQuotesWithHttpInfo(String scope, List<String> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getQuotesAsync(String scope, List<String> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit, final ApiCallback<ResourceListOfQuote> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertQuotesCall(String scope, List<UpsertQuoteRequest> quotes, OffsetDateTime effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call upsertQuotesValidateBeforeCall(String scope, List<UpsertQuoteRequest> quotes, OffsetDateTime effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertQuotesCall(scope, quotes, effectiveAt, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UpsertQuotesResponse upsertQuotes(String scope, List<UpsertQuoteRequest> quotes, OffsetDateTime effectiveAt) throws ApiException {
        ApiResponse<UpsertQuotesResponse> resp = upsertQuotesWithHttpInfo(scope, quotes, effectiveAt);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UpsertQuotesResponse> upsertQuotesWithHttpInfo(String scope, List<UpsertQuoteRequest> quotes, OffsetDateTime effectiveAt) throws ApiException {
        com.squareup.okhttp.Call call = upsertQuotesValidateBeforeCall(scope, quotes, effectiveAt, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertQuotesAsync(String scope, List<UpsertQuoteRequest> quotes, OffsetDateTime effectiveAt, final ApiCallback<UpsertQuotesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertQuotesValidateBeforeCall(scope, quotes, effectiveAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpsertQuotesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
