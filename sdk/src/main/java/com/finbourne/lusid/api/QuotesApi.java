...
public class QuotesApi {
     ...
     */
    public com.squareup.okhttp.Call deleteQuotesCall(String scope, List<DeleteQuoteRequest> quotes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call deleteQuotesValidateBeforeCall(String scope, List<DeleteQuoteRequest> quotes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteQuotesCall(scope, quotes, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DeleteQuotesResponse deleteQuotes(String scope, List<DeleteQuoteRequest> quotes) throws ApiException {
        ApiResponse<DeleteQuotesResponse> resp = deleteQuotesWithHttpInfo(scope, quotes);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeleteQuotesResponse> deleteQuotesWithHttpInfo(String scope, List<DeleteQuoteRequest> quotes) throws ApiException {
        com.squareup.okhttp.Call call = deleteQuotesValidateBeforeCall(scope, quotes, null, null);
     ...
     */
    public com.squareup.okhttp.Call deleteQuotesAsync(String scope, List<DeleteQuoteRequest> quotes, final ApiCallback<DeleteQuotesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteQuotesValidateBeforeCall(scope, quotes, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteQuotesResponse>(){}.getType();
     ...
     * @param scope The scope of the quotes (required)
     * @param quotes The quotes to upsert (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
