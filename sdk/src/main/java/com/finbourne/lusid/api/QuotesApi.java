...
import com.finbourne.lusid.model.DeleteQuoteRequest;
import com.finbourne.lusid.model.DeleteQuotesResponse;
...
public class QuotesApi {
     ...
     * @param scope The scope of the quote (required)
     * @param quotes The quotes to delete (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteQuoteCall(String scope, List<DeleteQuoteRequest> quotes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call deleteQuoteValidateBeforeCall(String scope, List<DeleteQuoteRequest> quotes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling deleteQuote(Async)");
        }
        

        com.squareup.okhttp.Call call = deleteQuoteCall(scope, quotes, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DeleteQuotesResponse deleteQuote(String scope, List<DeleteQuoteRequest> quotes) throws ApiException {
        ApiResponse<DeleteQuotesResponse> resp = deleteQuoteWithHttpInfo(scope, quotes);
        return resp.getData();
    }
     ...
     * @param scope The scope of the quote (required)
     * @param quotes The quotes to delete (optional)
     * @return ApiResponse&lt;DeleteQuotesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeleteQuotesResponse> deleteQuoteWithHttpInfo(String scope, List<DeleteQuoteRequest> quotes) throws ApiException {
        com.squareup.okhttp.Call call = deleteQuoteValidateBeforeCall(scope, quotes, null, null);
        Type localVarReturnType = new TypeToken<DeleteQuotesResponse>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call deleteQuoteAsync(String scope, List<DeleteQuoteRequest> quotes, final ApiCallback<DeleteQuotesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteQuoteValidateBeforeCall(scope, quotes, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteQuotesResponse>(){}.getType();
     ...
     * @param scope The scope of the quotes (required)
     * @param quoteIds The ids of the quotes (optional)
     * @param effectiveAt Optional. The date/time from which the quotes are effective (optional)
     * @param asAt Optional. The &#39;AsAt&#39; date/time (optional)
     * @param maxAge Optional. The quote staleness tolerance (optional)
     * @param page Optional. The page of results to return (optional)
     * @param limit Optional. The number of results per page (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getQuotesCall(String scope, List<QuoteId> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = quoteIds;
        ...
        if (maxAge != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("maxAge", maxAge));
        if (page != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getQuotesValidateBeforeCall(String scope, List<QuoteId> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getQuotesCall(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetQuotesResponse getQuotes(String scope, List<QuoteId> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit) throws ApiException {
        ApiResponse<GetQuotesResponse> resp = getQuotesWithHttpInfo(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetQuotesResponse> getQuotesWithHttpInfo(String scope, List<QuoteId> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getQuotesValidateBeforeCall(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getQuotesAsync(String scope, List<QuoteId> quoteIds, OffsetDateTime effectiveAt, OffsetDateTime asAt, String maxAge, Integer page, Integer limit, final ApiCallback<GetQuotesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getQuotesValidateBeforeCall(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetQuotesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param scope The scope of the quotes (required)
     * @param quotes The quotes to add (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertQuotesCall(String scope, List<UpsertQuoteRequest> quotes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = quotes;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call upsertQuotesValidateBeforeCall(String scope, List<UpsertQuoteRequest> quotes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertQuotesCall(scope, quotes, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UpsertQuotesResponse upsertQuotes(String scope, List<UpsertQuoteRequest> quotes) throws ApiException {
        ApiResponse<UpsertQuotesResponse> resp = upsertQuotesWithHttpInfo(scope, quotes);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UpsertQuotesResponse> upsertQuotesWithHttpInfo(String scope, List<UpsertQuoteRequest> quotes) throws ApiException {
        com.squareup.okhttp.Call call = upsertQuotesValidateBeforeCall(scope, quotes, null, null);
        Type localVarReturnType = new TypeToken<UpsertQuotesResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Add quotes (asynchronously)
     * Add quotes effective at the specified time. If a quote is added with the same id (and is effective at the same time) as an existing quote, then the more recently added quote will be returned when queried
     * @param scope The scope of the quotes (required)
     * @param quotes The quotes to add (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertQuotesAsync(String scope, List<UpsertQuoteRequest> quotes, final ApiCallback<UpsertQuotesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertQuotesValidateBeforeCall(scope, quotes, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpsertQuotesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
