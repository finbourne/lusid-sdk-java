...
public class SystemConfigurationApi {
     ...
     */
    public TransactionConfigurationData createConfigurationTransactionType(TransactionConfigurationDataRequest type) throws ApiException {
        ApiResponse<TransactionConfigurationData> resp = createConfigurationTransactionTypeWithHttpInfo(type);
        return resp.getData();
    }
     ...
     * Create a new transaction type by specifying a definition and the mappings to movements
     * @param type A transaction type definition (optional)
     * @return ApiResponse&lt;TransactionConfigurationData&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TransactionConfigurationData> createConfigurationTransactionTypeWithHttpInfo(TransactionConfigurationDataRequest type) throws ApiException {
        com.squareup.okhttp.Call call = createConfigurationTransactionTypeValidateBeforeCall(type, null, null);
        Type localVarReturnType = new TypeToken<TransactionConfigurationData>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call createConfigurationTransactionTypeAsync(TransactionConfigurationDataRequest type, final ApiCallback<TransactionConfigurationData> callback) throws ApiException {
