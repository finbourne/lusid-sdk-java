...
public class PropertyDefinitionsApi {
     ...
     * @param propertyKeys One or more property keys which identify each property that a definition should              be retrieved for. The format for each property key is {domain}/{scope}/{code}, e.g. \&quot;Instrument/system/Name\&quot;. (required)
     * @param asAt The asAt datetime at which to retrieve the property definition/s. (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getMultiplePropertyDefinitionsCall(List<String> propertyKeys, OffsetDateTime asAt, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getMultiplePropertyDefinitionsValidateBeforeCall(List<String> propertyKeys, OffsetDateTime asAt, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMultiplePropertyDefinitionsCall(propertyKeys, asAt, filter, progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfPropertyDefinition getMultiplePropertyDefinitions(List<String> propertyKeys, OffsetDateTime asAt, String filter) throws ApiException {
        ApiResponse<ResourceListOfPropertyDefinition> resp = getMultiplePropertyDefinitionsWithHttpInfo(propertyKeys, asAt, filter);
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfPropertyDefinition> getMultiplePropertyDefinitionsWithHttpInfo(List<String> propertyKeys, OffsetDateTime asAt, String filter) throws ApiException {
        com.squareup.okhttp.Call call = getMultiplePropertyDefinitionsValidateBeforeCall(propertyKeys, asAt, filter, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getMultiplePropertyDefinitionsAsync(List<String> propertyKeys, OffsetDateTime asAt, String filter, final ApiCallback<ResourceListOfPropertyDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMultiplePropertyDefinitionsValidateBeforeCall(propertyKeys, asAt, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPropertyDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param asAt The asAt datetime at which to retrieve the property definition. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
