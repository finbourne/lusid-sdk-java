...
public class PropertyDefinitionsApi {
     ...
     * @param definition The definition of the new property (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createPropertyDefinitionCall(CreatePropertyDefinitionRequest definition, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createPropertyDefinitionValidateBeforeCall(CreatePropertyDefinitionRequest definition, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = createPropertyDefinitionCall(definition, progressListener, progressRequestListener);
        return call;
    ...
    public PropertyDefinition createPropertyDefinition(CreatePropertyDefinitionRequest definition) throws ApiException {
        ApiResponse<PropertyDefinition> resp = createPropertyDefinitionWithHttpInfo(definition);
        return resp.getData();
    }
    ...
    public ApiResponse<PropertyDefinition> createPropertyDefinitionWithHttpInfo(CreatePropertyDefinitionRequest definition) throws ApiException {
        com.squareup.okhttp.Call call = createPropertyDefinitionValidateBeforeCall(definition, null, null);
        Type localVarReturnType = new TypeToken<PropertyDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Define a new property (asynchronously)
     * Create a new property definition
     * @param definition The definition of the new property (optional)
     ...
     */
    public com.squareup.okhttp.Call createPropertyDefinitionAsync(CreatePropertyDefinitionRequest definition, final ApiCallback<PropertyDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createPropertyDefinitionValidateBeforeCall(definition, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PropertyDefinition>(){}.getType();
     ...
     * @param domain The Property Domain of the property to be deleted (required)
     * @param scope The scope of the property to be deleted (required)
     * @param code The code of the property to be deleted (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deletePropertyDefinitionCall(String domain, String scope, String code, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deletePropertyDefinitionValidateBeforeCall(String domain, String scope, String code, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deletePropertyDefinitionCall(domain, scope, code, progressListener, progressRequestListener);
        return call;
    ...
    public DeletedEntityResponse deletePropertyDefinition(String domain, String scope, String code) throws ApiException {
        ApiResponse<DeletedEntityResponse> resp = deletePropertyDefinitionWithHttpInfo(domain, scope, code);
        return resp.getData();
    }
    ...
    public ApiResponse<DeletedEntityResponse> deletePropertyDefinitionWithHttpInfo(String domain, String scope, String code) throws ApiException {
        com.squareup.okhttp.Call call = deletePropertyDefinitionValidateBeforeCall(domain, scope, code, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deletePropertyDefinitionAsync(String domain, String scope, String code, final ApiCallback<DeletedEntityResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deletePropertyDefinitionValidateBeforeCall(domain, scope, code, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param propertyKeys One or more keys for properties for which the schema should be returned (optional)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getMultiplePropertyDefinitionsValidateBeforeCall(List<String> propertyKeys, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getMultiplePropertyDefinitionsCall(propertyKeys, asAt, sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfPropertyDefinition getMultiplePropertyDefinitions(List<String> propertyKeys, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfPropertyDefinition> resp = getMultiplePropertyDefinitionsWithHttpInfo(propertyKeys, asAt, sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfPropertyDefinition> getMultiplePropertyDefinitionsWithHttpInfo(List<String> propertyKeys, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = getMultiplePropertyDefinitionsValidateBeforeCall(propertyKeys, asAt, sortBy, start, limit, filter, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getMultiplePropertyDefinitionsAsync(List<String> propertyKeys, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfPropertyDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMultiplePropertyDefinitionsValidateBeforeCall(propertyKeys, asAt, sortBy, start, limit, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfPropertyDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param domain The Property Domain of the requested property (required)
     * @param scope The scope of the requested property (required)
     * @param code The code of the requested property (required)
     * @param asAt Optional. The AsAt date of the data (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPropertyDefinitionCall(String domain, String scope, String code, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPropertyDefinitionValidateBeforeCall(String domain, String scope, String code, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPropertyDefinitionCall(domain, scope, code, asAt, progressListener, progressRequestListener);
        return call;
    ...
    public PropertyDefinition getPropertyDefinition(String domain, String scope, String code, OffsetDateTime asAt) throws ApiException {
        ApiResponse<PropertyDefinition> resp = getPropertyDefinitionWithHttpInfo(domain, scope, code, asAt);
        return resp.getData();
    }
    ...
    public ApiResponse<PropertyDefinition> getPropertyDefinitionWithHttpInfo(String domain, String scope, String code, OffsetDateTime asAt) throws ApiException {
        com.squareup.okhttp.Call call = getPropertyDefinitionValidateBeforeCall(domain, scope, code, asAt, null, null);
        Type localVarReturnType = new TypeToken<PropertyDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPropertyDefinitionAsync(String domain, String scope, String code, OffsetDateTime asAt, final ApiCallback<PropertyDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPropertyDefinitionValidateBeforeCall(domain, scope, code, asAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PropertyDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param domain The Property Domain of the property being updated (required)
     * @param scope The scope of the property to be updated (required)
     * @param code The code of the property to be updated (required)
     * @param definition The updated definition of the property (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updatePropertyDefinitionCall(String domain, String scope, String code, UpdatePropertyDefinitionRequest definition, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = definition;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updatePropertyDefinitionValidateBeforeCall(String domain, String scope, String code, UpdatePropertyDefinitionRequest definition, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePropertyDefinitionCall(domain, scope, code, definition, progressListener, progressRequestListener);
        return call;
    ...
    public PropertyDefinition updatePropertyDefinition(String domain, String scope, String code, UpdatePropertyDefinitionRequest definition) throws ApiException {
        ApiResponse<PropertyDefinition> resp = updatePropertyDefinitionWithHttpInfo(domain, scope, code, definition);
        return resp.getData();
    }
    ...
    public ApiResponse<PropertyDefinition> updatePropertyDefinitionWithHttpInfo(String domain, String scope, String code, UpdatePropertyDefinitionRequest definition) throws ApiException {
        com.squareup.okhttp.Call call = updatePropertyDefinitionValidateBeforeCall(domain, scope, code, definition, null, null);
        Type localVarReturnType = new TypeToken<PropertyDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update the definition of the specified existing property (asynchronously)
     * Not all elements within a property definition are modifiable due to the potential implications for data  already stored against these properties
     * @param domain The Property Domain of the property being updated (required)
     * @param scope The scope of the property to be updated (required)
     * @param code The code of the property to be updated (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePropertyDefinitionAsync(String domain, String scope, String code, UpdatePropertyDefinitionRequest definition, final ApiCallback<PropertyDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePropertyDefinitionValidateBeforeCall(domain, scope, code, definition, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PropertyDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
