...
public class DataTypesApi {
     ...
     * @param units One or more unit identifiers for which the definition is being requested (optional)
     * @param filter Optional. Expression to filter the result set (optional)
     * @return IUnitDefinition
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public IUnitDefinition getUnitsFromDataType(String scope, String code, List<String> units, String filter) throws ApiException {
        ApiResponse<IUnitDefinition> resp = getUnitsFromDataTypeWithHttpInfo(scope, code, units, filter);
        return resp.getData();
    }
     ...
     * @param units One or more unit identifiers for which the definition is being requested (optional)
     * @param filter Optional. Expression to filter the result set (optional)
     * @return ApiResponse&lt;IUnitDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<IUnitDefinition> getUnitsFromDataTypeWithHttpInfo(String scope, String code, List<String> units, String filter) throws ApiException {
        com.squareup.okhttp.Call call = getUnitsFromDataTypeValidateBeforeCall(scope, code, units, filter, null, null);
        Type localVarReturnType = new TypeToken<IUnitDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUnitsFromDataTypeAsync(String scope, String code, List<String> units, String filter, final ApiCallback<IUnitDefinition> callback) throws ApiException {
