...
public class SchemasApi {
     ...
     */
    public com.squareup.okhttp.Call getEntitySchemaCall(String entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getEntitySchemaValidateBeforeCall(String entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getEntitySchemaCall(entity, progressListener, progressRequestListener);
        return call;
    ...
    public Schema getEntitySchema(String entity) throws ApiException {
        ApiResponse<Schema> resp = getEntitySchemaWithHttpInfo(entity);
        return resp.getData();
    }
    ...
    public ApiResponse<Schema> getEntitySchemaWithHttpInfo(String entity) throws ApiException {
        com.squareup.okhttp.Call call = getEntitySchemaValidateBeforeCall(entity, null, null);
     ...
     */
    public com.squareup.okhttp.Call getEntitySchemaAsync(String entity, final ApiCallback<Schema> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getEntitySchemaValidateBeforeCall(entity, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Schema>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPropertySchemaCall(List<String> propertyKeys, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPropertySchemaValidateBeforeCall(List<String> propertyKeys, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getPropertySchemaCall(propertyKeys, asAt, progressListener, progressRequestListener);
        return call;
    ...
    public PropertySchema getPropertySchema(List<String> propertyKeys, OffsetDateTime asAt) throws ApiException {
        ApiResponse<PropertySchema> resp = getPropertySchemaWithHttpInfo(propertyKeys, asAt);
        return resp.getData();
    }
    ...
    public ApiResponse<PropertySchema> getPropertySchemaWithHttpInfo(List<String> propertyKeys, OffsetDateTime asAt) throws ApiException {
        com.squareup.okhttp.Call call = getPropertySchemaValidateBeforeCall(propertyKeys, asAt, null, null);
        Type localVarReturnType = new TypeToken<PropertySchema>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get property schema (asynchronously)
     * Get the schemas for the provided list of property keys.
     * @param propertyKeys One or more property keys for which the schema is requested (optional)
     * @param asAt Optional. The AsAt date of the data (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPropertySchemaAsync(List<String> propertyKeys, OffsetDateTime asAt, final ApiCallback<PropertySchema> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPropertySchemaValidateBeforeCall(propertyKeys, asAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PropertySchema>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getValueTypesCall(List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getValueTypesValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getValueTypesCall(sortBy, start, limit, progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfValueType getValueTypes(List<String> sortBy, Integer start, Integer limit) throws ApiException {
        ApiResponse<ResourceListOfValueType> resp = getValueTypesWithHttpInfo(sortBy, start, limit);
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfValueType> getValueTypesWithHttpInfo(List<String> sortBy, Integer start, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getValueTypesValidateBeforeCall(sortBy, start, limit, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfValueType>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get value types (asynchronously)
     * Gets the available value types for which a schema is available.
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getValueTypesAsync(List<String> sortBy, Integer start, Integer limit, final ApiCallback<ResourceListOfValueType> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getValueTypesValidateBeforeCall(sortBy, start, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfValueType>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listEntitiesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listEntitiesValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listEntitiesCall(progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfString listEntities() throws ApiException {
        ApiResponse<ResourceListOfString> resp = listEntitiesWithHttpInfo();
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfString> listEntitiesWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = listEntitiesValidateBeforeCall(null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listEntitiesAsync(final ApiCallback<ResourceListOfString> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listEntitiesValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfString>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
