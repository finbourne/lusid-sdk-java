...
public class PagedResourceListOfSequenceDefinition {
  ...
  private List<SequenceDefinition> values = new ArrayList<>();
  ...
  public PagedResourceListOfSequenceDefinition() {
  }

  public PagedResourceListOfSequenceDefinition nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfSequenceDefinition previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfSequenceDefinition values(List<SequenceDefinition> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfSequenceDefinition addValuesItem(SequenceDefinition valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<SequenceDefinition> getValues() {

    return values;
  }


  public void setValues(List<SequenceDefinition> values) {
    this.values = values;
  }


  public PagedResourceListOfSequenceDefinition href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfSequenceDefinition links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfSequenceDefinition addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfSequenceDefinition {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfSequenceDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfSequenceDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfSequenceDefinition is not found in the empty JSON string", PagedResourceListOfSequenceDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfSequenceDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfSequenceDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfSequenceDefinition.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        SequenceDefinition.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfSequenceDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfSequenceDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfSequenceDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfSequenceDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfSequenceDefinition>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfSequenceDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfSequenceDefinition read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfSequenceDefinition given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfSequenceDefinition
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfSequenceDefinition
  */
  public static PagedResourceListOfSequenceDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfSequenceDefinition.class);
  }

 /**
  * Convert an instance of PagedResourceListOfSequenceDefinition to an JSON string
  *
  * @return JSON string
  */
