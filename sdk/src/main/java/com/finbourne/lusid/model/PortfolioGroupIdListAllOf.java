...
public class PortfolioGroupIdListAllOf {
  ...
  public PortfolioGroupIdListAllOf values(List<ResourceId> values) {
    this.values = values; 
    return this;
  }

  public PortfolioGroupIdListAllOf addValuesItem(ResourceId valuesItem) {
  ...
  **/
  ...
  public PortfolioGroupIdListAllOf referenceListType(ReferenceListTypeEnum referenceListType) {
