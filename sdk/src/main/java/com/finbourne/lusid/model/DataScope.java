...
public class DataScope {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DataScope
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataScope.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataScope is not found in the empty JSON string", DataScope.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataScope.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataScope` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataScope.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataScope' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataScope> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataScope.class));

       return (TypeAdapter<T>) new TypeAdapter<DataScope>() {
           @Override
           public void write(JsonWriter out, DataScope value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataScope read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DataScope given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DataScope
  * @throws IOException if the JSON string is invalid with respect to DataScope
  */
  public static DataScope fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataScope.class);
  }

 /**
  * Convert an instance of DataScope to an JSON string
  *
  * @return JSON string
  */
