...
public class TranslateInstrumentDefinitionsResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TranslateInstrumentDefinitionsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TranslateInstrumentDefinitionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TranslateInstrumentDefinitionsResponse is not found in the empty JSON string", TranslateInstrumentDefinitionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TranslateInstrumentDefinitionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TranslateInstrumentDefinitionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TranslateInstrumentDefinitionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TranslateInstrumentDefinitionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TranslateInstrumentDefinitionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TranslateInstrumentDefinitionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TranslateInstrumentDefinitionsResponse>() {
           @Override
           public void write(JsonWriter out, TranslateInstrumentDefinitionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TranslateInstrumentDefinitionsResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to TranslateInstrumentDefinitionsResponse
  */
  public static TranslateInstrumentDefinitionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TranslateInstrumentDefinitionsResponse.class);
  }
