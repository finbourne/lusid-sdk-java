...
public class PortfolioIdListComplianceParameter extends ComplianceParameter {
  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private ResourceId value;

  public PortfolioIdListComplianceParameter() {
    // this.complianceParameterType = this.getClass().getSimpleName();
  }

  public PortfolioIdListComplianceParameter value(ResourceId value) {
    this.value = value; 
    return this;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PortfolioIdListComplianceParameter {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortfolioIdListComplianceParameter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortfolioIdListComplianceParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PortfolioIdListComplianceParameter is not found in the empty JSON string", PortfolioIdListComplianceParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PortfolioIdListComplianceParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PortfolioIdListComplianceParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PortfolioIdListComplianceParameter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortfolioIdListComplianceParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortfolioIdListComplianceParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortfolioIdListComplianceParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortfolioIdListComplianceParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<PortfolioIdListComplianceParameter>() {
           @Override
           public void write(JsonWriter out, PortfolioIdListComplianceParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PortfolioIdListComplianceParameter read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PortfolioIdListComplianceParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PortfolioIdListComplianceParameter
  * @throws IOException if the JSON string is invalid with respect to PortfolioIdListComplianceParameter
  */
  public static PortfolioIdListComplianceParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortfolioIdListComplianceParameter.class);
  }

 /**
  * Convert an instance of PortfolioIdListComplianceParameter to an JSON string
  *
  * @return JSON string
  */
