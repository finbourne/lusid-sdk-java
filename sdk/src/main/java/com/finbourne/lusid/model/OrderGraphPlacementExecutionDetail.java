...
public class OrderGraphPlacementExecutionDetail {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrderGraphPlacementExecutionDetail
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderGraphPlacementExecutionDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderGraphPlacementExecutionDetail is not found in the empty JSON string", OrderGraphPlacementExecutionDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrderGraphPlacementExecutionDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderGraphPlacementExecutionDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderGraphPlacementExecutionDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderGraphPlacementExecutionDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderGraphPlacementExecutionDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderGraphPlacementExecutionDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderGraphPlacementExecutionDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderGraphPlacementExecutionDetail>() {
           @Override
           public void write(JsonWriter out, OrderGraphPlacementExecutionDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderGraphPlacementExecutionDetail read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to OrderGraphPlacementExecutionDetail
  */
  public static OrderGraphPlacementExecutionDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderGraphPlacementExecutionDetail.class);
  }
