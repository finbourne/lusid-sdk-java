...
import com.finbourne.lusid.model.InflationLinkedBondAllOf;
 ...
 */
@ApiModel(description = "Inflation Linked Bond.")
...
public class InflationLinkedBond extends LusidInstrument {
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "The start date of the bond.")
  ...
  **/
   ...
   * @return identifiers
  **/
  @ApiModelProperty(value = "External market codes and identifiers for the bond, e.g. ISIN.")
  ...
  public InflationLinkedBond domCcy(String domCcy) {
    this.domCcy = domCcy; 
    return this;
  }
  ...
  **/
   ...
   * @return baseCPI
  **/
  @ApiModelProperty(value = "BaseCPI value. This is optional, if not provided the BaseCPI value will be calculated from the BaseCPIDate,  If that too is not present the StartDate will be used.  Note that both BaseCPI and BaseCPIDate cannot be set.  Some bonds are issued with a BaseCPI date that does not correspond to the StartDate CPI value, in this  case the value should be provided here or with the BaseCPIDate.")
   ...
   * @return baseCPIDate
  **/
  @ApiModelProperty(value = "BaseCPIDate. This is optional, if not provided the BaseCPI value will taken from the BaseCPI property,  if that too is not present than the StartDate will be used.  If present, the BaseCPI is calculated for this date, note this is an un-lagged date (similar to StartDate)  so the Bond ObservationLag will be applied to this date when calculating the CPI.  Note that both BaseCPI and BaseCPIDate cannot be set.  Some bonds are issued with a BaseCPI date that does not correspond to the StartDate CPI value, in this  case the value should be provided here or with the actual BaseCPI.")
  ...
  **/
  @ApiModelProperty(value = "The calculation type applied to the bond coupon and principal amount.  The default CalculationType is `Standard` and currently this is the only value supported.    Supported string (enumeration) values are: [Standard, Quarterly, Ratio].")
  ...
  **/
  @ApiModelProperty(value = "Number of Good Business Days before the next coupon payment, in which the bond goes ex-dividend.  This is not common in inflation linked bonds but has been seen with (for example) bonds issued by  the Bank of Thailand.")
  ...
  **/
  @ApiModelProperty(value = "Number of decimal places used to round IndexRatio. This defaults to 5 if not set.")
  ...
  public InflationLinkedBond inflationIndexName(String inflationIndexName) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Name of the index, e.g. UKRPI.")
  ...
  public InflationLinkedBond inflationInterpolation(String inflationInterpolation) {
  ...
  **/
  @ApiModelProperty(value = "Inflation Interpolation. This is optional and defaults to Linear if not set.    Supported string (enumeration) values are: [Linear, Flat].")
  ...
  public InflationLinkedBond inflationRollDay(Integer inflationRollDay) {
  ...
  **/
  ...
  public InflationLinkedBond observationLag(String observationLag) {
  ...
  **/
  @ApiModelProperty(value = "Observation lag. This is a Tenor that must have units of Month.  This field is typically 3 or 4 months, but can vary, older bonds have 8 months lag.  For Bonds with a calculation type of Ratio, this property, if set, must be 0Invalid.")
   ...
   * @return principal
  **/
  @ApiModelProperty(required = true, value = "The face-value or principal for the bond at outset.")
  ...
  **/
  @ApiModelProperty(value = "If true then the principal is protected in that the redemption amount will be at least the face value (Principal).  This is typically set to true for inflation linked bonds issued by the United States and France (for example).  This is typically set to false for inflation linked bonds issued by the United Kingdom (post 2005).  For other sovereigns this can vary from issue to issue.  If not set this property defaults to true.  This is sometimes referred to as Deflation protection or an inflation floor of 0%.")
