...
import com.finbourne.lusid.model.KeyValuePairOfStringToFieldSchema;
...
public class Schema {
  ...
  private List<KeyValuePairOfStringToFieldSchema> values = null;
  ...
  **/
  ...
  public Schema href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public Schema values(List<KeyValuePairOfStringToFieldSchema> values) {
    this.values = values;
    return this;
  }

  public Schema addValuesItem(KeyValuePairOfStringToFieldSchema valuesItem) {
    if (this.values == null) {
  ...
  **/
  @ApiModelProperty(value = "")
  public List<KeyValuePairOfStringToFieldSchema> getValues() {
    return values;
  }

  public void setValues(List<KeyValuePairOfStringToFieldSchema> values) {
    this.values = values;
  }
