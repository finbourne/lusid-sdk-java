...
public class TriggerEventAllOf {
  ...
  public TriggerEventAllOf level(java.math.BigDecimal level) {
    this.level = level; 
    return this;
  }
  ...
  **/
  ...
  public TriggerEventAllOf triggerType(String triggerType) {
  ...
  **/
  ...
  public TriggerEventAllOf triggerDirection(String triggerDirection) {
  ...
  **/
  ...
  public TriggerEventAllOf triggerDate(OffsetDateTime triggerDate) {
  ...
  **/
  ...
  public TriggerEventAllOf maturityDate(OffsetDateTime maturityDate) {
  ...
  **/
  ...
  public TriggerEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
