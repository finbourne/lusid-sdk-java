...
public class PortfolioIdComplianceParameter extends ComplianceParameter {
  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private ResourceId value;

  public PortfolioIdComplianceParameter() {
    // this.complianceParameterType = this.getClass().getSimpleName();
  }

  public PortfolioIdComplianceParameter value(ResourceId value) {
    this.value = value; 
    return this;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PortfolioIdComplianceParameter {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortfolioIdComplianceParameter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortfolioIdComplianceParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PortfolioIdComplianceParameter is not found in the empty JSON string", PortfolioIdComplianceParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PortfolioIdComplianceParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PortfolioIdComplianceParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PortfolioIdComplianceParameter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortfolioIdComplianceParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortfolioIdComplianceParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortfolioIdComplianceParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortfolioIdComplianceParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<PortfolioIdComplianceParameter>() {
           @Override
           public void write(JsonWriter out, PortfolioIdComplianceParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PortfolioIdComplianceParameter read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PortfolioIdComplianceParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PortfolioIdComplianceParameter
  * @throws IOException if the JSON string is invalid with respect to PortfolioIdComplianceParameter
  */
  public static PortfolioIdComplianceParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortfolioIdComplianceParameter.class);
  }

 /**
  * Convert an instance of PortfolioIdComplianceParameter to an JSON string
  *
  * @return JSON string
  */
