...
public class ResourceListOfHoldingsAdjustmentHeader {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfHoldingsAdjustmentHeader
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfHoldingsAdjustmentHeader.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfHoldingsAdjustmentHeader is not found in the empty JSON string", ResourceListOfHoldingsAdjustmentHeader.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfHoldingsAdjustmentHeader.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfHoldingsAdjustmentHeader` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfHoldingsAdjustmentHeader.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        HoldingsAdjustmentHeader.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfHoldingsAdjustmentHeader.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfHoldingsAdjustmentHeader' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfHoldingsAdjustmentHeader> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfHoldingsAdjustmentHeader.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfHoldingsAdjustmentHeader>() {
           @Override
           public void write(JsonWriter out, ResourceListOfHoldingsAdjustmentHeader value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfHoldingsAdjustmentHeader read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfHoldingsAdjustmentHeader
  */
  public static ResourceListOfHoldingsAdjustmentHeader fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfHoldingsAdjustmentHeader.class);
  }
