...
public class ConstituentsAdjustmentHeader {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ConstituentsAdjustmentHeader
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConstituentsAdjustmentHeader.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConstituentsAdjustmentHeader is not found in the empty JSON string", ConstituentsAdjustmentHeader.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ConstituentsAdjustmentHeader.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConstituentsAdjustmentHeader` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConstituentsAdjustmentHeader.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConstituentsAdjustmentHeader' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConstituentsAdjustmentHeader> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConstituentsAdjustmentHeader.class));

       return (TypeAdapter<T>) new TypeAdapter<ConstituentsAdjustmentHeader>() {
           @Override
           public void write(JsonWriter out, ConstituentsAdjustmentHeader value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConstituentsAdjustmentHeader read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ConstituentsAdjustmentHeader
  */
  public static ConstituentsAdjustmentHeader fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConstituentsAdjustmentHeader.class);
  }
