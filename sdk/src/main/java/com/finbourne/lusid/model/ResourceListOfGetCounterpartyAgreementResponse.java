...
public class ResourceListOfGetCounterpartyAgreementResponse {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<GetCounterpartyAgreementResponse> values = new ArrayList<>();
  ...
  public ResourceListOfGetCounterpartyAgreementResponse() {
  }

  public ResourceListOfGetCounterpartyAgreementResponse values(List<GetCounterpartyAgreementResponse> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfGetCounterpartyAgreementResponse addValuesItem(GetCounterpartyAgreementResponse valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<GetCounterpartyAgreementResponse> getValues() {

    return values;
  }


  public void setValues(List<GetCounterpartyAgreementResponse> values) {
    this.values = values;
  }


  public ResourceListOfGetCounterpartyAgreementResponse href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfGetCounterpartyAgreementResponse links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfGetCounterpartyAgreementResponse addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfGetCounterpartyAgreementResponse nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfGetCounterpartyAgreementResponse previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfGetCounterpartyAgreementResponse {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfGetCounterpartyAgreementResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfGetCounterpartyAgreementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfGetCounterpartyAgreementResponse is not found in the empty JSON string", ResourceListOfGetCounterpartyAgreementResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfGetCounterpartyAgreementResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfGetCounterpartyAgreementResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfGetCounterpartyAgreementResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        GetCounterpartyAgreementResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfGetCounterpartyAgreementResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfGetCounterpartyAgreementResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfGetCounterpartyAgreementResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfGetCounterpartyAgreementResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfGetCounterpartyAgreementResponse>() {
           @Override
           public void write(JsonWriter out, ResourceListOfGetCounterpartyAgreementResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfGetCounterpartyAgreementResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfGetCounterpartyAgreementResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfGetCounterpartyAgreementResponse
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfGetCounterpartyAgreementResponse
  */
  public static ResourceListOfGetCounterpartyAgreementResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfGetCounterpartyAgreementResponse.class);
  }

 /**
  * Convert an instance of ResourceListOfGetCounterpartyAgreementResponse to an JSON string
  *
  * @return JSON string
  */
