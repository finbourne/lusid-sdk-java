 ...
 */
@ApiModel(description = "Information about a change to a field / property.  At least one of 'PreviousValue' or 'NewValue' will be set.")
...
public class ChangeItem {
   ...
   * @return fieldName
  **/
  @ApiModelProperty(required = true, value = "The name of the field or property that has been changed.")
  ...
  **/
  @ApiModelProperty(value = "The previous value for this field / property.")
   ...
   * @return newValue
  **/
  @ApiModelProperty(value = "The new value for this field / property.")
  ...
  **/
  @ApiModelProperty(value = "The market data time, i.e. the time to run the change from.")
  ...
  **/
  @ApiModelProperty(value = "The market data time, i.e. the time to run the change until.")
