...
public class TransactionSetConfigurationData {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("transactionConfigs");
    openapiFields.add("sideDefinitions");
    openapiFields.add("links");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("transactionConfigs");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransactionSetConfigurationData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionSetConfigurationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionSetConfigurationData is not found in the empty JSON string", TransactionSetConfigurationData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransactionSetConfigurationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionSetConfigurationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionSetConfigurationData.openapiRequiredFields) {
      ...
      if (!jsonObj.get("transactionConfigs").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `transactionConfigs` to be an array in the JSON string but got `%s`", jsonObj.get("transactionConfigs").toString()));
      }

      JsonArray jsonArraytransactionConfigs = jsonObj.getAsJsonArray("transactionConfigs");
      // validate the required field `transactionConfigs` (array)
      for (int i = 0; i < jsonArraytransactionConfigs.size(); i++) {
        TransactionConfigurationData.validateJsonElement(jsonArraytransactionConfigs.get(i));
      };
      if (jsonObj.get("sideDefinitions") != null && !jsonObj.get("sideDefinitions").isJsonNull()) {
        JsonArray jsonArraysideDefinitions = jsonObj.getAsJsonArray("sideDefinitions");
        if (jsonArraysideDefinitions != null) {
          // ensure the json data is an array
          if (!jsonObj.get("sideDefinitions").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `sideDefinitions` to be an array in the JSON string but got `%s`", jsonObj.get("sideDefinitions").toString()));
          }

          // validate the optional field `sideDefinitions` (array)
          for (int i = 0; i < jsonArraysideDefinitions.size(); i++) {
            SideConfigurationData.validateJsonElement(jsonArraysideDefinitions.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionSetConfigurationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionSetConfigurationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionSetConfigurationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionSetConfigurationData.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionSetConfigurationData>() {
           @Override
           public void write(JsonWriter out, TransactionSetConfigurationData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactionSetConfigurationData read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to TransactionSetConfigurationData
  */
  public static TransactionSetConfigurationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionSetConfigurationData.class);
  }
