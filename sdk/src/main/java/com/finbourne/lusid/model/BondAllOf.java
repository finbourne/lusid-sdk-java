...
public class BondAllOf {
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "The Start date of the bond, this is normally when accrual of the first coupon begins.")
   ...
   * @return maturityDate
  **/
  @ApiModelProperty(required = true, value = "The Maturity date of the bond, this is when the last coupon accrual period ends.  Note that while most bonds have their last payment on this date there are some cases where the final payment is the next working day.")
   ...
   * @return domCcy
  **/
  @ApiModelProperty(required = true, value = "The domestic currency of the instrument. This should be the same as the Currency set on the FlowConventions.")
  ...
  **/
   ...
   * @return principal
  **/
  @ApiModelProperty(required = true, value = "The face-value or principal for the bond at outset.  This might be reduced through its lifetime in the event of amortisation or similar.")
  ...
  **/
  ...
  public BondAllOf putIdentifiersItem(String key, String identifiersItem) {
  ...
  **/
  @ApiModelProperty(value = "Optional. If set, this is the date at which the bond begins to accrue interest, if not set then the bond begins to accrue on the StartDate.")
  ...
  public BondAllOf firstCouponPayDate(OffsetDateTime firstCouponPayDate) {
  ...
  **/
  @ApiModelProperty(value = "The date that the first coupon of the bond is paid. This is required for bonds that have a long first coupon or short first coupon. The first coupon pay date is used  as an anchor to compare with the start date and determine if this is a long/short coupon period.")
  ...
  public BondAllOf calculationType(String calculationType) {
  ...
  **/
  ...
  public BondAllOf roundingConventions(List<RoundingConvention> roundingConventions) {
    this.roundingConventions = roundingConventions; 
    return this;
  }

  public BondAllOf addRoundingConventionsItem(RoundingConvention roundingConventionsItem) {
  ...
  **/
  ...
  public BondAllOf exDividendConfiguration(ExDividendConfiguration exDividendConfiguration) {
