...
public class PagedResourceListOfLegalEntity {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfLegalEntity
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfLegalEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfLegalEntity is not found in the empty JSON string", PagedResourceListOfLegalEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfLegalEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfLegalEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfLegalEntity.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        LegalEntity.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfLegalEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfLegalEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfLegalEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfLegalEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfLegalEntity>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfLegalEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfLegalEntity read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfLegalEntity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfLegalEntity
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfLegalEntity
  */
  public static PagedResourceListOfLegalEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfLegalEntity.class);
  }

 /**
  * Convert an instance of PagedResourceListOfLegalEntity to an JSON string
  *
  * @return JSON string
  */
