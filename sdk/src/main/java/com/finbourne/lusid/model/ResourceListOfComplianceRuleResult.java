...
public class ResourceListOfComplianceRuleResult {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfComplianceRuleResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfComplianceRuleResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfComplianceRuleResult is not found in the empty JSON string", ResourceListOfComplianceRuleResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfComplianceRuleResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfComplianceRuleResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfComplianceRuleResult.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ComplianceRuleResult.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfComplianceRuleResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfComplianceRuleResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfComplianceRuleResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfComplianceRuleResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfComplianceRuleResult>() {
           @Override
           public void write(JsonWriter out, ResourceListOfComplianceRuleResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfComplianceRuleResult read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfComplianceRuleResult
  */
  public static ResourceListOfComplianceRuleResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfComplianceRuleResult.class);
  }
