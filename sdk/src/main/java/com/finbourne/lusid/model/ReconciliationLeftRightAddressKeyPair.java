...
public class ReconciliationLeftRightAddressKeyPair {
   ...
   * @return left
  **/
  @ApiModelProperty(required = true, value = "Address key defined by the lhs aggregation")
   ...
   * @return right
  **/
  @ApiModelProperty(required = true, value = "Address key defined by the rhs aggregation")
