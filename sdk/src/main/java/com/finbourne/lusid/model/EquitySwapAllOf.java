...
public class EquitySwapAllOf {
  ...
  **/
  ...
  public EquitySwapAllOf equitySwapDividendPaymentTiming(String equitySwapDividendPaymentTiming) {
  ...
  **/
  @ApiModelProperty(value = "Determines how the payment of dividends is handled for the equity swap.  Defaults to paying at the next Equity coupon date.                Supported string (enumeration) values are: [PayAtNextEquityCouponDate, PayAtMaturityOfSwap, PayAtNextFundingLegCouponDate, PayAtPaymentDateOfDividendEvent].")
