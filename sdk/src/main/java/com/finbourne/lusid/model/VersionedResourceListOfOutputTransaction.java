...
public class VersionedResourceListOfOutputTransaction {
  ...
  public VersionedResourceListOfOutputTransaction() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to VersionedResourceListOfOutputTransaction
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VersionedResourceListOfOutputTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VersionedResourceListOfOutputTransaction is not found in the empty JSON string", VersionedResourceListOfOutputTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VersionedResourceListOfOutputTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VersionedResourceListOfOutputTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VersionedResourceListOfOutputTransaction.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        OutputTransaction.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VersionedResourceListOfOutputTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VersionedResourceListOfOutputTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VersionedResourceListOfOutputTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VersionedResourceListOfOutputTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<VersionedResourceListOfOutputTransaction>() {
           @Override
           public void write(JsonWriter out, VersionedResourceListOfOutputTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VersionedResourceListOfOutputTransaction read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VersionedResourceListOfOutputTransaction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VersionedResourceListOfOutputTransaction
  * @throws IOException if the JSON string is invalid with respect to VersionedResourceListOfOutputTransaction
  */
  public static VersionedResourceListOfOutputTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionedResourceListOfOutputTransaction.class);
  }

 /**
  * Convert an instance of VersionedResourceListOfOutputTransaction to an JSON string
  *
  * @return JSON string
  */
