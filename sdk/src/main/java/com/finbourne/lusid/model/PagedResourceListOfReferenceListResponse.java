...
public class PagedResourceListOfReferenceListResponse {
  ...
  private List<ReferenceListResponse> values = new ArrayList<>();
  ...
  public PagedResourceListOfReferenceListResponse() {
  }

  public PagedResourceListOfReferenceListResponse nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfReferenceListResponse previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfReferenceListResponse values(List<ReferenceListResponse> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfReferenceListResponse addValuesItem(ReferenceListResponse valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<ReferenceListResponse> getValues() {

    return values;
  }


  public void setValues(List<ReferenceListResponse> values) {
    this.values = values;
  }


  public PagedResourceListOfReferenceListResponse href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfReferenceListResponse links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfReferenceListResponse addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfReferenceListResponse {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfReferenceListResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfReferenceListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfReferenceListResponse is not found in the empty JSON string", PagedResourceListOfReferenceListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfReferenceListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfReferenceListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfReferenceListResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ReferenceListResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfReferenceListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfReferenceListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfReferenceListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfReferenceListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfReferenceListResponse>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfReferenceListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfReferenceListResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfReferenceListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfReferenceListResponse
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfReferenceListResponse
  */
  public static PagedResourceListOfReferenceListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfReferenceListResponse.class);
  }

 /**
  * Convert an instance of PagedResourceListOfReferenceListResponse to an JSON string
  *
  * @return JSON string
  */
