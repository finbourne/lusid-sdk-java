...
public class StockSplitEventAllOf {
  ...
  public StockSplitEventAllOf equitySplitRatio(java.math.BigDecimal equitySplitRatio) {
  ...
  **/
  ...
  public StockSplitEventAllOf paymentDate(OffsetDateTime paymentDate) {
  ...
  **/
  ...
  public StockSplitEventAllOf recordDate(OffsetDateTime recordDate) {
  ...
  **/
  ...
  public StockSplitEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
