...
public class FundA2BDataRecord {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FundA2BDataRecord
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FundA2BDataRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FundA2BDataRecord is not found in the empty JSON string", FundA2BDataRecord.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FundA2BDataRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FundA2BDataRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FundA2BDataRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FundA2BDataRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<FundA2BDataRecord>() {
           @Override
           public void write(JsonWriter out, FundA2BDataRecord value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FundA2BDataRecord read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to FundA2BDataRecord
  */
  public static FundA2BDataRecord fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FundA2BDataRecord.class);
  }
