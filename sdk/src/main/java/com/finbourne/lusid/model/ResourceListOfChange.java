...
public class ResourceListOfChange {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<Change> values = new ArrayList<>();
  ...
  public ResourceListOfChange() {
  }

  public ResourceListOfChange values(List<Change> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfChange addValuesItem(Change valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<Change> getValues() {

    return values;
  }


  public void setValues(List<Change> values) {
    this.values = values;
  }


  public ResourceListOfChange href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfChange links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfChange addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfChange nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfChange previousPage(String previousPage) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfChange
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfChange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfChange is not found in the empty JSON string", ResourceListOfChange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfChange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfChange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfChange.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        Change.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfChange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfChange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfChange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfChange.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfChange>() {
           @Override
           public void write(JsonWriter out, ResourceListOfChange value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfChange read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfChange given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfChange
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfChange
  */
  public static ResourceListOfChange fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfChange.class);
  }

 /**
  * Convert an instance of ResourceListOfChange to an JSON string
  *
  * @return JSON string
  */
