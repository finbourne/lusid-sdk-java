...
public class FlexibleDeposit extends LusidInstrument {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FlexibleDeposit
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlexibleDeposit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FlexibleDeposit is not found in the empty JSON string", FlexibleDeposit.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlexibleDeposit.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlexibleDeposit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlexibleDeposit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlexibleDeposit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlexibleDeposit.class));

       return (TypeAdapter<T>) new TypeAdapter<FlexibleDeposit>() {
           @Override
           public void write(JsonWriter out, FlexibleDeposit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FlexibleDeposit read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to FlexibleDeposit
  */
  public static FlexibleDeposit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlexibleDeposit.class);
  }
