...
public class AggregationQuery {
  ...
  private Map<String, AddressKeyOptionDefinition> applicableOptions = null;
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Financially meaningful results can be presented as either simple flat types or more complex expanded types. This field gives the type of the more complex representation.  For example, the present value (PV) of a holding could be represented either as a simple decimal (with currency implied) or as a decimal-currency pair. In this example, the type returned in this field would be \"Result0D\", the decimal-currency pair. The available values are: String, Int, Decimal, DateTime, Boolean, ResultValue, Result0D, Json")
  ...
  **/
   ...
   * @return removalDate
  **/
  @ApiModelProperty(value = "If the life cycle status is set to deprecated then this will be populated with the date on or after which removal of the address query will happen")
  ...
  **/
  @ApiModelProperty(value = "A mapping from option names to the definition that the corresponding option value must match.")
