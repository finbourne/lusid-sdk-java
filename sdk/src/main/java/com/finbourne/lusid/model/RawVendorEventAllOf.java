...
public class RawVendorEventAllOf {
  ...
  private LifeCycleEventValue eventValue = null;
  ...
  public RawVendorEventAllOf effectiveAt(OffsetDateTime effectiveAt) {
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The effective date of the event")
  ...
  public RawVendorEventAllOf eventValue(LifeCycleEventValue eventValue) {
  ...
  **/
  ...
  public RawVendorEventAllOf eventType(String eventType) {
   ...
   * @return eventType
  **/
  @ApiModelProperty(required = true, value = "What type of internal event does this represent; reset, exercise, amortisation etc.")
  ...
  public RawVendorEventAllOf eventStatus(String eventStatus) {
  ...
  **/
  ...
  public RawVendorEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
