 ...
 */
@ApiModel(description = "A request to create or update multiple Executions.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ExecutionSetRequest {
  public static final String SERIALIZED_NAME_REQUESTS = "requests";
  @SerializedName(SERIALIZED_NAME_REQUESTS)
  private List<ExecutionRequest> requests = null;
   ...
   * @return requests
  **/
  @ApiModelProperty(value = "A collection of ExecutionRequests.")
