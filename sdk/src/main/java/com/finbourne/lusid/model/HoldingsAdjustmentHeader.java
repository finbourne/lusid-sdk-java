...
public class HoldingsAdjustmentHeader {
  ...
  * @throws IOException if the JSON Element is invalid with respect to HoldingsAdjustmentHeader
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HoldingsAdjustmentHeader.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HoldingsAdjustmentHeader is not found in the empty JSON string", HoldingsAdjustmentHeader.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!HoldingsAdjustmentHeader.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HoldingsAdjustmentHeader` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HoldingsAdjustmentHeader.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HoldingsAdjustmentHeader.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HoldingsAdjustmentHeader' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HoldingsAdjustmentHeader> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HoldingsAdjustmentHeader.class));

       return (TypeAdapter<T>) new TypeAdapter<HoldingsAdjustmentHeader>() {
           @Override
           public void write(JsonWriter out, HoldingsAdjustmentHeader value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HoldingsAdjustmentHeader read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to HoldingsAdjustmentHeader
  */
  public static HoldingsAdjustmentHeader fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HoldingsAdjustmentHeader.class);
  }
