...
public class CreateSequenceRequest {
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The code of the sequence definition to create")
   ...
   * @return increment
  **/
  @ApiModelProperty(value = "The value to increment between each value in the sequence")
   ...
   * @return minValue
  **/
  @ApiModelProperty(value = "The minimum value of the sequence")
   ...
   * @return maxValue
  **/
  @ApiModelProperty(value = "The maximum value of the sequence")
   ...
   * @return start
  **/
  @ApiModelProperty(value = "The start value of the sequence")
   ...
   * @return cycle
  **/
  @ApiModelProperty(value = "Set to true to start the sequence over again when it reaches the end. Defaults to false if not provided.")
   ...
   * @return pattern
  **/
  @ApiModelProperty(value = "The pattern to be used to generate next values in the sequence. Defaults to null if not provided.")
