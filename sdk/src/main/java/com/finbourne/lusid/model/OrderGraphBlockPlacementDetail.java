...
public class OrderGraphBlockPlacementDetail {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrderGraphBlockPlacementDetail
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderGraphBlockPlacementDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderGraphBlockPlacementDetail is not found in the empty JSON string", OrderGraphBlockPlacementDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrderGraphBlockPlacementDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderGraphBlockPlacementDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderGraphBlockPlacementDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderGraphBlockPlacementDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderGraphBlockPlacementDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderGraphBlockPlacementDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderGraphBlockPlacementDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderGraphBlockPlacementDetail>() {
           @Override
           public void write(JsonWriter out, OrderGraphBlockPlacementDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderGraphBlockPlacementDetail read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to OrderGraphBlockPlacementDetail
  */
  public static OrderGraphBlockPlacementDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderGraphBlockPlacementDetail.class);
  }
