...
public class RecResultHoldingItem {
  ...
  **/
  ...
  public RecResultHoldingItem holdingId(String holdingId) {
  ...
  **/
  ...
  public RecResultHoldingItem taxLotId(String taxLotId) {
  ...
  **/
  ...
  public RecResultHoldingItem itemType(String itemType) {
  ...
  **/
  ...
  public RecResultHoldingItem ruleAndAttributeValues(Map<String, String> ruleAndAttributeValues) {
    
    this.ruleAndAttributeValues = ruleAndAttributeValues;
    return this;
  }

  public RecResultHoldingItem putRuleAndAttributeValuesItem(String key, String ruleAndAttributeValuesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RecResultHoldingItem recResultHoldingItem = (RecResultHoldingItem) o;
    return Objects.equals(this.portfolioId, recResultHoldingItem.portfolioId) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to RecResultHoldingItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecResultHoldingItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecResultHoldingItem is not found in the empty JSON string", RecResultHoldingItem.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecResultHoldingItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecResultHoldingItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecResultHoldingItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecResultHoldingItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecResultHoldingItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RecResultHoldingItem>() {
           @Override
           public void write(JsonWriter out, RecResultHoldingItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecResultHoldingItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RecResultHoldingItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecResultHoldingItem
  * @throws IOException if the JSON string is invalid with respect to RecResultHoldingItem
  */
  public static RecResultHoldingItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecResultHoldingItem.class);
  }

 /**
  * Convert an instance of RecResultHoldingItem to an JSON string
  *
  * @return JSON string
  */
