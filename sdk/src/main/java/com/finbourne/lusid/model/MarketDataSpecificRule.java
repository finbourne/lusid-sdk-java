...
public class MarketDataSpecificRule {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, supplier, dataScope, quoteType, field, quoteInterval, asAt, priceSource, mask, dependencySourceFilter, sourceSystem);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MarketDataSpecificRule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MarketDataSpecificRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MarketDataSpecificRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MarketDataSpecificRule` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      DependencySourceFilter.validateJsonObject(jsonObj.getAsJsonObject("dependencySourceFilter"));
