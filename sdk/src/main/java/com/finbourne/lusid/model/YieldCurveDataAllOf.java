...
public class YieldCurveDataAllOf {
  ...
  **/
  ...
  public YieldCurveDataAllOf lineage(String lineage) {
   ...
   * @return lineage
  **/
  @ApiModelProperty(value = "Description of the complex market data's lineage e.g. 'FundAccountant_GreenQuality'.")
  ...
  public YieldCurveDataAllOf marketDataOptions(MarketDataOptions marketDataOptions) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: DiscountFactorCurveData, EquityVolSurfaceData, FxVolSurfaceData, IrVolCubeData, OpaqueMarketData, YieldCurveData, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData, FxForwardCurveByQuoteReference, CreditSpreadCurveData, EquityCurveByPricesData")
