...
public class PortfolioGroupIdList extends ReferenceList {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortfolioGroupIdList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortfolioGroupIdList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PortfolioGroupIdList is not found in the empty JSON string", PortfolioGroupIdList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PortfolioGroupIdList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PortfolioGroupIdList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PortfolioGroupIdList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortfolioGroupIdList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortfolioGroupIdList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortfolioGroupIdList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortfolioGroupIdList.class));

       return (TypeAdapter<T>) new TypeAdapter<PortfolioGroupIdList>() {
           @Override
           public void write(JsonWriter out, PortfolioGroupIdList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PortfolioGroupIdList read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PortfolioGroupIdList
  */
  public static PortfolioGroupIdList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortfolioGroupIdList.class);
  }
