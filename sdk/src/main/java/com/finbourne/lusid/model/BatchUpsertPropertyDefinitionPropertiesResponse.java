...
public class BatchUpsertPropertyDefinitionPropertiesResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to BatchUpsertPropertyDefinitionPropertiesResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchUpsertPropertyDefinitionPropertiesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BatchUpsertPropertyDefinitionPropertiesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchUpsertPropertyDefinitionPropertiesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
