...
public class ShareClass {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ShareClass
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShareClass.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShareClass is not found in the empty JSON string", ShareClass.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShareClass.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShareClass.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShareClass' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShareClass> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShareClass.class));

       return (TypeAdapter<T>) new TypeAdapter<ShareClass>() {
           @Override
           public void write(JsonWriter out, ShareClass value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShareClass read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ShareClass
  */
  public static ShareClass fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShareClass.class);
  }
