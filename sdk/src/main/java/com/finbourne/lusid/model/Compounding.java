...
public class Compounding {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Compounding
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Compounding.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Compounding.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Compounding` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
