...
public class PropertyInterval {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PropertyInterval
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PropertyInterval.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PropertyInterval.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PropertyInterval` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      DateRange.validateJsonElement(jsonObj.get("asAtRange"));
