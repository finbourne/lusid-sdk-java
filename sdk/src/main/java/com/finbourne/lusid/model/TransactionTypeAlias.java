...
public class TransactionTypeAlias {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionTypeAlias
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionTypeAlias.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransactionTypeAlias.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionTypeAlias` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
