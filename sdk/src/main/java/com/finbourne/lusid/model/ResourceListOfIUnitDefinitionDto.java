...
public class ResourceListOfIUnitDefinitionDto {
  ...
  private List<IUnitDefinitionDto> values = new ArrayList<>();
  ...
  public ResourceListOfIUnitDefinitionDto() {
  }
  ...
  public ResourceListOfIUnitDefinitionDto addValuesItem(IUnitDefinitionDto valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public ResourceListOfIUnitDefinitionDto href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfIUnitDefinitionDto addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfIUnitDefinitionDto nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfIUnitDefinitionDto previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfIUnitDefinitionDto {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfIUnitDefinitionDto
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfIUnitDefinitionDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfIUnitDefinitionDto is not found in the empty JSON string", ResourceListOfIUnitDefinitionDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfIUnitDefinitionDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfIUnitDefinitionDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfIUnitDefinitionDto.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        IUnitDefinitionDto.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfIUnitDefinitionDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfIUnitDefinitionDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfIUnitDefinitionDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfIUnitDefinitionDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfIUnitDefinitionDto>() {
           @Override
           public void write(JsonWriter out, ResourceListOfIUnitDefinitionDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfIUnitDefinitionDto read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfIUnitDefinitionDto given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfIUnitDefinitionDto
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfIUnitDefinitionDto
  */
  public static ResourceListOfIUnitDefinitionDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfIUnitDefinitionDto.class);
  }

 /**
  * Convert an instance of ResourceListOfIUnitDefinitionDto to an JSON string
  *
  * @return JSON string
  */
