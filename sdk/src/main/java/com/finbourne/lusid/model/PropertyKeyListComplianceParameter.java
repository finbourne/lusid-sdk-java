...
public class PropertyKeyListComplianceParameter extends ComplianceParameter {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PropertyKeyListComplianceParameter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PropertyKeyListComplianceParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PropertyKeyListComplianceParameter is not found in the empty JSON string", PropertyKeyListComplianceParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PropertyKeyListComplianceParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PropertyKeyListComplianceParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PropertyKeyListComplianceParameter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PropertyKeyListComplianceParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PropertyKeyListComplianceParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PropertyKeyListComplianceParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PropertyKeyListComplianceParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<PropertyKeyListComplianceParameter>() {
           @Override
           public void write(JsonWriter out, PropertyKeyListComplianceParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PropertyKeyListComplianceParameter read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PropertyKeyListComplianceParameter
  */
  public static PropertyKeyListComplianceParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PropertyKeyListComplianceParameter.class);
  }
