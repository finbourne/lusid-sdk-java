...
public class ResourceListOfGetRecipeResponse {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<GetRecipeResponse> values = new ArrayList<>();
  ...
  public ResourceListOfGetRecipeResponse() {
  }

  public ResourceListOfGetRecipeResponse values(List<GetRecipeResponse> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfGetRecipeResponse addValuesItem(GetRecipeResponse valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<GetRecipeResponse> getValues() {

    return values;
  }


  public void setValues(List<GetRecipeResponse> values) {
    this.values = values;
  }


  public ResourceListOfGetRecipeResponse href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfGetRecipeResponse links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfGetRecipeResponse addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfGetRecipeResponse nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfGetRecipeResponse previousPage(String previousPage) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfGetRecipeResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfGetRecipeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfGetRecipeResponse is not found in the empty JSON string", ResourceListOfGetRecipeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfGetRecipeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfGetRecipeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfGetRecipeResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        GetRecipeResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfGetRecipeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfGetRecipeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfGetRecipeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfGetRecipeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfGetRecipeResponse>() {
           @Override
           public void write(JsonWriter out, ResourceListOfGetRecipeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfGetRecipeResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfGetRecipeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfGetRecipeResponse
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfGetRecipeResponse
  */
  public static ResourceListOfGetRecipeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfGetRecipeResponse.class);
  }

 /**
  * Convert an instance of ResourceListOfGetRecipeResponse to an JSON string
  *
  * @return JSON string
  */
