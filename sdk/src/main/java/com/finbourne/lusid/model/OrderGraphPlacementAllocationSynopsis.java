...
public class OrderGraphPlacementAllocationSynopsis {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrderGraphPlacementAllocationSynopsis
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderGraphPlacementAllocationSynopsis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderGraphPlacementAllocationSynopsis is not found in the empty JSON string", OrderGraphPlacementAllocationSynopsis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrderGraphPlacementAllocationSynopsis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderGraphPlacementAllocationSynopsis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderGraphPlacementAllocationSynopsis.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydetails.size(); i++) {
        OrderGraphPlacementAllocationDetail.validateJsonElement(jsonArraydetails.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderGraphPlacementAllocationSynopsis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderGraphPlacementAllocationSynopsis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderGraphPlacementAllocationSynopsis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderGraphPlacementAllocationSynopsis.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderGraphPlacementAllocationSynopsis>() {
           @Override
           public void write(JsonWriter out, OrderGraphPlacementAllocationSynopsis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderGraphPlacementAllocationSynopsis read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to OrderGraphPlacementAllocationSynopsis
  */
  public static OrderGraphPlacementAllocationSynopsis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderGraphPlacementAllocationSynopsis.class);
  }
