...
public class ResourceListOfGetCreditSupportAnnexResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfGetCreditSupportAnnexResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfGetCreditSupportAnnexResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfGetCreditSupportAnnexResponse is not found in the empty JSON string", ResourceListOfGetCreditSupportAnnexResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfGetCreditSupportAnnexResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfGetCreditSupportAnnexResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfGetCreditSupportAnnexResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        GetCreditSupportAnnexResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfGetCreditSupportAnnexResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfGetCreditSupportAnnexResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfGetCreditSupportAnnexResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfGetCreditSupportAnnexResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfGetCreditSupportAnnexResponse>() {
           @Override
           public void write(JsonWriter out, ResourceListOfGetCreditSupportAnnexResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfGetCreditSupportAnnexResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfGetCreditSupportAnnexResponse
  */
  public static ResourceListOfGetCreditSupportAnnexResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfGetCreditSupportAnnexResponse.class);
  }
