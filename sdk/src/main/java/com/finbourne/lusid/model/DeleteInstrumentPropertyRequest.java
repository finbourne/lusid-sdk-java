...
public class DeleteInstrumentPropertyRequest {
  ...
  **/
  @ApiModelProperty(value = "The property key of the property to be removed from the instrument, e.g 'Instrument/default/Cusip`")
  ...
  **/
  @ApiModelProperty(value = "The date at which the property removal should be effective from. If no value is set, then 'now' is used.")
