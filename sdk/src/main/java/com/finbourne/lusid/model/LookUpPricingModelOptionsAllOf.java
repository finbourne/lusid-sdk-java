...
public class LookUpPricingModelOptionsAllOf {
  public static final String SERIALIZED_NAME_ADD_ACCRUAL = "addAccrual";
  @SerializedName(SERIALIZED_NAME_ADD_ACCRUAL)
  private Boolean addAccrual;

  public static final String SERIALIZED_NAME_APPLY_INDEX_RATIO = "applyIndexRatio";
  @SerializedName(SERIALIZED_NAME_APPLY_INDEX_RATIO)
  private Boolean applyIndexRatio;
  ...
  public LookUpPricingModelOptionsAllOf addAccrual(Boolean addAccrual) {
   ...
   * @return addAccrual
  **/
  @ApiModelProperty(required = true, value = "Add Instrument Accrual to Valuation")
  public Boolean getAddAccrual() {
    return addAccrual;
  }

  public void setAddAccrual(Boolean addAccrual) {
    this.addAccrual = addAccrual;
  }


  public LookUpPricingModelOptionsAllOf applyIndexRatio(Boolean applyIndexRatio) {
   ...
   * @return applyIndexRatio
  **/
  @ApiModelProperty(required = true, value = "Apply Index Ratio to price before valuation.  Used for InflationLinkedBond")
  public Boolean getApplyIndexRatio() {
    return applyIndexRatio;
  }

  public void setApplyIndexRatio(Boolean applyIndexRatio) {
    this.applyIndexRatio = applyIndexRatio;
  }


  public LookUpPricingModelOptionsAllOf modelOptionsType(ModelOptionsTypeEnum modelOptionsType) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    addAccrual: ").append(toIndentedString(addAccrual)).append("\n");
    sb.append("    applyIndexRatio: ").append(toIndentedString(applyIndexRatio)).append("\n");
