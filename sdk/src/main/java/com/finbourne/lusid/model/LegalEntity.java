...
public class LegalEntity {
  ...
  **/
  @ApiModelProperty(value = "The unique LUSID Legal Entity Identifier of the Legal Entity.")
  ...
  **/
  @ApiModelProperty(value = "A set of relationships associated to the Legal Entity.")
