...
public class GetCreditSupportAnnexResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetCreditSupportAnnexResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCreditSupportAnnexResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCreditSupportAnnexResponse is not found in the empty JSON string", GetCreditSupportAnnexResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetCreditSupportAnnexResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCreditSupportAnnexResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        CreditSupportAnnex.validateJsonElement(jsonObj.get("value"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCreditSupportAnnexResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCreditSupportAnnexResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCreditSupportAnnexResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCreditSupportAnnexResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCreditSupportAnnexResponse>() {
           @Override
           public void write(JsonWriter out, GetCreditSupportAnnexResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCreditSupportAnnexResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to GetCreditSupportAnnexResponse
  */
  public static GetCreditSupportAnnexResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCreditSupportAnnexResponse.class);
  }
