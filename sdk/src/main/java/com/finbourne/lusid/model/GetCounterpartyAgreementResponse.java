...
public class GetCounterpartyAgreementResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetCounterpartyAgreementResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetCounterpartyAgreementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetCounterpartyAgreementResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCounterpartyAgreementResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        CounterpartyAgreement.validateJsonObject(jsonObj.getAsJsonObject("value"));
      }
