...
public class GetCdsFlowConventionsResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetCdsFlowConventionsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCdsFlowConventionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCdsFlowConventionsResponse is not found in the empty JSON string", GetCdsFlowConventionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetCdsFlowConventionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCdsFlowConventionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        CdsFlowConventions.validateJsonElement(jsonObj.get("value"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCdsFlowConventionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCdsFlowConventionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCdsFlowConventionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCdsFlowConventionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCdsFlowConventionsResponse>() {
           @Override
           public void write(JsonWriter out, GetCdsFlowConventionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCdsFlowConventionsResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to GetCdsFlowConventionsResponse
  */
  public static GetCdsFlowConventionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCdsFlowConventionsResponse.class);
  }
