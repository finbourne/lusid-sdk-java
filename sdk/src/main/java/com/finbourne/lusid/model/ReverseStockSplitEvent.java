...
public class ReverseStockSplitEvent extends InstrumentEvent {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ReverseStockSplitEvent
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReverseStockSplitEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReverseStockSplitEvent is not found in the empty JSON string", ReverseStockSplitEvent.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReverseStockSplitEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReverseStockSplitEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReverseStockSplitEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReverseStockSplitEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReverseStockSplitEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<ReverseStockSplitEvent>() {
           @Override
           public void write(JsonWriter out, ReverseStockSplitEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReverseStockSplitEvent read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ReverseStockSplitEvent
  */
  public static ReverseStockSplitEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReverseStockSplitEvent.class);
  }
