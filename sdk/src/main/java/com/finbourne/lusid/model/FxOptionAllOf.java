...
public class FxOptionAllOf {
  ...
  **/
  @ApiModelProperty(required = true, value = "True if the option delivers the FX underlying, False if the option is settled in cash.")
  ...
  **/
   ...
   * @return payoutStyle
  **/
  @ApiModelProperty(value = "PayoutStyle for touch options.                For options without touch optionality, payoutStyle should not be set.  For options with touch optionality (where the touches data has been set), payoutStyle must be defined and cannot be None.    Supported string (enumeration) values are: [Deferred, Immediate].")
