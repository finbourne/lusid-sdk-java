...
public class FxOptionAllOf {
  ...
  **/
  ...
  public FxOptionAllOf fgnAmount(java.math.BigDecimal fgnAmount) {
   ...
   * @return fgnAmount
  **/
  @ApiModelProperty(value = "For a vanilla FxOption contract, FgnAmount cannot be set.  In case of a digital FxOption (IsPayoffDigital==true)  a payoff (if the option is in the money) can be either  in domestic or in foreign currency - for the latter  FgnAmount must be set.  Note: It is invalid to have FgnAmount and DomAmount  at the same time.")
   ...
   * @return strike
  **/
  @ApiModelProperty(value = "The strike of the option.")
  ...
  public FxOptionAllOf barriers(List<Barrier> barriers) {
    this.barriers = barriers; 
    return this;
  }

  public FxOptionAllOf addBarriersItem(Barrier barriersItem) {
   ...
   * @return barriers
  **/
  @ApiModelProperty(value = "For a barrier option the list should not be empty. Up to two barriers are supported.  An option cannot be at the same time barrier- and touch-option.  One (or both) of the lists must be empty.")
  ...
  public FxOptionAllOf exerciseType(String exerciseType) {
   ...
   * @return exerciseType
  **/
  @ApiModelProperty(value = "Type of optionality that is present; European, Bermudan, American.    Supported string (enumeration) values are: [European, Bermudan, American].")
  ...
  **/
  @ApiModelProperty(required = true, value = "True if the option is settled in cash, false if delivery.")
  ...
  public FxOptionAllOf isPayoffDigital(Boolean isPayoffDigital) {
  ...
  **/
  @ApiModelProperty(value = "By default IsPayoffDigital is false. If IsPayoffDigital=true,  the option is 'digital', and the option payoff is 0 or 1 unit of currency,  instead of a vanilla CallPayoff=max(spot-strike,0) or PutPayoff=max(strike-spot,0).")
  ...
  **/
  ...
  public FxOptionAllOf payoutStyle(String payoutStyle) {
   ...
   * @return payoutStyle
  **/
  @ApiModelProperty(value = "PayoutStyle for touch options.  For options without touch optionality (IsTouch==false),  PayoutStyle should not be set (ot it can be set to None)  For options with touch optionality (IsTouch==true),  PayoutStyle cannot be None.    Supported string (enumeration) values are: [Deferred, Immediate].")
  ...
  **/
  ...
  public FxOptionAllOf touches(List<Touch> touches) {
    this.touches = touches; 
    return this;
  }

  public FxOptionAllOf addTouchesItem(Touch touchesItem) {
   ...
   * @return touches
  **/
  @ApiModelProperty(value = "For a touch option the list should not be empty. Up to two touches are supported.  An option cannot be at the same time barrier- and touch-option.  One (or both) of the lists must be empty.")
