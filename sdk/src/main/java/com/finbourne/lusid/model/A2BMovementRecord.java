...
public class A2BMovementRecord {
  ...
  private List<ResponseMetaData> errors = null;
  ...
  **/
   ...
   * @return holdingType
  **/
  @ApiModelProperty(value = "The code for the type of the holding e.g. P, B, C, R, F etc.")
  ...
  **/
   ...
   * @return errors
  **/
  @ApiModelProperty(value = "Any errors with the record are reported here.")
