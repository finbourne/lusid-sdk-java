...
public class A2BMovementRecord {
  ...
  * @throws IOException if the JSON Object is invalid with respect to A2BMovementRecord
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!A2BMovementRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!A2BMovementRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `A2BMovementRecord` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
