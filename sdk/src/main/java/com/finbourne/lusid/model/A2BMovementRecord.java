...
public class A2BMovementRecord {
  ...
  * @throws IOException if the JSON Element is invalid with respect to A2BMovementRecord
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!A2BMovementRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in A2BMovementRecord is not found in the empty JSON string", A2BMovementRecord.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!A2BMovementRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `A2BMovementRecord` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!A2BMovementRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'A2BMovementRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<A2BMovementRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(A2BMovementRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<A2BMovementRecord>() {
           @Override
           public void write(JsonWriter out, A2BMovementRecord value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public A2BMovementRecord read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to A2BMovementRecord
  */
  public static A2BMovementRecord fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, A2BMovementRecord.class);
  }
