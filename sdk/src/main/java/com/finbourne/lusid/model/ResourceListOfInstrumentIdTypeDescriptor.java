...
public class ResourceListOfInstrumentIdTypeDescriptor {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfInstrumentIdTypeDescriptor
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfInstrumentIdTypeDescriptor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfInstrumentIdTypeDescriptor is not found in the empty JSON string", ResourceListOfInstrumentIdTypeDescriptor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfInstrumentIdTypeDescriptor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfInstrumentIdTypeDescriptor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfInstrumentIdTypeDescriptor.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        InstrumentIdTypeDescriptor.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfInstrumentIdTypeDescriptor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfInstrumentIdTypeDescriptor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfInstrumentIdTypeDescriptor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfInstrumentIdTypeDescriptor.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfInstrumentIdTypeDescriptor>() {
           @Override
           public void write(JsonWriter out, ResourceListOfInstrumentIdTypeDescriptor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfInstrumentIdTypeDescriptor read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfInstrumentIdTypeDescriptor
  */
  public static ResourceListOfInstrumentIdTypeDescriptor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfInstrumentIdTypeDescriptor.class);
  }
