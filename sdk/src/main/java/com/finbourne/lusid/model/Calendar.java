...
public class Calendar {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Calendar
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Calendar.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Calendar.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Calendar` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      WeekendMask.validateJsonObject(jsonObj.getAsJsonObject("weekendMask"));
