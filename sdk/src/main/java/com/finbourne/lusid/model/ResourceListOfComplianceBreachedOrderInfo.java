...
public class ResourceListOfComplianceBreachedOrderInfo {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfComplianceBreachedOrderInfo
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfComplianceBreachedOrderInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfComplianceBreachedOrderInfo is not found in the empty JSON string", ResourceListOfComplianceBreachedOrderInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfComplianceBreachedOrderInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfComplianceBreachedOrderInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfComplianceBreachedOrderInfo.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ComplianceBreachedOrderInfo.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfComplianceBreachedOrderInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfComplianceBreachedOrderInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfComplianceBreachedOrderInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfComplianceBreachedOrderInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfComplianceBreachedOrderInfo>() {
           @Override
           public void write(JsonWriter out, ResourceListOfComplianceBreachedOrderInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfComplianceBreachedOrderInfo read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfComplianceBreachedOrderInfo
  */
  public static ResourceListOfComplianceBreachedOrderInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfComplianceBreachedOrderInfo.class);
  }
