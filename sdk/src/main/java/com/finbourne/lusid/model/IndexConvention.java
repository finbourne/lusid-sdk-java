...
public class IndexConvention {
  ...
  **/
   ...
   * @return indexName
  **/
  @ApiModelProperty(value = "The name of the index for which this represents the conventions of.  For instance, \"SOFR\", \"LIBOR\", \"EURIBOR\", etc.  Defaults to \"INDEX\" if not specified.")
