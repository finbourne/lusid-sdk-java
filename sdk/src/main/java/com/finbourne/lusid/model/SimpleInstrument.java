 ...
 */
@ApiModel(description = "LUSID representation of a Simple Instrument, used as a basic definition of a generic instrument.  No analytics can be obtained for this.")
...
public class SimpleInstrument extends LusidInstrument {
  ...
  **/
   ...
   * @return assetClass
  **/
  @ApiModelProperty(required = true, value = "The available values are: InterestRates, FX, Inflation, Equities, Credit, Commodities, Money, Unknown")
