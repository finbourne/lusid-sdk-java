...
public class A2BCategory {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("holdingCurrency");
    openapiFields.add("portfolioCurrency");
  ...
  * @throws IOException if the JSON Element is invalid with respect to A2BCategory
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!A2BCategory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in A2BCategory is not found in the empty JSON string", A2BCategory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!A2BCategory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `A2BCategory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `holdingCurrency`
      if (jsonObj.get("holdingCurrency") != null && !jsonObj.get("holdingCurrency").isJsonNull()) {
        A2BBreakdown.validateJsonElement(jsonObj.get("holdingCurrency"));
      }
      // validate the optional field `portfolioCurrency`
      if (jsonObj.get("portfolioCurrency") != null && !jsonObj.get("portfolioCurrency").isJsonNull()) {
        A2BBreakdown.validateJsonElement(jsonObj.get("portfolioCurrency"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!A2BCategory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'A2BCategory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<A2BCategory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(A2BCategory.class));

       return (TypeAdapter<T>) new TypeAdapter<A2BCategory>() {
           @Override
           public void write(JsonWriter out, A2BCategory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public A2BCategory read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to A2BCategory
  */
  public static A2BCategory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, A2BCategory.class);
  }
