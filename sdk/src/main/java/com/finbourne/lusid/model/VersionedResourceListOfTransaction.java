...
public class VersionedResourceListOfTransaction {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VersionedResourceListOfTransaction
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VersionedResourceListOfTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VersionedResourceListOfTransaction is not found in the empty JSON string", VersionedResourceListOfTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VersionedResourceListOfTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VersionedResourceListOfTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VersionedResourceListOfTransaction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VersionedResourceListOfTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VersionedResourceListOfTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VersionedResourceListOfTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VersionedResourceListOfTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<VersionedResourceListOfTransaction>() {
           @Override
           public void write(JsonWriter out, VersionedResourceListOfTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VersionedResourceListOfTransaction read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to VersionedResourceListOfTransaction
  */
  public static VersionedResourceListOfTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionedResourceListOfTransaction.class);
  }
