...
public class TranslateEntitiesInlinedRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TranslateEntitiesInlinedRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TranslateEntitiesInlinedRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TranslateEntitiesInlinedRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TranslateEntitiesInlinedRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("schema") != null && !jsonObj.get("schema").isJsonNull()) {
        DialectSchema.validateJsonObject(jsonObj.getAsJsonObject("schema"));
      }
  }
