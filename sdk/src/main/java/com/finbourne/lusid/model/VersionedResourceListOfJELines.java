...
import com.finbourne.lusid.model.JELines;
...
public class VersionedResourceListOfJELines {
  ...
  private List<JELines> values = new ArrayList<>();
  ...
  public VersionedResourceListOfJELines() {
  }

  public VersionedResourceListOfJELines version(Version version) {
  ...
  **/
  ...
  public VersionedResourceListOfJELines values(List<JELines> values) {
    this.values = values; 
    return this;
  }

  public VersionedResourceListOfJELines addValuesItem(JELines valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<JELines> getValues() {

    return values;
  }


  public void setValues(List<JELines> values) {
    this.values = values;
  }


  public VersionedResourceListOfJELines href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public VersionedResourceListOfJELines nextPage(String nextPage) {
  ...
  **/
  ...
  public VersionedResourceListOfJELines previousPage(String previousPage) {
  ...
  **/
  ...
  public VersionedResourceListOfJELines links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public VersionedResourceListOfJELines addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VersionedResourceListOfJELines
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VersionedResourceListOfJELines.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VersionedResourceListOfJELines is not found in the empty JSON string", VersionedResourceListOfJELines.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VersionedResourceListOfJELines.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VersionedResourceListOfJELines` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VersionedResourceListOfJELines.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        JELines.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VersionedResourceListOfJELines.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VersionedResourceListOfJELines' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VersionedResourceListOfJELines> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VersionedResourceListOfJELines.class));

       return (TypeAdapter<T>) new TypeAdapter<VersionedResourceListOfJELines>() {
           @Override
           public void write(JsonWriter out, VersionedResourceListOfJELines value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VersionedResourceListOfJELines read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VersionedResourceListOfJELines given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VersionedResourceListOfJELines
  * @throws IOException if the JSON string is invalid with respect to VersionedResourceListOfJELines
  */
  public static VersionedResourceListOfJELines fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionedResourceListOfJELines.class);
  }

 /**
  * Convert an instance of VersionedResourceListOfJELines to an JSON string
  *
  * @return JSON string
  */
