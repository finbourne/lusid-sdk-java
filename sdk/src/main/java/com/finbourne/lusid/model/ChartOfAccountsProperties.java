...
public class ChartOfAccountsProperties {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ChartOfAccountsProperties
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChartOfAccountsProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChartOfAccountsProperties is not found in the empty JSON string", ChartOfAccountsProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ChartOfAccountsProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChartOfAccountsProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChartOfAccountsProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChartOfAccountsProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChartOfAccountsProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChartOfAccountsProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ChartOfAccountsProperties>() {
           @Override
           public void write(JsonWriter out, ChartOfAccountsProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChartOfAccountsProperties read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ChartOfAccountsProperties
  */
  public static ChartOfAccountsProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChartOfAccountsProperties.class);
  }
