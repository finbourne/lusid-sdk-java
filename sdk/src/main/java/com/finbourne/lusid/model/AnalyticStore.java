...
import com.finbourne.lusid.model.AnalyticStoreKey;
...
public class AnalyticStore {
  @SerializedName("key")
  private AnalyticStoreKey key = null;
  ...
  public AnalyticStore key(AnalyticStoreKey key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public AnalyticStoreKey getKey() {
    return key;
  }

  public void setKey(AnalyticStoreKey key) {
    this.key = key;
  }

  public AnalyticStore href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public AnalyticStore links(List<Link> links) {
    this.links = links;
    return this;
  }

  public AnalyticStore addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AnalyticStore analyticStore = (AnalyticStore) o;
    return Objects.equals(this.key, analyticStore.key) &&
        Objects.equals(this.href, analyticStore.href) &&
        Objects.equals(this.links, analyticStore.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, href, links);
  }
