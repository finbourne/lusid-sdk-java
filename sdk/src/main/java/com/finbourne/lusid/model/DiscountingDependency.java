...
import com.finbourne.lusid.model.DiscountingDependencyAllOf;
 ...
 */
@ApiModel(description = "For indicating a dependency on discounting for a given currency.  E.g Valuing a Bond with the Discounting model will declare a DiscountingDependency  for the domestic currency of the bond to account for the time-value of the future cashFlows of the bond.")
...
public class DiscountingDependency extends EconomicDependency {
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "The currency that needs to be discounted.")
   ...
   * @return date
  **/
  @ApiModelProperty(required = true, value = "The effectiveDate of the entity that this is a dependency for.  Unless there is an obvious date this should be, like for a historic reset, then this is the valuation date.")
