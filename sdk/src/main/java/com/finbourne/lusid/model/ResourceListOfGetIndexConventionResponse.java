...
public class ResourceListOfGetIndexConventionResponse {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<GetIndexConventionResponse> values = new ArrayList<>();
  ...
  public ResourceListOfGetIndexConventionResponse() {
  }

  public ResourceListOfGetIndexConventionResponse values(List<GetIndexConventionResponse> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfGetIndexConventionResponse addValuesItem(GetIndexConventionResponse valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<GetIndexConventionResponse> getValues() {

    return values;
  }


  public void setValues(List<GetIndexConventionResponse> values) {
    this.values = values;
  }


  public ResourceListOfGetIndexConventionResponse href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfGetIndexConventionResponse links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfGetIndexConventionResponse addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfGetIndexConventionResponse nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfGetIndexConventionResponse previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfGetIndexConventionResponse {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfGetIndexConventionResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfGetIndexConventionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfGetIndexConventionResponse is not found in the empty JSON string", ResourceListOfGetIndexConventionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfGetIndexConventionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfGetIndexConventionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfGetIndexConventionResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        GetIndexConventionResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfGetIndexConventionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfGetIndexConventionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfGetIndexConventionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfGetIndexConventionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfGetIndexConventionResponse>() {
           @Override
           public void write(JsonWriter out, ResourceListOfGetIndexConventionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfGetIndexConventionResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfGetIndexConventionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfGetIndexConventionResponse
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfGetIndexConventionResponse
  */
  public static ResourceListOfGetIndexConventionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfGetIndexConventionResponse.class);
  }

 /**
  * Convert an instance of ResourceListOfGetIndexConventionResponse to an JSON string
  *
  * @return JSON string
  */
