...
public class PagedResourceListOfRelationshipDefinition {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfRelationshipDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfRelationshipDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfRelationshipDefinition is not found in the empty JSON string", PagedResourceListOfRelationshipDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfRelationshipDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfRelationshipDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfRelationshipDefinition.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        RelationshipDefinition.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfRelationshipDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfRelationshipDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfRelationshipDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfRelationshipDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfRelationshipDefinition>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfRelationshipDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfRelationshipDefinition read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfRelationshipDefinition
  */
  public static PagedResourceListOfRelationshipDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfRelationshipDefinition.class);
  }
