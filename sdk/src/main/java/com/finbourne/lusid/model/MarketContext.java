...
public class MarketContext {
  ...
  **/
   ...
   * @return options
  **/
  @ApiModelProperty(value = "Miscellaneous options around market loading. In the simplest usage case, this is just a default supplier and instrument resolution code.")
