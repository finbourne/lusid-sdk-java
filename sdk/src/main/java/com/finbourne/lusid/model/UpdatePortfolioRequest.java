...
public class UpdatePortfolioRequest {
  ...
  **/
  ...
  public UpdatePortfolioRequest created(OffsetDateTime created) {
    this.created = created;
    return this;
  }

   /**
   * The effective datetime at which the transaction portfolio was created. No transactions can be added to the transaction portfolio before this date.
   * @return created
  **/
  @ApiModelProperty(required = true, value = "The effective datetime at which the transaction portfolio was created. No transactions can be added to the transaction portfolio before this date.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.displayName, updatePortfolioRequest.displayName) &&
        ...
        Objects.equals(this.created, updatePortfolioRequest.created);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, description, created);
  }
