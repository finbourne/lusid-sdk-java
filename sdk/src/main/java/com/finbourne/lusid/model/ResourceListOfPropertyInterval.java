...
public class ResourceListOfPropertyInterval {
  ...
  public ResourceListOfPropertyInterval values(List<PropertyInterval> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfPropertyInterval addValuesItem(PropertyInterval valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public ResourceListOfPropertyInterval href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfPropertyInterval links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfPropertyInterval addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfPropertyInterval nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfPropertyInterval previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfPropertyInterval {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfPropertyInterval
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfPropertyInterval.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfPropertyInterval is not found in the empty JSON string", ResourceListOfPropertyInterval.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfPropertyInterval.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfPropertyInterval` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfPropertyInterval.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfPropertyInterval.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfPropertyInterval' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfPropertyInterval> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfPropertyInterval.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfPropertyInterval>() {
           @Override
           public void write(JsonWriter out, ResourceListOfPropertyInterval value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfPropertyInterval read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfPropertyInterval given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfPropertyInterval
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfPropertyInterval
  */
  public static ResourceListOfPropertyInterval fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfPropertyInterval.class);
  }

 /**
  * Convert an instance of ResourceListOfPropertyInterval to an JSON string
  *
  * @return JSON string
  */
