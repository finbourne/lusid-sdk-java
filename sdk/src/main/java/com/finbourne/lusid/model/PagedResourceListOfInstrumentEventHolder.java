...
public class PagedResourceListOfInstrumentEventHolder {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfInstrumentEventHolder
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfInstrumentEventHolder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfInstrumentEventHolder is not found in the empty JSON string", PagedResourceListOfInstrumentEventHolder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfInstrumentEventHolder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfInstrumentEventHolder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfInstrumentEventHolder.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        InstrumentEventHolder.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfInstrumentEventHolder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfInstrumentEventHolder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfInstrumentEventHolder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfInstrumentEventHolder.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfInstrumentEventHolder>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfInstrumentEventHolder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfInstrumentEventHolder read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfInstrumentEventHolder
  */
  public static PagedResourceListOfInstrumentEventHolder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfInstrumentEventHolder.class);
  }
