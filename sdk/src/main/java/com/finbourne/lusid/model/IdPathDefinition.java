...
import com.finbourne.lusid.model.CodeOnlyIdPathDefinition;
import com.finbourne.lusid.model.FullIdPathDefinition;
import com.finbourne.lusid.model.ScopeAndCodeIdPathDefinition;
import com.finbourne.lusid.model.ScopeIdPathDefinition;
...
public class IdPathDefinition {
  @SerializedName("codeOnlyIdPathDefinition")
  private CodeOnlyIdPathDefinition codeOnlyIdPathDefinition = null;

  @SerializedName("fullIdPathDefinition")
  private FullIdPathDefinition fullIdPathDefinition = null;

  @SerializedName("scopeAndCodeIdPathDefinition")
  private ScopeAndCodeIdPathDefinition scopeAndCodeIdPathDefinition = null;

  @SerializedName("scopeIdPathDefinition")
  private ScopeIdPathDefinition scopeIdPathDefinition = null;
  ...
  public IdPathDefinition codeOnlyIdPathDefinition(CodeOnlyIdPathDefinition codeOnlyIdPathDefinition) {
    this.codeOnlyIdPathDefinition = codeOnlyIdPathDefinition;
    return this;
  }

   /**
   * Get codeOnlyIdPathDefinition
   * @return codeOnlyIdPathDefinition
  **/
  @ApiModelProperty(value = "")
  public CodeOnlyIdPathDefinition getCodeOnlyIdPathDefinition() {
    return codeOnlyIdPathDefinition;
  }

  public void setCodeOnlyIdPathDefinition(CodeOnlyIdPathDefinition codeOnlyIdPathDefinition) {
    this.codeOnlyIdPathDefinition = codeOnlyIdPathDefinition;
  }

  public IdPathDefinition fullIdPathDefinition(FullIdPathDefinition fullIdPathDefinition) {
    this.fullIdPathDefinition = fullIdPathDefinition;
    return this;
  }

   /**
   * Get fullIdPathDefinition
   * @return fullIdPathDefinition
  **/
  @ApiModelProperty(value = "")
  public FullIdPathDefinition getFullIdPathDefinition() {
    return fullIdPathDefinition;
  }

  public void setFullIdPathDefinition(FullIdPathDefinition fullIdPathDefinition) {
    this.fullIdPathDefinition = fullIdPathDefinition;
  }

  public IdPathDefinition scopeAndCodeIdPathDefinition(ScopeAndCodeIdPathDefinition scopeAndCodeIdPathDefinition) {
    this.scopeAndCodeIdPathDefinition = scopeAndCodeIdPathDefinition;
    return this;
  }

   /**
   * Get scopeAndCodeIdPathDefinition
   * @return scopeAndCodeIdPathDefinition
  **/
  @ApiModelProperty(value = "")
  public ScopeAndCodeIdPathDefinition getScopeAndCodeIdPathDefinition() {
    return scopeAndCodeIdPathDefinition;
  }

  public void setScopeAndCodeIdPathDefinition(ScopeAndCodeIdPathDefinition scopeAndCodeIdPathDefinition) {
    this.scopeAndCodeIdPathDefinition = scopeAndCodeIdPathDefinition;
  }

  public IdPathDefinition scopeIdPathDefinition(ScopeIdPathDefinition scopeIdPathDefinition) {
    this.scopeIdPathDefinition = scopeIdPathDefinition;
    return this;
  }

   /**
   * Get scopeIdPathDefinition
   * @return scopeIdPathDefinition
  **/
  @ApiModelProperty(value = "")
  public ScopeIdPathDefinition getScopeIdPathDefinition() {
    return scopeIdPathDefinition;
  }

  public void setScopeIdPathDefinition(ScopeIdPathDefinition scopeIdPathDefinition) {
    this.scopeIdPathDefinition = scopeIdPathDefinition;
  }
  ...
  **/
  ...
  public IdPathDefinition actions(List<ActionId> actions) {
    this.actions = actions;
    return this;
  }

  public IdPathDefinition addActionsItem(ActionId actionsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IdPathDefinition idPathDefinition = (IdPathDefinition) o;
    return Objects.equals(this.codeOnlyIdPathDefinition, idPathDefinition.codeOnlyIdPathDefinition) &&
        Objects.equals(this.fullIdPathDefinition, idPathDefinition.fullIdPathDefinition) &&
        Objects.equals(this.scopeAndCodeIdPathDefinition, idPathDefinition.scopeAndCodeIdPathDefinition) &&
        Objects.equals(this.scopeIdPathDefinition, idPathDefinition.scopeIdPathDefinition) &&
        Objects.equals(this.category, idPathDefinition.category) &&
        Objects.equals(this.actions, idPathDefinition.actions) &&
        Objects.equals(this.name, idPathDefinition.name) &&
        Objects.equals(this.description, idPathDefinition.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeOnlyIdPathDefinition, fullIdPathDefinition, scopeAndCodeIdPathDefinition, scopeIdPathDefinition, category, actions, name, description);
  }
  ...
  public String toString() {
    ...
    sb.append("    codeOnlyIdPathDefinition: ").append(toIndentedString(codeOnlyIdPathDefinition)).append("\n");
    sb.append("    fullIdPathDefinition: ").append(toIndentedString(fullIdPathDefinition)).append("\n");
    sb.append("    scopeAndCodeIdPathDefinition: ").append(toIndentedString(scopeAndCodeIdPathDefinition)).append("\n");
    sb.append("    scopeIdPathDefinition: ").append(toIndentedString(scopeIdPathDefinition)).append("\n");
