...
public class CreateSimplePositionPortfolioRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateSimplePositionPortfolioRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSimplePositionPortfolioRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSimplePositionPortfolioRequest is not found in the empty JSON string", CreateSimplePositionPortfolioRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSimplePositionPortfolioRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSimplePositionPortfolioRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSimplePositionPortfolioRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSimplePositionPortfolioRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSimplePositionPortfolioRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSimplePositionPortfolioRequest>() {
           @Override
           public void write(JsonWriter out, CreateSimplePositionPortfolioRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSimplePositionPortfolioRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to CreateSimplePositionPortfolioRequest
  */
  public static CreateSimplePositionPortfolioRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSimplePositionPortfolioRequest.class);
  }
