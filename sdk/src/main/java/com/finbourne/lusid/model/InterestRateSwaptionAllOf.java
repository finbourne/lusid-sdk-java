...
public class InterestRateSwaptionAllOf {
  ...
  **/
  ...
  public InterestRateSwaptionAllOf payOrReceiveFixed(String payOrReceiveFixed) {
  ...
  **/
  @ApiModelProperty(required = true, value = "True if on exercise the holder of the option enters the swap paying fixed, false if floating.    Supported string (enumeration) values are: [Pay, Receive].")
  ...
  public InterestRateSwaptionAllOf premium(Premium premium) {
  ...
  **/
  ...
  public InterestRateSwaptionAllOf deliveryMethod(String deliveryMethod) {
  ...
  **/
  @ApiModelProperty(required = true, value = "How does the option settle    Supported string (enumeration) values are: [Cash, Physical].")
