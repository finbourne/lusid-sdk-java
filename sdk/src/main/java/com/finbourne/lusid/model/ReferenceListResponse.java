...
public class ReferenceListResponse {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the reference list.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description of the reference list.")
   ...
   * @return tags
  **/
  @ApiModelProperty(value = "The tags associated with the reference list.")
