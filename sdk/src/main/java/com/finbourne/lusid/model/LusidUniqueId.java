...
public class LusidUniqueId {
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type for the LUSID unique id, this will depend on the type of entity found, for instance 'Instrument' would have a value of 'LusidInstrumentId'")
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "The value for the LUSID unique id")
