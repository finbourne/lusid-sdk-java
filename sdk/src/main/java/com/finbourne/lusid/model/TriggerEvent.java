...
import com.finbourne.lusid.model.TriggerEventAllOf;
 ...
 */
@ApiModel(description = "Definition of a trigger event.  This is an event that occurs on transformation of an option instrument being  triggered by a barrier/touch price level being hit by the underlying asset.")
...
public class TriggerEvent extends InstrumentEvent {
   ...
   * @return level
  **/
  @ApiModelProperty(required = true, value = "The underlying price level that triggers the event")
   ...
   * @return triggerType
  **/
  @ApiModelProperty(required = true, value = "The type of the trigger; valid options are Knock-In, Knock-Out, Touch or No-Touch")
  ...
  **/
  @ApiModelProperty(required = true, value = "The direction of the trigger; valid options are Up and Down")
   ...
   * @return triggerDate
  **/
  @ApiModelProperty(required = true, value = "The date the trigger happens at.")
   ...
   * @return maturityDate
  **/
  @ApiModelProperty(required = true, value = "The date the trigger takes effect.")
