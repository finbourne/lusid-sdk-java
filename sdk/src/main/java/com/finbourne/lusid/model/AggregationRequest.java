...
public class AggregationRequest {
  ...
  public AggregationRequest recipeId(ResourceId recipeId) {
   ...
   /**
   * The configuration recipe, consisting of user scope and recipe name, to use in performing the aggregation.
   * @return recipeId
  **/
  @ApiModelProperty(required = true, value = "The configuration recipe, consisting of user scope and recipe name, to use in performing the aggregation.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(recipeId, asAt, effectiveAt, metrics, groupBy, filters, limit, sort);
  }
