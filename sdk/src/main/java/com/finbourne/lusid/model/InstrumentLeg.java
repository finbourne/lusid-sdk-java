...
public class InstrumentLeg extends LusidInstrument {
  ...
  * @throws IOException if the JSON Element is invalid with respect to InstrumentLeg
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstrumentLeg.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
