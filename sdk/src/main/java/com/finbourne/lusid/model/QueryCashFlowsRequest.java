...
public class QueryCashFlowsRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to QueryCashFlowsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!QueryCashFlowsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!QueryCashFlowsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QueryCashFlowsRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
