...
public class UpsertInstrumentsResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpsertInstrumentsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpsertInstrumentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertInstrumentsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertInstrumentsResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
