 ...
 */
@ApiModel(description = "LUSID representation of an FX Forward.  Including FX Spot and Non-Deliverable Forwards.")
...
public class FxForward extends LusidInstrument {
  ...
  **/
  @ApiModelProperty(value = "The settlement currency.  If provided, present value will be calculated in settlement currency, otherwise the domestic currency. Applies only to non-deliverable FX Forwards.")
