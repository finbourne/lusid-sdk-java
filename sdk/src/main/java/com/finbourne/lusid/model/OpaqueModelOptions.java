...
public class OpaqueModelOptions extends ModelOptions {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OpaqueModelOptions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpaqueModelOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpaqueModelOptions is not found in the empty JSON string", OpaqueModelOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OpaqueModelOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpaqueModelOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OpaqueModelOptions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpaqueModelOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpaqueModelOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpaqueModelOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpaqueModelOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<OpaqueModelOptions>() {
           @Override
           public void write(JsonWriter out, OpaqueModelOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OpaqueModelOptions read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to OpaqueModelOptions
  */
  public static OpaqueModelOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpaqueModelOptions.class);
  }
