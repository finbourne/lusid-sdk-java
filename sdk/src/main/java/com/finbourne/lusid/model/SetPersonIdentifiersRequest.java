...
public class SetPersonIdentifiersRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to SetPersonIdentifiersRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetPersonIdentifiersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetPersonIdentifiersRequest is not found in the empty JSON string", SetPersonIdentifiersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SetPersonIdentifiersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetPersonIdentifiersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetPersonIdentifiersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetPersonIdentifiersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetPersonIdentifiersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetPersonIdentifiersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetPersonIdentifiersRequest>() {
           @Override
           public void write(JsonWriter out, SetPersonIdentifiersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetPersonIdentifiersRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to SetPersonIdentifiersRequest
  */
  public static SetPersonIdentifiersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetPersonIdentifiersRequest.class);
  }
