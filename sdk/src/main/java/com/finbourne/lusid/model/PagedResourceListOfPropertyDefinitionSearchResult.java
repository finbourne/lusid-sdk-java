...
public class PagedResourceListOfPropertyDefinitionSearchResult {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfPropertyDefinitionSearchResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfPropertyDefinitionSearchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfPropertyDefinitionSearchResult is not found in the empty JSON string", PagedResourceListOfPropertyDefinitionSearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfPropertyDefinitionSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfPropertyDefinitionSearchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfPropertyDefinitionSearchResult.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        PropertyDefinitionSearchResult.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfPropertyDefinitionSearchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfPropertyDefinitionSearchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfPropertyDefinitionSearchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfPropertyDefinitionSearchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfPropertyDefinitionSearchResult>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfPropertyDefinitionSearchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfPropertyDefinitionSearchResult read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfPropertyDefinitionSearchResult
  */
  public static PagedResourceListOfPropertyDefinitionSearchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfPropertyDefinitionSearchResult.class);
  }
