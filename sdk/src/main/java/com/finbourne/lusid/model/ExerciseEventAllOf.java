...
public class ExerciseEventAllOf {
  ...
  public ExerciseEventAllOf instrument(LusidInstrument instrument) {
  ...
  **/
  ...
  public ExerciseEventAllOf eventStatus(String eventStatus) {
  ...
  **/
  ...
  public ExerciseEventAllOf anchorDate(OffsetDateTime anchorDate) {
   ...
   * @return anchorDate
  **/
  @ApiModelProperty(required = true, value = "The date the exercise window starts, or point it takes effect on.")
  ...
  **/
  @ApiModelProperty(value = "The date the exercise window ends, or point it takes effect on.")
  ...
  public ExerciseEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
