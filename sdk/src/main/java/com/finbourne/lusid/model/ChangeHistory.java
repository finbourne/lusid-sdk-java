 ...
 */
@ApiModel(description = "A group of changes made by the same person at the same time.")
...
public class ChangeHistory {
   ...
   * @return userId
  **/
  @ApiModelProperty(required = true, value = "The unique identifier of the user that made the change.")
   ...
   * @return modifiedAsAt
  **/
  @ApiModelProperty(required = true, value = "The date/time of the change.")
   ...
   * @return requestId
  **/
  @ApiModelProperty(required = true, value = "The unique identifier of the request that the changes were part of.")
   ...
   * @return action
  **/
  @ApiModelProperty(required = true, value = "The action performed on the transaction, either created, updated, or deleted. The available values are: Create, Update, Delete")
   ...
   * @return changes
  **/
  @ApiModelProperty(required = true, value = "The collection of changes that were made.")
