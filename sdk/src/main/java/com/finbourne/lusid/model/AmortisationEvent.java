...
import com.finbourne.lusid.model.AmortisationEventAllOf;
 ...
 */
@ApiModel(description = "Definition of an Amortisation event.  This is an event that describes the occurence of amortisation.")
...
public class AmortisationEvent extends InstrumentEvent {
  ...
  **/
  @ApiModelProperty(required = true, value = "The amount reduced in this amortisation event.  That is, the difference between the previous notional amount and the current notional amount as set in this event.")
   ...
   * @return domCcy
  **/
  @ApiModelProperty(required = true, value = "Domestic currency of the originating instrument")
   ...
   * @return payReceive
  **/
  @ApiModelProperty(required = true, value = "Is this event in relation to the Pay or Receive leg")
  ...
  **/
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "The date the principal payment is to be made.")
