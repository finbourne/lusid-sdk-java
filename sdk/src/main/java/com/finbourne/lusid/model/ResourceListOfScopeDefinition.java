...
public class ResourceListOfScopeDefinition {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfScopeDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfScopeDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfScopeDefinition is not found in the empty JSON string", ResourceListOfScopeDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfScopeDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfScopeDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfScopeDefinition.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ScopeDefinition.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfScopeDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfScopeDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfScopeDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfScopeDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfScopeDefinition>() {
           @Override
           public void write(JsonWriter out, ResourceListOfScopeDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfScopeDefinition read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfScopeDefinition
  */
  public static ResourceListOfScopeDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfScopeDefinition.class);
  }
