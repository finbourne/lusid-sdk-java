...
public class DividendReinvestmentEvent extends InstrumentEvent {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DividendReinvestmentEvent
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DividendReinvestmentEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DividendReinvestmentEvent is not found in the empty JSON string", DividendReinvestmentEvent.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DividendReinvestmentEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DividendReinvestmentEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DividendReinvestmentEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DividendReinvestmentEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DividendReinvestmentEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<DividendReinvestmentEvent>() {
           @Override
           public void write(JsonWriter out, DividendReinvestmentEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DividendReinvestmentEvent read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to DividendReinvestmentEvent
  */
  public static DividendReinvestmentEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DividendReinvestmentEvent.class);
  }
