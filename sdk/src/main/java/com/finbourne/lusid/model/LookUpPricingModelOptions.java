...
public class LookUpPricingModelOptions extends ModelOptions {
  ...
  public LookUpPricingModelOptions() {
    // this.modelOptionsType = this.getClass().getSimpleName();
  }

  public LookUpPricingModelOptions addAccrual(Boolean addAccrual) {
  ...
  **/
  ...
  public LookUpPricingModelOptions applyIndexRatio(Boolean applyIndexRatio) {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("addAccrual");
    openapiFields.add("applyIndexRatio");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("addAccrual");
    openapiRequiredFields.add("applyIndexRatio");
  ...
  * @throws IOException if the JSON Element is invalid with respect to LookUpPricingModelOptions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LookUpPricingModelOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LookUpPricingModelOptions is not found in the empty JSON string", LookUpPricingModelOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!LookUpPricingModelOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LookUpPricingModelOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LookUpPricingModelOptions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LookUpPricingModelOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LookUpPricingModelOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LookUpPricingModelOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LookUpPricingModelOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<LookUpPricingModelOptions>() {
           @Override
           public void write(JsonWriter out, LookUpPricingModelOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LookUpPricingModelOptions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LookUpPricingModelOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LookUpPricingModelOptions
  * @throws IOException if the JSON string is invalid with respect to LookUpPricingModelOptions
  */
  public static LookUpPricingModelOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LookUpPricingModelOptions.class);
  }

 /**
  * Convert an instance of LookUpPricingModelOptions to an JSON string
  *
  * @return JSON string
  */
