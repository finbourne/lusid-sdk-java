...
public class DataDefinition {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DataDefinition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DataDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataDefinition` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
