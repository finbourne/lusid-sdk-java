...
public class FieldSchema {
  ...
  public FieldSchema scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  **/
  ...
  public FieldSchema name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public FieldSchema isMetric(Boolean isMetric) {
  ...
  **/
  ...
  public FieldSchema propertySchema(Map<String, FieldSchema> propertySchema) {
    this.propertySchema = propertySchema;
    return this;
  }

  public FieldSchema putPropertySchemaItem(String key, FieldSchema propertySchemaItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.scope, fieldSchema.scope) &&
        Objects.equals(this.name, fieldSchema.name) &&
        Objects.equals(this.displayName, fieldSchema.displayName) &&
        Objects.equals(this.type, fieldSchema.type) &&
        Objects.equals(this.isMetric, fieldSchema.isMetric) &&
        Objects.equals(this.displayOrder, fieldSchema.displayOrder) &&
        Objects.equals(this.propertySchema, fieldSchema.propertySchema);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, name, displayName, type, isMetric, displayOrder, propertySchema);
  }
