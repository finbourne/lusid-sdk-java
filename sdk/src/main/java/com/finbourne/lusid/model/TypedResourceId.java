...
public class TypedResourceId {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("idTypeScope");
    openapiFields.add("idTypeCode");
    openapiFields.add("code");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("idTypeScope");
    openapiRequiredFields.add("idTypeCode");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TypedResourceId
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypedResourceId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TypedResourceId is not found in the empty JSON string", TypedResourceId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TypedResourceId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TypedResourceId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TypedResourceId.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("idTypeScope").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `idTypeScope` to be a primitive type in the JSON string but got `%s`", jsonObj.get("idTypeScope").toString()));
      }
      if (!jsonObj.get("idTypeCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `idTypeCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("idTypeCode").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypedResourceId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypedResourceId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypedResourceId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypedResourceId.class));

       return (TypeAdapter<T>) new TypeAdapter<TypedResourceId>() {
           @Override
           public void write(JsonWriter out, TypedResourceId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TypedResourceId read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to TypedResourceId
  */
  public static TypedResourceId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypedResourceId.class);
  }
