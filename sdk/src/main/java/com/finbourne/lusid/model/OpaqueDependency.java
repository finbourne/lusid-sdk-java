...
public class OpaqueDependency extends EconomicDependency {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OpaqueDependency
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpaqueDependency.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OpaqueDependency.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpaqueDependency` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
