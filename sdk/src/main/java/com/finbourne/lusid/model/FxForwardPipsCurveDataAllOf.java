...
public class FxForwardPipsCurveDataAllOf {
  ...
  public FxForwardPipsCurveDataAllOf baseDate(OffsetDateTime baseDate) {
  ...
  **/
  ...
  public FxForwardPipsCurveDataAllOf domCcy(String domCcy) {
    this.domCcy = domCcy; 
    return this;
  }
  ...
  **/
  ...
  public FxForwardPipsCurveDataAllOf fgnCcy(String fgnCcy) {
    this.fgnCcy = fgnCcy; 
    return this;
  }
  ...
  **/
  ...
  public FxForwardPipsCurveDataAllOf dates(List<OffsetDateTime> dates) {
    this.dates = dates; 
    return this;
  }

  public FxForwardPipsCurveDataAllOf addDatesItem(OffsetDateTime datesItem) {
  ...
  **/
  ...
  public FxForwardPipsCurveDataAllOf pipRates(List<java.math.BigDecimal> pipRates) {
    this.pipRates = pipRates; 
    return this;
  }

  public FxForwardPipsCurveDataAllOf addPipRatesItem(java.math.BigDecimal pipRatesItem) {
  ...
  **/
  ...
  public FxForwardPipsCurveDataAllOf lineage(String lineage) {
  ...
  **/
  ...
  public FxForwardPipsCurveDataAllOf marketDataOptions(MarketDataOptions marketDataOptions) {
  ...
  **/
  ...
  public FxForwardPipsCurveDataAllOf marketDataType(MarketDataTypeEnum marketDataType) {
