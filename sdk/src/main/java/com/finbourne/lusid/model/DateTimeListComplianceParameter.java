...
public class DateTimeListComplianceParameter extends ComplianceParameter {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DateTimeListComplianceParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DateTimeListComplianceParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DateTimeListComplianceParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DateTimeListComplianceParameter` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
