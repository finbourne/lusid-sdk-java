...
public class GroupByStep {
  ...
  **/
  ...
  public GroupByStep groupedParameters(Map<String, List<ComplianceTemplateParameter>> groupedParameters) {
    
    this.groupedParameters = groupedParameters;
    return this;
  }

  public GroupByStep putGroupedParametersItem(String key, List<ComplianceTemplateParameter> groupedParametersItem) {
  ...
  **/
  ...
  public GroupByStep complianceStepType(ComplianceStepTypeEnum complianceStepType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, groupByStep.label) &&
        Objects.equals(this.groupedParameters, groupByStep.groupedParameters) &&
        Objects.equals(this.complianceStepType, groupByStep.complianceStepType);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to GroupByStep
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupByStep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupByStep is not found in the empty JSON string", GroupByStep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroupByStep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupByStep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupByStep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupByStep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupByStep.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupByStep>() {
           @Override
           public void write(JsonWriter out, GroupByStep value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroupByStep read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to GroupByStep
  */
  public static GroupByStep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupByStep.class);
  }
