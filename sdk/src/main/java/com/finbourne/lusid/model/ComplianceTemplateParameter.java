...
public class ComplianceTemplateParameter {
  ...
  public static final String SERIALIZED_NAME_IS_CHECKING_PARAMETER = "isCheckingParameter";
  @SerializedName(SERIALIZED_NAME_IS_CHECKING_PARAMETER)
  private Boolean isCheckingParameter;
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name for the required Compliance Template Parameter")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "The description for the required Compliance Template Parameter")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type for the required Compliance Template Parameter")
  ...
  public ComplianceTemplateParameter isCheckingParameter(Boolean isCheckingParameter) {
    this.isCheckingParameter = isCheckingParameter; 
    return this;
  }

   /**
   * Indicates whether this is the Compliance Template Parameter that will be used in the final check process
   * @return isCheckingParameter
  **/
  @ApiModelProperty(required = true, value = "Indicates whether this is the Compliance Template Parameter that will be used in the final check process")
  public Boolean getIsCheckingParameter() {
    return isCheckingParameter;
  }

  public void setIsCheckingParameter(Boolean isCheckingParameter) {
    this.isCheckingParameter = isCheckingParameter;
  }
  ...
  public String toString() {
    ...
    sb.append("    isCheckingParameter: ").append(toIndentedString(isCheckingParameter)).append("\n");
    sb.append("}");
    return sb.toString();
  }
