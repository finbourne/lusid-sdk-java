...
public class ResourceListOfReconciliationBreak {
  ...
  public ResourceListOfReconciliationBreak() {
  }
  ...
  **/
  ...
  public ResourceListOfReconciliationBreak href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfReconciliationBreak nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfReconciliationBreak previousPage(String previousPage) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfReconciliationBreak
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfReconciliationBreak.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfReconciliationBreak is not found in the empty JSON string", ResourceListOfReconciliationBreak.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfReconciliationBreak.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfReconciliationBreak` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfReconciliationBreak.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ReconciliationBreak.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfReconciliationBreak.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfReconciliationBreak' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfReconciliationBreak> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfReconciliationBreak.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfReconciliationBreak>() {
           @Override
           public void write(JsonWriter out, ResourceListOfReconciliationBreak value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfReconciliationBreak read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfReconciliationBreak given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfReconciliationBreak
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfReconciliationBreak
  */
  public static ResourceListOfReconciliationBreak fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfReconciliationBreak.class);
  }

 /**
  * Convert an instance of ResourceListOfReconciliationBreak to an JSON string
  *
  * @return JSON string
  */
