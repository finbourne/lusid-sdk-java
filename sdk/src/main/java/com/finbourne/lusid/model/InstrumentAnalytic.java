...
public class InstrumentAnalytic {
  ...
  public InstrumentAnalytic instrumentUid(String instrumentUid) {
  ...
  **/
  ...
  public InstrumentAnalytic value(Double value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "Value of the analytic, eg price")
  ...
  public InstrumentAnalytic denomination(String denomination) {
   ...
   * @return denomination
  **/
  @ApiModelProperty(value = "Underlying unit of the analytic, eg currency, EPS etc.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InstrumentAnalytic instrumentAnalytic = (InstrumentAnalytic) o;
    return Objects.equals(this.instrumentUid, instrumentAnalytic.instrumentUid) &&
        Objects.equals(this.value, instrumentAnalytic.value) &&
        Objects.equals(this.denomination, instrumentAnalytic.denomination);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instrumentUid, value, denomination);
  }
