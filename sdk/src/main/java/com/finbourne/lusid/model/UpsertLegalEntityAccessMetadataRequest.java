...
public class UpsertLegalEntityAccessMetadataRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertLegalEntityAccessMetadataRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertLegalEntityAccessMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertLegalEntityAccessMetadataRequest is not found in the empty JSON string", UpsertLegalEntityAccessMetadataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertLegalEntityAccessMetadataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertLegalEntityAccessMetadataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertLegalEntityAccessMetadataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertLegalEntityAccessMetadataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertLegalEntityAccessMetadataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertLegalEntityAccessMetadataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertLegalEntityAccessMetadataRequest>() {
           @Override
           public void write(JsonWriter out, UpsertLegalEntityAccessMetadataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertLegalEntityAccessMetadataRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpsertLegalEntityAccessMetadataRequest
  */
  public static UpsertLegalEntityAccessMetadataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertLegalEntityAccessMetadataRequest.class);
  }
