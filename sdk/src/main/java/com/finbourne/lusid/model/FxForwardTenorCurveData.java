...
public class FxForwardTenorCurveData extends ComplexMarketData {
  ...
  private List<FxTenorConvention> calendars = null;
  ...
  **/
   ...
   * @return calendars
  **/
  @ApiModelProperty(value = "The list of conventions that should be used when interpreting tenors as dates.")
  ...
  **/
  @ApiModelProperty(value = "Configures how to calculate the spot date from the build date using the Calendars provided.  Supported string (enumeration) values are: [ SingleCalendar, UnionCalendars ]")
