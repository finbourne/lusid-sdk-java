...
public class InstrumentIdTypeDescriptor {
   ...
   * @return idName
  **/
  @ApiModelProperty(required = true, value = "The name of the identifier.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The property key that corresponds to the identifier.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Whether or not the identifier is enforced to be unique.")
