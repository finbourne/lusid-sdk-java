...
public class InstrumentIdTypeDescriptor {
  ...
  public static final String SERIALIZED_NAME_PROPERTY_KEY_VALUE = "propertyKeyValue";
  @SerializedName(SERIALIZED_NAME_PROPERTY_KEY_VALUE)
  private String propertyKeyValue;

  public static final String SERIALIZED_NAME_IS_UNIQUE_IDENTIFIER = "isUniqueIdentifier";
  @SerializedName(SERIALIZED_NAME_IS_UNIQUE_IDENTIFIER)
  private Boolean isUniqueIdentifier;

  public InstrumentIdTypeDescriptor idName(String idName) {
    this.idName = idName;
    return this;
  }
  ...
  **/
  ...
  public InstrumentIdTypeDescriptor propertyKeyValue(String propertyKeyValue) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The property key that corresponds to this instrument identifier type")
  ...
  public InstrumentIdTypeDescriptor isUniqueIdentifier(Boolean isUniqueIdentifier) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The cardinality of the identifier type (i.e., how many instruments may share an identifer  of this identifier type)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.idName, instrumentIdTypeDescriptor.idName) &&
        Objects.equals(this.propertyKeyValue, instrumentIdTypeDescriptor.propertyKeyValue) &&
        Objects.equals(this.isUniqueIdentifier, instrumentIdTypeDescriptor.isUniqueIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(idName, propertyKeyValue, isUniqueIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("    propertyKeyValue: ").append(toIndentedString(propertyKeyValue)).append("\n");
    sb.append("    isUniqueIdentifier: ").append(toIndentedString(isUniqueIdentifier)).append("\n");
    sb.append("}");
    return sb.toString();
  }
