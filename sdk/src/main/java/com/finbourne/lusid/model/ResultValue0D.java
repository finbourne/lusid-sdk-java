...
import com.finbourne.lusid.model.ResultValue0DAllOf;
 ...
 */
@ApiModel(description = "Result value representing a 0D result. These results can be equipped with a unit")
...
public class ResultValue0D extends ResultValue {
   ...
   * @return units
  **/
  @ApiModelProperty(value = "Unit of the result")
