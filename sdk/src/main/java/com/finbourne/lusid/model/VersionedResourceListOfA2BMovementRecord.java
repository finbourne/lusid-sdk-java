...
public class VersionedResourceListOfA2BMovementRecord {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VersionedResourceListOfA2BMovementRecord
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VersionedResourceListOfA2BMovementRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VersionedResourceListOfA2BMovementRecord is not found in the empty JSON string", VersionedResourceListOfA2BMovementRecord.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VersionedResourceListOfA2BMovementRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VersionedResourceListOfA2BMovementRecord` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VersionedResourceListOfA2BMovementRecord.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        A2BMovementRecord.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VersionedResourceListOfA2BMovementRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VersionedResourceListOfA2BMovementRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VersionedResourceListOfA2BMovementRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VersionedResourceListOfA2BMovementRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<VersionedResourceListOfA2BMovementRecord>() {
           @Override
           public void write(JsonWriter out, VersionedResourceListOfA2BMovementRecord value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VersionedResourceListOfA2BMovementRecord read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to VersionedResourceListOfA2BMovementRecord
  */
  public static VersionedResourceListOfA2BMovementRecord fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionedResourceListOfA2BMovementRecord.class);
  }
