...
import com.finbourne.lusid.model.IrVolDependencyAllOf;
 ...
 */
@ApiModel(description = "Economic dependency required to price interest rate products that contain optionality, for example swaptions.  For example, can indicate a dependency on an IrVolCubeData.")
