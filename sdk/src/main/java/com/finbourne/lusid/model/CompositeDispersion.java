 ...
 */
@ApiModel(description = "A list of Dispersion calculations for the given years.")
...
public class CompositeDispersion {
  ...
  private List<ResourceId> constituentsInScope = null;
  ...
  private List<ResourceId> constituentsExcluded = null;
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The date for which dipsersion calculation has been done. This should be 31 Dec for each given year.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The result for the dispersion calculation on the given effectiveAt.")
   ...
   * @return variance
  **/
  @ApiModelProperty(required = true, value = "The variance on the given effectiveAt.")
  ...
  **/
  @ApiModelProperty(required = true, value = "First Quartile (Q1) =  (lower quartile) = the middle of the bottom half of the returns.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Third Quartile (Q3) =  (higher quartile) = the middle of the top half of the returns.")
   ...
   * @return range
  **/
  @ApiModelProperty(required = true, value = "Highest return - Lowest return.")
  ...
  **/
  @ApiModelProperty(value = "List containing Composite members which are part of the dispersion calcualtion.")
  ...
  **/
  @ApiModelProperty(value = "List containing the Composite members which are not part of the dispersion calculation")
