...
public class AnnulSingleStructuredDataResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AnnulSingleStructuredDataResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnulSingleStructuredDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnulSingleStructuredDataResponse is not found in the empty JSON string", AnnulSingleStructuredDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AnnulSingleStructuredDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnnulSingleStructuredDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnulSingleStructuredDataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnulSingleStructuredDataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnulSingleStructuredDataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnulSingleStructuredDataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnulSingleStructuredDataResponse>() {
           @Override
           public void write(JsonWriter out, AnnulSingleStructuredDataResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnnulSingleStructuredDataResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to AnnulSingleStructuredDataResponse
  */
  public static AnnulSingleStructuredDataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnulSingleStructuredDataResponse.class);
  }
