...
public class PerformanceReturnsMetric {
  ...
  **/
  ...
  public PerformanceReturnsMetric seedAmount(Double seedAmount) {
   ...
   * @return seedAmount
  **/
  @ApiModelProperty(value = "The given seed amount for the calculation of the indicative amount metrics.")
