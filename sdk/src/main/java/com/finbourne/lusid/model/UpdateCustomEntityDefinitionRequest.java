...
public class UpdateCustomEntityDefinitionRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateCustomEntityDefinitionRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCustomEntityDefinitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCustomEntityDefinitionRequest is not found in the empty JSON string", UpdateCustomEntityDefinitionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateCustomEntityDefinitionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCustomEntityDefinitionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCustomEntityDefinitionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCustomEntityDefinitionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCustomEntityDefinitionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCustomEntityDefinitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCustomEntityDefinitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCustomEntityDefinitionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateCustomEntityDefinitionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCustomEntityDefinitionRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpdateCustomEntityDefinitionRequest
  */
  public static UpdateCustomEntityDefinitionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCustomEntityDefinitionRequest.class);
  }
