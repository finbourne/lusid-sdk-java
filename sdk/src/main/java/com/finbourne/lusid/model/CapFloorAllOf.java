...
public class CapFloorAllOf {
  ...
  public CapFloorAllOf capFloorType(String capFloorType) {
  ...
  **/
  ...
  public CapFloorAllOf capStrike(java.math.BigDecimal capStrike) {
  ...
  **/
  ...
  public CapFloorAllOf floorStrike(java.math.BigDecimal floorStrike) {
  ...
  **/
  ...
  public CapFloorAllOf includeFirstCaplet(Boolean includeFirstCaplet) {
  ...
  **/
  ...
  public CapFloorAllOf underlyingFloatingLeg(FloatingLeg underlyingFloatingLeg) {
  ...
  **/
  ...
  public CapFloorAllOf instrumentType(InstrumentTypeEnum instrumentType) {
