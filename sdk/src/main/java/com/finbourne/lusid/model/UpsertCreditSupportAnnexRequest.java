...
public class UpsertCreditSupportAnnexRequest {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("creditSupportAnnex");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertCreditSupportAnnexRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertCreditSupportAnnexRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertCreditSupportAnnexRequest is not found in the empty JSON string", UpsertCreditSupportAnnexRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertCreditSupportAnnexRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertCreditSupportAnnexRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `creditSupportAnnex`
      if (jsonObj.get("creditSupportAnnex") != null && !jsonObj.get("creditSupportAnnex").isJsonNull()) {
        CreditSupportAnnex.validateJsonElement(jsonObj.get("creditSupportAnnex"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertCreditSupportAnnexRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertCreditSupportAnnexRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertCreditSupportAnnexRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertCreditSupportAnnexRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertCreditSupportAnnexRequest>() {
           @Override
           public void write(JsonWriter out, UpsertCreditSupportAnnexRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertCreditSupportAnnexRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpsertCreditSupportAnnexRequest
  */
  public static UpsertCreditSupportAnnexRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertCreditSupportAnnexRequest.class);
  }
