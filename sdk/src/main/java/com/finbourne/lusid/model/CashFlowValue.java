...
import com.finbourne.lusid.model.CashFlowValueAllOf;
 ...
 */
@ApiModel(description = "Result class for a cash flow value")
...
public class CashFlowValue extends ResultValue {
  ...
  private ResultValueDictionary diagnostics = null;
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "The payment date of the cash flow")
  ...
  **/
   ...
   * @return paymentCcy
  **/
  @ApiModelProperty(required = true, value = "The currency of the transaction")
