...
public class ResourceListOfQuoteAccessMetadataRule {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfQuoteAccessMetadataRule
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfQuoteAccessMetadataRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfQuoteAccessMetadataRule is not found in the empty JSON string", ResourceListOfQuoteAccessMetadataRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfQuoteAccessMetadataRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfQuoteAccessMetadataRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfQuoteAccessMetadataRule.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        QuoteAccessMetadataRule.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfQuoteAccessMetadataRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfQuoteAccessMetadataRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfQuoteAccessMetadataRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfQuoteAccessMetadataRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfQuoteAccessMetadataRule>() {
           @Override
           public void write(JsonWriter out, ResourceListOfQuoteAccessMetadataRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfQuoteAccessMetadataRule read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfQuoteAccessMetadataRule
  */
  public static ResourceListOfQuoteAccessMetadataRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfQuoteAccessMetadataRule.class);
  }
