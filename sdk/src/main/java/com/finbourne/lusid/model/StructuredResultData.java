...
public class StructuredResultData {
  ...
  * @throws IOException if the JSON Object is invalid with respect to StructuredResultData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StructuredResultData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StructuredResultData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StructuredResultData` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("dataMapKey") != null && !jsonObj.get("dataMapKey").isJsonNull()) {
        DataMapKey.validateJsonObject(jsonObj.getAsJsonObject("dataMapKey"));
      }
  }
