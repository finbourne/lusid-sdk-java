...
public class UpsertComplexMarketDataRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertComplexMarketDataRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertComplexMarketDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertComplexMarketDataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertComplexMarketDataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      ComplexMarketData.validateJsonElement(jsonObj.get("marketData"));
  }
