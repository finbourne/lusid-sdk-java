...
public class Property {
  ...
  public Property key(String key) {
   ...
   /**
   * The key of the property. This takes the format {domain}/{scope}/{code} e.g. &#39;Instrument/system/Name&#39; or &#39;Trade/strategy/quantsignal&#39;.
   * @return key
  **/
  @ApiModelProperty(required = true, value = "The key of the property. This takes the format {domain}/{scope}/{code} e.g. 'Instrument/system/Name' or 'Trade/strategy/quantsignal'.")
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "The value of the property.")
  ...
  public Property unit(String unit) {
   ...
   /**
   * The units of the property (if any).
   * @return unit
  **/
  @ApiModelProperty(value = "The units of the property (if any).")
