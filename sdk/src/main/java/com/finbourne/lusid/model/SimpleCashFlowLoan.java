...
import com.finbourne.lusid.model.SimpleCashFlowLoanAllOf;
 ...
 */
@ApiModel(description = "LUSID representation of a SimpleCashFlowLoan.  This is a simple loan, with interest payments and nationals provided and not calculated.")
...
public class SimpleCashFlowLoan extends LusidInstrument {
  ...
  **/
   ...
   * @return periods
  **/
  @ApiModelProperty(required = true, value = "Periods of the underlying loan")
