...
public class PagedResourceListOfCustomEntityType {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfCustomEntityType
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfCustomEntityType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfCustomEntityType is not found in the empty JSON string", PagedResourceListOfCustomEntityType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfCustomEntityType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfCustomEntityType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfCustomEntityType.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        CustomEntityType.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfCustomEntityType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfCustomEntityType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfCustomEntityType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfCustomEntityType.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfCustomEntityType>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfCustomEntityType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfCustomEntityType read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfCustomEntityType
  */
  public static PagedResourceListOfCustomEntityType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfCustomEntityType.class);
  }
