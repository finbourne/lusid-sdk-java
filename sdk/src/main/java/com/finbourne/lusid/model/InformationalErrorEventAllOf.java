...
public class InformationalErrorEventAllOf {
  ...
  public InformationalErrorEventAllOf errorDetail(String errorDetail) {
   ...
   * @return errorDetail
  **/
  @ApiModelProperty(required = true, value = "The details of the error")
  ...
  public InformationalErrorEventAllOf errorReason(String errorReason) {
   ...
   * @return errorReason
  **/
  @ApiModelProperty(required = true, value = "The error reason")
  ...
  public InformationalErrorEventAllOf effectiveAt(OffsetDateTime effectiveAt) {
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The effective date of the evaulation")
  ...
  public InformationalErrorEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
