...
public class GetQuotesResponse {
  ...
  private List<Quote> found = null;

  @SerializedName("notFound")
  private List<QuoteId> notFound = null;

  public GetQuotesResponse found(List<Quote> found) {
    this.found = found;
    return this;
  }

  public GetQuotesResponse addFoundItem(Quote foundItem) {
    if (this.found == null) {
  ...
  **/
  ...
  public List<Quote> getFound() {
    return found;
  }

  public void setFound(List<Quote> found) {
    this.found = found;
  }

  public GetQuotesResponse notFound(List<QuoteId> notFound) {
    this.notFound = notFound;
    return this;
  }

  public GetQuotesResponse addNotFoundItem(QuoteId notFoundItem) {
  ...
  **/
  @ApiModelProperty(value = "")
  public List<QuoteId> getNotFound() {
    return notFound;
  }

  public void setNotFound(List<QuoteId> notFound) {
    this.notFound = notFound;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.found, getQuotesResponse.found) &&
