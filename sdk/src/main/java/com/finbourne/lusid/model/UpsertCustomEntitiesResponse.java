...
public class UpsertCustomEntitiesResponse {
  ...
  private Map<String, CustomEntityResponse> values = null;
  ...
  **/
   ...
   * @return values
  **/
  @ApiModelProperty(value = "The custom-entities which have been successfully updated or created.")
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "The custom-entities that could not be updated or created or were left unchanged without error along with a reason for their failure.")
