...
public class UpsertReconciliationRunRequest {
  ...
  public UpsertReconciliationRunRequest() {
  }

  public UpsertReconciliationRunRequest date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public UpsertReconciliationRunRequest version(Integer version) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertReconciliationRunRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertReconciliationRunRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertReconciliationRunRequest is not found in the empty JSON string", UpsertReconciliationRunRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertReconciliationRunRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertReconciliationRunRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpsertReconciliationRunRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertReconciliationRunRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertReconciliationRunRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertReconciliationRunRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertReconciliationRunRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertReconciliationRunRequest>() {
           @Override
           public void write(JsonWriter out, UpsertReconciliationRunRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertReconciliationRunRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpsertReconciliationRunRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpsertReconciliationRunRequest
  * @throws IOException if the JSON string is invalid with respect to UpsertReconciliationRunRequest
  */
  public static UpsertReconciliationRunRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertReconciliationRunRequest.class);
  }

 /**
  * Convert an instance of UpsertReconciliationRunRequest to an JSON string
  *
  * @return JSON string
  */
