...
public class EconomicDependencyWithComplexMarketData {
  ...
  * @throws IOException if the JSON Element is invalid with respect to EconomicDependencyWithComplexMarketData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EconomicDependencyWithComplexMarketData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EconomicDependencyWithComplexMarketData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EconomicDependencyWithComplexMarketData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      EconomicDependency.validateJsonElement(jsonObj.get("economicDependency"));
