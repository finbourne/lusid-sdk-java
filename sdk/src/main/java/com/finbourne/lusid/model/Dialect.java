...
public class Dialect {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Dialect
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Dialect.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Dialect.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dialect` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      DialectId.validateJsonObject(jsonObj.getAsJsonObject("id"));
