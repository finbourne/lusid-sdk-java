...
public class ResultValueCurrency extends ResultValue {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResultValueCurrency
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResultValueCurrency.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResultValueCurrency is not found in the empty JSON string", ResultValueCurrency.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResultValueCurrency.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResultValueCurrency` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResultValueCurrency.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResultValueCurrency.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResultValueCurrency' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResultValueCurrency> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResultValueCurrency.class));

       return (TypeAdapter<T>) new TypeAdapter<ResultValueCurrency>() {
           @Override
           public void write(JsonWriter out, ResultValueCurrency value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResultValueCurrency read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResultValueCurrency
  */
  public static ResultValueCurrency fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResultValueCurrency.class);
  }
