...
public class PagedResourceListOfDataTypeSummary {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfDataTypeSummary
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfDataTypeSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfDataTypeSummary is not found in the empty JSON string", PagedResourceListOfDataTypeSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfDataTypeSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfDataTypeSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfDataTypeSummary.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        DataTypeSummary.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfDataTypeSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfDataTypeSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfDataTypeSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfDataTypeSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfDataTypeSummary>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfDataTypeSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfDataTypeSummary read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfDataTypeSummary
  */
  public static PagedResourceListOfDataTypeSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfDataTypeSummary.class);
  }
