...
public class ListComplexMarketDataWithMetaDataResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ListComplexMarketDataWithMetaDataResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListComplexMarketDataWithMetaDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListComplexMarketDataWithMetaDataResponse is not found in the empty JSON string", ListComplexMarketDataWithMetaDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListComplexMarketDataWithMetaDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListComplexMarketDataWithMetaDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `marketDataId`
      if (jsonObj.get("marketDataId") != null && !jsonObj.get("marketDataId").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListComplexMarketDataWithMetaDataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListComplexMarketDataWithMetaDataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListComplexMarketDataWithMetaDataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListComplexMarketDataWithMetaDataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListComplexMarketDataWithMetaDataResponse>() {
           @Override
           public void write(JsonWriter out, ListComplexMarketDataWithMetaDataResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListComplexMarketDataWithMetaDataResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ListComplexMarketDataWithMetaDataResponse
  */
  public static ListComplexMarketDataWithMetaDataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListComplexMarketDataWithMetaDataResponse.class);
  }
