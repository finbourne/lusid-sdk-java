...
public class GetIndexConventionResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetIndexConventionResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIndexConventionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIndexConventionResponse is not found in the empty JSON string", GetIndexConventionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetIndexConventionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIndexConventionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        IndexConvention.validateJsonElement(jsonObj.get("value"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIndexConventionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIndexConventionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIndexConventionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIndexConventionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIndexConventionResponse>() {
           @Override
           public void write(JsonWriter out, GetIndexConventionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIndexConventionResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to GetIndexConventionResponse
  */
  public static GetIndexConventionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIndexConventionResponse.class);
  }
