...
public class ValuationPointDataQueryParameters {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ValuationPointDataQueryParameters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationPointDataQueryParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationPointDataQueryParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationPointDataQueryParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationPointDataQueryParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationPointDataQueryParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationPointDataQueryParameters>() {
           @Override
           public void write(JsonWriter out, ValuationPointDataQueryParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationPointDataQueryParameters read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ValuationPointDataQueryParameters
  */
  public static ValuationPointDataQueryParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationPointDataQueryParameters.class);
  }
