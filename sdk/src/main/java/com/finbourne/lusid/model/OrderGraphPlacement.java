...
public class OrderGraphPlacement {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrderGraphPlacement
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderGraphPlacement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrderGraphPlacement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderGraphPlacement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      Placement.validateJsonElement(jsonObj.get("placement"));
      // validate the required field `blockId`
      ResourceId.validateJsonElement(jsonObj.get("blockId"));
      // validate the required field `ordered`
      OrderGraphPlacementOrderSynopsis.validateJsonElement(jsonObj.get("ordered"));
      // validate the required field `placed`
      OrderGraphPlacementPlacementSynopsis.validateJsonElement(jsonObj.get("placed"));
      // validate the required field `executed`
      OrderGraphPlacementExecutionSynopsis.validateJsonElement(jsonObj.get("executed"));
      // validate the required field `allocated`
      OrderGraphPlacementAllocationSynopsis.validateJsonElement(jsonObj.get("allocated"));
