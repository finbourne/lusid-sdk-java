...
public class VersionedResourceListOfPortfolioHolding {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VersionedResourceListOfPortfolioHolding
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VersionedResourceListOfPortfolioHolding.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VersionedResourceListOfPortfolioHolding is not found in the empty JSON string", VersionedResourceListOfPortfolioHolding.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VersionedResourceListOfPortfolioHolding.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VersionedResourceListOfPortfolioHolding` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VersionedResourceListOfPortfolioHolding.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VersionedResourceListOfPortfolioHolding.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VersionedResourceListOfPortfolioHolding' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VersionedResourceListOfPortfolioHolding> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VersionedResourceListOfPortfolioHolding.class));

       return (TypeAdapter<T>) new TypeAdapter<VersionedResourceListOfPortfolioHolding>() {
           @Override
           public void write(JsonWriter out, VersionedResourceListOfPortfolioHolding value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VersionedResourceListOfPortfolioHolding read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to VersionedResourceListOfPortfolioHolding
  */
  public static VersionedResourceListOfPortfolioHolding fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionedResourceListOfPortfolioHolding.class);
  }
