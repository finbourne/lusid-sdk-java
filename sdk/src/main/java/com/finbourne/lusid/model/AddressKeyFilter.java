...
public class AddressKeyFilter {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddressKeyFilter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddressKeyFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AddressKeyFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressKeyFilter` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("right") != null && !jsonObj.get("right").isJsonNull()) {
        ResultValue.validateJsonObject(jsonObj.getAsJsonObject("right"));
      }
  }
