 ...
 */
@ApiModel(description = "Class specifying a filtering operation")
...
public class AddressKeyFilter {
   ...
   * @return left
  **/
  @ApiModelProperty(value = "Address for the value in the row")
   ...
   * @return operator
  **/
  @ApiModelProperty(value = "What sort of comparison is the filter performing. Can be either \"eq\" for equals or \"neq\" for not equals.")
