...
public class BoolComplianceParameter extends ComplianceParameter {
  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private Boolean value;

  public BoolComplianceParameter() {
    // this.complianceParameterType = this.getClass().getSimpleName();
  }

  public BoolComplianceParameter value(Boolean value) {
    this.value = value; 
    return this;
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to BoolComplianceParameter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoolComplianceParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoolComplianceParameter is not found in the empty JSON string", BoolComplianceParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BoolComplianceParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoolComplianceParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BoolComplianceParameter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoolComplianceParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoolComplianceParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoolComplianceParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoolComplianceParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<BoolComplianceParameter>() {
           @Override
           public void write(JsonWriter out, BoolComplianceParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoolComplianceParameter read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BoolComplianceParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BoolComplianceParameter
  * @throws IOException if the JSON string is invalid with respect to BoolComplianceParameter
  */
  public static BoolComplianceParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoolComplianceParameter.class);
  }

 /**
  * Convert an instance of BoolComplianceParameter to an JSON string
  *
  * @return JSON string
  */
