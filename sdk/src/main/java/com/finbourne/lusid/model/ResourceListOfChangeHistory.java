...
public class ResourceListOfChangeHistory {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<ChangeHistory> values = new ArrayList<>();
  ...
  public ResourceListOfChangeHistory() {
  }

  public ResourceListOfChangeHistory values(List<ChangeHistory> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfChangeHistory addValuesItem(ChangeHistory valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<ChangeHistory> getValues() {

    return values;
  }


  public void setValues(List<ChangeHistory> values) {
    this.values = values;
  }


  public ResourceListOfChangeHistory href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfChangeHistory links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfChangeHistory addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfChangeHistory nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfChangeHistory previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfChangeHistory {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfChangeHistory
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfChangeHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfChangeHistory is not found in the empty JSON string", ResourceListOfChangeHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfChangeHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfChangeHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfChangeHistory.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ChangeHistory.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfChangeHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfChangeHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfChangeHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfChangeHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfChangeHistory>() {
           @Override
           public void write(JsonWriter out, ResourceListOfChangeHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfChangeHistory read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfChangeHistory given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfChangeHistory
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfChangeHistory
  */
  public static ResourceListOfChangeHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfChangeHistory.class);
  }

 /**
  * Convert an instance of ResourceListOfChangeHistory to an JSON string
  *
  * @return JSON string
  */
