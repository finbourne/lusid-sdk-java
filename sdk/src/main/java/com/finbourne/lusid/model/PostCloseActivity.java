...
public class PostCloseActivity {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PostCloseActivity
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCloseActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCloseActivity is not found in the empty JSON string", PostCloseActivity.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostCloseActivity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCloseActivity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCloseActivity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCloseActivity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCloseActivity.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCloseActivity>() {
           @Override
           public void write(JsonWriter out, PostCloseActivity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCloseActivity read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PostCloseActivity
  */
  public static PostCloseActivity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCloseActivity.class);
  }
