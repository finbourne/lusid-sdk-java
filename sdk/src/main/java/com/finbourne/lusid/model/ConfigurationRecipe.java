...
public class ConfigurationRecipe {
  ...
  **/
   ...
   * @return market
  **/
  @ApiModelProperty(value = "The market configuration node that defines where market data used in processing a request is loaded from and how it is resolved.")
