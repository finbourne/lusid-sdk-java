...
public class PortfolioDetails {
  ...
  **/
  ...
  public PortfolioDetails amortisationMethod(String amortisationMethod) {
   ...
   /**
   * The amortisation method the portfolio is using in the calculation.
   * @return amortisationMethod
  **/
  @ApiModelProperty(value = "The amortisation method the portfolio is using in the calculation.")
