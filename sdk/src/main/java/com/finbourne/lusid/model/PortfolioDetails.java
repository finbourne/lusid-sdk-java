...
public class PortfolioDetails {
  ...
  private List<String> instrumentScopes = null;
  ...
  **/
  @ApiModelProperty(value = "The resolution strategy used to resolve instruments of transactions/holdings upserted to the transaction portfolio.")
  ...
  **/
  @ApiModelProperty(value = "The amortisation method the portfolio is using in the calculation. This can be 'NoAmortisation', 'StraightLine' or 'EffectiveYield'.")
  ...
  **/
  @ApiModelProperty(value = "The scope of the transaction types.")
