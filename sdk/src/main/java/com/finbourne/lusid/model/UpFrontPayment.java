 ...
 */
@ApiModel(description = "Record describing an upfront payment entity.")
...
public class UpFrontPayment {
  ...
  public UpFrontPayment amount(java.math.BigDecimal amount) {
    this.amount = amount; 
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "The upfront amount.")
  ...
  public UpFrontPayment currency(String currency) {
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "The upfront currency.")
  ...
  public UpFrontPayment payDate(OffsetDateTime payDate) {
   ...
   * @return payDate
  **/
  @ApiModelProperty(required = true, value = "Date when the upfront is paid.")
  ...
  public UpFrontPayment payReceive(String payReceive) {
   ...
   * @return payReceive
  **/
  @ApiModelProperty(required = true, value = "Is it pay or receive.    Supported string (enumeration) values are: [Pay, Receive].")
  ...
  public String toString() {
    ...
    sb.append("class UpFrontPayment {\n");
