...
public class PagedResourceListOfPortfolioGroupSearchResult {
  ...
  private List<PortfolioGroupSearchResult> values = new ArrayList<>();
  ...
  public PagedResourceListOfPortfolioGroupSearchResult() {
  }

  public PagedResourceListOfPortfolioGroupSearchResult nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfPortfolioGroupSearchResult previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfPortfolioGroupSearchResult values(List<PortfolioGroupSearchResult> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfPortfolioGroupSearchResult addValuesItem(PortfolioGroupSearchResult valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<PortfolioGroupSearchResult> getValues() {

    return values;
  }


  public void setValues(List<PortfolioGroupSearchResult> values) {
    this.values = values;
  }


  public PagedResourceListOfPortfolioGroupSearchResult href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfPortfolioGroupSearchResult links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfPortfolioGroupSearchResult addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfPortfolioGroupSearchResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfPortfolioGroupSearchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfPortfolioGroupSearchResult is not found in the empty JSON string", PagedResourceListOfPortfolioGroupSearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfPortfolioGroupSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfPortfolioGroupSearchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfPortfolioGroupSearchResult.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        PortfolioGroupSearchResult.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfPortfolioGroupSearchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfPortfolioGroupSearchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfPortfolioGroupSearchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfPortfolioGroupSearchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfPortfolioGroupSearchResult>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfPortfolioGroupSearchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfPortfolioGroupSearchResult read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfPortfolioGroupSearchResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfPortfolioGroupSearchResult
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfPortfolioGroupSearchResult
  */
  public static PagedResourceListOfPortfolioGroupSearchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfPortfolioGroupSearchResult.class);
  }

 /**
  * Convert an instance of PagedResourceListOfPortfolioGroupSearchResult to an JSON string
  *
  * @return JSON string
  */
