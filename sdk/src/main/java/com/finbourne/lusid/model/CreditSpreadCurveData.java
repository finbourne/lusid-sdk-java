...
import com.finbourne.lusid.model.CreditSpreadCurveDataAllOf;
 ...
 */
@ApiModel(description = "A credit spread curve matching tenors against par spread quotes")
...
public class CreditSpreadCurveData extends ComplexMarketData {
  ...
  private List<OffsetDateTime> maturities = null;
  ...
  **/
   ...
   * @return domCcy
  **/
  @ApiModelProperty(required = true, value = "Domestic currency of the curve")
   ...
   * @return tenors
  **/
  @ApiModelProperty(required = true, value = "The tenors for which the rates apply")
  ...
  **/
  @ApiModelProperty(value = "If tenors are provided, this is the date against which the tenors will be resolved.  This is of importance to CDX spread quotes, which are usually quoted in tenors relative to the CDX start date.  In this case, the ReferenceDate would be equal to the CDX start date, and the BaseDate would be the date for which the spreads are valid.  If not provided, this defaults to the BaseDate of the curve.")
   ...
   * @return maturities
  **/
  @ApiModelProperty(value = "The maturity dates for which the rates apply.  Either tenors or maturities should be provided, not both.")
