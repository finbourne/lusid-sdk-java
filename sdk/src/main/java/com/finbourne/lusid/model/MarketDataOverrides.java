 ...
 */
@ApiModel(description = "Class which holds market data overrides to be used in valuation")
...
public class MarketDataOverrides {
  ...
  private List<EconomicDependencyWithComplexMarketData> complexMarketData = null;

  public static final String SERIALIZED_NAME_QUOTES = "quotes";
  @SerializedName(SERIALIZED_NAME_QUOTES)
  private List<EconomicDependencyWithQuote> quotes = null;
  ...
  **/
  @ApiModelProperty(value = "A list of EconomicDependency paired with quote data satisfying that economic dependency")
   ...
   * @return quotes
  **/
  @ApiModelProperty(value = "A list of EconomicDependency paired with a ComplexMarketData satisfying that economic dependency")
