...
public class UpsertPortfolioTransactionsResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertPortfolioTransactionsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertPortfolioTransactionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertPortfolioTransactionsResponse is not found in the empty JSON string", UpsertPortfolioTransactionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertPortfolioTransactionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertPortfolioTransactionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpsertPortfolioTransactionsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertPortfolioTransactionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertPortfolioTransactionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertPortfolioTransactionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertPortfolioTransactionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertPortfolioTransactionsResponse>() {
           @Override
           public void write(JsonWriter out, UpsertPortfolioTransactionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertPortfolioTransactionsResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpsertPortfolioTransactionsResponse
  */
  public static UpsertPortfolioTransactionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertPortfolioTransactionsResponse.class);
  }
