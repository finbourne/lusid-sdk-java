...
public class TransitionEventAllOf {
  ...
  private List<OutputTransition> outputTransitions = null;
  ...
  private InstrumentEventTypeEnum instrumentEventType;


  public TransitionEventAllOf announcementDate(OffsetDateTime announcementDate) {
  ...
  **/
  ...
  public TransitionEventAllOf exDate(OffsetDateTime exDate) {
    this.exDate = exDate; 
    return this;
  }
  ...
  **/
  ...
  public TransitionEventAllOf recordDate(OffsetDateTime recordDate) {
  ...
  **/
  ...
  public TransitionEventAllOf paymentDate(OffsetDateTime paymentDate) {
  ...
  **/
  ...
  public TransitionEventAllOf inputTransition(InputTransition inputTransition) {
  ...
  **/
  ...
  public TransitionEventAllOf outputTransitions(List<OutputTransition> outputTransitions) {
    this.outputTransitions = outputTransitions; 
    return this;
  }

  public TransitionEventAllOf addOutputTransitionsItem(OutputTransition outputTransitionsItem) {
  ...
  **/
  @ApiModelProperty(value = "The resulting transitions from this event")
  ...
  public TransitionEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent")
