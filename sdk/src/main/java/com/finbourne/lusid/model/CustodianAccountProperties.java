...
public class CustodianAccountProperties {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CustodianAccountProperties
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustodianAccountProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustodianAccountProperties is not found in the empty JSON string", CustodianAccountProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustodianAccountProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustodianAccountProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustodianAccountProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustodianAccountProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustodianAccountProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustodianAccountProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<CustodianAccountProperties>() {
           @Override
           public void write(JsonWriter out, CustodianAccountProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustodianAccountProperties read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to CustodianAccountProperties
  */
  public static CustodianAccountProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustodianAccountProperties.class);
  }
