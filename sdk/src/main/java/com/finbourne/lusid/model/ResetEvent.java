...
import com.finbourne.lusid.model.ResetEventAllOf;
 ...
 */
@ApiModel(description = "Definition of a reset event.  This is an event that describes a reset or fixing for an instrument such as the floating payment on  a swap cash flow.")
...
public class ResetEvent extends InstrumentEvent {
   ...
   * @return value
  **/
  @ApiModelProperty(value = "The quantity associated with the reset. This will only be populated if the information is known.")
   ...
   * @return resetType
  **/
  @ApiModelProperty(required = true, value = "The type of the reset; e.g. RIC, Currency-pair")
   ...
   * @return fixingSource
  **/
  @ApiModelProperty(value = "Fixing identification source, if available.")
   ...
   * @return eventStatus
  **/
  @ApiModelProperty(required = true, value = "What is the event status, is it a known (ie historic) or unknown (ie projected) event?")
   ...
   * @return fixingDate
  **/
  @ApiModelProperty(required = true, value = "The date the reset fixes, or is observed upon.")
