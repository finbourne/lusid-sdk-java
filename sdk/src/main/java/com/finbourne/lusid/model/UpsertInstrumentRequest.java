...
public class UpsertInstrumentRequest {
  ...
  public UpsertInstrumentRequest name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Required. The name of the instrument")
  ...
  public UpsertInstrumentRequest identifiers(Map<String, String> identifiers) {
    this.identifiers = identifiers;
    return this;
  }

  public UpsertInstrumentRequest putIdentifiersItem(String key, String identifiersItem) {
   ...
   * @return identifiers
  **/
  @ApiModelProperty(required = true, value = "Required. A set of identifiers that uniquely identify this instrument (e.g FIGI, RIC)")
  ...
  public UpsertInstrumentRequest lookThroughPortfolioId(ResourceId lookThroughPortfolioId) {
  ...
  **/
  @ApiModelProperty(value = "Optional. The identifier of the portfolio that represents this instrument")
  ...
  public UpsertInstrumentRequest definition(InstrumentEconomicDefinition definition) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpsertInstrumentRequest upsertInstrumentRequest = (UpsertInstrumentRequest) o;
    return Objects.equals(this.name, upsertInstrumentRequest.name) &&
        Objects.equals(this.identifiers, upsertInstrumentRequest.identifiers) &&
        Objects.equals(this.lookThroughPortfolioId, upsertInstrumentRequest.lookThroughPortfolioId) &&
        Objects.equals(this.definition, upsertInstrumentRequest.definition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, identifiers, lookThroughPortfolioId, definition);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpsertInstrumentRequest {\n");
