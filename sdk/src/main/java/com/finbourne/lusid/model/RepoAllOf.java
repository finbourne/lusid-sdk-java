...
public class RepoAllOf {
  ...
  private List<LusidInstrument> collateral = null;
  ...
  **/
   ...
   * @return accrualBasis
  **/
  @ApiModelProperty(required = true, value = "For calculation of interest, the accrual basis to be used.  For more information on day counts, see [knowledge base article KA-01798](https://support.lusid.com/knowledgebase/article/KA-01798)                Supported string (enumeration) values are: [Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActualActual, ActAct, ActActIsda, ActActIsma, ActActIcma, OneOne, Act364, Act365F, Act365L, Act365_25, Act252, Bus252, NL360, NL365, ActActAFB, Act365Cad, ThirtyActIsda, Thirty365Isda, ThirtyEActIsda, ThirtyE360Isda, ThirtyE365Isda, ThirtyU360EOM].")
  ...
  public RepoAllOf collateral(List<LusidInstrument> collateral) {
    this.collateral = collateral; 
    return this;
  }

  public RepoAllOf addCollateralItem(LusidInstrument collateralItem) {
   ...
   * @return collateral
  **/
  @ApiModelProperty(value = "The actual collateral in the Repo.  This property is for informational purposes only, Lusid pricing is not affected.")
  ...
  public RepoAllOf collateralValue(java.math.BigDecimal collateralValue) {
  ...
  **/
  ...
  public RepoAllOf haircut(java.math.BigDecimal haircut) {
  ...
  **/
  ...
  public RepoAllOf margin(java.math.BigDecimal margin) {
    this.margin = margin; 
    return this;
  }
  ...
  **/
  ...
  public RepoAllOf purchasePrice(java.math.BigDecimal purchasePrice) {
  ...
  **/
  ...
  public RepoAllOf repoRate(java.math.BigDecimal repoRate) {
  ...
  **/
  ...
  public RepoAllOf repurchasePrice(java.math.BigDecimal repurchasePrice) {
