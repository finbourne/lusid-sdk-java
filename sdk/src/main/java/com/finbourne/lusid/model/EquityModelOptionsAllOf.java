...
public class EquityModelOptionsAllOf {
  ...
  public EquityModelOptionsAllOf equityForwardProjectionType(String equityForwardProjectionType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Determines how forward equity prices should be projected.                Supported string (enumeration) values are: [FlatForwardCurveFromSpot, EquityCurveByPrices, ForwardProjectedFromRatesCurve].")
  ...
  public EquityModelOptionsAllOf modelOptionsType(ModelOptionsTypeEnum modelOptionsType) {
