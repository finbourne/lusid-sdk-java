...
public class InstrumentListAllOf {
  ...
  public InstrumentListAllOf values(List<String> values) {
    this.values = values; 
    return this;
  }

  public InstrumentListAllOf addValuesItem(String valuesItem) {
  ...
  **/
  ...
  public InstrumentListAllOf referenceListType(ReferenceListTypeEnum referenceListType) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class InstrumentListAllOf {\n");
