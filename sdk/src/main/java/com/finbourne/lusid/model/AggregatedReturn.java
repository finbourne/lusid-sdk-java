...
public class AggregatedReturn {
  ...
  private List<ResourceId> compositeMembersWithoutReturn = null;
  ...
  **/
   ...
   * @return endOfPeriod
  **/
  @ApiModelProperty(required = true, value = "The end of period date. For the monthly period this will be the Month End Date.")
  ...
  **/
  @ApiModelProperty(value = "The number of members in the Composite on the given day.")
  ...
  **/
  @ApiModelProperty(value = "List containing Composite members which post no return on the given day.")
