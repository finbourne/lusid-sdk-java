...
public class PortfolioProperties {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortfolioProperties
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortfolioProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PortfolioProperties is not found in the empty JSON string", PortfolioProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PortfolioProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PortfolioProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortfolioProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortfolioProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortfolioProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortfolioProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<PortfolioProperties>() {
           @Override
           public void write(JsonWriter out, PortfolioProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PortfolioProperties read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PortfolioProperties
  */
  public static PortfolioProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortfolioProperties.class);
  }
