 ...
 */
@ApiModel(description = "Container class pairing economic dependencies and quote data")
...
public class EconomicDependencyWithQuote {
  ...
  **/
   ...
   * @return scaleFactor
  **/
  @ApiModelProperty(value = "Scale factor for the quote - this can be null, in which case we default to 1.")
