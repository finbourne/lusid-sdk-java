...
public class EconomicDependencyWithQuote {
  ...
  * @throws IOException if the JSON Element is invalid with respect to EconomicDependencyWithQuote
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EconomicDependencyWithQuote.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EconomicDependencyWithQuote is not found in the empty JSON string", EconomicDependencyWithQuote.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EconomicDependencyWithQuote.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EconomicDependencyWithQuote` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EconomicDependencyWithQuote.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EconomicDependencyWithQuote.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EconomicDependencyWithQuote' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EconomicDependencyWithQuote> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EconomicDependencyWithQuote.class));

       return (TypeAdapter<T>) new TypeAdapter<EconomicDependencyWithQuote>() {
           @Override
           public void write(JsonWriter out, EconomicDependencyWithQuote value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EconomicDependencyWithQuote read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to EconomicDependencyWithQuote
  */
  public static EconomicDependencyWithQuote fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EconomicDependencyWithQuote.class);
  }
