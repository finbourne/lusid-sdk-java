...
public class UpsertReferencePortfolioConstituentsResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertReferencePortfolioConstituentsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertReferencePortfolioConstituentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertReferencePortfolioConstituentsResponse is not found in the empty JSON string", UpsertReferencePortfolioConstituentsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertReferencePortfolioConstituentsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertReferencePortfolioConstituentsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertReferencePortfolioConstituentsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertReferencePortfolioConstituentsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertReferencePortfolioConstituentsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertReferencePortfolioConstituentsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertReferencePortfolioConstituentsResponse>() {
           @Override
           public void write(JsonWriter out, UpsertReferencePortfolioConstituentsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertReferencePortfolioConstituentsResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpsertReferencePortfolioConstituentsResponse
  */
  public static UpsertReferencePortfolioConstituentsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertReferencePortfolioConstituentsResponse.class);
  }
