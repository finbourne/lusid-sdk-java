...
public class ComplexMarketDataId {
  ...
  public ComplexMarketDataId provider(String provider) {
   ...
   /**
   * The platform or vendor that provided the complex market data, e.g. &#39;DataScope&#39;, &#39;LUSID&#39;, &#39;ISDA&#39; etc.
   * @return provider
  **/
  @ApiModelProperty(required = true, value = "The platform or vendor that provided the complex market data, e.g. 'DataScope', 'LUSID', 'ISDA' etc.")
   ...
   * @return priceSource
  **/
  @ApiModelProperty(value = "The source or originator of the complex market data, e.g. a bank or financial institution.")
   ...
   * @return lineage
  **/
  @ApiModelProperty(value = "This is obsolete. It is not used, it will not be stored, and has no effects.  If you wish to attach a Lineage to your ComplexMarketData,  you should provide it in the optional Lineage field in the ComplexMarketData class.")
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(value = "The effectiveAt or cut label that this item of complex market data is/was updated/inserted with.")
   ...
   * @return marketAsset
  **/
  @ApiModelProperty(required = true, value = "The name of the market entity that the document represents")
