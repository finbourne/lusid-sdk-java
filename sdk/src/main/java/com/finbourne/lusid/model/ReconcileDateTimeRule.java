...
public class ReconcileDateTimeRule extends ReconciliationRule {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReconcileDateTimeRule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReconcileDateTimeRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReconcileDateTimeRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReconcileDateTimeRule` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
