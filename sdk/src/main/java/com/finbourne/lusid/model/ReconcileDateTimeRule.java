...
import com.finbourne.lusid.model.ReconcileDateTimeRuleAllOf;
 ...
 */
@ApiModel(description = "Comparison of date time values")
...
public class ReconcileDateTimeRule extends ReconciliationRule {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Exact, AbsoluteDifference")
