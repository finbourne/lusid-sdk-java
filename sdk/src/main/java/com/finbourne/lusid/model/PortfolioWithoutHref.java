...
public class PortfolioWithoutHref {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortfolioWithoutHref
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortfolioWithoutHref.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PortfolioWithoutHref is not found in the empty JSON string", PortfolioWithoutHref.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PortfolioWithoutHref.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortfolioWithoutHref.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortfolioWithoutHref' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortfolioWithoutHref> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortfolioWithoutHref.class));

       return (TypeAdapter<T>) new TypeAdapter<PortfolioWithoutHref>() {
           @Override
           public void write(JsonWriter out, PortfolioWithoutHref value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PortfolioWithoutHref read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PortfolioWithoutHref
  */
  public static PortfolioWithoutHref fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortfolioWithoutHref.class);
  }
