...
public class TranslateTradeTicketsResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TranslateTradeTicketsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TranslateTradeTicketsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TranslateTradeTicketsResponse is not found in the empty JSON string", TranslateTradeTicketsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TranslateTradeTicketsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TranslateTradeTicketsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TranslateTradeTicketsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TranslateTradeTicketsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TranslateTradeTicketsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TranslateTradeTicketsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TranslateTradeTicketsResponse>() {
           @Override
           public void write(JsonWriter out, TranslateTradeTicketsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TranslateTradeTicketsResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to TranslateTradeTicketsResponse
  */
  public static TranslateTradeTicketsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TranslateTradeTicketsResponse.class);
  }
