...
public class FundBookmark extends FundCalendarEntries {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FundBookmark
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FundBookmark.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FundBookmark is not found in the empty JSON string", FundBookmark.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FundBookmark.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FundBookmark.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FundBookmark' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FundBookmark> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FundBookmark.class));

       return (TypeAdapter<T>) new TypeAdapter<FundBookmark>() {
           @Override
           public void write(JsonWriter out, FundBookmark value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FundBookmark read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to FundBookmark
  */
  public static FundBookmark fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FundBookmark.class);
  }
