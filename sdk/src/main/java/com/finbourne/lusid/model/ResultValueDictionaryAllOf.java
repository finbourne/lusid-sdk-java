...
public class ResultValueDictionaryAllOf {
  public static final String SERIALIZED_NAME_ELEMENTS = "elements";
  @SerializedName(SERIALIZED_NAME_ELEMENTS)
  private Map<String, ResultValue> elements = null;

  /**
   * The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet, ResultValueLifeCycleEventValue, ResultValueDateTimeOffset
   */
  ...
  public ResultValueDictionaryAllOf elements(Map<String, ResultValue> elements) {
    this.elements = elements; 
    return this;
  }

  public ResultValueDictionaryAllOf putElementsItem(String key, ResultValue elementsItem) {
   ...
   * @return elements
  **/
  @ApiModelProperty(value = "The dictionary elements")
  ...
  public ResultValueDictionaryAllOf resultValueType(ResultValueTypeEnum resultValueType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, CashFlowValue, CashFlowValueSet, ResultValueLifeCycleEventValue, ResultValueDateTimeOffset")
  ...
  public String toString() {
    ...
    sb.append("class ResultValueDictionaryAllOf {\n");
