...
public class ResourceListOfComplianceRule {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<ComplianceRule> values = new ArrayList<>();
  ...
  public ResourceListOfComplianceRule() {
  }

  public ResourceListOfComplianceRule values(List<ComplianceRule> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfComplianceRule addValuesItem(ComplianceRule valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<ComplianceRule> getValues() {

    return values;
  }


  public void setValues(List<ComplianceRule> values) {
    this.values = values;
  }


  public ResourceListOfComplianceRule href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfComplianceRule links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfComplianceRule addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfComplianceRule nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfComplianceRule previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfComplianceRule {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfComplianceRule
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfComplianceRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfComplianceRule is not found in the empty JSON string", ResourceListOfComplianceRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfComplianceRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfComplianceRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfComplianceRule.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ComplianceRule.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfComplianceRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfComplianceRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfComplianceRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfComplianceRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfComplianceRule>() {
           @Override
           public void write(JsonWriter out, ResourceListOfComplianceRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfComplianceRule read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfComplianceRule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfComplianceRule
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfComplianceRule
  */
  public static ResourceListOfComplianceRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfComplianceRule.class);
  }

 /**
  * Convert an instance of ResourceListOfComplianceRule to an JSON string
  *
  * @return JSON string
  */
