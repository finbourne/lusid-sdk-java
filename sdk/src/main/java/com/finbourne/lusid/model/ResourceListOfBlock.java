...
public class ResourceListOfBlock {
  ...
  public ResourceListOfBlock() {
  }

  public ResourceListOfBlock values(List<Block> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfBlock addValuesItem(Block valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public void setValues(List<Block> values) {
    this.values = values;
  }


  public ResourceListOfBlock href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfBlock links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfBlock addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfBlock nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfBlock previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfBlock {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfBlock
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfBlock is not found in the empty JSON string", ResourceListOfBlock.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfBlock.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfBlock` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfBlock.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        Block.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfBlock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfBlock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfBlock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfBlock.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfBlock>() {
           @Override
           public void write(JsonWriter out, ResourceListOfBlock value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfBlock read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfBlock given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfBlock
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfBlock
  */
  public static ResourceListOfBlock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfBlock.class);
  }

 /**
  * Convert an instance of ResourceListOfBlock to an JSON string
  *
  * @return JSON string
  */
