...
public class ReconciliationBreakId {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ReconciliationBreakId
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReconciliationBreakId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReconciliationBreakId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReconciliationBreakId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("reconciliationRun") != null && !jsonObj.get("reconciliationRun").isJsonNull()) {
        ReconciliationRunId.validateJsonElement(jsonObj.get("reconciliationRun"));
      }
