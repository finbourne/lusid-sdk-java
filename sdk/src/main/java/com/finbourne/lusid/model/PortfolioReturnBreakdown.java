 ...
 */
@ApiModel(description = "A list of Composite Breakdowns.")
...
public class PortfolioReturnBreakdown {
  ...
  **/
   ...
   * @return rateOfReturn
  **/
  @ApiModelProperty(value = "The return number.")
  ...
  **/
   ...
   * @return weight
  **/
  @ApiModelProperty(value = "The weight of the constituent into the composite.")
  ...
  **/
  @ApiModelProperty(value = "The number of the constituents which have a missing return on that day.")
   ...
   * @return currency
  **/
  @ApiModelProperty(value = "The currency of the portfolio.")
   ...
   * @return openFxRate
  **/
  @ApiModelProperty(value = "The opening fxRate which is used in calculation.")
   ...
   * @return closeFxRate
  **/
  @ApiModelProperty(value = "The closing fxRate which is used in calculation.")
  ...
  **/
  @ApiModelProperty(value = "The rate of return in the local currency.")
  ...
  **/
  @ApiModelProperty(value = "The opening market value in the local currency.")
  ...
  **/
  @ApiModelProperty(value = "The closing market value in the local currency.")
