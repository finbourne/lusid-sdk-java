...
import com.finbourne.lusid.model.ErrorDetailBase;
...
public class ErrorResponse {
  ...
  private List<ErrorDetailBase> items = null;
  ...
  **/
  ...
  public ErrorResponse detailedMessage(String detailedMessage) {
  ...
  **/
  ...
  public ErrorResponse items(List<ErrorDetailBase> items) {
    this.items = items;
    return this;
  }

  public ErrorResponse addItemsItem(ErrorDetailBase itemsItem) {
    if (this.items == null) {
  ...
  **/
  @ApiModelProperty(value = "")
  public List<ErrorDetailBase> getItems() {
    return items;
  }

  public void setItems(List<ErrorDetailBase> items) {
    this.items = items;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, errorResponse.status) &&
        ...
        Objects.equals(this.detailedMessage, errorResponse.detailedMessage) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, code, message, detailedMessage, items, moreInfo);
  }
