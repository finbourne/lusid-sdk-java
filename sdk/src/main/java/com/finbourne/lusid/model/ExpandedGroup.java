...
public class ExpandedGroup {
  ...
  **/
  ...
  public ExpandedGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.href, expandedGroup.href) &&
        ...
        Objects.equals(this.name, expandedGroup.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, id, name, description, values, subGroups, version, links);
  }
