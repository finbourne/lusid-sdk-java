...
public class PortfolioReconciliationRequest {
   ...
   * @return portfolioId
  **/
  @ApiModelProperty(required = true, value = "The id of the portfolio to be reconciled")
  ...
  public PortfolioReconciliationRequest effectiveAt(OffsetDateTime effectiveAt) {
