...
public class PagedResourceListOfPortfolioSearchResult {
  ...
  public PagedResourceListOfPortfolioSearchResult() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfPortfolioSearchResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfPortfolioSearchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfPortfolioSearchResult is not found in the empty JSON string", PagedResourceListOfPortfolioSearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfPortfolioSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfPortfolioSearchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfPortfolioSearchResult.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        PortfolioSearchResult.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfPortfolioSearchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfPortfolioSearchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfPortfolioSearchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfPortfolioSearchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfPortfolioSearchResult>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfPortfolioSearchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfPortfolioSearchResult read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfPortfolioSearchResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfPortfolioSearchResult
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfPortfolioSearchResult
  */
  public static PagedResourceListOfPortfolioSearchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfPortfolioSearchResult.class);
  }

 /**
  * Convert an instance of PagedResourceListOfPortfolioSearchResult to an JSON string
  *
  * @return JSON string
  */
