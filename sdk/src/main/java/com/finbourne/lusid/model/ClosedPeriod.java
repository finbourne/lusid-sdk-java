...
public class ClosedPeriod {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ClosedPeriod
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClosedPeriod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClosedPeriod is not found in the empty JSON string", ClosedPeriod.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClosedPeriod.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClosedPeriod' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClosedPeriod> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClosedPeriod.class));

       return (TypeAdapter<T>) new TypeAdapter<ClosedPeriod>() {
           @Override
           public void write(JsonWriter out, ClosedPeriod value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClosedPeriod read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ClosedPeriod
  */
  public static ClosedPeriod fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClosedPeriod.class);
  }
