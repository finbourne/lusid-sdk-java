 ...
 */
@ApiModel(description = "In evaluating a left and right hand side holding or valuation set, two data records result. These are then compared based on a set of  rules. This results in either a match or failure to match. If there is a match both left and right will be present, otherwise one will not.  A difference will be present if a match was calculated.  The options used in comparison may result in elision of results where an exact or tolerable match is made.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ReconciliationLine {
  public static final String SERIALIZED_NAME_LEFT = "left";
  @SerializedName(SERIALIZED_NAME_LEFT)
  private Map<String, Object> left = null;

  public static final String SERIALIZED_NAME_RIGHT = "right";
  @SerializedName(SERIALIZED_NAME_RIGHT)
  private Map<String, Object> right = null;

  public static final String SERIALIZED_NAME_DIFFERENCE = "difference";
  @SerializedName(SERIALIZED_NAME_DIFFERENCE)
  private Map<String, Object> difference = null;
  ...
  private Map<String, Object> resultComparison = null;
   ...
   * @return left
  **/
  @ApiModelProperty(value = "Left hand side of the comparison")
   ...
   * @return right
  **/
  @ApiModelProperty(value = "Right hand side of the comparison")
   ...
   * @return difference
  **/
  @ApiModelProperty(value = "Difference between LHS and RHS of comparison")
  ...
  **/
  @ApiModelProperty(value = "The logical or semantic description of the difference, e.g. \"Matches\" or \"MatchesWithTolerance\" or \"Failed\".")
