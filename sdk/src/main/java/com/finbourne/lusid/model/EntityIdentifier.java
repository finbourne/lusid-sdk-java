 ...
 */
@ApiModel(description = "Dto to expose mapped keys to new standardised format")
...
public class EntityIdentifier {
  ...
  **/
  @ApiModelProperty(value = "The scope of the identifier")
  ...
  **/
  @ApiModelProperty(required = true, value = "The type of the identifier")
