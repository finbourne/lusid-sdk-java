...
public class UpsertLegalEntitiesResponse {
  ...
  private Map<String, LegalEntity> values = null;
  ...
  **/
   ...
   * @return values
  **/
  @ApiModelProperty(value = "The legal entities which have been successfully updated or created.")
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "The legal entities that could not be updated or created or were left unchanged without error along with a reason for their failure.")
