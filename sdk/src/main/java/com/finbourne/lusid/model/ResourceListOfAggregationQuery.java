...
public class ResourceListOfAggregationQuery {
  ...
  public ResourceListOfAggregationQuery() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfAggregationQuery
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfAggregationQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfAggregationQuery is not found in the empty JSON string", ResourceListOfAggregationQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfAggregationQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfAggregationQuery` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfAggregationQuery.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        AggregationQuery.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfAggregationQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfAggregationQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfAggregationQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfAggregationQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfAggregationQuery>() {
           @Override
           public void write(JsonWriter out, ResourceListOfAggregationQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfAggregationQuery read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfAggregationQuery given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfAggregationQuery
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfAggregationQuery
  */
  public static ResourceListOfAggregationQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfAggregationQuery.class);
  }

 /**
  * Convert an instance of ResourceListOfAggregationQuery to an JSON string
  *
  * @return JSON string
  */
