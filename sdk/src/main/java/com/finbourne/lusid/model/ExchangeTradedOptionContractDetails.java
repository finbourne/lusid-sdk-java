 ...
 */
@ApiModel(description = "Most, if not all, information about contracts is standardised. See, e.g. https://www.cmegroup.com/ for  common codes and similar data. This appears to be in common use by well known market information providers, e.g. Bloomberg and Refinitiv.  There is a lot of overlap with this and FuturesContractDetails but as that is an established DTO we must duplicate a number of fields here")
...
public class ExchangeTradedOptionContractDetails {
  ...
  **/
   ...
   * @return deliveryType
  **/
  @ApiModelProperty(required = true, value = "The delivery type, cash or physical. An option on a future is physically settled if upon exercising the  holder receives a future.    Supported string (enumeration) values are: [Cash, Physical].")
  ...
  **/
   ...
   * @return exerciseDate
  **/
  @ApiModelProperty(required = true, value = "Exercise Date.")
   ...
   * @return exerciseType
  **/
  @ApiModelProperty(required = true, value = "The exercise type, European, American or Bermudan.    Supported string (enumeration) values are: [European, Bermudan, American].")
   ...
   * @return optionCode
  **/
  @ApiModelProperty(required = true, value = "Option Contract Code, typically one or two letters, e.g. OG => Option on Gold.")
   ...
   * @return optionType
  **/
  @ApiModelProperty(required = true, value = "The option type, Call or Put.    Supported string (enumeration) values are: [Call, Put].")
  ...
  **/
  @ApiModelProperty(required = true, value = "Code of the underlying, for an option on futures this should be the futures code.")
