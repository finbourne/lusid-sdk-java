...
public class IndexModelOptions extends ModelOptions {
  ...
  * @throws IOException if the JSON Element is invalid with respect to IndexModelOptions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IndexModelOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!IndexModelOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IndexModelOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
