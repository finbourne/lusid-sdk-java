...
public class UpsertCorporateActionsResponse {
  ...
  **/
   ...
   * @return values
  **/
  @ApiModelProperty(value = "The corporate actions which have been successfully updated or inserted.")
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "The corporate actions that could not be updated or inserted along with a reason for their failure.")
