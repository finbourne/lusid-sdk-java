 ...
 */
@ApiModel(description = "The lineage of the event value")
...
public class LifeCycleEventLineage {
  ...
  **/
  @ApiModelProperty(value = "The instrument type of the instrument for the event.")
   ...
   * @return instrumentId
  **/
  @ApiModelProperty(value = "The LUID of the instrument for the event.")
   ...
   * @return legId
  **/
  @ApiModelProperty(value = "Leg id for the event.")
  ...
  **/
  @ApiModelProperty(value = "The source transaction of the instrument for the event.")
