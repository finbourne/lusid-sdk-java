...
public class MbsPrincipalEvent extends InstrumentEvent {
  ...
  public MbsPrincipalEvent() {
    // this.instrumentEventType = this.getClass().getSimpleName();
  }

  public MbsPrincipalEvent exDate(OffsetDateTime exDate) {
  ...
  **/
  ...
  public MbsPrincipalEvent paymentDate(OffsetDateTime paymentDate) {
  ...
  **/
  ...
  public MbsPrincipalEvent currency(String currency) {
  ...
  **/
  ...
  public MbsPrincipalEvent principalPerUnit(java.math.BigDecimal principalPerUnit) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MbsPrincipalEvent mbsPrincipalEvent = (MbsPrincipalEvent) o;
  ...
  * @throws IOException if the JSON Element is invalid with respect to MbsPrincipalEvent
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MbsPrincipalEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MbsPrincipalEvent is not found in the empty JSON string", MbsPrincipalEvent.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MbsPrincipalEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MbsPrincipalEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MbsPrincipalEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MbsPrincipalEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MbsPrincipalEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<MbsPrincipalEvent>() {
           @Override
           public void write(JsonWriter out, MbsPrincipalEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MbsPrincipalEvent read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MbsPrincipalEvent given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MbsPrincipalEvent
  * @throws IOException if the JSON string is invalid with respect to MbsPrincipalEvent
  */
  public static MbsPrincipalEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MbsPrincipalEvent.class);
  }

 /**
  * Convert an instance of MbsPrincipalEvent to an JSON string
  *
  * @return JSON string
  */
