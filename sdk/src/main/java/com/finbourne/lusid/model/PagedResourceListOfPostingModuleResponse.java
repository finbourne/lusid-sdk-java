...
public class PagedResourceListOfPostingModuleResponse {
  ...
  public PagedResourceListOfPostingModuleResponse() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfPostingModuleResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfPostingModuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfPostingModuleResponse is not found in the empty JSON string", PagedResourceListOfPostingModuleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfPostingModuleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfPostingModuleResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfPostingModuleResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        PostingModuleResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfPostingModuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfPostingModuleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfPostingModuleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfPostingModuleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfPostingModuleResponse>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfPostingModuleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfPostingModuleResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfPostingModuleResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfPostingModuleResponse
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfPostingModuleResponse
  */
  public static PagedResourceListOfPostingModuleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfPostingModuleResponse.class);
  }

 /**
  * Convert an instance of PagedResourceListOfPostingModuleResponse to an JSON string
  *
  * @return JSON string
  */
