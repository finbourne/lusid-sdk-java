...
public class AggregatedReturnsRequest {
  ...
  **/
  ...
  public AggregatedReturnsRequest returnId(ResourceId returnId) {
  ...
  **/
  ...
  public ResourceId getReturnId() {
    return returnId;
  }

  public void setReturnId(ResourceId returnId) {
    this.returnId = returnId;
  }
