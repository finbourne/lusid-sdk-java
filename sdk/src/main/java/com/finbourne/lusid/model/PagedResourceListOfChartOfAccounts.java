...
public class PagedResourceListOfChartOfAccounts {
  ...
  private List<ChartOfAccounts> values = new ArrayList<>();
  ...
  public PagedResourceListOfChartOfAccounts nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfChartOfAccounts previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfChartOfAccounts values(List<ChartOfAccounts> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfChartOfAccounts addValuesItem(ChartOfAccounts valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<ChartOfAccounts> getValues() {

    return values;
  }


  public void setValues(List<ChartOfAccounts> values) {
    this.values = values;
  }


  public PagedResourceListOfChartOfAccounts href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfChartOfAccounts links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfChartOfAccounts addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfChartOfAccounts {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfChartOfAccounts
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfChartOfAccounts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfChartOfAccounts is not found in the empty JSON string", PagedResourceListOfChartOfAccounts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfChartOfAccounts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfChartOfAccounts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfChartOfAccounts.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ChartOfAccounts.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfChartOfAccounts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfChartOfAccounts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfChartOfAccounts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfChartOfAccounts.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfChartOfAccounts>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfChartOfAccounts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfChartOfAccounts read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfChartOfAccounts given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfChartOfAccounts
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfChartOfAccounts
  */
  public static PagedResourceListOfChartOfAccounts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfChartOfAccounts.class);
  }

 /**
  * Convert an instance of PagedResourceListOfChartOfAccounts to an JSON string
  *
  * @return JSON string
  */
