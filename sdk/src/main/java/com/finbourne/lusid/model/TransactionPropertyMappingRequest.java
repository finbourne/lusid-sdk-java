...
public class TransactionPropertyMappingRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransactionPropertyMappingRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionPropertyMappingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionPropertyMappingRequest is not found in the empty JSON string", TransactionPropertyMappingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransactionPropertyMappingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionPropertyMappingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionPropertyMappingRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionPropertyMappingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionPropertyMappingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionPropertyMappingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionPropertyMappingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionPropertyMappingRequest>() {
           @Override
           public void write(JsonWriter out, TransactionPropertyMappingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactionPropertyMappingRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to TransactionPropertyMappingRequest
  */
  public static TransactionPropertyMappingRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionPropertyMappingRequest.class);
  }
