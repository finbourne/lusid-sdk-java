...
public class TransactionPropertyMappingRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionPropertyMappingRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionPropertyMappingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransactionPropertyMappingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionPropertyMappingRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
