  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FixedLegAllOfOverrides.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FixedLegAllOfOverrides` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("Amortization") != null && !jsonObj.get("Amortization").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("Spreads") != null && !jsonObj.get("Spreads").isJsonArray()) {
