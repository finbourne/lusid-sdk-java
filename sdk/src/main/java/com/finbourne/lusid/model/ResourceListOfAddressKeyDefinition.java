...
public class ResourceListOfAddressKeyDefinition {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfAddressKeyDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfAddressKeyDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfAddressKeyDefinition is not found in the empty JSON string", ResourceListOfAddressKeyDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfAddressKeyDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfAddressKeyDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfAddressKeyDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfAddressKeyDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfAddressKeyDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfAddressKeyDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfAddressKeyDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfAddressKeyDefinition>() {
           @Override
           public void write(JsonWriter out, ResourceListOfAddressKeyDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfAddressKeyDefinition read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfAddressKeyDefinition
  */
  public static ResourceListOfAddressKeyDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfAddressKeyDefinition.class);
  }
