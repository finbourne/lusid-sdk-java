...
public class PagedResourceListOfPortfolioGroup {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfPortfolioGroup
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfPortfolioGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfPortfolioGroup is not found in the empty JSON string", PagedResourceListOfPortfolioGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfPortfolioGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfPortfolioGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfPortfolioGroup.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        PortfolioGroup.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfPortfolioGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfPortfolioGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfPortfolioGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfPortfolioGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfPortfolioGroup>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfPortfolioGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfPortfolioGroup read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfPortfolioGroup
  */
  public static PagedResourceListOfPortfolioGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfPortfolioGroup.class);
  }
