...
public class UpsertInstrumentPropertiesResponse {
  ...
  private List<ErrorDetail> failed = null;

  @SerializedName("links")
  private List<Link> links = null;

  public UpsertInstrumentPropertiesResponse href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public UpsertInstrumentPropertiesResponse failed(List<ErrorDetail> failed) {
    this.failed = failed;
    return this;
  }

  public UpsertInstrumentPropertiesResponse addFailedItem(ErrorDetail failedItem) {
    if (this.failed == null) {
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "A list of any values that failed to be upserted.")
  public List<ErrorDetail> getFailed() {
    return failed;
  }

  public void setFailed(List<ErrorDetail> failed) {
    this.failed = failed;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.href, upsertInstrumentPropertiesResponse.href) &&
        Objects.equals(this.failed, upsertInstrumentPropertiesResponse.failed) &&
        Objects.equals(this.links, upsertInstrumentPropertiesResponse.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(href, failed, links);
  }
