...
public class UpsertInstrumentPropertiesResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertInstrumentPropertiesResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertInstrumentPropertiesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertInstrumentPropertiesResponse is not found in the empty JSON string", UpsertInstrumentPropertiesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertInstrumentPropertiesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertInstrumentPropertiesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpsertInstrumentPropertiesResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertInstrumentPropertiesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertInstrumentPropertiesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertInstrumentPropertiesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertInstrumentPropertiesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertInstrumentPropertiesResponse>() {
           @Override
           public void write(JsonWriter out, UpsertInstrumentPropertiesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertInstrumentPropertiesResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpsertInstrumentPropertiesResponse
  */
  public static UpsertInstrumentPropertiesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertInstrumentPropertiesResponse.class);
  }
