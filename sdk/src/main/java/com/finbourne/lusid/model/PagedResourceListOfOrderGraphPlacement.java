...
public class PagedResourceListOfOrderGraphPlacement {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfOrderGraphPlacement
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfOrderGraphPlacement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfOrderGraphPlacement is not found in the empty JSON string", PagedResourceListOfOrderGraphPlacement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfOrderGraphPlacement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfOrderGraphPlacement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfOrderGraphPlacement.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        OrderGraphPlacement.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfOrderGraphPlacement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfOrderGraphPlacement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfOrderGraphPlacement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfOrderGraphPlacement.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfOrderGraphPlacement>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfOrderGraphPlacement value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfOrderGraphPlacement read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfOrderGraphPlacement
  */
  public static PagedResourceListOfOrderGraphPlacement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfOrderGraphPlacement.class);
  }
