...
public class DataTypeSummary {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DataTypeSummary
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DataTypeSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataTypeSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataTypeSummary` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
