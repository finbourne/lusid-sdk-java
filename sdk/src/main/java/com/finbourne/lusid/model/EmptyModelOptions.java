...
public class EmptyModelOptions extends ModelOptions {
  ...
  * @throws IOException if the JSON Element is invalid with respect to EmptyModelOptions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmptyModelOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmptyModelOptions is not found in the empty JSON string", EmptyModelOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EmptyModelOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmptyModelOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmptyModelOptions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmptyModelOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmptyModelOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmptyModelOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmptyModelOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<EmptyModelOptions>() {
           @Override
           public void write(JsonWriter out, EmptyModelOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmptyModelOptions read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to EmptyModelOptions
  */
  public static EmptyModelOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmptyModelOptions.class);
  }
