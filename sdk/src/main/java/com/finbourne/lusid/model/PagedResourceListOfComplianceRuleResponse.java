...
public class PagedResourceListOfComplianceRuleResponse {
  ...
  public PagedResourceListOfComplianceRuleResponse() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfComplianceRuleResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfComplianceRuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfComplianceRuleResponse is not found in the empty JSON string", PagedResourceListOfComplianceRuleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfComplianceRuleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfComplianceRuleResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfComplianceRuleResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ComplianceRuleResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfComplianceRuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfComplianceRuleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfComplianceRuleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfComplianceRuleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfComplianceRuleResponse>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfComplianceRuleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfComplianceRuleResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfComplianceRuleResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfComplianceRuleResponse
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfComplianceRuleResponse
  */
  public static PagedResourceListOfComplianceRuleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfComplianceRuleResponse.class);
  }

 /**
  * Convert an instance of PagedResourceListOfComplianceRuleResponse to an JSON string
  *
  * @return JSON string
  */
