...
public class Portfolio {
  ...
  **/
   ...
   * @return baseCurrency
  **/
  @ApiModelProperty(value = "The base currency of the portfolio.")
  ...
  **/
  @ApiModelProperty(value = "A set of relationships associated to the portfolio.")
  ...
  **/
  @ApiModelProperty(value = "The instrument scope resolution strategy of this portfolio.")
