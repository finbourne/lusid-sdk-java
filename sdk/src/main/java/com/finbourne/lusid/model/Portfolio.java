...
public class Portfolio {
  ...
  /**
   * The type of portfolio this is (e.g. Transaction Portfolio, Reference  Portfolio)
   */
   ...
   * @return href
  **/
  @ApiModelProperty(value = "Link to retrieve the current entity")
   ...
   * @return id
  **/
  @ApiModelProperty(value = "Identifier for the portfolio")
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The type of portfolio this is (e.g. Transaction Portfolio, Reference  Portfolio)")
   ...
   * @return displayName
  **/
  @ApiModelProperty(value = "Display name of the portfolio")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "Description of the portfolio")
   ...
   * @return created
  **/
  @ApiModelProperty(value = "Portfolio creation time in UTC")
  ...
  **/
  @ApiModelProperty(value = "If this is a derived portfolio, the identifier of the portfolio from which it is derived")
  ...
  **/
  ...
  public Portfolio properties(List<Property> properties) {
    this.properties = properties;
    return this;
  }

  public Portfolio addPropertiesItem(Property propertiesItem) {
   ...
   /**
   * Any requested portfolio properties
   * @return properties
  **/
  @ApiModelProperty(value = "Any requested portfolio properties")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, id, type, displayName, description, created, parentPortfolioId, version, isDerived, properties, links);
  }
