...
public class DeleteCustodianAccountsResponse {
  ...
  public static final String SERIALIZED_NAME_CUSTODIAN_ACCOUNT_IDS = "custodianAccountIds";
  @SerializedName(SERIALIZED_NAME_CUSTODIAN_ACCOUNT_IDS)
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("custodianAccountIds");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeleteCustodianAccountsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCustodianAccountsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("custodianAccountIds") != null && !jsonObj.get("custodianAccountIds").isJsonNull()) {
        ...
        if (jsonArraycustodianAccountIds != null) {
          // ensure the json data is an array
          if (!jsonObj.get("custodianAccountIds").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `custodianAccountIds` to be an array in the JSON string but got `%s`", jsonObj.get("custodianAccountIds").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCustodianAccountsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCustodianAccountsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCustodianAccountsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCustodianAccountsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCustodianAccountsResponse>() {
           @Override
           public void write(JsonWriter out, DeleteCustodianAccountsResponse value) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to DeleteCustodianAccountsResponse
  */
  public static DeleteCustodianAccountsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCustodianAccountsResponse.class);
  }
