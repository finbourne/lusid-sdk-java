...
public class ResourceListOfAccessMetadataValueOf {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfAccessMetadataValueOf
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfAccessMetadataValueOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfAccessMetadataValueOf is not found in the empty JSON string", ResourceListOfAccessMetadataValueOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfAccessMetadataValueOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfAccessMetadataValueOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfAccessMetadataValueOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfAccessMetadataValueOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfAccessMetadataValueOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfAccessMetadataValueOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfAccessMetadataValueOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfAccessMetadataValueOf>() {
           @Override
           public void write(JsonWriter out, ResourceListOfAccessMetadataValueOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfAccessMetadataValueOf read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfAccessMetadataValueOf
  */
  public static ResourceListOfAccessMetadataValueOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfAccessMetadataValueOf.class);
  }
