...
public class SideConfigurationData {
  ...
  * @throws IOException if the JSON Element is invalid with respect to SideConfigurationData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SideConfigurationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SideConfigurationData is not found in the empty JSON string", SideConfigurationData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SideConfigurationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SideConfigurationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SideConfigurationData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SideConfigurationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SideConfigurationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SideConfigurationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SideConfigurationData.class));

       return (TypeAdapter<T>) new TypeAdapter<SideConfigurationData>() {
           @Override
           public void write(JsonWriter out, SideConfigurationData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SideConfigurationData read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to SideConfigurationData
  */
  public static SideConfigurationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SideConfigurationData.class);
  }
