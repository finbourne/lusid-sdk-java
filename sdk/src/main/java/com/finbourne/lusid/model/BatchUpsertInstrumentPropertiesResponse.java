...
public class BatchUpsertInstrumentPropertiesResponse {
   ...
   * @return values
  **/
  @ApiModelProperty(required = true, value = "The properties that have been successfully upserted")
   ...
   * @return failed
  **/
  @ApiModelProperty(required = true, value = "The properties that could not be upserted along with a reason for their failure.")
