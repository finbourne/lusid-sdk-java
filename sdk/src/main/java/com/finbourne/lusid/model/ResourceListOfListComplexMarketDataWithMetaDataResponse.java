...
public class ResourceListOfListComplexMarketDataWithMetaDataResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfListComplexMarketDataWithMetaDataResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfListComplexMarketDataWithMetaDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfListComplexMarketDataWithMetaDataResponse is not found in the empty JSON string", ResourceListOfListComplexMarketDataWithMetaDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfListComplexMarketDataWithMetaDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfListComplexMarketDataWithMetaDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfListComplexMarketDataWithMetaDataResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ListComplexMarketDataWithMetaDataResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfListComplexMarketDataWithMetaDataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfListComplexMarketDataWithMetaDataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfListComplexMarketDataWithMetaDataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfListComplexMarketDataWithMetaDataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfListComplexMarketDataWithMetaDataResponse>() {
           @Override
           public void write(JsonWriter out, ResourceListOfListComplexMarketDataWithMetaDataResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfListComplexMarketDataWithMetaDataResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfListComplexMarketDataWithMetaDataResponse
  */
  public static ResourceListOfListComplexMarketDataWithMetaDataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfListComplexMarketDataWithMetaDataResponse.class);
  }
