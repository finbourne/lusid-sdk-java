...
public class PagedResourceListOfCustomEntityResponse {
  ...
  private List<CustomEntityResponse> values = new ArrayList<>();
  ...
  public PagedResourceListOfCustomEntityResponse nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfCustomEntityResponse previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfCustomEntityResponse values(List<CustomEntityResponse> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfCustomEntityResponse addValuesItem(CustomEntityResponse valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<CustomEntityResponse> getValues() {

    return values;
  }


  public void setValues(List<CustomEntityResponse> values) {
    this.values = values;
  }


  public PagedResourceListOfCustomEntityResponse href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfCustomEntityResponse links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfCustomEntityResponse addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfCustomEntityResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfCustomEntityResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfCustomEntityResponse is not found in the empty JSON string", PagedResourceListOfCustomEntityResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfCustomEntityResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfCustomEntityResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfCustomEntityResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        CustomEntityResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfCustomEntityResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfCustomEntityResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfCustomEntityResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfCustomEntityResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfCustomEntityResponse>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfCustomEntityResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfCustomEntityResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfCustomEntityResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfCustomEntityResponse
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfCustomEntityResponse
  */
  public static PagedResourceListOfCustomEntityResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfCustomEntityResponse.class);
  }

 /**
  * Convert an instance of PagedResourceListOfCustomEntityResponse to an JSON string
  *
  * @return JSON string
  */
