...
public class ResourceListOfInstrumentEventHolder {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfInstrumentEventHolder
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfInstrumentEventHolder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfInstrumentEventHolder is not found in the empty JSON string", ResourceListOfInstrumentEventHolder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfInstrumentEventHolder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfInstrumentEventHolder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfInstrumentEventHolder.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfInstrumentEventHolder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfInstrumentEventHolder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfInstrumentEventHolder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfInstrumentEventHolder.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfInstrumentEventHolder>() {
           @Override
           public void write(JsonWriter out, ResourceListOfInstrumentEventHolder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfInstrumentEventHolder read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfInstrumentEventHolder
  */
  public static ResourceListOfInstrumentEventHolder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfInstrumentEventHolder.class);
  }
