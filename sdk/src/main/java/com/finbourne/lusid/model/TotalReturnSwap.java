...
public class TotalReturnSwap extends LusidInstrument {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TotalReturnSwap
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TotalReturnSwap.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TotalReturnSwap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TotalReturnSwap` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
