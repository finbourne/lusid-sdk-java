...
public class TransactionConfigurationMovementData {
  ...
  private List<PerpetualProperty> properties = new ArrayList<>();
  ...
  **/
  ...
  public TransactionConfigurationMovementData side(SideEnum side) {
    this.side = side;
    return this;
  }
  ...
  **/
  ...
  public TransactionConfigurationMovementData properties(List<PerpetualProperty> properties) {
    this.properties = properties;
    return this;
  }

  public TransactionConfigurationMovementData addPropertiesItem(PerpetualProperty propertiesItem) {
