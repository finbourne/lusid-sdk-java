...
public class GetStructuredResultDataResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetStructuredResultDataResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStructuredResultDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStructuredResultDataResponse is not found in the empty JSON string", GetStructuredResultDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetStructuredResultDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStructuredResultDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStructuredResultDataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStructuredResultDataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStructuredResultDataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStructuredResultDataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStructuredResultDataResponse>() {
           @Override
           public void write(JsonWriter out, GetStructuredResultDataResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStructuredResultDataResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to GetStructuredResultDataResponse
  */
  public static GetStructuredResultDataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStructuredResultDataResponse.class);
  }
