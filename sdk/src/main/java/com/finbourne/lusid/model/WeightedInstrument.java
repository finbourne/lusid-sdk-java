...
public class WeightedInstrument {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WeightedInstrument
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WeightedInstrument.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WeightedInstrument.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WeightedInstrument` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("instrument") != null && !jsonObj.get("instrument").isJsonNull()) {
        LusidInstrument.validateJsonObject(jsonObj.getAsJsonObject("instrument"));
      }
  }
