...
import com.finbourne.lusid.model.IdPathDefinition;
...
public class AccessControlledAction {
  ...
  @SerializedName("limitedSet")
  private List<IdPathDefinition> limitedSet = null;
  ...
  **/
  ...
  public AccessControlledAction action(ActionId action) {
   ...
   /**
   * The fully qualified ActionId that can be access controlled
   * @return action
  **/
  @ApiModelProperty(required = true, value = "The fully qualified ActionId that can be access controlled")
  ...
  public AccessControlledAction limitedSet(List<IdPathDefinition> limitedSet) {
    this.limitedSet = limitedSet;
    return this;
  }

  public AccessControlledAction addLimitedSetItem(IdPathDefinition limitedSetItem) {
  ...
  **/
  ...
  public List<IdPathDefinition> getLimitedSet() {
    return limitedSet;
  }

  public void setLimitedSet(List<IdPathDefinition> limitedSet) {
    this.limitedSet = limitedSet;
  }
