...
public class CreateTransactionPortfolioRequest {
  ...
  **/
   ...
   * @return created
  **/
  @ApiModelProperty(value = "The effectiveAt datetime at which the transaction portfolio will be created. No transactions can be upserted to the transaction portfolio before this date. Defaults to the current datetime if not specified.")
  ...
  **/
  @ApiModelProperty(value = "A set of unique transaction properties to group the transaction portfolio's holdings by. Each property must be from the 'Trade' domain and should be identified by its key which has the format {domain}/{scope}/{code}, e.g. 'Trade/strategies/quantsignal'.")
  ...
  public CreateTransactionPortfolioRequest properties(Map<String, PropertyValue> properties) {
    this.properties = properties;
    return this;
  }

  public CreateTransactionPortfolioRequest putPropertiesItem(String key, PropertyValue propertiesItem) {
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "A set of unique portfolio properties to add to the transaction portfolio. Each property should be identified by its key which has the format {domain}/{scope}/{code}, e.g. 'Portfolio/Manager/Id'. These properties must be pre-defined.")
