...
public class ReconcileNumericRule extends ReconciliationRule {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReconcileNumericRule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReconcileNumericRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReconcileNumericRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReconcileNumericRule` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
