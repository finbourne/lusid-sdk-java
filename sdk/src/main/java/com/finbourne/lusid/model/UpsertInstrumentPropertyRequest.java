...
public class UpsertInstrumentPropertyRequest {
  ...
  private List<InstrumentProperty> properties = new ArrayList<>();

  public static final String SERIALIZED_NAME_DELETED_PROPERTIES = "deletedProperties";
  @SerializedName(SERIALIZED_NAME_DELETED_PROPERTIES)
  private List<DeleteInstrumentPropertyRequest> deletedProperties = new ArrayList<>();
  ...
  public UpsertInstrumentPropertyRequest lusidInstrumentId(String lusidInstrumentId) {
   ...
   /**
   * The unique Lusid Instrument Identifier (LUID) of the instrument to update or insert properties on.
   * @return lusidInstrumentId
  **/
  @ApiModelProperty(required = true, value = "The unique Lusid Instrument Identifier (LUID) of the instrument to update or insert properties on.")
  ...
  **/
  ...
  public UpsertInstrumentPropertyRequest addDeletedPropertiesItem(DeleteInstrumentPropertyRequest deletedPropertiesItem) {
   ...
   /**
   * Set of unique instrument properties to delete from the instrument.
   * @return deletedProperties
  **/
  @ApiModelProperty(value = "Set of unique instrument properties to delete from the instrument.")
