...
import com.finbourne.lusid.model.DeleteInstrumentPropertyRequest;
import com.finbourne.lusid.model.InstrumentProperty;
 ...
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-04T10:56:47.608Z")
public class UpsertInstrumentPropertyRequest {
  @SerializedName("lusidInstrumentId")
  private String lusidInstrumentId = null;

  @SerializedName("properties")
  private List<InstrumentProperty> properties = null;

  @SerializedName("deletedProperties")
  private List<DeleteInstrumentPropertyRequest> deletedProperties = null;

  public UpsertInstrumentPropertyRequest lusidInstrumentId(String lusidInstrumentId) {
  ...
  **/
  ...
  public UpsertInstrumentPropertyRequest properties(List<InstrumentProperty> properties) {
    this.properties = properties;
    return this;
  }

  public UpsertInstrumentPropertyRequest addPropertiesItem(InstrumentProperty propertiesItem) {
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "A collection of properties to create or update")
  public List<InstrumentProperty> getProperties() {
    return properties;
  }

  public void setProperties(List<InstrumentProperty> properties) {
    this.properties = properties;
  }

  public UpsertInstrumentPropertyRequest deletedProperties(List<DeleteInstrumentPropertyRequest> deletedProperties) {
    this.deletedProperties = deletedProperties;
    return this;
  }

  public UpsertInstrumentPropertyRequest addDeletedPropertiesItem(DeleteInstrumentPropertyRequest deletedPropertiesItem) {
   ...
   /**
   * A collection of property keys to remove property values from, if any are set for the instrument
   * @return deletedProperties
  **/
  @ApiModelProperty(value = "A collection of property keys to remove property values from, if any are set for the instrument")
  public List<DeleteInstrumentPropertyRequest> getDeletedProperties() {
    return deletedProperties;
  }

  public void setDeletedProperties(List<DeleteInstrumentPropertyRequest> deletedProperties) {
    this.deletedProperties = deletedProperties;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.lusidInstrumentId, upsertInstrumentPropertyRequest.lusidInstrumentId) &&
        Objects.equals(this.properties, upsertInstrumentPropertyRequest.properties) &&
        Objects.equals(this.deletedProperties, upsertInstrumentPropertyRequest.deletedProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lusidInstrumentId, properties, deletedProperties);
  }
