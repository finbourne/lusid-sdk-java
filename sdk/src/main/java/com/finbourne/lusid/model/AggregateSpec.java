...
public class AggregateSpec {
  ...
  /**
   * The available values are: Sum, Proportion, Average, Count, Min, Max, Value, SumOfPositiveValues, SumOfNegativeValues, SumOfAbsoluteValues, ProportionOfAbsoluteValues
   */
  ...
  **/
   ...
   * @return op
  **/
  @ApiModelProperty(required = true, value = "The available values are: Sum, Proportion, Average, Count, Min, Max, Value, SumOfPositiveValues, SumOfNegativeValues, SumOfAbsoluteValues, ProportionOfAbsoluteValues")
  public OpEnum getOp() {
    return op;
  }
