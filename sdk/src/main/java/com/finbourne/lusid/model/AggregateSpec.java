...
public class AggregateSpec {
  ...
  **/
   ...
   * @return op
  **/
  @ApiModelProperty(required = true, value = "The available values are: Sum, Proportion, Average, Count, Min, Max, Value, SumOfPositiveValues, SumOfNegativeValues, SumOfAbsoluteValues, ProportionOfAbsoluteValues, SumCumulativeInAdvance, SumCumulativeInArrears")
  public OpEnum getOp() {
    return op;
  }
   ...
   * @return options
  **/
  @ApiModelProperty(value = "Additional options to apply when performing computations. Options that do not apply to the Key will be  ignored. Option values can be boolean, numeric, string or date-time.")
