...
public class PagedResourceListOfAddressKeyDefinition {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfAddressKeyDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfAddressKeyDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfAddressKeyDefinition is not found in the empty JSON string", PagedResourceListOfAddressKeyDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfAddressKeyDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfAddressKeyDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfAddressKeyDefinition.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        AddressKeyDefinition.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfAddressKeyDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfAddressKeyDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfAddressKeyDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfAddressKeyDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfAddressKeyDefinition>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfAddressKeyDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfAddressKeyDefinition read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfAddressKeyDefinition
  */
  public static PagedResourceListOfAddressKeyDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfAddressKeyDefinition.class);
  }
