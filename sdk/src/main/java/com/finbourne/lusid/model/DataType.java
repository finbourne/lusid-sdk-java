...
public class DataType {
  ...
  **/
   ...
   * @return valueType
  **/
  @ApiModelProperty(required = true, value = "The available values are: String, Int, Decimal, DateTime, Boolean, Map, List, PropertyArray, Percentage, Code, Id, Uri, Currency, MetricValue, ResourceId, ResultValue, CutLocalTime, DateOrCutLabel")
