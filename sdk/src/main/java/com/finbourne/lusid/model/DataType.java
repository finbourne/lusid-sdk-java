...
public class DataType {
  ...
  private List<PropertyValue> acceptableValues = new ArrayList<>();
  ...
  **/
  ...
  public DataType acceptableValues(List<PropertyValue> acceptableValues) {
    this.acceptableValues = acceptableValues;
    return this;
  }

  public DataType addAcceptableValuesItem(PropertyValue acceptableValuesItem) {
  ...
  **/
  @ApiModelProperty(value = "")
  public List<PropertyValue> getAcceptableValues() {
    return acceptableValues;
  }

  public void setAcceptableValues(List<PropertyValue> acceptableValues) {
    this.acceptableValues = acceptableValues;
  }
