...
public class Placement {
  ...
  **/
   ...
   * @return blockIds
  **/
  @ApiModelProperty(required = true, value = "The IDs of the Blocks associated with this placement.")
  ...
  **/
   ...
   * @return counterparty
  **/
  @ApiModelProperty(value = "Optionally specifies the market entity this placement is placed with.")
  ...
  **/
  @ApiModelProperty(value = "Optionally specifies the execution system in use.")
   ...
   * @return entryType
  **/
  @ApiModelProperty(value = "Optionally specifies the entry type of this placement.")
