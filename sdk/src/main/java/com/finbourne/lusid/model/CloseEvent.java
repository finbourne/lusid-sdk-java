...
import com.finbourne.lusid.model.CloseEventAllOf;
 ...
 */
@ApiModel(description = "The termination of an instrument.  In some cases termination can happen over a range of dates e.g. american option exercise.  In most cases the startDate == endDate")
...
public class CloseEvent extends InstrumentEvent {
   ...
   * @return startDate
  **/
  @ApiModelProperty(value = "The first date on which the instrument could close")
   ...
   * @return endDate
  **/
  @ApiModelProperty(value = "The last date on which the instrument could close")
