...
public class FlowConventions {
  ...
  **/
   ...
   * @return settleDays
  **/
  @ApiModelProperty(value = "DEPRECATED  Number of Good Business Days between the trade date and the effective or settlement date of the instrument.  This field is now deprecated and not picked up in schedule generation or adjustment to bond accrual start date. Defaulted to 0 if not set.")
   ...
   * @return resetDays
  **/
  @ApiModelProperty(value = "The number of Good Business Days between determination and payment of reset. Defaulted to 0 if not set.")
