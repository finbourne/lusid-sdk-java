...
public class UpsertCorporateActionRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The announcement date of the corporate action")
   ...
   * @return exDate
  **/
  @ApiModelProperty(required = true, value = "The ex date of the corporate action")
   ...
   * @return recordDate
  **/
  @ApiModelProperty(required = true, value = "The record date of the corporate action")
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "The payment date of the corporate action")
   ...
   * @return transitions
  **/
  @ApiModelProperty(required = true, value = "The transitions that result from this corporate action")
