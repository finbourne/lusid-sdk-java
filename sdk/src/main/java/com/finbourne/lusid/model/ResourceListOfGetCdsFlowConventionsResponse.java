...
public class ResourceListOfGetCdsFlowConventionsResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfGetCdsFlowConventionsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfGetCdsFlowConventionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfGetCdsFlowConventionsResponse is not found in the empty JSON string", ResourceListOfGetCdsFlowConventionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfGetCdsFlowConventionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfGetCdsFlowConventionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfGetCdsFlowConventionsResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        GetCdsFlowConventionsResponse.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfGetCdsFlowConventionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfGetCdsFlowConventionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfGetCdsFlowConventionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfGetCdsFlowConventionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfGetCdsFlowConventionsResponse>() {
           @Override
           public void write(JsonWriter out, ResourceListOfGetCdsFlowConventionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfGetCdsFlowConventionsResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfGetCdsFlowConventionsResponse
  */
  public static ResourceListOfGetCdsFlowConventionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfGetCdsFlowConventionsResponse.class);
  }
