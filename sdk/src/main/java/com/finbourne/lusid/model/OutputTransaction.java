...
public class OutputTransaction {
  ...
  **/
   ...
   * @return source
  **/
  @ApiModelProperty(value = "Where this transaction came from, either Client or System")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionId, type, description, instrumentUid, transactionDate, settlementDate, units, transactionPrice, totalConsideration, exchangeRate, transactionToPortfolioRate, transactionCurrency, properties, counterpartyId, source, nettingSet, transactionStatus, entryDateTime, cancelDateTime, realisedGainLoss);
  }
