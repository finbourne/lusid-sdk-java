...
public class OutputTransaction {
  ...
  **/
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Set of unique transaction properties and associated values to stored with the transaction. Each property will be from the 'Trade' domain.")
  ...
  **/
   ...
   * @return source
  **/
  @ApiModelProperty(required = true, value = "The source of the transaction. This is used to look up the appropriate transaction group set in the transaction type configuration.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The status of the transaction.")
