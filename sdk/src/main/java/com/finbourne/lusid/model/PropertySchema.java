...
public class PropertySchema {
  ...
  private List<KeyValuePairOfPropertyKeyToFieldSchema> values = null;
  ...
  **/
  ...
  public PropertySchema values(List<KeyValuePairOfPropertyKeyToFieldSchema> values) {
    this.values = values;
    return this;
  }

  public PropertySchema addValuesItem(KeyValuePairOfPropertyKeyToFieldSchema valuesItem) {
    if (this.values == null) {
  ...
  **/
  @ApiModelProperty(value = "")
  public List<KeyValuePairOfPropertyKeyToFieldSchema> getValues() {
    return values;
  }

  public void setValues(List<KeyValuePairOfPropertyKeyToFieldSchema> values) {
    this.values = values;
  }
