...
public class UpsertStructuredDataResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertStructuredDataResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertStructuredDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertStructuredDataResponse is not found in the empty JSON string", UpsertStructuredDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertStructuredDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertStructuredDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertStructuredDataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertStructuredDataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertStructuredDataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertStructuredDataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertStructuredDataResponse>() {
           @Override
           public void write(JsonWriter out, UpsertStructuredDataResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertStructuredDataResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpsertStructuredDataResponse
  */
  public static UpsertStructuredDataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertStructuredDataResponse.class);
  }
