...
public class TransactionRequest {
  ...
  **/
  ...
  public TransactionRequest instrumentUid(String instrumentUid) {
  ...
  **/
  ...
  public TransactionRequest settlementDate(OffsetDateTime settlementDate) {
  ...
  **/
   ...
   * @return units
  **/
  @ApiModelProperty(required = true, value = "Quantity of transaction in units of the instrument")
  ...
  **/
   ...
   * @return exchangeRate
  **/
  @ApiModelProperty(value = "Rate between transaction and settle currency")
  ...
  **/
  ...
  public TransactionRequest source(SourceEnum source) {
    this.source = source;
    return this;
  }
   ...
   * @return source
  **/
  @ApiModelProperty(required = true, value = "Where this transaction came from, either Client or System")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.transactionId, transactionRequest.transactionId) &&
        ...
        Objects.equals(this.instrumentUid, transactionRequest.instrumentUid) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionId, type, instrumentUid, transactionDate, settlementDate, units, transactionPrice, totalConsideration, exchangeRate, transactionCurrency, properties, counterpartyId, source, nettingSet);
  }
