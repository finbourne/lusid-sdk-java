...
import com.finbourne.lusid.model.FxForwardCurveByQuoteReferenceAllOf;
...
public class FxForwardCurveByQuoteReference extends ComplexMarketData {
  ...
  **/
  @ApiModelProperty(required = true, value = "For each tenor, a list of identifiers. These will be looked up in the quotes store to resolve the actual rates.")
