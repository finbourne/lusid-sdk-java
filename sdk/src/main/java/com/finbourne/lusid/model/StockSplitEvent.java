...
import com.finbourne.lusid.model.StockSplitEventAllOf;
 ...
 */
@ApiModel(description = "A split in the company's shares. Shareholders are given additional company shares based on the terms of the stock split.")
...
public class StockSplitEvent extends InstrumentEvent {
  ...
  **/
  @ApiModelProperty(required = true, value = "This number describes the rate at which the company will be dividing their current shares outstanding. It is displayed as new shares per old.")
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "Date on which the stock-split takes effect.")
