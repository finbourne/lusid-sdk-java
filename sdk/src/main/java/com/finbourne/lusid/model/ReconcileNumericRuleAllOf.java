...
public class ReconcileNumericRuleAllOf {
  /**
  ...
  public ReconcileNumericRuleAllOf comparisonType(ComparisonTypeEnum comparisonType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Exact, AbsoluteDifference, RelativeDifference")
  ...
  public ReconcileNumericRuleAllOf tolerance(java.math.BigDecimal tolerance) {
  ...
  **/
  ...
  public ReconcileNumericRuleAllOf appliesTo(AggregateSpec appliesTo) {
  ...
  **/
  ...
  public ReconcileNumericRuleAllOf ruleType(RuleTypeEnum ruleType) {
