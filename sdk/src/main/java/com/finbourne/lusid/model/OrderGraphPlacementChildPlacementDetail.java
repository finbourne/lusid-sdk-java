...
public class OrderGraphPlacementChildPlacementDetail {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrderGraphPlacementChildPlacementDetail
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderGraphPlacementChildPlacementDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderGraphPlacementChildPlacementDetail is not found in the empty JSON string", OrderGraphPlacementChildPlacementDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrderGraphPlacementChildPlacementDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderGraphPlacementChildPlacementDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderGraphPlacementChildPlacementDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderGraphPlacementChildPlacementDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderGraphPlacementChildPlacementDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderGraphPlacementChildPlacementDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderGraphPlacementChildPlacementDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderGraphPlacementChildPlacementDetail>() {
           @Override
           public void write(JsonWriter out, OrderGraphPlacementChildPlacementDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderGraphPlacementChildPlacementDetail read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to OrderGraphPlacementChildPlacementDetail
  */
  public static OrderGraphPlacementChildPlacementDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderGraphPlacementChildPlacementDetail.class);
  }
