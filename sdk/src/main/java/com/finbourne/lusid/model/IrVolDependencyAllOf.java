...
public class IrVolDependencyAllOf {
  ...
  public IrVolDependencyAllOf currency(String currency) {
  ...
  **/
  ...
  public IrVolDependencyAllOf volType(String volType) {
  ...
  **/
  ...
  public IrVolDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public IrVolDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: OpaqueDependency, CashDependency, DiscountingDependency, EquityCurveDependency, EquityVolDependency, FxDependency, FxForwardsDependency, FxVolDependency, IndexProjectionDependency, IrVolDependency, QuoteDependency, Vendor")
