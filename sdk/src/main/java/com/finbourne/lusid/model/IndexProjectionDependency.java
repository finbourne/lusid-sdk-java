...
import com.finbourne.lusid.model.IndexProjectionDependencyAllOf;
 ...
 */
@ApiModel(description = "Represents either a dependency on projections of an index.  E.g. If the interest leg of a swap is a FloatingLeg, then it will declare an IndexProjectionDependency upon pricing.  This is to indicate that pricing the floating leg requires predictions of future fixings of the index.")
...
public class IndexProjectionDependency extends EconomicDependency {
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "The currency of the corresponding IndexConvention. E.g. this would be USD for a convention named USD.6M.LIBOR")
   ...
   * @return tenor
  **/
  @ApiModelProperty(required = true, value = "The tenor of the corresponding IndexConvention. E.g. this would be \"6M\" for a convention named USD.6M.LIBOR")
   ...
   * @return indexName
  **/
  @ApiModelProperty(required = true, value = "The IndexName of the corresponding IndexConvention. E.g. this would be \"LIBOR\" for a convention named USD.6M.LIBOR")
