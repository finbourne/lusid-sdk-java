...
public class CorporateActionTransition {
  ...
  public CorporateActionTransition inputTransition(CorporateActionTransitionComponent inputTransition) {
   ...
   /**
   * Indicating the basis of the corporate action - which security and how many units
   * @return inputTransition
  **/
  @ApiModelProperty(value = "Indicating the basis of the corporate action - which security and how many units")
