...
public class FxForwardModelOptionsAllOf {
  /**
  ...
  private ModelOptionsTypeEnum modelOptionsType;


  public FxForwardModelOptionsAllOf forwardRateObservableType(ForwardRateObservableTypeEnum forwardRateObservableType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: ForwardPoints, ForwardRate, RatesCurve, FxForwardCurve, Invalid")
  ...
  public FxForwardModelOptionsAllOf discountingMethod(DiscountingMethodEnum discountingMethod) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Standard, ConstantTimeValueOfMoney, Invalid")
  ...
  public FxForwardModelOptionsAllOf convertToReportCcy(Boolean convertToReportCcy) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Convert all FX flows to the report currency  By setting this all FX forwards will be priced using Forward Curves that have Report Currency as the base.")
  ...
  public FxForwardModelOptionsAllOf modelOptionsType(ModelOptionsTypeEnum modelOptionsType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Invalid, OpaqueModelOptions, EmptyModelOptions, IndexModelOptions, FxForwardModelOptions, FundingLegModelOptions, EquityModelOptions, LookUpPricingModelOptions")
