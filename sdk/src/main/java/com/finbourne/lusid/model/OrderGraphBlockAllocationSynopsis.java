...
public class OrderGraphBlockAllocationSynopsis {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrderGraphBlockAllocationSynopsis
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderGraphBlockAllocationSynopsis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderGraphBlockAllocationSynopsis is not found in the empty JSON string", OrderGraphBlockAllocationSynopsis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrderGraphBlockAllocationSynopsis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderGraphBlockAllocationSynopsis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderGraphBlockAllocationSynopsis.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydetails.size(); i++) {
        OrderGraphBlockAllocationDetail.validateJsonElement(jsonArraydetails.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderGraphBlockAllocationSynopsis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderGraphBlockAllocationSynopsis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderGraphBlockAllocationSynopsis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderGraphBlockAllocationSynopsis.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderGraphBlockAllocationSynopsis>() {
           @Override
           public void write(JsonWriter out, OrderGraphBlockAllocationSynopsis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderGraphBlockAllocationSynopsis read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to OrderGraphBlockAllocationSynopsis
  */
  public static OrderGraphBlockAllocationSynopsis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderGraphBlockAllocationSynopsis.class);
  }
