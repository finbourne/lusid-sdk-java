...
public class CreateCalendarRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCalendarRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateCalendarRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateCalendarRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCalendarRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      ResourceId.validateJsonObject(jsonObj.getAsJsonObject("calendarId"));
