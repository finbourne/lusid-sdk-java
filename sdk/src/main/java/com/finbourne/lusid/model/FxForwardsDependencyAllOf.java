...
public class FxForwardsDependencyAllOf {
  ...
  public FxForwardsDependencyAllOf domesticCurrency(String domesticCurrency) {
  ...
  **/
  ...
  public FxForwardsDependencyAllOf foreignCurrency(String foreignCurrency) {
  ...
  **/
  ...
  public FxForwardsDependencyAllOf curveType(String curveType) {
  ...
  **/
  ...
  public FxForwardsDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public FxForwardsDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
