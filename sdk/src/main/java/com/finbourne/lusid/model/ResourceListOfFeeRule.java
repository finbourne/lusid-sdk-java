...
public class ResourceListOfFeeRule {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<FeeRule> values = new ArrayList<>();
  ...
  public ResourceListOfFeeRule() {
  }

  public ResourceListOfFeeRule values(List<FeeRule> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfFeeRule addValuesItem(FeeRule valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<FeeRule> getValues() {

    return values;
  }


  public void setValues(List<FeeRule> values) {
    this.values = values;
  }


  public ResourceListOfFeeRule href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfFeeRule links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfFeeRule addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ResourceListOfFeeRule nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfFeeRule previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfFeeRule {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfFeeRule
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfFeeRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfFeeRule is not found in the empty JSON string", ResourceListOfFeeRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfFeeRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfFeeRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfFeeRule.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        FeeRule.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfFeeRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfFeeRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfFeeRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfFeeRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfFeeRule>() {
           @Override
           public void write(JsonWriter out, ResourceListOfFeeRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfFeeRule read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfFeeRule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfFeeRule
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfFeeRule
  */
  public static ResourceListOfFeeRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfFeeRule.class);
  }

 /**
  * Convert an instance of ResourceListOfFeeRule to an JSON string
  *
  * @return JSON string
  */
