...
public class FundA2BMovementRecord {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FundA2BMovementRecord
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FundA2BMovementRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FundA2BMovementRecord is not found in the empty JSON string", FundA2BMovementRecord.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FundA2BMovementRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FundA2BMovementRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FundA2BMovementRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FundA2BMovementRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<FundA2BMovementRecord>() {
           @Override
           public void write(JsonWriter out, FundA2BMovementRecord value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FundA2BMovementRecord read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to FundA2BMovementRecord
  */
  public static FundA2BMovementRecord fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FundA2BMovementRecord.class);
  }
