...
public class QuoteId {
  ...
  * @throws IOException if the JSON Element is invalid with respect to QuoteId
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuoteId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!QuoteId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QuoteId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      QuoteSeriesId.validateJsonElement(jsonObj.get("quoteSeriesId"));
