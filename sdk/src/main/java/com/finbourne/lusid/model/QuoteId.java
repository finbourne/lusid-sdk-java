...
public class QuoteId {
  ...
  public enum InstrumentIdTypeEnum {
    ...
    public static InstrumentIdTypeEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<InstrumentIdTypeEnum> {
      ...
      public InstrumentIdTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return InstrumentIdTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("instrumentIdType")
  private InstrumentIdTypeEnum instrumentIdType = null;
  ...
  public QuoteId provider(String provider) {
  ...
  **/
  ...
  public QuoteId priceSource(String priceSource) {
  ...
  **/
  ...
  public QuoteId instrumentId(String instrumentId) {
  ...
  **/
  ...
  public QuoteId instrumentIdType(InstrumentIdTypeEnum instrumentIdType) {
  ...
  **/
  ...
  public QuoteId quoteType(QuoteTypeEnum quoteType) {
  ...
  **/
  ...
  public QuoteId priceSide(PriceSideEnum priceSide) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.provider, quoteId.provider) &&
        Objects.equals(this.priceSource, quoteId.priceSource) &&
        Objects.equals(this.instrumentId, quoteId.instrumentId) &&
        Objects.equals(this.instrumentIdType, quoteId.instrumentIdType) &&
        Objects.equals(this.quoteType, quoteId.quoteType) &&
        Objects.equals(this.priceSide, quoteId.priceSide);
  }

  @Override
  public int hashCode() {
    return Objects.hash(provider, priceSource, instrumentId, instrumentIdType, quoteType, priceSide);
  }
