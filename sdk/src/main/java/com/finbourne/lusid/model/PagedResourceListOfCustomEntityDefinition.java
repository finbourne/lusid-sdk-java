...
public class PagedResourceListOfCustomEntityDefinition {
  ...
  private List<CustomEntityDefinition> values = new ArrayList<>();
  ...
  public PagedResourceListOfCustomEntityDefinition() {
  }

  public PagedResourceListOfCustomEntityDefinition nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfCustomEntityDefinition previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfCustomEntityDefinition values(List<CustomEntityDefinition> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfCustomEntityDefinition addValuesItem(CustomEntityDefinition valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
    public List<CustomEntityDefinition> getValues() {

    return values;
  }


  public void setValues(List<CustomEntityDefinition> values) {
    this.values = values;
  }


  public PagedResourceListOfCustomEntityDefinition href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfCustomEntityDefinition links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfCustomEntityDefinition addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfCustomEntityDefinition {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfCustomEntityDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfCustomEntityDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfCustomEntityDefinition is not found in the empty JSON string", PagedResourceListOfCustomEntityDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfCustomEntityDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfCustomEntityDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfCustomEntityDefinition.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        CustomEntityDefinition.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfCustomEntityDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfCustomEntityDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfCustomEntityDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfCustomEntityDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfCustomEntityDefinition>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfCustomEntityDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfCustomEntityDefinition read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfCustomEntityDefinition given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfCustomEntityDefinition
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfCustomEntityDefinition
  */
  public static PagedResourceListOfCustomEntityDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfCustomEntityDefinition.class);
  }

 /**
  * Convert an instance of PagedResourceListOfCustomEntityDefinition to an JSON string
  *
  * @return JSON string
  */
