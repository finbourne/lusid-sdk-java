...
public class CreateClientInstrumentRequest {
  ...
  private String clientInstrumentId = null;
  ...
  private InstrumentDefinition instrument = null;

  public CreateClientInstrumentRequest clientInstrumentId(String clientInstrumentId) {
    this.clientInstrumentId = clientInstrumentId;
    return this;
  }

   /**
   * Get clientInstrumentId
  ...
  **/
  ...
  public CreateClientInstrumentRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CreateClientInstrumentRequest lookThroughPortfolioId(ResourceId lookThroughPortfolioId) {
  ...
  **/
  ...
  public CreateClientInstrumentRequest instrument(InstrumentDefinition instrument) {
   ...
   * @return instrument
  **/
  @ApiModelProperty(value = "Expanded instrument definition - in the case of OTC instruments  this contains the definition of the non-exchange traded instrument.  The format for this can be client-defined, but in order to transparently use  vendor libraries it must conform to a format that LUSID understands.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateClientInstrumentRequest createClientInstrumentRequest = (CreateClientInstrumentRequest) o;
    return Objects.equals(this.clientInstrumentId, createClientInstrumentRequest.clientInstrumentId) &&
        Objects.equals(this.name, createClientInstrumentRequest.name) &&
        Objects.equals(this.lookThroughPortfolioId, createClientInstrumentRequest.lookThroughPortfolioId) &&
        Objects.equals(this.instrument, createClientInstrumentRequest.instrument);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientInstrumentId, name, lookThroughPortfolioId, instrument);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateClientInstrumentRequest {\n");
    
    sb.append("    clientInstrumentId: ").append(toIndentedString(clientInstrumentId)).append("\n");
