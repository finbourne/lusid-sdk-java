...
public class RelationDefinition {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RelationDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelationDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RelationDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RelationDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("relationDefinitionId") != null && !jsonObj.get("relationDefinitionId").isJsonNull()) {
        ResourceId.validateJsonElement(jsonObj.get("relationDefinitionId"));
      }
