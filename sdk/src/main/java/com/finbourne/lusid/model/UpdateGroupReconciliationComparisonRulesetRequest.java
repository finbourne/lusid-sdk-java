...
public class UpdateGroupReconciliationComparisonRulesetRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayName, reconciliationType, coreAttributeRules, aggregateAttributeRules);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateGroupReconciliationComparisonRulesetRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGroupReconciliationComparisonRulesetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGroupReconciliationComparisonRulesetRequest is not found in the empty JSON string", UpdateGroupReconciliationComparisonRulesetRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGroupReconciliationComparisonRulesetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGroupReconciliationComparisonRulesetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGroupReconciliationComparisonRulesetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGroupReconciliationComparisonRulesetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGroupReconciliationComparisonRulesetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGroupReconciliationComparisonRulesetRequest>() {
           @Override
           public void write(JsonWriter out, UpdateGroupReconciliationComparisonRulesetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGroupReconciliationComparisonRulesetRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpdateGroupReconciliationComparisonRulesetRequest
  */
  public static UpdateGroupReconciliationComparisonRulesetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGroupReconciliationComparisonRulesetRequest.class);
  }
