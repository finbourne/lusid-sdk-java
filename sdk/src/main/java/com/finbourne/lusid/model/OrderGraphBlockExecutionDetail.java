...
public class OrderGraphBlockExecutionDetail {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrderGraphBlockExecutionDetail
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderGraphBlockExecutionDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderGraphBlockExecutionDetail is not found in the empty JSON string", OrderGraphBlockExecutionDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrderGraphBlockExecutionDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderGraphBlockExecutionDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderGraphBlockExecutionDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderGraphBlockExecutionDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderGraphBlockExecutionDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderGraphBlockExecutionDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderGraphBlockExecutionDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderGraphBlockExecutionDetail>() {
           @Override
           public void write(JsonWriter out, OrderGraphBlockExecutionDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderGraphBlockExecutionDetail read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to OrderGraphBlockExecutionDetail
  */
  public static OrderGraphBlockExecutionDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderGraphBlockExecutionDetail.class);
  }
