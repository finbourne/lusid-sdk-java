...
public class PagedResourceListOfReconciliationRunBreak {
  ...
  public PagedResourceListOfReconciliationRunBreak() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfReconciliationRunBreak
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfReconciliationRunBreak.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfReconciliationRunBreak is not found in the empty JSON string", PagedResourceListOfReconciliationRunBreak.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfReconciliationRunBreak.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfReconciliationRunBreak` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfReconciliationRunBreak.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ReconciliationRunBreak.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfReconciliationRunBreak.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfReconciliationRunBreak' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfReconciliationRunBreak> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfReconciliationRunBreak.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfReconciliationRunBreak>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfReconciliationRunBreak value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfReconciliationRunBreak read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PagedResourceListOfReconciliationRunBreak given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResourceListOfReconciliationRunBreak
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfReconciliationRunBreak
  */
  public static PagedResourceListOfReconciliationRunBreak fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfReconciliationRunBreak.class);
  }

 /**
  * Convert an instance of PagedResourceListOfReconciliationRunBreak to an JSON string
  *
  * @return JSON string
  */
