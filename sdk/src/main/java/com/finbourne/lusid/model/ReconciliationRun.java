...
public class ReconciliationRun {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ReconciliationRun
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReconciliationRun.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReconciliationRun is not found in the empty JSON string", ReconciliationRun.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReconciliationRun.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReconciliationRun` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `id`
      if (jsonObj.get("id") != null && !jsonObj.get("id").isJsonNull()) {
        ReconciliationRunId.validateJsonElement(jsonObj.get("id"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReconciliationRun.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReconciliationRun' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReconciliationRun> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReconciliationRun.class));

       return (TypeAdapter<T>) new TypeAdapter<ReconciliationRun>() {
           @Override
           public void write(JsonWriter out, ReconciliationRun value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReconciliationRun read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReconciliationRun given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReconciliationRun
  * @throws IOException if the JSON string is invalid with respect to ReconciliationRun
  */
  public static ReconciliationRun fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReconciliationRun.class);
  }

 /**
  * Convert an instance of ReconciliationRun to an JSON string
  *
  * @return JSON string
  */
