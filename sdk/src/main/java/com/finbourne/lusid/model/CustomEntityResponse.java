...
public class CustomEntityResponse {
  ...
  **/
   ...
   * @return entityType
  **/
  @ApiModelProperty(required = true, value = "The type of custom entity this is.")
  ...
  **/
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "A display label for the custom entity.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A description of the custom entity.")
   ...
   * @return identifiers
  **/
  @ApiModelProperty(required = true, value = "The identifiers the custom entity will be upserted with.")
   ...
   * @return fields
  **/
  @ApiModelProperty(required = true, value = "The fields that decorate the custom entity.")
  ...
  **/
  @ApiModelProperty(required = true, value = "A set of relationships associated to the custom entity.")
