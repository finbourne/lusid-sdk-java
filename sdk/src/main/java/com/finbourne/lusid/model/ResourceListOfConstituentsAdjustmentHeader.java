...
public class ResourceListOfConstituentsAdjustmentHeader {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfConstituentsAdjustmentHeader
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfConstituentsAdjustmentHeader.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfConstituentsAdjustmentHeader is not found in the empty JSON string", ResourceListOfConstituentsAdjustmentHeader.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfConstituentsAdjustmentHeader.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfConstituentsAdjustmentHeader` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfConstituentsAdjustmentHeader.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ConstituentsAdjustmentHeader.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfConstituentsAdjustmentHeader.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfConstituentsAdjustmentHeader' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfConstituentsAdjustmentHeader> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfConstituentsAdjustmentHeader.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfConstituentsAdjustmentHeader>() {
           @Override
           public void write(JsonWriter out, ResourceListOfConstituentsAdjustmentHeader value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfConstituentsAdjustmentHeader read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfConstituentsAdjustmentHeader
  */
  public static ResourceListOfConstituentsAdjustmentHeader fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfConstituentsAdjustmentHeader.class);
  }
