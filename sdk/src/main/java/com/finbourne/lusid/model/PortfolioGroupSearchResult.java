...
public class PortfolioGroupSearchResult {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortfolioGroupSearchResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortfolioGroupSearchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PortfolioGroupSearchResult is not found in the empty JSON string", PortfolioGroupSearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PortfolioGroupSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PortfolioGroupSearchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PortfolioGroupSearchResult.openapiRequiredFields) {
      ...
      if (jsonObj.get("portfolios") != null && !jsonObj.get("portfolios").isJsonNull()) {
        ...
        if (jsonArrayportfolios != null) {
          ...
          for (int i = 0; i < jsonArrayportfolios.size(); i++) {
            ResourceId.validateJsonElement(jsonArrayportfolios.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortfolioGroupSearchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortfolioGroupSearchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortfolioGroupSearchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortfolioGroupSearchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PortfolioGroupSearchResult>() {
           @Override
           public void write(JsonWriter out, PortfolioGroupSearchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PortfolioGroupSearchResult read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PortfolioGroupSearchResult
  */
  public static PortfolioGroupSearchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortfolioGroupSearchResult.class);
  }
