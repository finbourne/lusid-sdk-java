...
public class UpsertPortfolioAccessMetadataRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertPortfolioAccessMetadataRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertPortfolioAccessMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertPortfolioAccessMetadataRequest is not found in the empty JSON string", UpsertPortfolioAccessMetadataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertPortfolioAccessMetadataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertPortfolioAccessMetadataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpsertPortfolioAccessMetadataRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertPortfolioAccessMetadataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertPortfolioAccessMetadataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertPortfolioAccessMetadataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertPortfolioAccessMetadataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertPortfolioAccessMetadataRequest>() {
           @Override
           public void write(JsonWriter out, UpsertPortfolioAccessMetadataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertPortfolioAccessMetadataRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpsertPortfolioAccessMetadataRequest
  */
  public static UpsertPortfolioAccessMetadataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertPortfolioAccessMetadataRequest.class);
  }
