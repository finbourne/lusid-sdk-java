...
public class InformationalEvent extends InstrumentEvent {
  ...
  * @throws IOException if the JSON Object is invalid with respect to InformationalEvent
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InformationalEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!InformationalEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InformationalEvent` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
