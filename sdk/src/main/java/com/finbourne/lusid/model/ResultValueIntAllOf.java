...
public class ResultValueIntAllOf {
  ...
  public ResultValueIntAllOf value(Integer value) {
    this.value = value; 
    return this;
  }
  ...
  **/
  ...
  public ResultValueIntAllOf dimension(Integer dimension) {
   ...
   * @return dimension
  **/
  @ApiModelProperty(value = "The dimension of the result. Can be null if there is no sensible way of defining the dimension. This field should not be  populate by the user on upsertion.")
  ...
  public ResultValueIntAllOf resultValueType(ResultValueTypeEnum resultValueType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: ResultValue, ResultValueDictionary, ResultValue0D, ResultValueDecimal, ResultValueInt, ResultValueString, ResultValueBool, ResultValueCurrency, CashFlowValue, CashFlowValueSet, ResultValueLifeCycleEventValue, ResultValueDateTimeOffset")
  ...
  public String toString() {
    ...
    sb.append("class ResultValueIntAllOf {\n");
