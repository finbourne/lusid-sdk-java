...
public class CounterpartySignatory {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CounterpartySignatory
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CounterpartySignatory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CounterpartySignatory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CounterpartySignatory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      TypedResourceId.validateJsonElement(jsonObj.get("legalEntityIdentifier"));
  }
