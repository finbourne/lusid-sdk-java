...
public class UpsertTransactionPropertiesResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertTransactionPropertiesResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertTransactionPropertiesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertTransactionPropertiesResponse is not found in the empty JSON string", UpsertTransactionPropertiesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertTransactionPropertiesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertTransactionPropertiesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertTransactionPropertiesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertTransactionPropertiesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertTransactionPropertiesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertTransactionPropertiesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertTransactionPropertiesResponse>() {
           @Override
           public void write(JsonWriter out, UpsertTransactionPropertiesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertTransactionPropertiesResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpsertTransactionPropertiesResponse
  */
  public static UpsertTransactionPropertiesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertTransactionPropertiesResponse.class);
  }
