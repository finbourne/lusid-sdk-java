...
public class ReconcileStringRule extends ReconciliationRule {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReconcileStringRule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReconcileStringRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReconcileStringRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReconcileStringRule` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
