...
public class DecimalListAllOf {
  ...
  private ReferenceListTypeEnum referenceListType;


  public DecimalListAllOf values(List<java.math.BigDecimal> values) {
    this.values = values; 
    return this;
  }

  public DecimalListAllOf addValuesItem(java.math.BigDecimal valuesItem) {
  ...
  **/
  ...
  public DecimalListAllOf referenceListType(ReferenceListTypeEnum referenceListType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The reference list values. The available values are: PortfolioGroupIdList, PortfolioIdList, AddressKeyList, StringList, InstrumentList, DecimalList")
