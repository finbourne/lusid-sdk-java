...
public class PropertyDefinition {
  ...
  **/
   ...
   * @return valueType
  **/
  @ApiModelProperty(value = "The type of values that can be associated with this property. This is defined by the property's data type. The available values are: String, Int, Decimal, DateTime, Boolean, Map, List, PropertyArray, Percentage, Code, Id, Uri, Currency, MetricValue, ResourceId, ResultValue, CutLocalTime, DateOrCutLabel")
