...
public class PropertyDefinition {
  ...
  **/
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Set of unique property definition properties and associated values to store with the property definition. Each property must be from the 'PropertyDefinition' domain.")
