...
public class PropertyDefinition {
  ...
  private LifeTimeEnum lifeTime = null;
  ...
  public enum DomainEnum {
    ...
    public static class Adapter extends TypeAdapter<DomainEnum> {
      ...
      public DomainEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return DomainEnum.fromValue(String.valueOf(value));
      }
    }
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, key, valueType, valueRequired, displayName, dataTypeId, lifeTime, type, unitSchema, domain, scope, code, links);
  }
