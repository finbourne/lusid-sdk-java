...
public class ScripDividendEvent extends InstrumentEvent {
  ...
  public ScripDividendEvent() {
    // this.instrumentEventType = this.getClass().getSimpleName();
  }

  public ScripDividendEvent announcementDate(OffsetDateTime announcementDate) {
  ...
  **/
  ...
  public ScripDividendEvent exDate(OffsetDateTime exDate) {
  ...
  **/
  ...
  public ScripDividendEvent recordDate(OffsetDateTime recordDate) {
  ...
  **/
  ...
  public ScripDividendEvent paymentDate(OffsetDateTime paymentDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScripDividendEvent scripDividendEvent = (ScripDividendEvent) o;
    return Objects.equals(this.announcementDate, scripDividendEvent.announcementDate) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to ScripDividendEvent
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScripDividendEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScripDividendEvent is not found in the empty JSON string", ScripDividendEvent.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScripDividendEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScripDividendEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScripDividendEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScripDividendEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScripDividendEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<ScripDividendEvent>() {
           @Override
           public void write(JsonWriter out, ScripDividendEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScripDividendEvent read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ScripDividendEvent given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ScripDividendEvent
  * @throws IOException if the JSON string is invalid with respect to ScripDividendEvent
  */
  public static ScripDividendEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScripDividendEvent.class);
  }

 /**
  * Convert an instance of ScripDividendEvent to an JSON string
  *
  * @return JSON string
  */
