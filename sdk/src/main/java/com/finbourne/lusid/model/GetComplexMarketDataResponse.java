...
public class GetComplexMarketDataResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetComplexMarketDataResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetComplexMarketDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetComplexMarketDataResponse is not found in the empty JSON string", GetComplexMarketDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetComplexMarketDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetComplexMarketDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetComplexMarketDataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetComplexMarketDataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetComplexMarketDataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetComplexMarketDataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetComplexMarketDataResponse>() {
           @Override
           public void write(JsonWriter out, GetComplexMarketDataResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetComplexMarketDataResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to GetComplexMarketDataResponse
  */
  public static GetComplexMarketDataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetComplexMarketDataResponse.class);
  }
