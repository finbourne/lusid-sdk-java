...
public class CreditSpreadCurveDataAllOf {
  ...
  public CreditSpreadCurveDataAllOf baseDate(OffsetDateTime baseDate) {
  ...
  **/
  ...
  public CreditSpreadCurveDataAllOf domCcy(String domCcy) {
    this.domCcy = domCcy; 
    return this;
  }
  ...
  **/
  ...
  public CreditSpreadCurveDataAllOf tenors(List<String> tenors) {
    this.tenors = tenors; 
    return this;
  }

  public CreditSpreadCurveDataAllOf addTenorsItem(String tenorsItem) {
  ...
  **/
  ...
  public CreditSpreadCurveDataAllOf referenceDate(OffsetDateTime referenceDate) {
  ...
  **/
  ...
  public CreditSpreadCurveDataAllOf maturities(List<OffsetDateTime> maturities) {
    this.maturities = maturities; 
    return this;
  }

  public CreditSpreadCurveDataAllOf addMaturitiesItem(OffsetDateTime maturitiesItem) {
  ...
  **/
  ...
  public CreditSpreadCurveDataAllOf lineage(String lineage) {
  ...
  **/
  ...
  public CreditSpreadCurveDataAllOf marketDataOptions(MarketDataOptions marketDataOptions) {
  ...
  **/
  ...
  public CreditSpreadCurveDataAllOf marketDataType(MarketDataTypeEnum marketDataType) {
