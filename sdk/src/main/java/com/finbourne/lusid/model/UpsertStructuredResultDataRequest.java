...
public class UpsertStructuredResultDataRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpsertStructuredResultDataRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertStructuredResultDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpsertStructuredResultDataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertStructuredResultDataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      StructuredResultDataId.validateJsonElement(jsonObj.get("id"));
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        StructuredResultData.validateJsonElement(jsonObj.get("data"));
      }
  }
