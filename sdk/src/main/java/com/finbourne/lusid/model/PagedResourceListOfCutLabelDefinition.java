...
public class PagedResourceListOfCutLabelDefinition {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfCutLabelDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfCutLabelDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfCutLabelDefinition is not found in the empty JSON string", PagedResourceListOfCutLabelDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfCutLabelDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfCutLabelDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfCutLabelDefinition.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        CutLabelDefinition.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfCutLabelDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfCutLabelDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfCutLabelDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfCutLabelDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfCutLabelDefinition>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfCutLabelDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfCutLabelDefinition read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfCutLabelDefinition
  */
  public static PagedResourceListOfCutLabelDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfCutLabelDefinition.class);
  }
