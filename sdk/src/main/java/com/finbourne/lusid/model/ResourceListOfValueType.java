...
public class ResourceListOfValueType {
  ...
  public ResourceListOfValueType() {
  }

  public ResourceListOfValueType values(List<ValueType> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfValueType addValuesItem(ValueType valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public ResourceListOfValueType href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfValueType nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfValueType previousPage(String previousPage) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ResourceListOfValueType
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceListOfValueType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceListOfValueType is not found in the empty JSON string", ResourceListOfValueType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResourceListOfValueType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceListOfValueType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceListOfValueType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceListOfValueType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceListOfValueType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceListOfValueType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceListOfValueType.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceListOfValueType>() {
           @Override
           public void write(JsonWriter out, ResourceListOfValueType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceListOfValueType read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResourceListOfValueType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResourceListOfValueType
  * @throws IOException if the JSON string is invalid with respect to ResourceListOfValueType
  */
  public static ResourceListOfValueType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceListOfValueType.class);
  }

 /**
  * Convert an instance of ResourceListOfValueType to an JSON string
  *
  * @return JSON string
  */
