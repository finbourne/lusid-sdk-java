...
public class FloatingLeg extends InstrumentLeg {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(startDate, maturityDate, legDefinition, notional, overrides, capRate, floorRate, super.hashCode());
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingLeg
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingLeg.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FloatingLeg.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FloatingLeg` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
