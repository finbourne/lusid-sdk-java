...
public class AllocationGroupDefinition {
  ...
  **/
  ...
  public AllocationGroupDefinition apportionmentMethodProperty(AllocationMethodProperty apportionmentMethodProperty) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AllocationGroupDefinition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllocationGroupDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllocationGroupDefinition is not found in the empty JSON string", AllocationGroupDefinition.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AllocationGroupDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllocationGroupDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllocationGroupDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllocationGroupDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllocationGroupDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<AllocationGroupDefinition>() {
           @Override
           public void write(JsonWriter out, AllocationGroupDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllocationGroupDefinition read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to AllocationGroupDefinition
  */
  public static AllocationGroupDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllocationGroupDefinition.class);
  }
