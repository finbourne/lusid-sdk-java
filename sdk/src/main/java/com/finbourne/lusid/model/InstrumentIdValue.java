...
public class InstrumentIdValue {
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "The value of the instrument id, which must not be empty or null. e.g, 'BBG123456'")
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(value = "The effective at date of the instrument id, which is optional. The default value in the null case  is DateTimeOffset.MinValue.")
