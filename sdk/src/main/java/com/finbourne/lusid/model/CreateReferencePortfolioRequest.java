...
public class CreateReferencePortfolioRequest {
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "The name of the reference portfolio.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A long form text description of the portfolio.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Unique identifier for the portfolio.")
   ...
   * @return created
  **/
  @ApiModelProperty(value = "The original creation date, defaults to today if not specified when creating a portfolio.")
  ...
  **/
  @ApiModelProperty(value = "Instrument Scopes.")
   ...
   * @return baseCurrency
  **/
  @ApiModelProperty(value = "The base currency of the transaction portfolio in ISO 4217 currency code format.")
