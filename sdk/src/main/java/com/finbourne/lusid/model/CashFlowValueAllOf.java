...
public class CashFlowValueAllOf {
  ...
  public CashFlowValueAllOf paymentDate(OffsetDateTime paymentDate) {
  ...
  **/
  ...
  public CashFlowValueAllOf diagnostics(ResultValueDictionary diagnostics) {
  ...
  **/
  ...
  public CashFlowValueAllOf cashFlowLineage(CashFlowLineage cashFlowLineage) {
  ...
  **/
  ...
  public CashFlowValueAllOf paymentAmount(java.math.BigDecimal paymentAmount) {
  ...
  **/
  ...
  public CashFlowValueAllOf paymentCcy(String paymentCcy) {
  ...
  **/
  ...
  public CashFlowValueAllOf resultValueType(ResultValueTypeEnum resultValueType) {
