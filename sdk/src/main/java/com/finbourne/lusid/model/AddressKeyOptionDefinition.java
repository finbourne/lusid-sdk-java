 ...
 */
@ApiModel(description = "The definition of an Address Key Option")
...
public class AddressKeyOptionDefinition {
  ...
  private List<String> allowedValueSet = null;
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type of the option")
   ...
   * @return optional
  **/
  @ApiModelProperty(required = true, value = "Is this option required or optional?")
  ...
  **/
  @ApiModelProperty(value = "If the option is a string or enum, the allowed set of values it can take.")
   ...
   * @return defaultValue
  **/
  @ApiModelProperty(value = "If the option is not required, what is the default value?")
