...
public class MarketDataKeyRule {
  ...
  **/
   ...
   * @return quoteType
  **/
  @ApiModelProperty(required = true, value = "The available values are: Price, Spread, Rate, LogNormalVol, NormalVol, ParSpread, IsdaSpread, Upfront, Index, Ratio, Delta, PoolFactor")
