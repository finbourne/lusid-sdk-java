...
public class MarketDataKeyRule {
   ...
   * @return dataScope
  **/
  @ApiModelProperty(value = "the scope in which the data should be found when using this rule.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.dataScope, marketDataKeyRule.dataScope) &&
        Objects.equals(this.key, marketDataKeyRule.key) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataScope, key, supplier, quoteType, priceSide);
  }
