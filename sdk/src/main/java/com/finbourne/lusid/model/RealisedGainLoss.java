...
public class RealisedGainLoss {
  ...
  private OffsetDateTime purchaseTradeDate = null;

  @SerializedName("purchaseSettlementDate")
  private OffsetDateTime purchaseSettlementDate = null;
  ...
  **/
   ...
   * @return units
  **/
  @ApiModelProperty(value = "Quantity against which gain has been made in units of the instrument")
  ...
  **/
  @ApiModelProperty(value = "Date the position was originally purchased")
  ...
  **/
  @ApiModelProperty(value = "Date the position originally settled")
  ...
  **/
  @ApiModelProperty(value = "Price the instrument was purchased at")
   ...
   * @return costTradeCcy
  **/
  @ApiModelProperty(value = "Purchase cost in the trade currency")
  ...
  **/
  @ApiModelProperty(value = "Gains or losses in the trade currency")
  ...
  **/
  @ApiModelProperty(value = "Total gains or losses in the portfolio currency")
  ...
  **/
  @ApiModelProperty(value = "Market gains or losses in the portfolio currency")
  ...
  **/
  @ApiModelProperty(value = "Currency gains or losses in the portfolio currency")
