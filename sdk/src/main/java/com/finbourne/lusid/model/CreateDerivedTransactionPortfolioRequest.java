...
public class CreateDerivedTransactionPortfolioRequest {
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "The name of the derived transaction portfolio.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A description for the derived transaction portfolio.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The code of the derived transaction portfolio. Together with the scope this uniquely identifies the derived transaction portfolio.")
  ...
  **/
   ...
   * @return created
  **/
  @ApiModelProperty(value = "The effective datetime at which to create the derived transaction portfolio. No transactions can be added to the derived transaction portfolio before this date. Defaults to the current LUSID system datetime if not specified.")
  ...
  **/
  @ApiModelProperty(value = "The resolution strategy used to resolve instruments of transactions/holdings upserted to this derived portfolio.")
