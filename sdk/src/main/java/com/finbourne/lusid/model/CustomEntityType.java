 ...
 */
@ApiModel(description = "Representation of a Custom Entity Type on the LUSID API")
...
public class CustomEntityType {
  ...
  **/
  @ApiModelProperty(required = true, value = "The name provided when the custom entity type was created. This has been prefixed with “~” and returned as “entityType”, which is the identifier for the custom entity type.")
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "A display label for the custom entity type.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A description for the custom entity type.")
   ...
   * @return entityType
  **/
  @ApiModelProperty(required = true, value = "The identifier for the custom entity type, derived from the “entityTypeName” provided on creation.")
   ...
   * @return fieldSchema
  **/
  @ApiModelProperty(required = true, value = "The description of the fields on the custom entity type.")
