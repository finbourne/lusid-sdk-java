...
public class FxForwardPipsCurveData extends ComplexMarketData {
  ...
  * @throws IOException if the JSON Object is invalid with respect to FxForwardPipsCurveData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FxForwardPipsCurveData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FxForwardPipsCurveData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FxForwardPipsCurveData` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
