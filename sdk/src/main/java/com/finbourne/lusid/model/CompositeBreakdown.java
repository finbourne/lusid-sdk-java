...
public class CompositeBreakdown {
  ...
  private List<PortfolioReturnBreakdown> constituents = null;
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The effectiveAt for the calculation.")
  ...
  **/
   ...
   * @return constituents
  **/
  @ApiModelProperty(value = "The constituents with their information which are part of the composite.")
