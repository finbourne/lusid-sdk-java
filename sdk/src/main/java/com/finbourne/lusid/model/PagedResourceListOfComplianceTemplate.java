...
public class PagedResourceListOfComplianceTemplate {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PagedResourceListOfComplianceTemplate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagedResourceListOfComplianceTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResourceListOfComplianceTemplate is not found in the empty JSON string", PagedResourceListOfComplianceTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PagedResourceListOfComplianceTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagedResourceListOfComplianceTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagedResourceListOfComplianceTemplate.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ComplianceTemplate.validateJsonElement(jsonArrayvalues.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResourceListOfComplianceTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResourceListOfComplianceTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResourceListOfComplianceTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResourceListOfComplianceTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResourceListOfComplianceTemplate>() {
           @Override
           public void write(JsonWriter out, PagedResourceListOfComplianceTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagedResourceListOfComplianceTemplate read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PagedResourceListOfComplianceTemplate
  */
  public static PagedResourceListOfComplianceTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResourceListOfComplianceTemplate.class);
  }
