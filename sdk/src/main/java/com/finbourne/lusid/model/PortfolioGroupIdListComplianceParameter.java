...
public class PortfolioGroupIdListComplianceParameter extends ComplianceParameter {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortfolioGroupIdListComplianceParameter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortfolioGroupIdListComplianceParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PortfolioGroupIdListComplianceParameter is not found in the empty JSON string", PortfolioGroupIdListComplianceParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PortfolioGroupIdListComplianceParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PortfolioGroupIdListComplianceParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PortfolioGroupIdListComplianceParameter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortfolioGroupIdListComplianceParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortfolioGroupIdListComplianceParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortfolioGroupIdListComplianceParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortfolioGroupIdListComplianceParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<PortfolioGroupIdListComplianceParameter>() {
           @Override
           public void write(JsonWriter out, PortfolioGroupIdListComplianceParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PortfolioGroupIdListComplianceParameter read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to PortfolioGroupIdListComplianceParameter
  */
  public static PortfolioGroupIdListComplianceParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortfolioGroupIdListComplianceParameter.class);
  }
