...
import com.finbourne.lusid.model.InflationSwapAllOf;
 ...
 */
@ApiModel(description = "LUSID representation of an Inflation Swap.  The implementation supports the following swap types:  * Zero Coupon inflation swap, with a single payment at maturity.  * LPI Swap (capped and floored)  * Year on Year inflation swap")
...
public class InflationSwap extends LusidInstrument {
  ...
  **/
  @ApiModelProperty(value = "silly flag for old swaps    Supported string (enumeration) values are: [Linear, Flat].")
