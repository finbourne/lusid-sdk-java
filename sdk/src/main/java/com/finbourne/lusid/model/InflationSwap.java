...
public class InflationSwap extends LusidInstrument {
  ...
  * @throws IOException if the JSON Object is invalid with respect to InflationSwap
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InflationSwap.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!InflationSwap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InflationSwap` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
