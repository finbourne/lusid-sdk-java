 ...
 */
@ApiModel(description = "Barrier class for exotic FxOption")
...
public class Barrier {
   ...
   * @return direction
  **/
  @ApiModelProperty(required = true, value = "Supported string (enumeration) values are: [Down, Up].")
   ...
   * @return level
  **/
  @ApiModelProperty(required = true, value = "Trigger level, which the underlying should (or should not) cross/touch.")
   ...
   * @return monitoring
  **/
  @ApiModelProperty(value = "Supported string (enumeration) values are: [European, Bermudan, American].")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Supported string (enumeration) values are: [Knockin, Knockout].")
