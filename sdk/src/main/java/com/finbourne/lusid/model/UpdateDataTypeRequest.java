...
public class UpdateDataTypeRequest {
  ...
  private List<UpdateUnitRequest> acceptableUnits = null;
   ...
   * @return displayName
  **/
  @ApiModelProperty(value = "The display name of the data type.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description of the data type.")
