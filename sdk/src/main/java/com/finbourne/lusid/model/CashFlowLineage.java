 ...
 */
@ApiModel(description = "Lineage for cash flow value")
...
public class CashFlowLineage {
  ...
  **/
  @ApiModelProperty(value = "The instrument type of the instrument to which the cash flow belongs to. When upserting CashFlowValues, this  should be null.")
   ...
   * @return cashFlowType
  **/
  @ApiModelProperty(value = "The cashflow type.When upserting CashFlowValues, this should be null, or one of [Unknown, Coupon, Notional,  Premium, Principal, Protection, Cash]")
   ...
   * @return instrumentId
  **/
  @ApiModelProperty(value = "The LUID of the instrument to which the cash flow belongs to. When upserting this should be null.")
   ...
   * @return legId
  **/
  @ApiModelProperty(value = "The leg id to which the cash flow belongs to.")
  ...
  **/
  @ApiModelProperty(value = "The source transaction of the instrument to which the cash flow belongs to. When upserting this should be null")
   ...
   * @return payReceive
  **/
  @ApiModelProperty(value = "Does the cash flow belong to the Pay or Receive leg. When upserting this should either be null or one of [Pay, Receive, NotApplicable]")
