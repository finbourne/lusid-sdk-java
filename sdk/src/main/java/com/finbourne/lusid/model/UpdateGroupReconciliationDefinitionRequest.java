...
public class UpdateGroupReconciliationDefinitionRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateGroupReconciliationDefinitionRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGroupReconciliationDefinitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGroupReconciliationDefinitionRequest is not found in the empty JSON string", UpdateGroupReconciliationDefinitionRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGroupReconciliationDefinitionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGroupReconciliationDefinitionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGroupReconciliationDefinitionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGroupReconciliationDefinitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGroupReconciliationDefinitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGroupReconciliationDefinitionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateGroupReconciliationDefinitionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGroupReconciliationDefinitionRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpdateGroupReconciliationDefinitionRequest
  */
  public static UpdateGroupReconciliationDefinitionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGroupReconciliationDefinitionRequest.class);
  }
