...
public class CreateResults {
  ...
  **/
  ...
  public CreateResults scope(String scope) {
    this.scope = scope;
    return this;
  }
   ...
   * @return scope
  **/
  @ApiModelProperty(value = "The scope of the data to be stored.")
  ...
  public CreateResults key(String key) {
    this.key = key;
    return this;
  }
   ...
   * @return key
  **/
  @ApiModelProperty(value = "The key is a unique point in 'run' space. For a given scope and time point, one would wish to  identify a unique result set for a given recipe. In essence, this key is the unique identifier for the tuple (recipe,portfolios)  However, that only matters when one is trying to use it automatically to retrieve them.  A question becomes whether we would wish to store groups of protfolio results together, or only single ones.  Also, whether we would accept uploading of groups and then split them apart.")
  ...
  public CreateResults date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
   ...
   * @return date
  **/
  @ApiModelProperty(value = "The date for which the results should be stored.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, createResults.data) &&
        Objects.equals(this.scope, createResults.scope) &&
        Objects.equals(this.key, createResults.key) &&
        Objects.equals(this.date, createResults.date) &&
        Objects.equals(this.format, createResults.format);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, scope, key, date, format);
  }
