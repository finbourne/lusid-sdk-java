...
public class ApiClient {
    ...
    private String basePath = "http://local-unit-test-server.lusid.com:58431";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.3566/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://local-unit-test-server.lusid.com:58431
