...
public class ApiClient {
    ...
    private String basePath = "https://fbn-ci.lusid.com/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.4750/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://fbn-ci.lusid.com/api
