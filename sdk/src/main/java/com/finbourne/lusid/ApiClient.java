...
public class ApiClient {
    ...
    private String basePath = "http://local-unit-test-server.lusid.com:47887";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.3268/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://local-unit-test-server.lusid.com:47887
