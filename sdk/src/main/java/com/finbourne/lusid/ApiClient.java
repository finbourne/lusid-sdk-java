...
public class ApiClient {
    ...
    private String basePath = "http://local-unit-test-server.lusid.com:38040";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.3956/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://local-unit-test-server.lusid.com:38040
