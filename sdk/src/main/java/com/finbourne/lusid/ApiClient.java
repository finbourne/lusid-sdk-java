...
public class ApiClient {
    ...
    private String basePath = "https://www.lusid.com/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.5031/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.lusid.com/api
