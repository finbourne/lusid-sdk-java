...
public class ApiClient {
    ...
    private String basePath = "http://local-unit-test-server.lusid.com:56616";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.2797/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://local-unit-test-server.lusid.com:56616
