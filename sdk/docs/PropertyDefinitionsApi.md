...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **domain** | **String**| The Property Domain of the property to be deleted | [enum: Trade, Portfolio, Security, Holding, ReferenceHolding, TxnType, Instrument]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **domain** | **String**| The Property Domain of the requested property | [enum: Trade, Portfolio, Security, Holding, ReferenceHolding, TxnType, Instrument]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **domain** | **String**| The Property Domain of the property being updated | [enum: Trade, Portfolio, Security, Holding, ReferenceHolding, TxnType, Instrument]
