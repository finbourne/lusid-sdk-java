...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **domain** | **String**| The Property Domain of the property to be deleted | [enum: Trade, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, CutDefinition, Analytic]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **domain** | **String**| The Property Domain of the requested property | [enum: Trade, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, CutDefinition, Analytic]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **domain** | **String**| The Property Domain of the property being updated | [enum: Trade, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, CutDefinition, Analytic]
