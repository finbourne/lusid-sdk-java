# com.finbourne.lusid.model.ValuationRequest
...
**reportCurrency** | **String** | Three to five letter currency string indicating what currency to report in for ReportCurrency denominated queries.  If not present, then the currency of the relevant portfolio will be used in its place. | [optional] [default to String]
