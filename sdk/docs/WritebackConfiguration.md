# com.finbourne.lusid.model.WritebackConfiguration
...
// Example with SettleExpectedActivityWritebackConfiguration WritebackConfiguration
SettleExpectedActivityWritebackConfiguration writebackConfiguration = new SettleExpectedActivityWritebackConfiguration();
writebackConfiguration.setType(SettleExpectedActivityWritebackConfiguration.TypeEnum.SETTLEEXPECTEDACTIVITYWRITEBACKCONFIGURATION);
WritebackConfiguration config = new WritebackConfiguration(writebackConfiguration);

```
 See all compatible oneOf types with WritebackConfiguration
* [SettleExpectedActivityWritebackConfiguration](./SettleExpectedActivityWritebackConfiguration.md)
