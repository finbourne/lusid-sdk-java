...
**scope** | **String** | The scope of the entities to check. Required for scoped entity types (Instrument, Portfolio, InvestmentAccount).  Must not be provided for unscoped entity types (LegalEntity). | [optional] [default to String]
