# com.finbourne.lusid.model.ConsentDeniedElection
Election to deny consent to the proposed action (CONN).
...
ConsentDeniedElection consentDeniedElectionInstance = new ConsentDeniedElection()
