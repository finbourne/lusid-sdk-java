# com.finbourne.lusid.model.ComplianceRuleTemplateEntity
...
**prevailingComplianceRuleTemplate** | [**ComplianceRuleTemplate**](ComplianceRuleTemplate.md) |  | [optional] [default to ComplianceRuleTemplate]
**deletedComplianceRuleTemplate** | [**ComplianceRuleTemplate**](ComplianceRuleTemplate.md) |  | [optional] [default to ComplianceRuleTemplate]
...
**previewedComplianceRuleTemplate** | [**ComplianceRuleTemplate**](ComplianceRuleTemplate.md) |  | [optional] [default to ComplianceRuleTemplate]
...
ComplianceRuleTemplate PrevailingComplianceRuleTemplate = new ComplianceRuleTemplate();
ComplianceRuleTemplate DeletedComplianceRuleTemplate = new ComplianceRuleTemplate();
@jakarta.annotation.Nullable String PreviewedStatus = "example PreviewedStatus";
ComplianceRuleTemplate PreviewedComplianceRuleTemplate = new ComplianceRuleTemplate();
@jakarta.annotation.Nullable List<Link> Links = new List<Link>();


ComplianceRuleTemplateEntity complianceRuleTemplateEntityInstance = new ComplianceRuleTemplateEntity()
    .Href(Href)
    ...
    .PrevailingComplianceRuleTemplate(PrevailingComplianceRuleTemplate)
    .DeletedComplianceRuleTemplate(DeletedComplianceRuleTemplate)
    .PreviewedStatus(PreviewedStatus)
    .PreviewedComplianceRuleTemplate(PreviewedComplianceRuleTemplate)
    .Links(Links);
```
