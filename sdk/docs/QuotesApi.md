...
> QuoteAccessMetadataRule deleteQuoteAccessMetadataRule(scope).provider(provider).priceSource(priceSource).instrumentIdType(instrumentIdType).instrumentId(instrumentId).quoteType(quoteType).field(field).effectiveAt(effectiveAt).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      QuoteAccessMetadataRule result = apiInstance.deleteQuoteAccessMetadataRule(scope)
            .provider(provider)
...
<a id="deleteQuotes"></a>
# **deleteQuotes**
> AnnulQuotesResponse deleteQuotes(scope).requestBody(requestBody).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AnnulQuotesResponse result = apiInstance.deleteQuotes(scope)
...
<a id="getQuotes"></a>
# **getQuotes**
> GetQuotesResponse getQuotes(scope).effectiveAt(effectiveAt).asAt(asAt).maxAge(maxAge).requestBody(requestBody).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetQuotesResponse result = apiInstance.getQuotes(scope)
            .effectiveAt(effectiveAt)
            .asAt(asAt)
            .maxAge(maxAge)
            .requestBody(requestBody)
...
> QuoteAccessMetadataRule getQuotesAccessMetadataRule(scope).provider(provider).priceSource(priceSource).instrumentIdType(instrumentIdType).instrumentId(instrumentId).quoteType(quoteType).field(field).effectiveAt(effectiveAt).asAt(asAt).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      QuoteAccessMetadataRule result = apiInstance.getQuotesAccessMetadataRule(scope)
            .provider(provider)
            .priceSource(priceSource)
            .instrumentIdType(instrumentIdType)
            .instrumentId(instrumentId)
...
> ResourceListOfQuoteAccessMetadataRule listQuotesAccessMetadataRules(scope).asAt(asAt).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    OffsetDateTime asAt = OffsetDateTime.now(); // OffsetDateTime | The asAt datetime at which to retrieve the access metadata rule. Defaults to return the latest version if not specified.
    try {
      ResourceListOfQuoteAccessMetadataRule result = apiInstance.listQuotesAccessMetadataRules(scope)
            .asAt(asAt)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
...
> QuoteAccessMetadataRule upsertQuoteAccessMetadataRule(scope, upsertQuoteAccessMetadataRuleRequest).effectiveAt(effectiveAt).effectiveUntil(effectiveUntil).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      QuoteAccessMetadataRule result = apiInstance.upsertQuoteAccessMetadataRule(scope, upsertQuoteAccessMetadataRuleRequest)
            .effectiveAt(effectiveAt)
...
<a id="upsertQuotes"></a>
# **upsertQuotes**
> UpsertQuotesResponse upsertQuotes(scope).requestBody(requestBody).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UpsertQuotesResponse result = apiInstance.upsertQuotes(scope)
            .requestBody(requestBody)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
