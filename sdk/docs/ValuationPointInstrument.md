...
@jakarta.annotation.Nullable List<String> ValuationPointOriginSource = new List<String>();
@jakarta.annotation.Nullable List<String> ValuationPointOriginType = new List<String>();
