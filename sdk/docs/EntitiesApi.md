...
> InstrumentEntity getInstrumentByEntityUniqueId(entityUniqueId).effectiveAt(effectiveAt).asAt(asAt).previews(previews).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InstrumentEntity result = apiInstance.getInstrumentByEntityUniqueId(entityUniqueId)
