# com.finbourne.lusid.model.FinalisedValuationPoint

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**code** | **String** | The unique code of the Valuation Point. The Valuation Point Code, together with the Fund Scope and Code, uniquely identifies a Valuation Point. | [default to String]
**finalisedFromVariant** | **String** | The variant of the Estimate Valuation Point that was finalised to create the Finalised Valuation Point. | [optional] [default to String]
...
@jakarta.annotation.Nullable String FinalisedFromVariant = "example FinalisedFromVariant";
