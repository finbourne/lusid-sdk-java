# com.finbourne.lusid.model.PagedResourceListOfOrderInstruction
...
PagedResourceListOfOrderInstruction pagedResourceListOfOrderInstructionInstance = new PagedResourceListOfOrderInstruction()
    .NextPage(NextPage)
